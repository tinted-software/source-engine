...
private:
  ...
  // list of servers to be refreshed, in order... this would be more optimal as
  // a queue
  CUtlVector<int> m_RefreshList;

  int m_iUpdateSerialNumber; // serial number of current update so we don't get
                             // results overlapping between different server
                             // list updates
