...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CRulesContextMenu::CRulesContextMenu(Panel *parent)
    : Menu(parent, "RulesContextMenu") {
...
void CRulesContextMenu::ShowMenu(Panel *target, unsigned int cvarID) {
  ...
  AddMenuItem("cvar", "&Change Value", new KeyValues("cvar", "cvarID", cvarID),
              CRulesContextMenu::parent);
