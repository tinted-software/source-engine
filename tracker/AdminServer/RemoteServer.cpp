  ...
  while (1) {
    ...
    case SERVERDATA_RESPONSE_VALUE: {
      ...
      for (int i = m_ResponseHandlers.Head();
           m_ResponseHandlers.IsValidIndex(i); i = m_ResponseHandlers.Next(i)) {
    ...
    case SERVERDATA_UPDATE: {
      ...
      for (int i = m_MessageHandlers.Head(); m_MessageHandlers.IsValidIndex(i);
           i = m_MessageHandlers.Next(i)) {
