...
//menus work 		3) Forward all commands to the tool system so all smarts can reside
//there 		4) Control the size of the menu bar + the working area
//=============================================================================
...
CToolUI::CToolUI(vgui::Panel *pParent, const char *panelName,
    ...
    : BaseClass(pParent, panelName), m_pClientArea(0),
