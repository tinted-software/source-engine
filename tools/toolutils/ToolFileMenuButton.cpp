...
CToolFileMenuButton::CToolFileMenuButton(vgui::Panel *pParent,
  ...
  // Add the Perforce menu options only if there is a valid P4 interface (SDK
  // users won't have this)
  if (p4) {
    m_pPerforce = new vgui::Menu(this, "Perforce");
    m_pMenu->AddCascadingMenuItem("#ToolPerforce", this, m_pPerforce);
    m_nPerforceAdd =
        m_pPerforce->AddMenuItem("perforce_add", "#ToolPerforceAdd",
                                 new KeyValues("OnPerforceAdd"), this);
    m_nPerforceOpen =
