...
public:
  ...
  AddNewParticleSystemDefinition(const char *pName);

  // Deletes a particle system definition
  void
  DeleteParticleSystemDefinition(CDmeParticleSystemDefinition *pParticleSystem);
  ...
  void ReplaceParticleSystemDefinition(
