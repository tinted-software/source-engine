...
//-----------------------------------------------------------------------------
class CPetTool : public CBaseToolSystem,
                 public IFileMenuCallbacks,
                 public IPetDocCallback,
                 public IPetTool {
...
public:
  ...
  KEYBINDING_FUNC(redo, KEY_Z, vgui::MODIFIER_CONTROL | vgui::MODIFIER_SHIFT,
                  OnRedo, "#redo_help", 0);
  KEYBINDING_FUNC_NODECLARE(edit_copy, KEY_C, vgui::MODIFIER_CONTROL, OnCopy,
                            "#edit_copy_help", 0);
  KEYBINDING_FUNC_NODECLARE(edit_paste, KEY_V, vgui::MODIFIER_CONTROL, OnPaste,
                            "#edit_paste_help", 0);
  ...
  void SetCurrentParticleSystem(CDmeParticleSystemDefinition *pParticleSystem,
                                bool bForceBrowserSelection = true);
...
private:
  ...
  // The entity report
  vgui::DHANDLE<CParticleSystemDefinitionBrowser>
