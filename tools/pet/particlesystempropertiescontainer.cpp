...
CParticleSystemPropertiesContainer::CParticleSystemPropertiesContainer(
    CPetDoc *pDoc, vgui::Panel *pParent)
...
void CParticleSystemPropertiesContainer::GetKnownParticleDefinitions(
  ...
  CDmrParticleSystemList particleSystemList =
      g_pPetTool->GetDocument()->GetParticleSystemDefinitionList();
...
void CParticleSystemPropertiesContainer::OnParticleSystemModified() {
  CAppNotifyScopeGuard sg(
      "CParticleSystemPropertiesContainer::OnParticleSystemModified",
      NOTIFY_SETDIRTYFLAG);
}
...
//-----------------------------------------------------------------------------
void CParticleSystemPropertiesContainer::OnParticleFunctionSelChanged(
    KeyValues *pParams) {
