...
public:
  CParticleSystemDefinitionBrowser(CPetDoc *pDoc, vgui::Panel *pParent,
                                   const char *pName); // standard constructor
...
private:
  ...
  // Create from KV
  void LoadKVSection(CDmeParticleSystemDefinition *pNew,
                     KeyValues *pOverridesKv, ParticleFunctionType_t eType);
