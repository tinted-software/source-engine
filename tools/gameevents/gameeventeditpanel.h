...
public:
  CGameEventEditPanel(CGameEventEditDoc *pDoc,
...
private:
  // Text to attribute...
  // void TextEntryToAttribute( vgui::TextEntry *pEntry, const char
  // *pAttributeName ); void TextEntriesToVector( vgui::TextEntry *pEntry[3],
