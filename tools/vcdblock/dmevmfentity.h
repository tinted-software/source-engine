...
public:
  ...
  bool CopyFromServer(CBaseEntity *pServerEnt, const char *szSrcField,
...
private:
  ...
  CDmaVar<Vector> m_vecLocalAngles; // something funky with the vmf importer, it
                                    // asserts when it's a QAngle
