...
public:
  CScrollableEditablePanel(vgui::Panel *pParent, vgui::EditablePanel *pChild,
                           const char *pName);
...
CScrollableEditablePanel::CScrollableEditablePanel(vgui::Panel *pParent,
                                                   vgui::EditablePanel *pChild,
                                                   const char *pName)
...
// Constructor
//-----------------------------------------------------------------------------
CInfoTargetPropertiesPanel::CInfoTargetPropertiesPanel(CVcdBlockDoc *pDoc,
                                                       vgui::Panel *pParent)
  ...
  m_pInfoTargetScroll =
      new CScrollableEditablePanel(this, m_pInfoTarget, "InfoTargetScroll");
...
// Text to attribute...
//-----------------------------------------------------------------------------
void CInfoTargetPropertiesPanel::TextEntryToAttribute(
...
void CInfoTargetPropertiesPanel::TextEntriesToVector(
