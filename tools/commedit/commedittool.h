...
public:
  ...
  virtual void ShowEntityInEntityProperties(CDmeCommentaryNodeEntity *
                                            pEntity) = 0;
};
...
public:
  ...
  KEYBINDING_FUNC(redo, KEY_Z, vgui::MODIFIER_CONTROL | vgui::MODIFIER_SHIFT,
                  OnRedo, "#redo_help", 0);
  KEYBINDING_FUNC_NODECLARE(CommEditAddNewNodes, KEY_A, vgui::MODIFIER_CONTROL,
                            OnAddNewNodes, "#CommEditAddNewNodesHelp", 0);
