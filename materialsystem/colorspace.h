...
extern float g_LinearToVertex[4096]; // linear (0..4) to screen corrected vertex
                                     // space (0..1?)
...
LinearToBumpedLightmap(FLTX4 linearColor, FLTX4 linearBumpColor1,
                       ...
                       fltx4 &retBump2,
                       fltx4 &retBump3) // these will be returned on registers
{
  ...
  correctionScale = MulSIMD(
      AndNotSIMD(zeroTerms, linearColor), // crush values that were zero in
...
LinearToBumpedLightmap(const float *linearColor, const float *linearBumpColor1,
                       const float *linearBumpColor2,
                       const float *linearBumpColor3, unsigned short *ret,
                       unsigned short *retBump1, unsigned short *retBump2,
