...
enum ResidencyType_t { RESIDENT_NONE, RESIDENT_PARTIAL, RESIDENT_FULL };
...
public:
  ...
  virtual bool AsyncReadTextureFromFile(
      IVTFTexture * pVTFTexture, unsigned int nAdditionalCreationFlags) = 0;
