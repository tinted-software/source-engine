...
VertexFormat_t
CShaderAPIDx10::ComputeVertexFormat(int numSnapshots,
...
void CShaderAPIDx10::OverrideAlphaWriteEnable(bool bOverrideEnable,
                                              bool bAlphaWriteEnable) {}

void CShaderAPIDx10::OverrideColorWriteEnable(bool bOverrideEnable,
...
ImageFormat CShaderAPIDx10::GetNearestSupportedFormat(
    ImageFormat fmt, bool bFilteringRequired /* = true */) const {
  return fmt;
}

ImageFormat
CShaderAPIDx10::GetNearestRenderTargetFormat(ImageFormat fmt) const {
  return fmt;
}
...
CShaderAPIDx10::CreateTexture(int width, int height, int depth,
...
ShaderAPITextureHandle_t
CShaderAPIDx10::CreateDepthTexture(ImageFormat renderFormat, int width,
...
void CShaderAPIDx10::ClearBuffersObeyStencilEx(bool bClearColor,
                                               bool bClearAlpha,
                                               bool bClearDepth) {}
...
double CShaderAPIDx10::CurrentTime() const { return Sys_FloatTime(); }
