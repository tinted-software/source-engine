...
enum RecordingCommands_t {
  ...
  DX8_KEYFRAME, // isn't actually a dx8 command, used to help find particular
                // frames
  ...
  DX8_SET_VERTEX_BUFFER_FORMAT, // isn't actually a dx8 command. . let's
                                // playback know what format a buffer is for
                                // listing info
