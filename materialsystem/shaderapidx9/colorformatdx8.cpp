...
static bool TestTextureFormat(D3DFORMAT format, bool bIsRenderTarget,
  ...
  if (!IsX360() && bIsRenderTarget &&
      ((format == NVFMT_RAWZ) || (format == NVFMT_INTZ) ||
  ...
  } else // 360
  {
    ...
    hr = D3D()->CheckDeviceFormat(g_DisplayAdapter, g_DeviceType, format, 0,
...
D3DFORMAT GetNearestD3DColorFormat(ImageFormat fmt, bool isRenderTarget,
  ...
  case IMAGE_FORMAT_LINEAR_BGRA8888:
    ...
    if (TestTextureFormat(D3DFMT_LIN_A8R8G8B8, isRenderTarget, bIsVertexTexture,
                          bIsFilterableRequired))
  ...
  case IMAGE_FORMAT_LINEAR_BGRX8888:
    if (TestTextureFormat(D3DFMT_LIN_X8R8G8B8, isRenderTarget, bIsVertexTexture,
                          bIsFilterableRequired))
  ...
  case IMAGE_FORMAT_LINEAR_BGRX5551:
    if (TestTextureFormat(D3DFMT_LIN_X1R5G5B5, isRenderTarget, bIsVertexTexture,
                          bIsFilterableRequired))
  ...
  case IMAGE_FORMAT_LINEAR_I8:
    if (TestTextureFormat(D3DFMT_LIN_L8, isRenderTarget, bIsVertexTexture,
                          bIsFilterableRequired))
  ...
  case IMAGE_FORMAT_LINEAR_RGBA16161616:
    if (TestTextureFormat(D3DFMT_LIN_A16B16G16R16, isRenderTarget,
                          bIsVertexTexture, bIsFilterableRequired))
