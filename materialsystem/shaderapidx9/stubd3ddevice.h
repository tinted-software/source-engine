...
public:
  ...
  void __stdcall SetCursorPosition(UINT XScreenSpace, UINT YScreenSpace,
                                   DWORD Flags) {
  ...
  HRESULT __stdcall GetBackBuffer(UINT BackBuffer, D3DBACKBUFFER_TYPE Type,
  ...
  HRESULT __stdcall CreateDepthStencilSurface(UINT Width, UINT Height,
                                              D3DFORMAT Format,
                                              D3DMULTISAMPLE_TYPE MultiSample,
                                              IDirect3DSurface8 **ppSurface) {
  ...
  HRESULT __stdcall CreateImageSurface(UINT Width, UINT Height,
                                       D3DFORMAT Format,
                                       IDirect3DSurface8 **ppSurface) {
  ...
  HRESULT __stdcall CopyRects(IDirect3DSurface8 *pSourceSurface,
  ...
  HRESULT __stdcall UpdateTexture(IDirect3DBaseTexture8 *pSourceTexture,
  ...
  HRESULT __stdcall SetRenderTarget(IDirect3DSurface8 *pRenderTarget,
  ...
  HRESULT __stdcall MultiplyTransform(D3DTRANSFORMSTATETYPE transformState,
                                      CONST D3DMATRIX *pMatrix) {
  ...
  HRESULT __stdcall GetInfo(DWORD DevInfoID, void *pDevInfoStruct,
  ...
  HRESULT __stdcall CreateVertexShader(CONST DWORD *pDeclaration,
  ...
  HRESULT __stdcall SetVertexShaderConstant(DWORD Register,
  ...
  HRESULT __stdcall GetVertexShaderConstant(DWORD Register, void *pConstantData,
                                            DWORD ConstantCount) {
  ...
  HRESULT __stdcall GetVertexShaderDeclaration(DWORD Handle, void *pData,
                                               DWORD *pSizeOfData) {
    FPRINTF(s_FileHandle, "GetVertexShaderDeclaration\n");
    return m_pD3DDevice->GetVertexShaderDeclaration(Handle, pData, pSizeOfData);
  }

  HRESULT __stdcall GetVertexShaderFunction(DWORD Handle, void *pData,
                                            DWORD *pSizeOfData) {
  ...
  HRESULT __stdcall SetIndices(IDirect3DIndexBuffer8 *pIndexData,
                               UINT BaseVertexIndex) {
    FPRINTF(s_FileHandle, "SetIndices\n");
    return m_pD3DDevice->SetIndices(pIndexData, BaseVertexIndex);
  }

  HRESULT __stdcall GetIndices(IDirect3DIndexBuffer8 **ppIndexData,
  ...
  HRESULT __stdcall SetPixelShaderConstant(DWORD Register,
                                           CONST void *pConstantData,
                                           DWORD ConstantCount) {
  ...
  HRESULT __stdcall GetPixelShaderConstant(DWORD Register, void *pConstantData,
                                           DWORD ConstantCount) {
  ...
  HRESULT __stdcall GetPixelShaderFunction(DWORD Handle, void *pData,
                                           DWORD *pSizeOfData) {
