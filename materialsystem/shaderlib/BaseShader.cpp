...
bool g_shaderConfigDumpEnable =
    false; // true;		//DO NOT CHECK IN ENABLED FIXME
...
//-----------------------------------------------------------------------------
// Finds a particular parameter	(works because the lowest parameters match the
// shader)
//-----------------------------------------------------------------------------
...
void CBaseShader::GetTextureDimensions(float *pOutWidth, float *pOutHeight,
                                       int nTextureVar) {
