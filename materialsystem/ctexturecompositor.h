...
//================================== //
//
// Purpose: Defines a texture compositor which uses simple operations and
// shaders to create complex procedural textures.
//
//==============================================================================================
////
...
public:
  CTextureCompositor(int _width, int _height, int nTeam,
                     const char *pCompositeName, uint64 nRandomSeed,
...
public:
  static CTextureCompositorTemplate *Create(const char *pName,
                                            KeyValues *pTmplDesc);
...
private:
  ...
  // If we are an implementation of another template, what is that template's
  // name?
  CUtlString m_ImplementsName;

  // Have we checked this template and it's hierarchy for cycles? If so we can
  // early out on future checks.
...
CTextureCompositor *CreateTextureCompositor(int _w, int _h,
                                            ...
                                            int nTeamNum, uint64 _randomSeed,
