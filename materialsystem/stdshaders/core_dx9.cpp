...
SHADER_PARAM(FLOWMAPFRAME, SHADER_PARAM_TYPE_INTEGER, "0",
             "frame number for $flowmap")
SHADER_PARAM(FLOWMAPSCROLLRATE, SHADER_PARAM_TYPE_VEC2, "[0 0",
...
inline void DrawPass(IMaterialVar **params, IShaderShadow *pShaderShadow,
  ...
  SHADOW_STATE {
    ...
    if (g_pHardwareConfig->SupportsPixelShaders_2_b()) {
      ...
      SET_STATIC_PIXEL_SHADER_COMBO(CORECOLORTEXTURE,
                                    bHasCoreColorTexture && (nPass == 0));
