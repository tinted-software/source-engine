...
BEGIN_VS_SHADER(MonitorScreen_DX9,
                "This is a shader that does a contrast/saturation version of "
                "base times lightmap.")

BEGIN_SHADER_PARAMS
SHADER_PARAM(CONTRAST, SHADER_PARAM_TYPE_FLOAT, "0.0",
...
SHADER_PARAM(TEXTURE2, SHADER_PARAM_TYPE_TEXTURE,
             "shadertest/lightmappedtexture", "second texture")
