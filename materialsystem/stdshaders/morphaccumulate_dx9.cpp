...
SHADER_DRAW {
  ...
  DYNAMIC_STATE {
    ...
    if (!bUseConstantBasedAccum) {
      ...
      int nXOffset = pShaderAPI->GetIntRenderingParameter(
          INT_RENDERPARM_MORPH_WEIGHT_X_OFFSET);
      int nYOffset = pShaderAPI->GetIntRenderingParameter(
          INT_RENDERPARM_MORPH_WEIGHT_Y_OFFSET);
      int nSubrectWidth = pShaderAPI->GetIntRenderingParameter(
          INT_RENDERPARM_MORPH_WEIGHT_SUBRECT_WIDTH);
      int nSubrectHeight = pShaderAPI->GetIntRenderingParameter(
