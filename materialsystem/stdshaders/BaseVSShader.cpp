...
void CBaseVSShader::SetVertexShaderMatrix2x4(int vertexReg, int matrixVar) {
  ...
  if (pTranslationVar) {
    s_pShaderAPI->SetVertexShaderConstant(
        vertexReg, &pTranslationVar->GetMatrixValue()[0][0], 2);
  } else {
    VMatrix matrix;
...
// constant.
//-----------------------------------------------------------------------------
void CBaseVSShader::LoadViewportTransformScaledIntoVertexShaderConstant(
    int vertexReg) {
  ...
  // (x, y, z, w) = (Width / bbWidth, Height / bbHeight, MinX / bbWidth, MinY /
  // bbHeight)
  Vector4D viewportTransform(1.0f * viewport.m_nWidth / bbWidth,
...
void CBaseVSShader::SetHWMorphVertexShaderState(
  ...
  float pMorphAccumSize[4] = {(float)nMorphWidth, (float)nMorphHeight,
                              (float)nDim, 0.0f};
  ...
  float pMorphAccumSubrect[4] = {(float)nXOffset, (float)nYOffset,
