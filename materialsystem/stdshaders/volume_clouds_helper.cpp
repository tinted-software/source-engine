...
void DrawVolumeClouds(CBaseVSShader *pShader, IMaterialVar **params,
  ...
  DYNAMIC_STATE {
    ...
    vPackedVsConst1[0] -=
        (float)((int)(vPackedVsConst1[0] / (2.0f * 3.14159f))) * 2.0f *
        3.14159f;
    vPackedVsConst1[1] -=
        (float)((int)(vPackedVsConst1[1] / (2.0f * 3.14159f))) * 2.0f *
        3.14159f;
    vPackedVsConst1[2] -=
        (float)((int)(vPackedVsConst1[2] / (2.0f * 3.14159f))) * 2.0f *
        3.14159f;
    ...
    vPackedConst6[0] = IS_PARAM_DEFINED(info.m_nRefractAmount)
