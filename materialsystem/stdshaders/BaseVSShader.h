...
public:
  ...
  void
  SetEnvMapTintPixelShaderDynamicState(int pixelReg, int tintVar, int alphaVar,
...
#if SUPPORT_DX8
  void
  DrawFlashlight_dx80(IMaterialVar **params, IShaderDynamicAPI *pShaderAPI,
                      IShaderShadow *pShaderShadow, bool bBump, int bumpmapVar,
                      int bumpmapFrame, int bumpTransform,
                      ...
                      int baseTexture2FrameVar, bool bTeeth = false,
...
FORCEINLINE void
SetFlashLightColorFromState(FlashlightState_t const &state,
                            IShaderDynamicAPI *pShaderAPI, int nPSRegister = 28,
