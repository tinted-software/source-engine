...
void InitParamsPortalRefract_DX8(CBaseVSShader *pShader, IMaterialVar **params,
...
void InitPortalRefract_DX8(CBaseVSShader *pShader, IMaterialVar **params,
                           PortalRefractVarsDX8_t &info) {
...
void DrawPortalRefract_DX8(CBaseVSShader *pShader, IMaterialVar **params,
  ...
  DYNAMIC_STATE {
    ...
    vPackedConst1[0] = (IS_PARAM_DEFINED(info.m_nPortalOpenAmount)
    ...
    vPackedConst1[2] = (IS_PARAM_DEFINED(info.m_nPortalColorScale)
