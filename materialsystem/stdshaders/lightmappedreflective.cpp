...
inline void DrawReflectionRefraction(IMaterialVar **params,
  ...
  DYNAMIC_STATE {
    ...
    if (params[BASETEXTURE]->IsTexture()) {
      ...
      SetVertexShaderTextureTransform(VERTEX_SHADER_SHADER_SPECIFIC_CONST_3,
    ...
    // fresnel constants
    float flFresnelFactor = params[MAXREFLECTIVITY]->GetFloatValue() -
                            params[MINREFLECTIVITY]->GetFloatValue();
