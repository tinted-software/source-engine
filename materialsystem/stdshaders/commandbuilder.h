...
public:
  ...
  FORCEINLINE void PutIntPtr(intp nValue) { Put(nValue); }
...
public:
  ...
  FORCEINLINE void
  SetEnvMapTintPixelShaderDynamicStateGammaToLinear(int pixelReg, int tintVar,
  ...
  FORCEINLINE void
  SetDepthFeatheringPixelShaderConstant(int iConstant, float fDepthBlendScale) {
