...
const char *GetPixelShaderName(IMaterialVar **params, bool bHasBaseTexture,
                               bool bHasDetailTexture) {
...
SHADER_DRAW {
  ...
  SHADOW_STATE {
    ...
    const char *pPixelShaderName =
        GetPixelShaderName(params, bHasBaseTexture, bHasDetailTexture);
