...
SHADER_PARAM_OVERRIDE(BASETEXTURE, SHADER_PARAM_TYPE_TEXTURE,
                      "shadertest/GooInGlass", "Base texture", 0)
...
SHADER_PARAM_OVERRIDE(ALPHA, SHADER_PARAM_TYPE_FLOAT, "1.0", "unused",
                      SHADER_PARAM_NOT_EDITABLE)
SHADER_PARAM(BUMPMAP, SHADER_PARAM_TYPE_TEXTURE, "shadertest/GooInGlass_normal",
             "bump map")
SHADER_PARAM(BUMPTRANSFORM, SHADER_PARAM_TYPE_MATRIX,
             "center .5 .5 scale 1 1 rotate 0 translate 0 0",
             "$bump texcoord transform")
SHADER_PARAM(ENVMAP, SHADER_PARAM_TYPE_TEXTURE, "shadertest/GooInGlass_env",
             "envmap")
SHADER_PARAM(GLASSENVMAP, SHADER_PARAM_TYPE_TEXTURE,
             "shadertest/GooInGlass_envglass", "Glass Envmap")
SHADER_PARAM(ENVMAPTINT, SHADER_PARAM_TYPE_COLOR, "[1 1 1]", "envmap tint")
SHADER_PARAM(GLASSENVMAPTINT, SHADER_PARAM_TYPE_COLOR, "[1 1 1]", "envmap tint")
SHADER_PARAM(TRANSLUCENTGOO, SHADER_PARAM_TYPE_BOOL, "0",
             "whether or not goo is translucent")
END_SHADER_PARAMS
