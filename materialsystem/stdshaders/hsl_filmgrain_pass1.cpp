...
//
// First pass converts from RGB to HSL and tweaks with noise similar to After
// Effects
//
...
SHADER_PARAM(SCALEBIAS, SHADER_PARAM_TYPE_VEC4, "",
             "Scale and bias for grain placement")
SHADER_PARAM(HSLNOISESCALE, SHADER_PARAM_TYPE_VEC4, "",
             "Strength of film grain")
...
SHADER_DRAW {
  SHADOW_STATE {
    ...
    //			pShaderShadow->PolyMode(
    //SHADER_POLYMODEFACE_FRONT_AND_BACK, SHADER_POLYMODE_LINE );
