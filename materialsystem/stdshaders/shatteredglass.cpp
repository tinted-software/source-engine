...
SHADER_PARAM_OVERRIDE(BASETEXTURE, SHADER_PARAM_TYPE_TEXTURE,
                      "Glass/glasswindowbreak070b", "unused",
                      SHADER_PARAM_NOT_EDITABLE)
SHADER_PARAM(DETAIL, SHADER_PARAM_TYPE_TEXTURE, "Glass/glasswindowbreak070b",
             "detail")
...
SHADER_PARAM(ENVMAPMASK, SHADER_PARAM_TYPE_TEXTURE,
             "glass/glasswindowbreak070b_mask", "envmap mask")
...
SHADER_INIT {
  ...
  if (params[ENVMAP]->IsDefined()) {
    ...
    if (params[ENVMAPMASK]->IsDefined()) {
      LoadTexture(ENVMAPMASK, g_pHardwareConfig->GetHDRType() == HDR_TYPE_NONE
                                  ? TEXTUREFLAGS_SRGB
                                  : 0);
    }
  }
...
SHADER_DRAW {
  ...
  DYNAMIC_STATE {
    ...
    SetVertexShaderTextureScale(VERTEX_SHADER_SHADER_SPECIFIC_CONST_2,
                                DETAILSCALE);
