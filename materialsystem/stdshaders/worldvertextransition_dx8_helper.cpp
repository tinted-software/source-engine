...
void DrawWorldVertexTransitionEditor_DX8(
  ...
  DYNAMIC_STATE {
    pShader->BindTexture(SHADER_SAMPLER0, info.m_nBaseTextureVar,
                         info.m_nBaseTextureFrameVar);
    pShader->BindTexture(SHADER_SAMPLER1, info.m_nBaseTexture2Var,
                         info.m_nBaseTexture2FrameVar);
    ...
    pShader->SetVertexShaderTextureTransform(nTextureTransformConst,
                                             info.m_nBaseTextureTransformVar);
    pShader->SetVertexShaderTextureTransform(nTextureTransformConst2,
                                             info.m_nBaseTexture2TransformVar);
