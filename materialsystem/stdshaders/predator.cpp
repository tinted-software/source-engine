...
BEGIN_SHADER_PARAMS
SHADER_PARAM(REFRACTIONAMOUNT, SHADER_PARAM_TYPE_VEC2, "[0.2 0.2]",
             "refaction amount")
...
SHADER_PARAM(BUMPMAP, SHADER_PARAM_TYPE_TEXTURE,
             "models/shadertes/shader1_normal", "bump map")
SHADER_PARAM(BUMPFRAME, SHADER_PARAM_TYPE_INTEGER, "0",
             "frame number for $bumpmap")
SHADER_PARAM(BUMPOFFSET, SHADER_PARAM_TYPE_VEC2, "[0 0]",
             "2D bump offset for texture scrolling")
END_SHADER_PARAMS
