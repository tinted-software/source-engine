...
BEGIN_SHADER_PARAMS
SHADER_PARAM(YTEXTURE, SHADER_PARAM_TYPE_TEXTURE, "shadertest/BaseTexture",
             "Y Bink Texture")
//		SHADER_PARAM( ATEXTURE, SHADER_PARAM_TYPE_TEXTURE,
//"shadertest/BaseTexture", "A Bink Texture" )
SHADER_PARAM(CRTEXTURE, SHADER_PARAM_TYPE_TEXTURE, "shadertest/BaseTexture",
             "Cr Bink Texture")
SHADER_PARAM(CBTEXTURE, SHADER_PARAM_TYPE_TEXTURE, "shadertest/BaseTexture",
             "Cb Bink Texture")
END_SHADER_PARAMS
...
SHADER_DRAW {
  ...
  for (nPass = 0; nPass < 2; nPass++) {
    ...
    DYNAMIC_STATE {
      ...
      // we don't do alpha for these on dx8
      //				BindTexture( SHADER_SAMPLER3, ATEXTURE,
      //FRAME );
