...
public:
  CLanGames(vgui::Panel *parent, bool bAutoRefresh = true,
  ...
  void ManualShowButtons(bool bShowConnect, bool bShowRefreshAll,
                         bool bShowFilter);

  // If you pass NULL for pSpecificAddresses, it will broadcast on certain
  // points. If you pass a non-null value, then it will send info queries
  // directly to those ports.
