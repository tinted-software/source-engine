...
CHistoryGames::CHistoryGames(vgui::Panel *parent)
  ...
  m_pGameList->AddColumnHeader(10, "LastPlayed", "#ServerBrowser_LastPlayed",
                               100);
...
void CHistoryGames::OnOpenContextMenu(int itemID) {
  ...
  if (serverID != -1) {
    ...
    menu->AddMenuItem("RemoveServer", "#ServerBrowser_RemoveServerFromHistory",
                      new KeyValues("RemoveFromHistory"), this);
  } else {
