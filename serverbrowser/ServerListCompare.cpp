...
//-----------------------------------------------------------------------------
int __cdecl PasswordCompare(ListPanel *pPanel, const ListPanelItem &p1,
...
//-----------------------------------------------------------------------------
int __cdecl BotsCompare(ListPanel *pPanel, const ListPanelItem &p1,
                        const ListPanelItem &p2) {
  newgameserver_t *s1 = ServerBrowserDialog().GetServer(p1.userData);
  newgameserver_t *s2 = ServerBrowserDialog().GetServer(p2.userData);
...
// Purpose: list column sort function
//-----------------------------------------------------------------------------
int __cdecl SecureCompare(ListPanel *pPanel, const ListPanelItem &p1,
                          const ListPanelItem &p2) {
  return 0;
}
...
// Purpose: list column sort function
//-----------------------------------------------------------------------------
int __cdecl IPAddressCompare(ListPanel *pPanel, const ListPanelItem &p1,
                             const ListPanelItem &p2) {
  newgameserver_t *s1 = ServerBrowserDialog().GetServer(p1.userData);
  newgameserver_t *s2 = ServerBrowserDialog().GetServer(p2.userData);
...
//-----------------------------------------------------------------------------
int __cdecl PingCompare(ListPanel *pPanel, const ListPanelItem &p1,
                        const ListPanelItem &p2) {
  newgameserver_t *s1 = ServerBrowserDialog().GetServer(p1.userData);
  newgameserver_t *s2 = ServerBrowserDialog().GetServer(p2.userData);
...
//-----------------------------------------------------------------------------
int __cdecl MapCompare(ListPanel *pPanel, const ListPanelItem &p1,
                       const ListPanelItem &p2) {
  newgameserver_t *s1 = ServerBrowserDialog().GetServer(p1.userData);
  newgameserver_t *s2 = ServerBrowserDialog().GetServer(p2.userData);
...
//-----------------------------------------------------------------------------
int __cdecl GameCompare(ListPanel *pPanel, const ListPanelItem &p1,
                        const ListPanelItem &p2) {
  newgameserver_t *s1 = ServerBrowserDialog().GetServer(p1.userData);
  newgameserver_t *s2 = ServerBrowserDialog().GetServer(p2.userData);
...
//-----------------------------------------------------------------------------
int __cdecl ServerNameCompare(ListPanel *pPanel, const ListPanelItem &p1,
                              const ListPanelItem &p2) {
  newgameserver_t *s1 = ServerBrowserDialog().GetServer(p1.userData);
  newgameserver_t *s2 = ServerBrowserDialog().GetServer(p2.userData);
...
//-----------------------------------------------------------------------------
int __cdecl PlayersCompare(ListPanel *pPanel, const ListPanelItem &p1,
                           const ListPanelItem &p2) {
  newgameserver_t *s1 = ServerBrowserDialog().GetServer(p1.userData);
  newgameserver_t *s2 = ServerBrowserDialog().GetServer(p2.userData);
...
// Purpose: Player number comparison function
//-----------------------------------------------------------------------------
int __cdecl LastPlayedCompare(ListPanel *pPanel, const ListPanelItem &p1,
                              const ListPanelItem &p2) {
  return 0;
}
...
//-----------------------------------------------------------------------------
int __cdecl TagsCompare(ListPanel *pPanel, const ListPanelItem &p1,
                        const ListPanelItem &p2) {
  newgameserver_t *s1 = ServerBrowserDialog().GetServer(p1.userData);
  newgameserver_t *s2 = ServerBrowserDialog().GetServer(p2.userData);
...
//-----------------------------------------------------------------------------
int __cdecl ReplayCompare(ListPanel *pPanel, const ListPanelItem &p1,
                          const ListPanelItem &p2) {
  newgameserver_t *s1 = ServerBrowserDialog().GetServer(p1.userData);
  newgameserver_t *s2 = ServerBrowserDialog().GetServer(p2.userData);
