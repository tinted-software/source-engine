...
typedef struct IPropertySetterVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *PrintXMLW)(IPropertySetter *This,
                                        /* [out] */ WCHAR *pszXML,
                                        /* [in] */ int cchXML,
                                        /* [out] */ int *pcchPrinted,
                                        /* [in] */ int indent);
...
typedef struct IMediaLocatorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *FindMediaFile)(IMediaLocator *This, BSTR Input,
                                            BSTR FilterString, BSTR *pOutput,
                                            long Flags);

  HRESULT(STDMETHODCALLTYPE *AddFoundLocation)(IMediaLocator *This,
                                               BSTR DirectoryName);
...
typedef struct IRenderEngineVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *SetTimelineObject)(IRenderEngine *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetFilterGraph)(IRenderEngine *This,
                                             IGraphBuilder *pFG);

  HRESULT(STDMETHODCALLTYPE *SetInterestRange)(IRenderEngine *This,
                                               REFERENCE_TIME Start,
                                               REFERENCE_TIME Stop);

  HRESULT(STDMETHODCALLTYPE *SetInterestRange2)(IRenderEngine *This,
                                                double Start, double Stop);

  HRESULT(STDMETHODCALLTYPE *SetRenderRange)(IRenderEngine *This,
                                             REFERENCE_TIME Start,
                                             REFERENCE_TIME Stop);

  HRESULT(STDMETHODCALLTYPE *SetRenderRange2)(IRenderEngine *This, double Start,
                                              double Stop);
  ...
  HRESULT(STDMETHODCALLTYPE *SetSourceConnectCallback)(IRenderEngine *This,
                                                       IGrfCache *pCallback);

  HRESULT(STDMETHODCALLTYPE *SetDynamicReconnectLevel)(IRenderEngine *This,
                                                       long Level);
  ...
  HRESULT(STDMETHODCALLTYPE *SetSourceNameValidation)(IRenderEngine *This,
                                                      BSTR FilterString,
  ...
  HRESULT(STDMETHODCALLTYPE *GetCaps)(IRenderEngine *This, long Index,
                                      long *pReturn);
...
typedef struct IRenderEngine2Vtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *SetResizerGUID)(IRenderEngine2 *This,
                                             GUID ResizerGuid);
...
typedef struct IFindCompressorCBVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetCompressor)(IFindCompressorCB *This,
                                            AM_MEDIA_TYPE *pType,
...
typedef struct ISmartRenderEngineVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetGroupCompressor)(ISmartRenderEngine *This,
                                                 long Group,
                                                 IBaseFilter **pCompressor);

  HRESULT(STDMETHODCALLTYPE *SetFindCompressorCB)(ISmartRenderEngine *This,
...
typedef struct IAMTimelineSplittableVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *SplitAt)(IAMTimelineSplittable *This,
                                      REFERENCE_TIME Time);

  HRESULT(STDMETHODCALLTYPE *SplitAt2)(IAMTimelineSplittable *This,
                                       REFTIME Time);
...
typedef struct IAMTimelineTrackVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *InsertSpace)(IAMTimelineTrack *This,
                                          REFERENCE_TIME rtStart,
                                          REFERENCE_TIME rtEnd);

  HRESULT(STDMETHODCALLTYPE *InsertSpace2)(IAMTimelineTrack *This,
                                           REFTIME rtStart, REFTIME rtEnd);

  HRESULT(STDMETHODCALLTYPE *ZeroBetween)(IAMTimelineTrack *This,
                                          REFERENCE_TIME rtStart,
                                          REFERENCE_TIME rtEnd);

  HRESULT(STDMETHODCALLTYPE *ZeroBetween2)(IAMTimelineTrack *This,
                                           REFTIME rtStart, REFTIME rtEnd);

  HRESULT(STDMETHODCALLTYPE *GetNextSrcEx)(IAMTimelineTrack *This,
...
typedef struct IAMTimelineVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *ValidateSourceNames)(IAMTimeline *This,
                                                  long ValidateFlags,
                                                  IMediaLocator *pOverride,
...
typedef struct IResizeVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *get_Size)(IResize *This,
                                       /* [out] */ int *piHeight,
                                       /* [out] */ int *piWidth,
                                       /* [out] */ long *pFlag);

  HRESULT(STDMETHODCALLTYPE *get_InputSize)(IResize *This,
                                            /* [out] */ int *piHeight,
                                            /* [out] */ int *piWidth);

  HRESULT(STDMETHODCALLTYPE *put_Size)(IResize *This,
                                       /* [in] */ int Height,
                                       /* [in] */ int Width,
                                       /* [in] */ long Flag);

  HRESULT(STDMETHODCALLTYPE *get_MediaType)(IResize *This,
