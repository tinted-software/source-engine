...
DECLARE_INTERFACE_(IDirect3DRM, IUnknown) {
  ...
  STDMETHOD(CreateLight)(THIS_ D3DRMLIGHTTYPE, D3DCOLOR, LPDIRECT3DRMLIGHT *)
      PURE;
  ...
  STDMETHOD(CreateUserVisual)(THIS_ D3DRMUSERVISUALCALLBACK, LPVOID lPArg,
                              LPDIRECT3DRMUSERVISUAL *) PURE;
  STDMETHOD(LoadTexture)(THIS_ const char *, LPDIRECT3DRMTEXTURE *) PURE;
  STDMETHOD(LoadTextureFromResource)(THIS_ HRSRC rs, LPDIRECT3DRMTEXTURE *)
      PURE;
...
DECLARE_INTERFACE_(IDirect3DRM2, IUnknown) {
  ...
  STDMETHOD(LoadTextureFromResource)(THIS_ HMODULE hModule, LPCTSTR strName,
                                     LPCTSTR strType, LPDIRECT3DRMTEXTURE2 *)
      PURE;
...
DECLARE_INTERFACE_(IDirect3DRM3, IUnknown) {
  ...
  STDMETHOD(LoadTextureFromResource)(THIS_ HMODULE hModule, LPCTSTR strName,
                                     LPCTSTR strType, LPDIRECT3DRMTEXTURE3 *)
      PURE;
  ...
  STDMETHOD(CreateClippedVisual)(THIS_ LPDIRECT3DRMVISUAL,
                                 LPDIRECT3DRMCLIPPEDVISUAL *) PURE;
