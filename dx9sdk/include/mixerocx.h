...
typedef struct IMixerOCXNotifyVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *OnInvalidateRect)(IMixerOCXNotify *This,
                                               /* [in] */ LPCRECT lpcRect);

  HRESULT(STDMETHODCALLTYPE *OnStatusChange)(IMixerOCXNotify *This,
                                             /* [in] */ ULONG ulStatusFlags);

  HRESULT(STDMETHODCALLTYPE *OnDataChange)(IMixerOCXNotify *This,
...
typedef struct IMixerOCXVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *OnDisplayChange)(IMixerOCX *This,
                                              /* [in] */ ULONG ulBitsPerPixel,
                                              /* [in] */ ULONG ulScreenWidth,
  ...
  HRESULT(STDMETHODCALLTYPE *GetVideoSize)(IMixerOCX *This,
                                           /* [out] */ LPDWORD pdwVideoWidth,
                                           /* [out] */ LPDWORD pdwVideoHeight);

  HRESULT(STDMETHODCALLTYPE *GetStatus)(IMixerOCX *This,
                                        /* [out] */ LPDWORD *pdwStatus);

  HRESULT(STDMETHODCALLTYPE *OnDraw)(IMixerOCX *This,
                                     /* [in] */ HDC hdcDraw,
                                     /* [in] */ LPCRECT prcDraw);

  HRESULT(STDMETHODCALLTYPE *SetDrawRegion)(IMixerOCX *This,
                                            /* [in] */ LPPOINT lpptTopLeftSC,
                                            /* [in] */ LPCRECT prcDrawCC,
                                            /* [in] */ LPCRECT lprcClip);

  HRESULT(STDMETHODCALLTYPE *Advise)(IMixerOCX *This,
