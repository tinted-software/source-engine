...
DECLARE_INTERFACE_(IKsControl, IUnknown) {
  ...
  STDMETHOD_(NTSTATUS,
             KsProperty)(THIS_ IN PKSPROPERTY Property, IN ULONG PropertyLength,
  ...
  STDMETHOD_(NTSTATUS, KsEvent)(THIS_ IN PKSEVENT Event OPTIONAL,
                                IN ULONG EventLength, IN OUT PVOID EventData,
                                IN ULONG DataLength, OUT ULONG * BytesReturned)
      PURE;
};
...
DECLARE_INTERFACE_(IKsReferenceClock, IUnknown) {
  ...
  STDMETHOD_(LONGLONG,
             GetCorrelatedPhysicalTime)(THIS_ OUT PLONGLONG SystemTime) PURE;
