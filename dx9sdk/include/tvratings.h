...
typedef struct IXDSToRatVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(IXDSToRat *This,
                                               /* [out] */ UINT *pctinfo);

  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IXDSToRat *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
...
typedef struct IEvalRatVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(IEvalRat *This,
                                               /* [out] */ UINT *pctinfo);

  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IEvalRat *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
                                          /* [out] */ ITypeInfo **ppTInfo);
