...
DECLARE_INTERFACE_(IDirectSound, IUnknown) {
  ...
  STDMETHOD(CreateSoundBuffer)(THIS_ __in LPCDSBUFFERDESC pcDSBufferDesc,
...
DECLARE_INTERFACE_(IDirectSound8, IDirectSound) {
  ...
  // IDirectSound methods
  STDMETHOD(CreateSoundBuffer)(THIS_ __in LPCDSBUFFERDESC pcDSBufferDesc,
                               __out LPDIRECTSOUNDBUFFER * ppDSBuffer,
                               __null LPUNKNOWN pUnkOuter) PURE;
  STDMETHOD(GetCaps)(THIS_ __out LPDSCAPS pDSCaps) PURE;
  STDMETHOD(DuplicateSoundBuffer)(
      THIS_ __in LPDIRECTSOUNDBUFFER pDSBufferOriginal,
...
DECLARE_INTERFACE_(IDirectSoundBuffer, IUnknown) {
  ...
  STDMETHOD(GetCurrentPosition)(THIS_ __out_opt LPDWORD pdwCurrentPlayCursor,
  ...
  STDMETHOD(Initialize)(THIS_ __in LPDIRECTSOUND pDirectSound,
  ...
  STDMETHOD(Unlock)(THIS_ __in_bcount(dwAudioBytes1) LPVOID pvAudioPtr1,
                    DWORD dwAudioBytes1,
...
DECLARE_INTERFACE_(IDirectSoundBuffer8, IDirectSoundBuffer) {
  ...
  STDMETHOD(SetFX)(THIS_ DWORD dwEffectsCount,
                   ...
                   __out_ecount_opt(dwEffectsCount) LPDWORD pdwResultCodes)
      PURE;
  STDMETHOD(AcquireResources)(THIS_ DWORD dwFlags, DWORD dwEffectsCount,
                              __out_ecount(dwEffectsCount)
                                  LPDWORD pdwResultCodes) PURE;
  STDMETHOD(GetObjectInPath)(THIS_ __in REFGUID rguidObject, DWORD dwIndex,
                             __in REFGUID rguidInterface,
...
DECLARE_INTERFACE_(IDirectSound3DListener, IUnknown) {
  ...
  STDMETHOD(GetOrientation)(THIS_ __out D3DVECTOR * pvOrientFront,
                            __out D3DVECTOR * pvOrientTop) PURE;
  ...
  STDMETHOD(SetAllParameters)(THIS_ __in LPCDS3DLISTENER pcListener,
                              DWORD dwApply) PURE;
...
DECLARE_INTERFACE_(IDirectSound3DBuffer, IUnknown) {
  ...
  STDMETHOD(GetConeAngles)(THIS_ __out LPDWORD pdwInsideConeAngle,
  ...
  STDMETHOD(GetPosition)(THIS_ __out D3DVECTOR * pvPosition) PURE;
  STDMETHOD(GetVelocity)(THIS_ __out D3DVECTOR * pvVelocity) PURE;
  STDMETHOD(SetAllParameters)(THIS_ __in LPCDS3DBUFFER pcDs3dBuffer,
                              DWORD dwApply) PURE;
...
DECLARE_INTERFACE_(IDirectSoundCapture, IUnknown) {
  ...
  STDMETHOD(CreateCaptureBuffer)(THIS_ __in LPCDSCBUFFERDESC pcDSCBufferDesc,
                                 __deref_out LPDIRECTSOUNDCAPTUREBUFFER *
                                     ppDSCBuffer,
                                 __null LPUNKNOWN pUnkOuter) PURE;
...
DECLARE_INTERFACE_(IDirectSoundCaptureBuffer, IUnknown) {
  ...
  STDMETHOD(GetCurrentPosition)(THIS_ __out_opt LPDWORD pdwCapturePosition,
                                __out_opt LPDWORD pdwReadPosition) PURE;
  STDMETHOD(GetFormat)(
      THIS_ __out_bcount_opt(dwSizeAllocated) LPWAVEFORMATEX pwfxFormat,
      DWORD dwSizeAllocated, __out_opt LPDWORD pdwSizeWritten) PURE;
  STDMETHOD(GetStatus)(THIS_ __out LPDWORD pdwStatus) PURE;
  STDMETHOD(Initialize)(THIS_ __in LPDIRECTSOUNDCAPTURE pDirectSoundCapture,
...
DECLARE_INTERFACE_(IDirectSoundCaptureBuffer8, IDirectSoundCaptureBuffer) {
  ...
  STDMETHOD(GetFXStatus)(DWORD dwEffectsCount,
                         __out_ecount(dwEffectsCount) LPDWORD pdwFXStatus) PURE;
};
...
DECLARE_INTERFACE_(IKsPropertySet, IUnknown) {
  ...
  STDMETHOD(Get)(THIS_ __in REFGUID rguidPropSet, ULONG ulId,
                 __in_bcount(ulInstanceLength) LPVOID pInstanceData,
                 ULONG ulInstanceLength,
                 __out_bcount(ulDataLength) LPVOID pPropertyData,
                 ULONG ulDataLength, __out PULONG pulBytesReturned) PURE;
  STDMETHOD(Set)(THIS_ __in REFGUID rguidPropSet, ULONG ulId,
                 __in_bcount(ulInstanceLength) LPVOID pInstanceData,
                 ULONG ulInstanceLength,
                 __in_bcount(ulDataLength) LPVOID pPropertyData,
                 ULONG ulDataLength) PURE;
  STDMETHOD(QuerySupport)(THIS_ __in REFGUID rguidPropSet, ULONG ulId,
...
DECLARE_INTERFACE_(IDirectSoundFXDistortion, IUnknown) {
  ...
  STDMETHOD(SetAllParameters)(THIS_ __in LPCDSFXDistortion pcDsFxDistortion)
      PURE;
  STDMETHOD(GetAllParameters)(THIS_ __out LPDSFXDistortion pDsFxDistortion)
      PURE;
};
...
DECLARE_INTERFACE_(IDirectSoundFXCompressor, IUnknown) {
  ...
  STDMETHOD(SetAllParameters)(THIS_ __in LPCDSFXCompressor pcDsFxCompressor)
      PURE;
  STDMETHOD(GetAllParameters)(THIS_ __out LPDSFXCompressor pDsFxCompressor)
      PURE;
};
...
DECLARE_INTERFACE_(IDirectSoundFXI3DL2Reverb, IUnknown) {
  ...
  STDMETHOD(SetAllParameters)(THIS_ __in LPCDSFXI3DL2Reverb pcDsFxI3DL2Reverb)
      PURE;
  STDMETHOD(GetAllParameters)(THIS_ __out LPDSFXI3DL2Reverb pDsFxI3DL2Reverb)
      PURE;
...
DECLARE_INTERFACE_(IDirectSoundFXWavesReverb, IUnknown) {
  ...
  STDMETHOD(SetAllParameters)(THIS_ __in LPCDSFXWavesReverb pcDsFxWavesReverb)
      PURE;
  STDMETHOD(GetAllParameters)(THIS_ __out LPDSFXWavesReverb pDsFxWavesReverb)
      PURE;
};
