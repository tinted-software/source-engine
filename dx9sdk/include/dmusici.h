...
DECLARE_INTERFACE_(IDirectMusicLoader, IUnknown) {
  ...
  /* IDirectMusicLoader */
  STDMETHOD(GetObject)(THIS_ LPDMUS_OBJECTDESC pDesc, REFIID riid,
                       LPVOID FAR * ppv) PURE;
...
DECLARE_INTERFACE_(IDirectMusicSegment, IUnknown) {
  ...
  STDMETHOD(InitPlay)(THIS_ IDirectMusicSegmentState * *ppSegState,
                      IDirectMusicPerformance * pPerformance, DWORD dwFlags)
      PURE;
...
DECLARE_INTERFACE_(IDirectMusicSegment8, IDirectMusicSegment) {
  ...
  STDMETHOD(SetTrackConfig)(
      THIS_ REFGUID rguidTrackClassID, /* Class ID of the type of track on which
                                          to set the configuration flags. */
      DWORD dwGroupBits,               /* Group bits. */
      DWORD dwIndex, /* Nth track (or DMUS_SEG_ALLTRACKS) that matches class id
                        and group id. */
...
DECLARE_INTERFACE_(IDirectMusicAudioPath, IUnknown) {
  ...
  STDMETHOD(Activate)(THIS_ BOOL fActivate)
      PURE; /* True to activate, False to deactivate. */
  STDMETHOD(SetVolume)(
  ...
  STDMETHOD(ConvertPChannel)(THIS_ DWORD dwPChannelIn, /* Pchannel of source. */
      ...
      PURE; /* Equivalent pchannel on performance. */
};
...
DECLARE_INTERFACE_(IDirectMusicPerformance8, IDirectMusicPerformance) {
  ...
  /*  IDirectMusicPerformance8 */
  STDMETHOD(InitAudio)(
      THIS_ IDirectMusic * *ppDirectMusic, /* Optional DMusic pointer. */
      IDirectSound * *ppDirectSound,       /* Optional DSound pointer. */
      HWND hWnd,                           /* HWND for DSound. */
      DWORD dwDefaultPathType, /* Requested default audio path type, also
                                  optional. */
  ...
  STDMETHOD(PlaySegmentEx)(
      ...
      IUnknown * pTransition, /* Optional template segment to compose transition
                                 with. */
  ...
  STDMETHOD(StopEx)(THIS_ IUnknown *
                        pObjectToStop, /* Segstate, AudioPath, or Segment. */
...
DECLARE_INTERFACE_(IDirectMusicComposer, IUnknown) {
  ...
  STDMETHOD(ComposeTemplateFromShape)(THIS_ WORD wNumMeasures, WORD wShape,
                                      BOOL fIntro, BOOL fEnd, WORD wEndLength,
                                      IDirectMusicSegment * *ppTemplate) PURE;
  STDMETHOD(ChangeChordMap)(THIS_ IDirectMusicSegment * pSegment,
                            BOOL fTrackScale, IDirectMusicChordMap * pChordMap)
      PURE;
};
