...
DECLARE_INTERFACE_(IDirect3DDevice8, IUnknown) {
  ...
  STDMETHOD(CreateImageSurface)(THIS_ UINT Width, UINT Height, D3DFORMAT Format,
                                IDirect3DSurface8 * *ppSurface) PURE;
  STDMETHOD(CopyRects)(THIS_ IDirect3DSurface8 * pSourceSurface,
  ...
  STDMETHOD(DrawIndexedPrimitive)(THIS_ D3DPRIMITIVETYPE, UINT minIndex,
  ...
  STDMETHOD(SetVertexShaderConstant)(THIS_ DWORD Register,
  ...
  STDMETHOD(SetPixelShaderConstant)(THIS_ DWORD Register,
                                    CONST void *pConstantData,
                                    DWORD ConstantCount) PURE;
