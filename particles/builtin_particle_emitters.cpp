...
class C_OP_InstantaneousEmitter : public CParticleOperatorInstance {
  ...
  virtual void SkipToTime(float flTime, CParticleCollection *pParticles,
    ...
    //would have to know the maximum 		 lifetime of the child particles and only
    //skip if past that.
...
uint32 C_OP_InstantaneousEmitter::Emit(CParticleCollection *pParticles,
                                       float flCurStrength,
                                       void *pContext) const {
...
class C_OP_ContinuousEmitter : public CParticleOperatorInstance {
  ...
  virtual void SkipToTime(float flTime, CParticleCollection *pParticles,
    ...
    // if ( !IsInfinitelyEmitting() )
    //	pCtx->m_flTotalActualParticlesSoFar = min(
...
uint32 C_OP_ContinuousEmitter::Emit(CParticleCollection *pParticles,
...
uint32 C_OP_NoiseEmitter::Emit(CParticleCollection *pParticles,
                               float flCurStrength, void *pContext) const {
  // Have we emitted all the particles we're going to emit?
  // NOTE: Using C_OP_ContinuousEmitter:: avoids a virtual function call
  NoiseEmitterContext_t *pCtx =
