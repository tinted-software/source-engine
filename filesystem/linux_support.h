...
bool findFileInDirCaseInsensitive(const char *file,
                                  OUT_Z_BYTECAP(bufSize) char *output,
                                  size_t bufSize);
// The _safe version of this function should be preferred since it always infers
// the directory size correctly.
template <size_t bufSize>
bool findFileInDirCaseInsensitive_safe(const char *file,
                                       OUT_Z_ARRAY char (&output)[bufSize]) {
