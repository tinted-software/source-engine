...
public:
  ...
  virtual int CreateTextureByTexture(ITexture *pTexture,
                                     bool procedural = true) = 0;
  ...
  virtual void SetSubTextureRGBAEx(int id, int drawX, int drawY,
  ...
  virtual void UpdateSubTextureRGBA(int id, int drawX, int drawY,
                                    unsigned const char *rgba,
                                    int subTextureWide, int subTextureTall,
