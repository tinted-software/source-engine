...
} // fake adapters = one real adapter times however many displays are on
void GLMDisplayDB::Populate(void) {}
int GLMDisplayDB::GetFakeAdapterCount(void) { return 1; }
bool GLMDisplayDB::GetFakeAdapterInfo(int fakeAdapterIndex, int *rendererOut,
                                      int *displayOut,
...
bool GLMDisplayDB::GetRendererInfo(int rendererIndex,
                                   GLMRendererInfoFields *infoOut) {
  return true;
}
int GLMDisplayDB::GetDisplayCount(int rendererIndex) { return 1; }
bool GLMDisplayDB::GetDisplayInfo(int rendererIndex, int displayIndex,
                                  GLMDisplayInfoFields *infoOut) {
  return true;
}
int GLMDisplayDB::GetModeCount(int rendererIndex, int displayIndex) {}
bool GLMDisplayDB::GetModeInfo(int rendererIndex, int displayIndex,
                               int modeIndex,
