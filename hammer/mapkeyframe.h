...
public:
  ...
  // Factories.
  //
  static CMapClass *CreateMapKeyFrame(CHelperInfo *pHelperInfo,
                                      CMapEntity *pParent);
...
protected:
  ...
  float m_flSpeed;    // average speed travelling to next time; if this is
                      // non-zero, m_flMoveTime is calculated from it
