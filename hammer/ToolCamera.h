...
public:
  ...
  enum SNCTYPE { sncNext = -1, sncFirst = 0, sncPrev = 1 };
...
protected:
  ...
  // Tool3D implementation.
  //
  virtual int HitTest(CMapView *pView, const Vector2D &vPoint,
...
private:
  ...
  static ChunkFileResult_t LoadCameraKeyCallback(const char *szKey,
                                                 const char *szValue,
                                                 CAMSTRUCT *pCam);
  static ChunkFileResult_t LoadCamerasKeyCallback(const char *szKey,
                                                  const char *szValue,
                                                  Camera3D *pCameras);
  static ChunkFileResult_t LoadCameraCallback(CChunkFile *pFile,
                                              Camera3D *pCameras);
