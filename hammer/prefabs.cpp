...
//			of prefabs implemented here: Half-Life style prefabs,
//and Half-Life 2 			style prefabs.
//
...
//
//			For Half-Life 2, prefabs are stored in a tree of
//folders, each folder 			representing a library, and the each .VMF file in the
//folder containing 			a single prefab.
//
//=============================================================================//
