...
private:
  ...
  static void GetNewTextureMatches(const char *pszOldName,
                                   EditorTextureList_t &MatchList);
  static bool TextureNameMatchesMaterialName(const char *pszTextureName,
                                             const char *pszMaterialName);
  static void ReplaceFaceTexture(CMapFace *pFace, IEditorTexture *pNewTexture);
  static void ReplaceDecalTexture(CMapEntity *pEnt,
  ...
  static void MsgConvertFace(CMapFace *pFace,
                             PRINTF_FORMAT_STRING const char *format, ...);
  static void MsgConvertDecal(CMapEntity *pEnt,
                              PRINTF_FORMAT_STRING const char *format, ...);
