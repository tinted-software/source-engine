...
protected:
  ...
  bool m_bDifferent; // Set to true when we have multiselected objects with
                     // different angles.
...
// Purpose:
//-----------------------------------------------------------------------------
void CAngleBox::SetEditControl(CAngleCombo *pEdit) { m_pEdit = pEdit; }
...
private:
  ...
  bool m_bEnableUpdate; // Whether we forward update notifications to the linked
                        // angle box control.
};

void CAngleCombo::SetAngleBox(CAngleBox *pBox) { m_pBox = pBox; }
