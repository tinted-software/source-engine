...
public:
  ...
  static void EnableBuildDetailObjects(
      bool bBuild); // This is used to delay building detail objects until the
...
protected:
  ...
  void PlaceDetail(DetailModel_t const &model, const Vector &pt,
                   const Vector &normal);
  void EmitDetailObjectsOnFace(CMapFace *pMapFace, DetailObject_t &detail);
  void EmitDetailObjectsOnDisplacementFace(CMapFace *pMapFace,
                                           DetailObject_t &detail);

  void AddDetailSpriteToFace(const Vector &vecOrigin, const QAngle &vecAngles,
                             DetailModel_t const &model, float flScale);
  void AddDetailModelToFace(const char *pModelName, const Vector &pt,
