...
public:
  CTextAttributes()
      : m_bsBold("\\b"), m_bsUnderline("\\ul"), m_bsItalic("\\i"),
        m_bsStrike("\\strike") {
  ...
  operator CString() const {
    ...
    s.Format(
        ...
        ((CString)m_bsBold).GetBuffer(), ((CString)m_bsUnderline).GetBuffer(),
        ((CString)m_bsItalic).GetBuffer(), ((CString)m_bsStrike).GetBuffer(),
