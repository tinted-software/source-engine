...
public:
  CHammerDocTemplate(UINT nIDResource, CRuntimeClass *pDocClass,
...
public:
  ...
  COLORREF GetProfileColor(const char *pszSection, const char *pszKey, int r,
                           int g, int b);
  ...
  int GetNextAutosaveNumber(CUtlMap<FILETIME, WIN32_FIND_DATA, int> *pFileMap,
                            DWORD *pdwTotalDirSize, const CString *) const;
...
// event update system - lets you check for events such as gemoetry modification
// for updating stuff.
