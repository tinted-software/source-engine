...
protected:
  ...
  VMatrix m_ViewMatrix; // Camera view matrix, based on current yaw, pitch, and
                        // roll.
  Vector m_ViewPoint;
  float m_fYaw;   // Counterclockwise rotation around the CAMERA_UP axis, in
                  // degrees [-359, 359].
  float m_fPitch; // Counterclockwise rotation around the CAMERA_RIGHT axis, in
                  // degrees [-90, 90].
  float m_fRoll; // Counterclockwise rotation around the CAMERA_FORWARD axis, in
                 // degrees [-359, 359].
