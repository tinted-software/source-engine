...
//-----------------------------------------------------------------------------
// Purpose: Handles resize messages. Moves the child windows to the proper
// positions. Input  : nType -
//			cx -
//			cy -
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Purpose: Called when either the filter combo or the keywords combo text
// changes.
//-----------------------------------------------------------------------------
...
// Output : LRESULT
//-----------------------------------------------------------------------------
LRESULT CTextureBrowser::OnTexturewindowSelchange(WPARAM wParam,
                                                  LPARAM lParam) {
  IEditorTexture *pTex =
      g_Textures.FindActiveTexture(m_cTextureWindow.szCurTexture);
  CString str;
...
void CTextureBrowser::OnFilterTranslucent(void) {
  ...
  m_cTextureWindow.SetTypeFilter(CTextureWindow::TYPEFILTER_TRANSLUCENT,
                                 checked);
}
...
//			format will be visible in the browse window. By default,
//this 			format will be the same as the current active texture format.
