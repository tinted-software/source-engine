...
// Output : LPCTSTR
//-----------------------------------------------------------------------------
LPCTSTR GetDefaultTextureName(void) { return szDefaultTexture; }
...
LPCTSTR GetNullTextureName() { return szNullTexture; }
...
//-----------------------------------------------------------------------------
// This class renders a given IEditorTexture in its OnPaint handler. It is used
// in the texture Find/Replace dialog, the Face Properties dialog, and the
// texture bar.
//-----------------------------------------------------------------------------
...
void wndTex::OnPaint(void) {
  ...
  dc.SelectPalette(m_pTexture->HasPalette() ? m_pTexture->GetPalette()
