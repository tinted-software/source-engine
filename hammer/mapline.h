...
public:
  ...
  //
  CMapLine(void);
  CMapLine(const char *pszStartValueKey, const char *pszStartKey,
           const char *pszEndValueKey, const char *pszEndKey);
  ~CMapLine(void);
...
protected:
  ...
  char m_szStartValueKey[80]; // The key in our parent entity to look at for our
                              // start target.
