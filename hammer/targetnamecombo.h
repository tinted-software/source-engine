...
class CTargetNameComboBox : public CFilteredComboBox,
                            protected CFilteredComboBox::ICallbacks {
...
public:
  ...
  static CTargetNameComboBox *Create(CFilteredComboBox::ICallbacks *pCallbacks,
  ...
  // Gets the list of entities with this name. The data is valid until the next
  // SetEntityList call.
