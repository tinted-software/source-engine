...
//			allows the user to edit which visgroups the selected
//objects belong to.
//
//=============================================================================//
...
// Input  : b -
//-----------------------------------------------------------------------------
void COP_Groups::SetMultiEdit(bool b) { CObjectPage::SetMultiEdit(b); }
...
//-----------------------------------------------------------------------------
// Purpose: Called when the check state of a group is toggled in the groups
// list. Input  : wParam - Index of item in the groups list that was toggled.
...
void COP_Groups::OnSize(UINT nType, int cx, int cy) { m_AnchorMgr.OnSize(); }
