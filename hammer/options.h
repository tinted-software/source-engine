...
public:
  ...
  bool bScaleAxisColor; // Whether to use the intensity slider to scale the axis
                        // color in the 2D view.
  bool bScaleGridColor; // Whether to use the intensity slider to scale the grid
                        // color in the 2D view.
  bool bScaleGridDotColor; // Whether to use the intensity slider to scale the
                           // dotted grid color in the 2D view.
  bool bScaleGrid10Color; // Whether to use the intensity slider to scale the 10
                          // grid color in the 2D view.
  bool bScaleGrid1024Color; // Whether to use the intensity slider to scale the
                            // 1024 grid color in the 2D view.
  ...
  COLORREF clrEntity; // The default color of point entities & brush entities,
                      // can be overridden by the FGD.
  ...
  COLORREF
      clrModelCollisionWireframe; // The color of a model's collision wireframe
  COLORREF
      clrModelCollisionWireframeDisabled; // The color of a model's collision
                                          // wireframe when set to "Not Solid"
...
public:
  ...
  int nModelDistance;  // Distance in world units within which studio models
                       // render.
  int nDetailDistance; // Distance in world units within which detail props
                       // render.
...
public:
  ...
  // This happens if it can't initialize the file system, or if they're missing
  // gameinfo.txt. It forces them to choose or create a config that works.
