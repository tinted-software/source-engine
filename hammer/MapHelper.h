...
//			subordinate to their entity parents, and provide
//services such as 			enhanced presentation and manipulation of keyvalues for their
//parent 			entity.
//
//			Like all children, helpers are transformed with their
//parent.
//
// $NoKeywords: $
//=============================================================================//
