...
//			based on whether the current selection represents a
//single entity, 			multiple entities, or an unresolved entity targetname.
//
...
// Purpose:
//-----------------------------------------------------------------------------
CTargetNameComboBox::CTargetNameComboBox(
...
//-----------------------------------------------------------------------------
CTargetNameComboBox::~CTargetNameComboBox(void) { FreeSubLists(); }
...
CTargetNameComboBox *
CTargetNameComboBox::Create(CFilteredComboBox::ICallbacks *pCallbacks,
                            DWORD dwStyle, RECT rect, CWnd *pParentWnd,
                            UINT nID) {
...
void CTargetNameComboBox::SetEntityList(const CMapEntityList *pEntityList) {
  // We want all notifications, even if the current text doesn't match an exact
  // entity name.
  ...
  for (int i = m_EntityLists.First(); i != m_EntityLists.InvalidIndex();
       i = m_EntityLists.Next(i)) {
