...
//			for binding. May become a general purpose texture
//object.
//
//=============================================================================//
...
//			nFlags - Flags indicating the pixel format of the image
//data. The default 					is 24 bit RGB, no alpha component, but can be set to:
//
//				TEXTURE_HAS_ALPHA: the image has an alpha
//component. Each texel is 32 bits.
//
...
//			dwFlags -
//-----------------------------------------------------------------------------
void CTexture::Draw(CDC *pDC, RECT &rect, int iFontHeight, int iIconHeight,
                    DrawTexData_t &DrawTexData) {}

//-----------------------------------------------------------------------------
// Purpose: Returns the full path of the file from which this texture was
// loaded.
//-----------------------------------------------------------------------------
...
//				copied. Otherwise, the buffer must be large
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CTexture::Load(void) { return (true); }
