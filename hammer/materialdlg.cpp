...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CFaceSmoothingDlg::CFaceSmoothingDlg(CWnd *pParent)
    : CDialog(CFaceSmoothingDlg::IDD, pParent) {
  InitButtonIDs();
}
...
void CFaceSmoothingDlg::OnClose(void) {
  ...
  if (pSheet) {
    pSheet->m_MaterialPage.SetMaterialPageTool(
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CFaceSmoothingVisualDlg::CFaceSmoothingVisualDlg(CWnd *pParent)
    : CDialog(CFaceSmoothingDlg::IDD, pParent) {
  InitButtonIDs();
}
