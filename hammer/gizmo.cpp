...
CGizmo::CGizmo(void) {
  ...
  if (bFirst) {
    ...
    g_pRotateHandleTexture =
        g_Textures.FindActiveTexture("editor/gizmoRotateHandle");
    g_pScaleHandleTexture =
        g_Textures.FindActiveTexture("editor/gizmoScaleHandle");
    g_pTranslateHandleTexture =
        g_Textures.FindActiveTexture("editor/gizmoTranslateHandle");
    bFirst = false;
  }
...
void CGizmo::DrawGizmoAxis(CRender3D *pRender, Vector &Origin, Vector &EndPoint,
  ...
  meshBuilder.Position3f(Start[0] - ViewUp[0] * GIZMO_AXIS_WIDTH,
                         Start[1] - ViewUp[1] * GIZMO_AXIS_WIDTH,
                         Start[2] - ViewUp[2] * GIZMO_AXIS_WIDTH);
  meshBuilder.Color3ub(red, green, blue);
  meshBuilder.AdvanceVertex();

  meshBuilder.TexCoord2f(0, 2, 0);
  meshBuilder.Position3f(End[0] - ViewUp[0] * GIZMO_AXIS_WIDTH,
                         End[1] - ViewUp[1] * GIZMO_AXIS_WIDTH,
  ...
  meshBuilder.TexCoord2f(0, 0, 0);
  meshBuilder.Position3f(Start[0] - ViewUp[0] * GIZMO_HANDLE_WIDTH,
                         Start[1] - ViewUp[1] * GIZMO_HANDLE_WIDTH,
                         Start[2] - ViewUp[2] * GIZMO_HANDLE_WIDTH);
  meshBuilder.Color3ub(red, green, blue);
  meshBuilder.AdvanceVertex();

  meshBuilder.TexCoord2f(0, 1, 0);
  meshBuilder.Position3f(End[0] - ViewUp[0] * GIZMO_HANDLE_WIDTH,
                         End[1] - ViewUp[1] * GIZMO_HANDLE_WIDTH,
