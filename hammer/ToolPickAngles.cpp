...
//-----------------------------------------------------------------------------
CToolPickAngles::CToolPickAngles(void) { m_pNotifyTarget = NULL; }
...
//-----------------------------------------------------------------------------
bool CToolPickAngles::OnLMouseUp3D(CMapView3D *pView, UINT nFlags,
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickAngles::OnLMouseDown3D(CMapView3D *pView, UINT nFlags,
                                     const Vector2D &vPoint) {
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickAngles::OnLMouseDblClk3D(CMapView3D *pView, UINT nFlags,
                                       const Vector2D &vPoint) {
  return true;
}
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickAngles::OnRMouseUp3D(CMapView3D *pView, UINT nFlags,
                                   const Vector2D &vPoint) {
  return true;
}
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickAngles::OnRMouseDown3D(CMapView3D *pView, UINT nFlags,
                                     const Vector2D &vPoint) {
  return true;
}
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickAngles::OnMouseMove3D(CMapView3D *pView, UINT nFlags,
                                    const Vector2D &vPoint) {
  SetToolCursor();
  return true;
}
