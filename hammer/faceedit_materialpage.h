...
#define FACE_APPLY_ALL                                                         \
  FACE_APPLY_MATERIAL | FACE_APPLY_MAPPING | FACE_APPLY_LIGHTMAP_SCALE
...
public:
  ...
  // Update
  //
  void ClickFace(CMapSolid *pSolid, int faceIndex, int cmd,
                 int clickMode = -1); // primary interface update call
