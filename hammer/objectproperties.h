...
public:
  ...
  CObjectProperties(UINT nIDCaption, CWnd *pParentWnd = NULL,
                    UINT iSelectPage = 0);
  CObjectProperties(LPCTSTR pszCaption, CWnd *pParentWnd = NULL,
                    UINT iSelectPage = 0);
...
protected:
  ...
  void GetTabsForLayout(LayoutType_t eLayoutType, bool &bEntity, bool &bGroups,
  ...
  CObjectPage *m_pLastActivePage; // Used for restoring the last active page
