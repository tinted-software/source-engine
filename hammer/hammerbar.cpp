...
//			calls the function to move the bar's controls around on
//a resize. 			also calls the CWnd OnSize so it can do what it needs to.
...
//			determines position and stretch settings based on
//default design /
...
//				BOTTOM_JUSTIFY - will move with the bottom of
//the dialog 				RIGHT_JUSTIFY - will move with the right side of the dialog//
// Output : void
//-----------------------------------------------------------------------------
