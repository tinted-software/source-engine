...
void StockSolid::AddDataField(STSDF_TYPE type, const char *pszName,
                              int iRangeLower, int iRangeUpper) {
...
void StockBlock::CreateMapSolid(CMapSolid *pSolid,
  ...
  pSolid->CalcBounds();
  pSolid->InitializeTextureAxes(eAlignment,
...
void StockWedge::CreateMapSolid(CMapSolid *pSolid,
  ...
  pSolid->CalcBounds();
  pSolid->InitializeTextureAxes(eTextureAlignment,
                                INIT_TEXTURE_ALL | INIT_TEXTURE_FORCE);
}
...
void StockCylinder::CreateMapSolid(CMapSolid *pSolid,
  ...
  Vector pmPoints[64];
  polyMake(origin[0] - fWidth, origin[1] - fDepth, origin[0] + fWidth,
           origin[1] + fDepth, nSides, 0, pmPoints);
...
void StockSphere::CreateMapSolid(CMapSolid *pSolid,
  ...
  //
  // Each slice is a ring of four-sided faces, except for the top and bottom
  // slices, which are flattened cones.
  //
  ...
  for (int nSlice = 0; nSlice < nSides; nSlice++) {
    ...
    polyMake(origin[0] - fUpperWidth, origin[1] - fUpperDepth,
             origin[0] + fUpperWidth, origin[1] + fUpperDepth, nSides, 0,
             TopPoints);
    ...
    polyMake(origin[0] - fLowerWidth, origin[1] - fLowerDepth,
             origin[0] + fLowerWidth, origin[1] + fLowerDepth, nSides, 0,
             BottomPoints);
