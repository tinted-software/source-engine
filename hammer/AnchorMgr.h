...
enum EAnchorHorz {
  k_eAnchorLeft, // Anchor this side of the control to the left of its parent
                 // window.
  k_eAnchorRight // Anchor this side of the control to the right of its parent
                 // window.
};
enum EAnchorVert {
  k_eAnchorTop,   // Anchor this side of the control to the top of its parent
                  // window.
  k_eAnchorBottom // Anchor this side of the control to the bottom of its parent
                  // window.
};
...
public:
  ...
  CAnchorDef(int dlgItemID, EAnchorHorz eLeftSide = k_eAnchorLeft,
             EAnchorVert eTopSide = k_eAnchorTop,
             EAnchorHorz eRightSide = k_eAnchorRight,
             EAnchorVert eBottomSide = k_eAnchorBottom);
  CAnchorDef(HWND hWnd, EAnchorHorz eLeftSide = k_eAnchorLeft,
             EAnchorVert eTopSide = k_eAnchorTop,
             EAnchorHorz eRightSide = k_eAnchorRight,
             EAnchorVert eBottomSide = k_eAnchorBottom);
  ...
  void Init(HWND hWnd, int dlgItemID, EAnchorHorz eLeftSide,
...
public:
  ...
  // Call this when the parent window's size changes and it'll resize all the
  // subcontrols.
  void OnSize();
