...
#if !defined(                                                                  \
    AFX_SOUNDBROWSER_H__33046A12_7CF9_4031_AD10_A76200E73280__INCLUDED_)
...
class CSoundBrowser : public CDialog {
  // Construction
public:
  CSoundBrowser(const char *pCurrentSoundName,
...
private:
  ...
  BOOL m_bSoundPlayed; // used so we can do a timer query to keep disable the
                       // stop sound button
