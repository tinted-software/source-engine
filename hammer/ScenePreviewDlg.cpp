...
CScenePreviewDlg::CScenePreviewDlg(CChoreoScene *pScene, const char *pFilename,
                                   CWnd *pParent /*=NULL*/)
...
BOOL CScenePreviewDlg::OnInitDialog() {
  ...
  m_hIdleThread =
      CreateThread(NULL, 0, &CScenePreviewDlg::StaticIdleThread, this, 0, NULL);
...
LRESULT CScenePreviewDlg::DefWindowProc(UINT message, WPARAM wParam,
                                        LPARAM lParam) {
