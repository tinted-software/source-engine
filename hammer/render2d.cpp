...
//-----------------------------------------------------------------------------
CRender2D::CRender2D() { m_vCurLine.Init(); }
...
void CRender2D::MoveTo(const Vector &vPoint) { m_vCurLine = vPoint; }
...
//			bFill - Whether to fill the ellipse with the fill color
//or not.
//-----------------------------------------------------------------------------
...
void CRender2D::DrawRectangle(const Vector &vMins, const Vector &vMaxs,
                              bool bFill, int extent) {
