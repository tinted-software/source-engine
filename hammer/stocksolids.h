...
public:
  ...
  virtual void CreateMapSolid(CMapSolid *pSolid,
                              TextureAlignment_t eAlignment) = 0;
...
protected:
  ...
  typedef enum { DFTYPE_INTEGER, DFTYPE_BOOLEAN } STSDF_TYPE;
