...
private:
  ...
  friend bool FindDrawCommand(CUtlVector<CDrawCommand *> &drawCommands,
...
private:
  ...
  void BuildLMGroups(CBSPInfo &file, CUtlVector<CFace> &faces,
  ...
  void CreateDisplacements(CBSPInfo &file, CUtlVector<CFace> &faces,
                           CUtlVector<CDispInfoFaces> &dispInfos);
