...
//			It lets the user pick an existing visgroup or create a
//new one.
//
//=============================================================================//
...
//-----------------------------------------------------------------------------
void CNewVisGroupDlg::GetName(CString &str) { str = m_strName; }
...
//-----------------------------------------------------------------------------
// Purpose: Switches the mode of the dialog to pick an existing visgroup rather
// than
//			create a new one.
//-----------------------------------------------------------------------------
