...
enum { lbdBool, lbdString, lbdInteger };

enum { lbeYesNo, lbeOnOff, lbeString, lbeInteger, lbeTexture, lbeChoices };
...
public:
  ...
  void AddItem(char *pszCaption, int iEditType, PVOID pData, int iRangeMin = -1,
               int iRangeMax = -1, const char *pszHelp = NULL);
