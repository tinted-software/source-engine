...
public:
  ...
  void SetDisabledBrushAndPen(LPDRAWITEMSTRUCT lpDrawItemStruct,
                              CBrush **ppOldBrush, CPen **ppOldPen);
  void SetUnSelectedBrushAndPen(LPDRAWITEMSTRUCT lpDrawItemStruct,
                                CBrush **ppOldBrush, CPen **ppOldPen);
  void SetSelectedBrushAndPen(LPDRAWITEMSTRUCT lpDrawItemStruct,
                              CBrush **ppOldBrush, CPen **ppOldPen);
  void ResetBrushAndPen(LPDRAWITEMSTRUCT lpDrawItemStruct, CBrush *pBrush,
                        CPen *pPen);
};
