...
//-----------------------------------------------------------------------------
void CToolPickFace::OnDeactivate() { DeselectAll(); }
...
//-----------------------------------------------------------------------------
bool CToolPickFace::OnLMouseUp3D(CMapView3D *pView, UINT nFlags,
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickFace::OnLMouseDown3D(CMapView3D *pView, UINT nFlags,
                                   const Vector2D &vPoint) {
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickFace::OnLMouseDblClk3D(CMapView3D *pView, UINT nFlags,
                                     const Vector2D &vPoint) {
  return true;
}
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickFace::OnRMouseUp3D(CMapView3D *pView, UINT nFlags,
                                 const Vector2D &vPoint) {
  return true;
}
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickFace::OnRMouseDown3D(CMapView3D *pView, UINT nFlags,
                                   const Vector2D &vPoint) {
  return true;
}
...
// Output : Returns true if the message was handled by the tool, false if not.
//-----------------------------------------------------------------------------
bool CToolPickFace::OnMouseMove3D(CMapView3D *pView, UINT nFlags,
                                  const Vector2D &vPoint) {
  SetEyedropperCursor();
  return true;
}
...
//			FaceListPartial -
//-----------------------------------------------------------------------------
void CToolPickFace::SetSelectedFaces(CMapFaceList &FaceListFull,
...
//-----------------------------------------------------------------------------
void CToolPickFace::GetSelectedFaces(CMapFaceList &FaceListFull,
                                     CMapFaceList &FaceListPartial) {
