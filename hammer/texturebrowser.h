...
protected:
  ...
  static char m_szLastKeywords[MAX_PATH]; // The text in the keywords combo when
                                          // the user last exited the browser.
  ...
  char m_szNameFilter[128]; // Overrides the name filter history for a single
                            // browser session.
  ...
  TextureWindowTexList
      m_TextureSubList; // Holds a specific sublist of textures to browse.
};
