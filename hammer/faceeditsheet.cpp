...
//
// Purpose: A page in a tabbed dialog that allows the editing of face
// properties.
//
//=============================================================================//
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
CFaceEditSheet::CFaceEditSheet(LPCTSTR pszCaption, CWnd *pParentWnd,
                               UINT iSelectPage)
...
//			dialog at once. When updates are re-enabled, the window
//is updated.
...
//-----------------------------------------------------------------------------
void CFaceEditSheet::ClickFace(CMapSolid *pSolid, int faceIndex, int cmd,
                               int clickMode) {
  //
...
void CFaceEditSheet::OnClose(void) {
  ...
  // dialogs
  m_MaterialPage.SetMaterialPageTool(
      CFaceEditMaterialPage::MATERIALPAGETOOL_MATERIAL);
