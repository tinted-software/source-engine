...
BaseInputDialog::~BaseInputDialog() { CleanUpContextKeyValues(); }
...
//-----------------------------------------------------------------------------
InputMessageBox::InputMessageBox(vgui::Panel *parent, const char *title,
                                 char const *prompt)
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
InputDialog::InputDialog(vgui::Panel *parent, const char *title,
                         char const *prompt, char const *defaultValue /*=""*/)
    : BaseClass(parent, title) {
  SetSize(320, 120);
...
void InputDialog::OnCommand(const char *command) {
  ...
  // it'd be nice at some point to find all uses of InputDialog and just use
  // BaseInputDialog's OnCommand
