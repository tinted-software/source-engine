...
// Input:
//		baseName: is the name of the animations without their frame
//number or 			file extension, (e.g. c1.tga becomes just c.) 		framecount: number of
