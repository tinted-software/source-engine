...
//-----------------------------------------------------------------------------
void Image::GetContentSize(int &wide, int &tall) { GetSize(wide, tall); }
...
//-----------------------------------------------------------------------------
void Image::DrawSetTextFont(HFont font) { surface()->DrawSetTextFont(font); }
...
//-----------------------------------------------------------------------------
void Image::DrawPrintChar(wchar_t ch) { surface()->DrawUnicodeChar(ch); }
...
//-----------------------------------------------------------------------------
void Image::DrawSetTexture(int id) { surface()->DrawSetTexture(id); }
...
bool Image::Evict() { return false; }

int Image::GetNumFrames() { return 0; }

void Image::SetFrame(int nFrame) {}

HTexture Image::GetID() { return 0; }
