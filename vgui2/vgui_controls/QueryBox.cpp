...
// Purpose: Constructor
//-----------------------------------------------------------------------------
QueryBox::QueryBox(const char *title, const char *queryText,
                   vgui::Panel *parent)
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
QueryBox::QueryBox(const wchar_t *wszTitle, const wchar_t *wszQueryText,
                   vgui::Panel *parent)
...
void QueryBox::PerformLayout() {
  ...
  m_pOkButton->SetPos((wide / 2) - (m_pOkButton->GetWide()) - 1 + x,
                      tall - m_pOkButton->GetTall() - 15 * scale);
  m_pCancelButton->SetPos((wide / 2) + x + 16 * scale,
                          tall - m_pCancelButton->GetTall() - 15 * scale);
}
