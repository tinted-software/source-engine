...
DirectoryTreeView::DirectoryTreeView(DirectorySelectDialog *parent,
                                     const char *name)
...
void DirectorySelectDialog::SetDefaultCreateDirectoryName(
  ...
  strncpy(m_szDefaultCreateDirName, defaultCreateDirName,
          sizeof(m_szDefaultCreateDirName));
...
void DirectorySelectDialog::ExpandTreeNode(const char *path,
  ...
  const char *pFileName =
      g_pFullFileSystem->FindFirstEx(searchString, NULL, &h);
