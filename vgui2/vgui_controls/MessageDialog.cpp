...
// CMessageDialog
//-----------------------------------------------------------------------------
CMessageDialog::CMessageDialog(vgui::Panel *pParent, const uint nType,
...
void CMessageDialog::ApplySchemeSettings(vgui::IScheme *pScheme) {
  ...
  if (m_bShowActivity && m_ActivityIndent) {
    ...
    m_pMsg->SetBounds(iX + m_ActivityIndent, iY, max(0, iW - m_ActivityIndent),
                      iH);
  }
...
// Purpose:
//-----------------------------------------------------------------------------
uint CMessageDialog::GetType(void) { return m_nType; }
