...
CVMTPicker::CVMTPicker(vgui::Panel *pParent, bool bAllowMultiselect)
  ...
  m_pPreviewSplitter =
      new Splitter(this, "PreviewSplitter", SPLITTER_MODE_VERTICAL, 1);
  vgui::Panel *pSplitterLeftSide = m_pPreviewSplitter->GetChild(0);
  vgui::Panel *pSplitterRightSide = m_pPreviewSplitter->GetChild(1);

  m_p2D3DSplitter = new Splitter(pSplitterRightSide, "2D3DSplitter",
...
//
//-----------------------------------------------------------------------------
CVMTPickerFrame::CVMTPickerFrame(vgui::Panel *pParent, const char *pTitle,
