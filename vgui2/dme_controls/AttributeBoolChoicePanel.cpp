...
//
//-----------------------------------------------------------------------------
CAttributeBoolChoicePanel::CAttributeBoolChoicePanel(
...
void CAttributeBoolChoicePanel::PopulateComboBox(vgui::ComboBox *pComboBox) {
  ...
  CDmeEditorBoolChoicesInfo *pInfo =
      CastElement<CDmeEditorBoolChoicesInfo>(GetEditorInfo());
  if (!pInfo)
    return;
  ...
  if (pInfo->HasChoiceType()) {
    ...
    if (ElementPropertiesChoices()->GetBoolChoiceList(
...
//-----------------------------------------------------------------------------
void CAttributeBoolChoicePanel::SetAttributeFromComboBox(
...
//-----------------------------------------------------------------------------
void CAttributeBoolChoicePanel::SetComboBoxFromAttribute(
