...
// Add a choice
//-----------------------------------------------------------------------------
void CDmeEditorIntChoicesInfo::AddChoice(int nValue,
...
//
//-----------------------------------------------------------------------------
CAttributeIntChoicePanel::CAttributeIntChoicePanel(
...
void CAttributeIntChoicePanel::PopulateComboBox(vgui::ComboBox *pComboBox) {
  ...
  CDmeEditorIntChoicesInfo *pInfo =
      CastElement<CDmeEditorIntChoicesInfo>(GetEditorInfo());
  if (!pInfo)
    return;
  ...
  if (pInfo->HasChoiceType()) {
    ...
    if (ElementPropertiesChoices()->GetIntChoiceList(
...
//-----------------------------------------------------------------------------
void CAttributeIntChoicePanel::SetAttributeFromComboBox(
  ...
  CUndoScopeGuard guard(NOTIFY_SOURCE_PROPERTIES_TREE, NOTIFY_SETDIRTYFLAG,
...
//-----------------------------------------------------------------------------
void CAttributeIntChoicePanel::SetComboBoxFromAttribute(
