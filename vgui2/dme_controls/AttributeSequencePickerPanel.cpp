...
void CAttributeSequencePickerPanel::ShowPickerDialog() {
  CMDLPickerFrame *pMDLPickerDialog =
      new CMDLPickerFrame(this, "Select .MDL File");
...
//-----------------------------------------------------------------------------
void CAttributeSequencePickerPanel::ShowSequencePickerDialog(
    const char *pMDLName) {
  ...
  CSequencePickerFrame *pSequencePickerDialog =
      new CSequencePickerFrame(this, pickType);
