...
CBaseAttributePanel::CBaseAttributePanel(vgui::Panel *parent,
    ...
    : BaseClass(parent, info.m_pAttributeName), m_pType(0),
      m_hObject(info.m_pElement), m_hEditorInfo(info.m_pEditorInfo),
      m_hEditorTypeDict(info.m_pEditorTypeDictionary),
      m_pNotify(info.m_pNotify), m_nArrayIndex(info.m_nArrayIndex),
