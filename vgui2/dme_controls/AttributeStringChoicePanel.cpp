...
//-----------------------------------------------------------------------------
IMPLEMENT_ELEMENT_FACTORY(DmeEditorStringChoicesInfo,
                          CDmeEditorStringChoicesInfo);
...
// Add a choice
//-----------------------------------------------------------------------------
CDmElement *CDmeEditorStringChoicesInfo::AddChoice(const char *pValueString,
...
// Constructor
//-----------------------------------------------------------------------------
CAttributeStringChoicePanel::CAttributeStringChoicePanel(
...
void CAttributeStringChoicePanel::PopulateComboBox(vgui::ComboBox *pComboBox) {
  ...
  CDmeEditorStringChoicesInfo *pInfo =
      CastElement<CDmeEditorStringChoicesInfo>(GetEditorInfo());
  if (!pInfo)
    return;
  ...
  if (pInfo->HasChoiceType()) {
    ...
    if (ElementPropertiesChoices()->GetStringChoiceList(
            pInfo->GetChoiceType(), GetPanelElement(), GetAttributeName(),
...
//-----------------------------------------------------------------------------
void CAttributeStringChoicePanel::SetAttributeFromComboBox(
    vgui::ComboBox *pComboBox, KeyValues *pKeyValues) {
...
//-----------------------------------------------------------------------------
void CAttributeStringChoicePanel::SetComboBoxFromAttribute(
