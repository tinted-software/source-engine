...
/// you need to send your public key to Valve.  This key should be on a single
/// line of text that begins with "ssh-ed25519".  (The format used in the
/// .ssh/authorized_keys file.)
STEAMDATAGRAM_TICKET_INTERFACE bool
SteamDatagram_InitTicketGenerator_Ed25519(void *pvPrivateKey,
                                          size_t cbPrivateKey);
...
STEAMDATAGRAM_TICKET_INTERFACE bool
SteamDatagram_SerializeAndSignTicket(const SteamDatagramRelayAuthTicket &ticket,
                                     SteamDatagramSignedTicketBlob &outBlob);
...
/// Input buffer will be securely wiped.
STEAMDATAGRAM_TICKET_INTERFACE bool
SteamDatagram_InitTicketGenerator_RSA_deprecated(void *pvPrivateKey,
                                                 size_t cbPrivateKey);

/// Generate a signature for legacy support
STEAMDATAGRAM_TICKET_INTERFACE bool
SteamDatagram_SerializeAndSignTicket_deprecated(
    const SteamDatagramRelayAuthTicket &ticket,
    SteamDatagramSignedTicketBlob &outBlob);
