...
// Dag editor panel
//-----------------------------------------------------------------------------
class CDmePresetGroupEditorPanel : public vgui::EditablePanel,
...
public:
  ...
  void MovePresetGroupInFrontOf(CDmePresetGroup *pDragGroup,
...
private:
  ...
  // If it finds a duplicate group/preset name, reports an error message and
  // returns it found one
  bool HasDuplicatePresetName(const char *pPresetName,
                              CDmePreset *pIgnorePreset = NULL);
  bool HasDuplicateGroupName(const char *pControlName,
                             CDmePresetGroup *pIgnoreGroup = NULL);
