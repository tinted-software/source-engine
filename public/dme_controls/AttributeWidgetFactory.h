...
struct AttributeWidgetInfo_t {
  AttributeWidgetInfo_t() { m_nArrayIndex = -1; }
...
public:
  virtual vgui::Panel *Create(vgui::Panel *pParent,
                              const AttributeWidgetInfo_t &info) = 0;
};
...
public:
  ...
  GetWidgetFactory(const char *pWidgetName) = 0;
  ...
  virtual void ApplyChanges(vgui::Panel *pWidget,
                            vgui::Panel *pSender = NULL) = 0;
