...
#define PNG_HEADER_VERSION_STRING " libpng version 1.5.2 - March 31, 2011\n"
...
PNG_EXPORT(8, jmp_buf *, png_set_longjmp_fn,
           (png_structp png_ptr, png_longjmp_ptr longjmp_fn,
            size_t jmp_buf_size));
...
PNG_EXPORT(19, void, png_info_init_3,
...
PNG_FP_EXPORT(32, void, png_set_rgb_to_gray,
              (png_structp png_ptr, int error_action, double red,
               double green));
PNG_FIXED_EXPORT(33, void, png_set_rgb_to_gray_fixed,
                 (png_structp png_ptr, int error_action, png_fixed_point red,
...
PNG_EXPORT(44, void, png_set_shift,
           (png_structp png_ptr, png_const_color_8p true_bits));
#endif
...
PNG_FIXED_EXPORT(208, void, png_set_gamma_fixed,
                 (png_structp png_ptr, png_fixed_point screen_gamma,
                  png_fixed_point default_file_gamma));
#endif
...
PNG_EXPORT(55, void, png_read_rows,
           (png_structp png_ptr, png_bytepp row, png_bytepp display_row,
...
PNG_EXPORT(75, void, png_set_error_fn,
           (png_structp png_ptr, png_voidp error_ptr, png_error_ptr error_fn,
...
PNG_EXPORT(82, void, png_set_mem_fn,
           (png_structp png_ptr, png_voidp mem_ptr, png_malloc_ptr malloc_fn,
...
PNG_EXPORT(86, void, png_set_user_transform_info,
           (png_structp png_ptr, png_voidp user_transform_ptr,
...
PNG_EXPORT(90, void, png_set_progressive_read_fn,
           (png_structp png_ptr, png_voidp progressive_ptr,
...
PNG_EXPORT(92, void, png_process_data,
           (png_structp png_ptr, png_infop info_ptr, png_bytep buffer,
...
PNG_EXPORTA(94, png_voidp, png_malloc,
            (png_structp png_ptr, png_alloc_size_t size), PNG_ALLOCATED);
...
PNG_EXPORT(98, void, png_free_data,
           (png_structp png_ptr, png_infop info_ptr, png_uint_32 free_me,
            int num));

/* Reassign responsibility for freeing existing data, whether allocated
 * by libpng or by the application */
PNG_EXPORT(99, void, png_data_freer,
           (png_structp png_ptr, png_infop info_ptr, int freer,
            png_uint_32 mask));
...
PNG_FP_EXPORT(135, void, png_set_cHRM,
              (png_structp png_ptr, png_infop info_ptr, double white_x,
...
PNG_EXPORT(146, void, png_set_oFFs,
           (png_structp png_ptr, png_infop info_ptr, png_int_32 offset_x,
...
PNG_EXPORT(148, void, png_set_pCAL,
           (png_structp png_ptr, png_infop info_ptr, png_const_charp purpose,
...
PNG_EXPORT(152, void, png_set_PLTE,
           (png_structp png_ptr, png_infop info_ptr, png_const_colorp palette,
            int num_palette));
...
PNG_EXPORT(159, void, png_set_iCCP,
           (png_structp png_ptr, png_infop info_ptr, png_const_charp name,
...
PNG_EXPORT(161, void, png_set_sPLT,
           (png_structp png_ptr, png_infop info_ptr, png_const_sPLT_tp entries,
            int nentries));
#endif
...
PNG_EXPORT(163, void, png_set_text,
           (png_structp png_ptr, png_infop info_ptr, png_const_textp text_ptr,
            int num_text));
#endif
...
PNG_FP_EXPORT(170, void, png_set_sCAL,
              (png_structp png_ptr, png_infop info_ptr, int unit, double width,
               double height));
PNG_FIXED_EXPORT(213, void, png_set_sCAL_fixed,
                 (png_structp png_ptr, png_infop info_ptr, int unit,
                  png_fixed_point width, png_fixed_point height));
...
PNG_EXPORT(172, void, png_set_keep_unknown_chunks,
           (png_structp png_ptr, int keep, png_const_bytep chunk_list,
            int num_chunks));
...
PNG_EXPORT(185, void, png_set_strip_error_numbers,
           (png_structp png_ptr, png_uint_32 strip_mode));
#endif

/* Added in libpng-1.2.6 */
#ifdef PNG_SET_USER_LIMITS_SUPPORTED
PNG_EXPORT(186, void, png_set_user_limits,
           (png_structp png_ptr, png_uint_32 user_width_max,
...
PNG_EXPORTA(200, png_const_bytep, png_get_io_chunk_name, (png_structp png_ptr),
            PNG_DEPRECATED);
