...
template <int M, int N> class NMatrix {
public:
  NMatrixMN() {}
...
template <int M, int N> inline NMatrixMN NMatrixMN::SetupNMatrixNull() {
  NMatrix ret;
  memset(ret.m, 0, sizeof(float) * M * N);
  return ret;
}

template <int M, int N> inline NMatrixMN NMatrixMN::SetupNMatrixIdentity() {
...
template <int M, int N> inline NMatrixMN NMatrixMN::operator-() const {
  NMatrixMN ret;
...
template <int M, int N> inline NMatrixMN NMatrixMN::operator*(float val) const {
  NMatrixMN ret;
...
template <int M, int N> inline NMatrix<N, M> NMatrixMN::Transpose() const {
  NMatrix<N, M> ret;
