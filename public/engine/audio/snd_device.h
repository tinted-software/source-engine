...
// sound
//			At the time of this writing there are Windows WAVEOUT,
//Direct Sound, 			and Null implementations.
//
//=====================================================================================//
...
#define SOUND_MIX_SPECIAL_DSP                                                  \
  3 // mix only samples with channel set to 'special dsp'
...
#define SOUND_BUSS_SPECIAL_DSP                                                 \
  (1 << 5) // mix ch->bspecialdsp samples into special dsp buffer
...
public:
  ...
  // Audio_GetNullDevice which will create a "null" device that makes no sound.
  // If we can't create a real sound device, this will return a device of that
  // type.  All of the interface functions can be called on the null device, but
  // it will not, of course, make sound.
