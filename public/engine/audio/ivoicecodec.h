...
public:
  ...
  // exceed this. bFinal        		-	Set to true on the last
  // call to Compress (the user stopped talking).
  //							Some codecs like big
  //block sizes and will hang onto data you give them in Compress calls. 							When
  //you call with bFinal, the codec will give you compressed data no matter
  //what.
