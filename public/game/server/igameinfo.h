...
public:
  ...
  // returns how many teams the game has (typically always 4; 0 = unassigned, 1
  // = spectator, 2 = team1, 3 = team2)
  ...
  // accessor to hook mod specific information about the rules. for TF2, fields
  // such as
