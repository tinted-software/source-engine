...
public:
  ...
  // if VU meter is "writable," it will be a tab stop, and be focusable. when
  // activated it will enter a mode where you can set the bar with the dpad. if
  // VU meter is not writable, it just displays a value.
