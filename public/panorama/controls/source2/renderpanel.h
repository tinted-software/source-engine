...
//-----------------------------------------------------------------------------
// Purpose: Render panel, to use for raw source2 render operations directly in
// render thread
//-----------------------------------------------------------------------------
...
public:
  ...
  // Override and make return true if you need to paint every single frame, and
  // will not manually call SetRepaint when you want to repaint
