...
struct CascadeStyleFileInfo_t {
  ...
  uint m_unSelectorSpecificity; // score for this selector (high = overrides
                                // lower valued selectors)
};

//-----------------------------------------------------------------------------
// Purpose: All the info needed to identify a panel. Used when looking up a
// style w/o a IUIPanel*
//-----------------------------------------------------------------------------
