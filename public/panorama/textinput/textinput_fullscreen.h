...
public:
  CTextInputFullscreen(panorama::CPanel2D *pPanel, const char *pchPanelID,
...
private:
  bool EventTextInputHandlerStateChange(
      const panorama::CPanelPtr<panorama::IUIPanel> &ptrPanel,
      bool bActivating);
  bool EventTextInputFinished(
      const panorama::CPanelPtr<panorama::IUIPanel> &ptrPanel, bool bSubmitted,
      const char *pchText);
