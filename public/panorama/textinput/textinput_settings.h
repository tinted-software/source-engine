...
public:
  ...
  void SetHideSuggestions(bool bHideSuggestions) {
    m_bHideSuggestions = bHideSuggestions;
  }
  bool BHideSuggestions() const { return m_bHideSuggestions; }

  void SetDoubleSpaceToDotSpace(bool bDoubleSpaceToDotSpace) {
    m_bDoubleSpaceToDotSpace = bDoubleSpaceToDotSpace;
  }
  ...
  void SetDoneActionString(const char *pszActionString) {
    m_strDoneActionString = pszActionString;
  }
  const char *GetDoneActionString() const { return m_strDoneActionString; }

  void SetCancelActionString(const char *pszCancelActionString) {
    m_strCancelActionString = pszCancelActionString;
  }
