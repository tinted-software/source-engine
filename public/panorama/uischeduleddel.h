...
// Panorama wrapper around CUtlSymbol which always creates symbol in
// panorama.dll module
...
public:
  ...
  double GetSecondsUntilScheduled() {
    return MAX(m_flNextScheduled - UIEngine()->GetCurrentFrameTime(), 0.0);
  }
