...
public:
  ...
  virtual CStyleSymbol
  GetPropertyNameForAlias(panorama::CStyleSymbol symName) = 0;
  virtual CStyleProperty *
  CreateStyleProperty(panorama::CStyleSymbol symName) = 0;
...
//-----------------------------------------------------------------------------
inline int CompareStylePropertyName(const CUtlString *plhs,
                                    const CUtlString *prhs) {
...
//-----------------------------------------------------------------------------
inline bool StylePropertyNameLessThan(const CUtlString &lhs,
                                      const CUtlString &rhs, void *pContext) {
