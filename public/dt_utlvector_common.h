...
template <class T, class A> class UtlVectorTemplate {
public:
  static void ResizeUtlVector(void *pStruct, int offsetToUtlVector, int len) {
    ...
    // This is important to do because EnsureCapacity doesn't actually call the
    // constructors on the elements, but we need them to be initialized,
