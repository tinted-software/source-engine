...
struct StripHeader_t {
  ...
  inline BoneStateChangeHeader_t *pBoneStateChange(int i) const {
    return (BoneStateChangeHeader_t *)(((byte *)this) + boneStateChangeOffset) +
           i;
  };
};
...
struct StripGroupHeader_t {
  ...
  inline StripHeader_t *pStrip(int i) const {
    if (flags & STRIPGROUP_IS_MDL49)
      return (
          StripHeader_t *)((StripHeader_v49_t *)(((byte *)this) + stripOffset) +
                           i);
    else
...
struct MeshHeader_t {
  ...
  inline StripGroupHeader_t *pStripGroup(int i) const {
    if (flags & STRIPGROUP_IS_MDL49)
      return (StripGroupHeader_t
                  *)((StripGroupHeader_v49_t *)(((byte *)this) +
                                                stripGroupHeaderOffset) +
                     i);
    else
      return (StripGroupHeader_t *)(((byte *)this) + stripGroupHeaderOffset) +
             i;
  };
  unsigned char flags;
};
