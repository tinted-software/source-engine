...
enum TranslateStackInfo_StyleFlags_t {
  ...
  TSISTYLEFLAG_LINE = (1 << 4), // file line number
                                // Sample: "(162)"
...
GetFileAndLineFromAddress(const void *pAddress, tchar *pFileNameOut,
                          int iMaxFileNameLength, uint32 &iLineNumberOut,
                          uint32 *pDisplacementOut = NULL);
PLATFORM_INTERFACE bool
GetSymbolNameFromAddress(const void *pAddress, tchar *pSymbolNameOut,
...
public:
  ...
  void *pStack[128]; // probably too big, possibly too small for some
                     ...
                     // how to generalize this without templatizing pollution or
                     // mallocs
