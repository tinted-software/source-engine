...
public:
  CItemUploadSubPanel(vgui::Panel *pParent, const char *pszName,
...
protected:
  ...
  vgui::PanelListPanel
      *m_pPanelListPanel;       // Standard list of widgets to set parameters
  ...
  void SetStatus(bool bValid, const char *pszPrefix,
                 const char *pszMessage = NULL, bool bHide = false);
};
...
public:
  CGlobalSubPanel(vgui::Panel *pParent, const char *pszName,
                  const char *pszNextName);
...
//
//=============================================================================
class CGeometrySubPanel : public CItemUploadSubPanel,
                          public vgui::IFileOpenStateMachineClient {
  DECLARE_CLASS_SIMPLE(CGeometrySubPanel, CItemUploadSubPanel);

public:
  CGeometrySubPanel(vgui::Panel *pParent, const char *pszName,
                    const char *pszNextName);
  ...
  virtual void SetupFileOpenDialog(vgui::FileOpenDialog *pDialog,
                                   bool bOpenFile, const char *pszFileFormat,
                                   KeyValues *pContextKeyValues);
  virtual bool OnReadFileFromDisk(const char *pszFileName,
                                  const char *pszFileFormat,
                                  KeyValues *pContextKeyValues);
  virtual bool OnWriteFileToDisk(const char *pszFileName,
                                 const char *pszFileFormat,
                                 KeyValues *pContextKeyValues);
...
//
//=============================================================================
class CMaterialSubPanel : public CItemUploadSubPanel,
                          public vgui::IFileOpenStateMachineClient {
  DECLARE_CLASS_SIMPLE(CMaterialSubPanel, CItemUploadSubPanel);

public:
  CMaterialSubPanel(vgui::Panel *pParent, const char *pszName,
                    const char *pszNextName);
...
public:
  CFinalSubPanel(vgui::Panel *pParent, const char *pszName,
                 const char *pszNextName);
