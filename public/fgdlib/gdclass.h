...
//			file (FGD). Each class is type of entity that can be
//placed in 			the editor and has attributes such as: keys that may be set, 			the
//default size and color of the entity, inputs and outputs, 			and any default
//models that are created when the entity is placed.
//
