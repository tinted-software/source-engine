...
#define FL_FAKECLIENT                                                          \
  (1 << 8) // Fake client, simulated server side; don't send network messages to
           // them
...
enum MoveCollide_t {
  ...
  MOVECOLLIDE_FLY_SLIDE, // slides along surfaces (no bounce) - applies friciton
                         // (adjusts velocity)
...
enum {
  ...
  EF_BONEMERGE_FASTCULL =
      0x080, // For use with EF_BONEMERGE. If this is set, then it places this
...
enum Collision_Group_t {
  ...
  COLLISION_GROUP_PLAYER_MOVEMENT, // For HL2, same as Collision_Group_Player,
                                   // for TF2, this filters out other players
                                   // and CBaseObjects
  ...
  COLLISION_GROUP_PUSHAWAY, // Nonsolid on client and server, pushaway in player
                            // code
