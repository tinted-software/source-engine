...
struct Polyhedron_IndexedLineReference_t {
  ...
  unsigned char
      iEndPointIndex; // since two polygons reference any one line, one needs to
                      // traverse the line backwards, this flags that behavior
};
...
public:
  ...
  static CPolyhedron_AllocByNew *
  Allocate(unsigned short iVertices, unsigned short iLines,
