...
#define FEMMS {_asm _emit 0x0f _asm _emit 0x0e}
...
#define PREFETCHWMLONG(src, off)                                               \
  {_asm _emit 0x0f _asm _emit 0x0d _asm _emit 0x88 |                           \
   (_K3D_##src & 0x07) _asm _emit(off & 0x000000ff) _asm _emit(off &           \
                                                               0x0000ff00) >>  \
...
/* Defines for new, K7 opcodes */
#define SFENCE {_asm _emit 0x0f _asm _emit 0xae _asm _emit 0xf8}
