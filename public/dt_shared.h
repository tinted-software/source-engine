...
DataTableProp
PropVector(char *pVarName, int offset, int sizeofVar = SIZEOF_IGNORE,
           int nBits = 32, // Number of bits (for each floating-point component)
...
DataTableProp
PropInt(char *pVarName, int offset,
