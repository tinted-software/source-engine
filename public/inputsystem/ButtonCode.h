...
#define STEAMCONTROLLER_BUTTON_INTERNAL(_joystick, _button)                    \
  (STEAMCONTROLLER_FIRST_BUTTON +                                              \
   ((_joystick) * STEAMCONTROLLER_MAX_BUTTON_COUNT) + (_button))
#define STEAMCONTROLLER_AXIS_BUTTON_INTERNAL(_joystick, _button)               \
  (STEAMCONTROLLER_FIRST_AXIS_BUTTON +                                         \
   ((_joystick) * STEAMCONTROLLER_AXIS_BUTTON_COUNT) + (_button))
...
inline bool IsJoystickCode(ButtonCode_t code) {
  return (((code >= JOYSTICK_FIRST) && (code <= JOYSTICK_LAST)) ||
          ((code >= STEAMCONTROLLER_FIRST_BUTTON) &&
           (code <= STEAMCONTROLLER_LAST_BUTTON)));
}
...
inline bool IsSteamControllerButtonCode(ButtonCode_t code) {
  return (code >= STEAMCONTROLLER_FIRST_BUTTON) &&
         (code <= STEAMCONTROLLER_LAST_BUTTON);
}

inline bool IsSteamControllerAxisCode(ButtonCode_t code) {
  return (code >= STEAMCONTROLLER_FIRST_AXIS_BUTTON) &&
         (code <= STEAMCONTROLLER_LAST_AXIS_BUTTON);
}
