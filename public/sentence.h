...
public:
  ...
  //				This strips out all of the stuff used by the
  //editor, leaving just one blank work, no sentence text, and just 					the phonemes
  //without the phoneme text...(same as the cacherestore version below)
