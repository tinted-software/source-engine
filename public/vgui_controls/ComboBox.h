...
public:
  ...
  void SilentActivateItem(int itemID); // Sets the menu to the appropriate row
                                       // without sending a TextChanged message
  void
  SilentActivateItemByRow(int row); // Sets the menu to the appropriate row
                                    // without sending a TextChanged message
