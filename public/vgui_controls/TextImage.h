...
public:
  // takes the string and looks it up in the localization file to convert it to
  // unicode
...
private:
  ...
  StringIndex_t _unlocalizedTextSymbol; // store off the unlocalized text index
                                        // for build mode
  ...
  bool m_bWrapCenter; // Separate from m_bWrap to ensure it doesn't break legacy
                      // code.
  CUtlVector<int>
