...
//			Contains the information to map a string message name
//with parameters 			to a function call
//-----------------------------------------------------------------------------
...
#define MESSAGE_FUNC_HANDLE_HANDLE(name, scriptname, p1, p2)                   \
  _MessageFuncCommon(name, scriptname, 2, vgui::DATATYPE_HANDLE, #p1,          \
                     vgui::DATATYPE_HANDLE, #p2);                              \
  virtual void name(vgui::VPANEL p1, vgui::VPANEL p2)
...
#define MAP_MESSAGE_INT_INT(type, name, func, param1, param2)                  \
  {name,   (vgui::MessageFunc_t) & type::func,                                 \
   2,      vgui::DATATYPE_INT,                                                 \
   param1, vgui::DATATYPE_INT,                                                 \
   param2}
