...
struct BoundKey_t {
  ...
  bool isbuiltin; // whether this was by the #DECLARE macros or via code/parsing
                  // a config file
...
#define DECLARE_KEYBINDINGMAP(className)                                       \
  static void KB_AddToMap(char const *bindingname, vgui::KeyCode defaultcode,  \
                          int default_modifiers, vgui::MessageFunc_t function, \
                          char const *helpstring, char const *docstring,       \
                          bool passive) {                                      \
    ...
    static void InitVar() {                                                    \
      ...
      if (!bAdded) {                                                           \
        ...
        KB_AddToMap(#name, keycode, modifiers,                                 \
                    (vgui::MessageFunc_t) & ThisClass::function, help, doc,    \
                    passive);                                                  \
      }                                                                        \
    }                                                                          \
