...
//			This interface cannot be changed without rebuilding all
//vgui projects 			Primarily this interface handles dispatching messages from core
//vgui to controls 			The additional functions are all their for debugging or
