...
enum EWebPageLoadError {
  ...
  eCacheMiss, // Usually caused by navigating to a page with POST data via back
              // or forward buttons
  ...
  eConnectionProblem, // network connectivity problem, server offline or user
                      // not on internet
  eProxyConnectionProblem, // User is configured to use proxy, but we can't use
                           // it
...
public:
  ...
  // the browser wants to ask the user to select a local file and tell it about
  // it
