...
public:
  ...
  virtual VPANEL GetMouseOver() = 0; // returns the panel the mouse is currently
                                     // over, ignoring mouse capture
  ...
  virtual void GetCandidate(int num, OUT_Z_BYTECAP(destSizeBytes) wchar_t *dest,
                            int destSizeBytes) = 0;
