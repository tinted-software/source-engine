...
public:
  ...
  enum ETextureFormat {
    eTextureFormat_RGBA,
    eTextureFormat_BGRA,
    eTextureFormat_BGRA_Opaque, // bgra format but alpha is always 255, CEF does
                                // this, we can use this fact for better perf on
                                // win32 gdi
  };
  ...
  enum EFontFlags {
    ...
    FONTFLAG_CUSTOM = 0x400, // custom generated font - never fall back to asian
                             // compatibility mode
  ...
  // stereo)
  virtual void
  SetFullscreenViewport(int x, int y, int w,
