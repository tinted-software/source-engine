...
protected:
  ...
  template <bool bCaseInsensitive> class CCompare {
  public:
  ...
  template <bool bCaseInsensitive> class CHash {
  public:
    CHash(int ignored) {}
  ...
  typedef CUtlHash<Entry_t, CCompare<bCaseInsensitive>, CHash<bCaseInsensitive>>
      CHashTable;
...
template <typename T, bool bCaseInsensitive, bool bDupeStrings>
inline const T &
CUtlHashDict<T, bCaseInsensitive, bDupeStrings>::Element(unsigned i) const {
  return m_Elements[i].value;
}
...
template <typename T, bool bCaseInsensitive, bool bDupeStrings>
inline T &
CUtlHashDict<T, bCaseInsensitive, bDupeStrings>::operator[](unsigned i) {
  return m_Elements[i].value;
}

template <typename T, bool bCaseInsensitive, bool bDupeStrings>
inline const T &
CUtlHashDict<T, bCaseInsensitive, bDupeStrings>::operator[](unsigned i) const {
  return m_Elements[i].value;
}
...
template <typename T, bool bCaseInsensitive, bool bDupeStrings>
unsigned
CUtlHashDict<T, bCaseInsensitive, bDupeStrings>::Insert(const char *pName,
                                                        const T &element) {
...
template <typename T, bool bCaseInsensitive, bool bDupeStrings>
unsigned
CUtlHashDict<T, bCaseInsensitive, bDupeStrings>::Find(const char *pName) const {
  MEM_ALLOC_CREDIT_CLASS();
  if (pName)
...
template <typename T, bool bCaseInsensitive, bool bDupeStrings>
unsigned
CUtlHashDict<T, bCaseInsensitive, bDupeStrings>::Next(unsigned i) const {
