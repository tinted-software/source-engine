...
//-----------------------------------------------------------------------------
template <class T> inline bool SerializesOnMultipleLines() { return false; }

template <> inline bool SerializesOnMultipleLines<VMatrix>() { return true; }

template <> inline bool SerializesOnMultipleLines<CUtlBinaryBlock>() {
  return true;
}
...
//-----------------------------------------------------------------------------
template <class T> bool Serialize(CUtlBuffer &buf, const CUtlVector<T> &src) {
...
template <class T> bool Unserialize(CUtlBuffer &buf, CUtlVector<T> &dest) {
  dest.RemoveAll();
