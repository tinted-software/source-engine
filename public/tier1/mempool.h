...
//-----------------------------------------------------------------------------
template <class T> class CClassMemoryPool : public CUtlMemoryPool {
public:
...
template <class T> inline T *CClassMemoryPool<T>::Alloc() {
  T *pRet;
...
template <class T> inline T *CClassMemoryPool<T>::AllocZero() {
  T *pRet;
...
template <class T> inline void CClassMemoryPool<T>::Clear() {
