...
//-----------------------------------------------------------------------------
template <class T, size_t MAX_SIZE> class CUtlArray : public base_array_t {
public:
  ...
  // Returns the number of elements in the array, NumAllocated() is included for
  // consistency with UtlVector
  int Count() const;
...
template <typename T, size_t MAX_SIZE>
typename CUtlArray<T, MAX_SIZE>::const_iterator
CUtlArray<T, MAX_SIZE>::begin() const {
  return Base();
}
...
template <typename T, size_t MAX_SIZE>
typename CUtlArray<T, MAX_SIZE>::const_iterator
CUtlArray<T, MAX_SIZE>::end() const {
  return Base() + Count();
}
