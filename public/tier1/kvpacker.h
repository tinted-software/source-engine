...
//			consistent way across all branches, including Steam. If
//you change 			this packing format you need to do so in a backward compatible way
//			so that the Steam servers and all the various GCs can
