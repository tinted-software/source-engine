...
//-----------------------------------------------------------------------------
template <class T> class CUtlFlags {
public:
...
// Constructor
//-----------------------------------------------------------------------------
template <class T> CUtlFlags<T>::CUtlFlags(int nInitialFlags) {
...
// Set flags
//-----------------------------------------------------------------------------
template <class T> void CUtlFlags<T>::SetFlag(int nFlagMask) {
  // Makes sure we didn't truncate
...
template <class T> void CUtlFlags<T>::SetFlag(int nFlagMask, bool bEnable) {
  // Makes sure we didn't truncate
  Assert(nFlagMask == (T)nFlagMask);
...
// Clear flags
//-----------------------------------------------------------------------------
template <class T> void CUtlFlags<T>::ClearFlag(int nFlagMask) {
  // Makes sure we didn't truncate
  Assert(nFlagMask == (T)nFlagMask);
  m_nFlags &= ~((T)nFlagMask);
}
...
// Is a flag set?
//-----------------------------------------------------------------------------
template <class T> bool CUtlFlags<T>::IsFlagSet(int nFlagMask) const {
  // Makes sure we didn't truncate
  Assert(nFlagMask == (T)nFlagMask);
...
// Is any flag set?
//-----------------------------------------------------------------------------
template <class T> bool CUtlFlags<T>::IsAnyFlagSet() const {
  return m_nFlags != 0;
}
