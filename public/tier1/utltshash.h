...
template <class T> abstract_class ITSHashConstructor {
public:
...
template <int BUCKET_COUNT, class KEYTYPE = intp> class CUtlTSHashGenericHash {
public:
...
template <int BUCKET_COUNT, class KEYTYPE> class CUtlTSHashUseKeyHashMethod {
public:
  static int Hash(const KEYTYPE &key, int nBucketMask) {
...
template <class T, int BUCKET_COUNT, class KEYTYPE, class HashFuncs,
          int nAlignment>
inline void
CUtlTSHash<T, BUCKET_COUNT, KEYTYPE, HashFuncs, nAlignment>::Purge(void) {
  RemoveAll();
}
...
template <class T, int BUCKET_COUNT, class KEYTYPE, class HashFuncs,
          int nAlignment>
inline int
CUtlTSHash<T, BUCKET_COUNT, KEYTYPE, HashFuncs, nAlignment>::Count() const {
...
CUtlTSHash<T, BUCKET_COUNT, KEYTYPE, HashFuncs, nAlignment>::Insert(
    KEYTYPE uiKey, const T &data, bool *pDidInsert) {
#ifdef _DEBUG
  if (m_ContentionCheck != 0) {
    DebuggerBreak();
  }
...
template <class T, int BUCKET_COUNT, class KEYTYPE, class HashFuncs,
          int nAlignment>
inline void
CUtlTSHash<T, BUCKET_COUNT, KEYTYPE, HashFuncs, nAlignment>::FindAndRemove(
    KEYTYPE uiKey) {
...
template <class T, int BUCKET_COUNT, class KEYTYPE, class HashFuncs,
          int nAlignment>
inline T const &
CUtlTSHash<T, BUCKET_COUNT, KEYTYPE, HashFuncs, nAlignment>::Element(
    UtlTSHashHandle_t hHash) const {
  return ((HashFixedData_t *)hHash)->m_Data;
}
...
template <class T, int BUCKET_COUNT, class KEYTYPE, class HashFuncs,
          int nAlignment>
inline T &
CUtlTSHash<T, BUCKET_COUNT, KEYTYPE, HashFuncs, nAlignment>::operator[](
    UtlTSHashHandle_t hHash) {
  return ((HashFixedData_t *)hHash)->m_Data;
}
...
template <class T, int BUCKET_COUNT, class KEYTYPE, class HashFuncs,
          int nAlignment>
inline KEYTYPE
CUtlTSHash<T, BUCKET_COUNT, KEYTYPE, HashFuncs, nAlignment>::GetID(
    UtlTSHashHandle_t hHash) const {
