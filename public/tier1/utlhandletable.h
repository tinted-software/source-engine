...
//-----------------------------------------------------------------------------
template <class T, int HandleBits> class CUtlHandleTable {
public:
  CUtlHandleTable();
...
template <class T, int HandleBits>
unsigned int
CUtlHandleTable<T, HandleBits>::GetSerialNumber(UtlHandle_t handle) {
...
//-----------------------------------------------------------------------------
template <class T> class CUtlHandle {
public:
  // Constructors
  CUtlHandle();
...
template <class T> CUtlHandle<T>::CUtlHandle(const CUtlHandle<T> &h) {
  m_handle = h.m_handle;
}
...
// Assignment
//-----------------------------------------------------------------------------
template <class T> void CUtlHandle<T>::Set(T *pObject) {
...
template <class T> const CUtlHandle<T> &CUtlHandle<T>::operator=(T *pObject) {
  Set(pObject);
  return *this;
}
...
// Is the handle valid?
//-----------------------------------------------------------------------------
template <class T> bool CUtlHandle<T>::IsValid() const {
...
template <class T> CUtlHandle<T>::operator bool() {
...
// Equality
//-----------------------------------------------------------------------------
template <class T> bool CUtlHandle<T>::operator==(CUtlHandle<T> h) const {
  return m_handle == h.m_handle;
}

template <class T> bool CUtlHandle<T>::operator==(T *pObject) const {
  UtlHandle_t h = pObject ? pObject->GetHandle() : UTLHANDLE_INVALID;
  return m_handle == h;
}

template <class T> bool CUtlHandle<T>::operator==(UtlHandle_t h) const {
  return m_handle == h;
}
