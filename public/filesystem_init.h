...
enum FSErrorMode_t {
  ...
  FS_ERRORMODE_VCONFIG, // Call Error() for errors and run vconfig when
                        // appropriate.
  FS_ERRORMODE_NONE, // Just return FSReturnCode values and setup the string for
...
public:
  ...
  // If this is set, then any search paths with a _english will be replaced with
  // _m_pLanguage and added before the _english path (default: null)
