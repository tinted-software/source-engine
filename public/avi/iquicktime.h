...
public:
  virtual bool
  CreateNewMovieFile(MovieHandle_t &theMovie, const char *pFilename, int nWidth,
                     int nHeight, int nFps, eVideoEncodeQuality quality,
...
public:
  ...
  // Returns the frame size of the QUICKTIME Image Frame (stored in a subrect of
  // the material itself)
  ...
  virtual bool
  EstimateMovieSize(unsigned long &EstSize, int nWidth, int nHeight, int nFps,
