...
public:
  ...
  bool
  WritePFM(char const *filename); // save to floating point pixmap (.pfm) file
  ...
  FloatBitMap_t *
  QuarterSizeWithGaussian(void) const; // downsample 2x using a gaussian
...
public:
  ...
  void
  WriteTGAs(char const *basename) const; // outputs name_00.tga, name_01.tga,...
};
