...
public:
  ...
  // k_EResultFail these stats will only be auto-updated for clients playing on
  // the server. For other users you'll need to call RequestUserStats() again to
  // refresh any data
  ...
  // controlled by the game creators. Set the IP range of your official servers
  // on the Steamworks page
