...
KeyFrame_t *g_KeyFramePtr =
    &g_KeyFrames[-LOWEST_KEYFRAME]; // points to the middle keyframe, keyframe 0
...
int Motion_GetNumberOfTimeModifiers(void) { return ARRAYSIZE(g_TimeModifiers); }
...
void CPositionInterpolator_Linear::GetDetails(char **outName, int *outMinKeyReq,
                                              int *outMaxKeyReq) {
  *outName = "Linear";
  *outMinKeyReq = 0;
  *outMaxKeyReq = 1;
...
void CPositionInterpolator_CatmullRom::GetDetails(char **outName,
                                                  int *outMinKeyReq,
                                                  int *outMaxKeyReq) {
...
void CPositionInterpolator_Rope::GetDetails(char **outName, int *outMinKeyReq,
                                            int *outMaxKeyReq) {
  *outName = "Rope";
  *outMinKeyReq = 0;
  *outMinKeyReq = 1;
...
//TimeModifyFunc (above) 			Requires the keyframes be already set
