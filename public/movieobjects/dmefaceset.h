...
public:
  ...
  // Total number of indices in the face set including the -1 end of face
  // designators
  ...
  // Total number of indices in the face set excluding the -1 end of face
  // designators
  ...
  // Returns the number of faces in total... This should be the number of -1
  // indices in the face set Which should equal  NumIndices() - GetIndexCount()
  // but this function accounts for empty faces (which aren't counted as faces)
  // and a missing -1 terminator at the end
...
// Inline methods
//-----------------------------------------------------------------------------
inline int CDmeFaceSet::NumIndices() const { return m_indices.Count(); }

inline const int *CDmeFaceSet::GetIndices() const { return m_indices.Base(); }

inline int CDmeFaceSet::GetIndex(int i) const { return m_indices[i]; }
