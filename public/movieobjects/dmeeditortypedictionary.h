...
//-----------------------------------------------------------------------------
// Contains all attributes related to a particular attribute on a particular
// editor type
//-----------------------------------------------------------------------------
...
public:
  ...
  // Returns the editor info associated with a single entry in an attribute
  // array
...
public:
  ...
  // Returns the editor info associated with an editor type
  CDmeEditorAttributeInfo *GetAttributeInfo(CDmElement *pElement,
                                            const char *pAttributeName);

  // Returns the editor info associated with a single entry in an attribute
  // array
  CDmeEditorAttributeInfo *GetAttributeArrayInfo(CDmElement *pElement,
                                                 const char *pAttributeName);
