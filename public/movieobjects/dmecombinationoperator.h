...
public:
  ...
  void
  SetMultiControlLevel(ControlIndex_t nControlIndex, float flLevel,
                       CombinationControlType_t type = COMBO_CONTROL_NORMAL);
  ...
  // Sets the value of a control
  float
  GetControlValue(ControlIndex_t nControlIndex,
                  CombinationControlType_t type = COMBO_CONTROL_NORMAL) const;
  ...
  AddDominationRule(const CUtlVector<const char *> dominators,
                    const CUtlVector<const char *> suppressed);
  CDmeCombinationDominationRule *
  AddDominationRule(CDmeCombinationDominationRule *pSrcRule);
...
private:
  ...
  RawControlIndex_t
  FindRawControlIndex(const char *pControlName,
                      bool bIgnoreDefaultControls = false) const;
