...
public:
  ...
  // other (uncommon) options besides 30(29.97 - ntsc video) are 24 (23.976 -
  // ntsc film) and 60 (59.94 - ntsc progressive)
...
public:
  ...
  DmeTime_t TimeAtCurrentFrame(DmeFramerate_t framerate,
                               bool bRoundDown = true) const;
