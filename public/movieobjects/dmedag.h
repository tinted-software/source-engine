...
//
// A class representing a Dag (directed acyclic graph) node used for holding
// transforms, lights, cameras and shapes
//
//=============================================================================
...
protected:
  void GetBoundingSphere(Vector &center, float &radius,
                         const matrix3x4_t &pMat) const;
