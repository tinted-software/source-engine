...
//-----------------------------------------------------------------------------
//
// This glue code here is to make it easy to create methods using various
// DmElement types
//
//-----------------------------------------------------------------------------
...
public:
  ...
  virtual bool PerformCompilationStep(CDmElement *pElement,
                                      CompilationStep_t step) = 0;
...
protected:                                                                     \
  ...
  virtual CompileFuncTree_t *GetCompileTree() { return &m_CompileFuncTree; }   \
...
protected:                                                                     \
  virtual void InitializeFuncMaps() {                                          \
    ...
    m_OpenEditorFuncTree.m_pBaseAdapterTree =                                  \
        &BaseClass::m_OpenEditorFuncTree;                                      \
...
#define DECLARE_OPENEDITORFUNC(_className)                                     \
  ...
  COpenEditorFuncAdapter<ThisClass, _className>                                \
      m_##_className##OpenEditorAdapter
...
private:
  ...
  bool AddCompileDependencies(CDmeMakefile *pMakefile,
