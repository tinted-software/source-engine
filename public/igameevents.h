...
public:
  ...
  // known or no listener is registered for it. bForce forces the creation even
  // if no listener is active
  ...
  // if an event was created but not fired for some reason, it has to bee freed,
  // same UnserializeEvent
