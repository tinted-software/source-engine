...
enum CommandBufferCommand_t {
  ...
  CBCMD_SET_PIXEL_SHADER_FLASHLIGHT_STATE =
      2001, // cmd, int color reg, int atten reg, int origin reg, sampler (for
            // flashlight texture)
...
enum CommandBufferInstanceCommand_t {
  ...
  CBICMD_SETMODULATIONPIXELSHADERDYNAMICSTATE_LINEARCOLORSPACE, // int cmd, int
                                                                // constant
                                                                // register,
                                                                // Vector color2
  ...
  CBICMD_SETMODULATIONPIXELSHADERDYNAMICSTATE_IDENTITY, // int cmd, int constant
                                                        // register
