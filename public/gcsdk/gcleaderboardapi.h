...
/**
 * Yielding call that attempts to find a leaderboard by name, creating one if
 * necessary.
 * @param pName
 ...
 */
uint32 Leaderboard_YieldingFind(const char *pName,
                                ELeaderboardSortMethod eLeaderboardSortMethod,
                                ELeaderboardDisplayType eLeaderboardDisplayType,
                                bool bCreateIfNotFound);

/**
 * Yielding call that attempts to set the score for the steamID in the
 * leaderboard.
