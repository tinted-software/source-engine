...
public:
  ...
  CreateFlashlight(const FlashlightState_t &lightState) = 0;
...
public:
  ...
  virtual CBaseEntity *FindEntityByName(CBaseEntity *pStartEntity,
                                        ...
                                        IEntityFindFilter *pFilter = NULL) = 0;
...
public:
  // Iterates through ALL entities (separate list for client vs. server)
  virtual EntitySearchResult
  NextChoreoEntity(EntitySearchResult currentEnt) = 0;
