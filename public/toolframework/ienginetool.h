...
public:
  ...
  // Something like this
  // virtual void		AddMessageHandler( int wm_message, bool
  // (*pfnCallback)( int wm_message, int wParam, int lParam ) ) = 0; virtual
  // void		RemoveMessageHanlder( int wm_message, bool
  // (*pfnCallbackToRemove)( int wm_message, int wParam, int lParam ) ) = 0;
...
public:
  ...
  virtual void
  SetClientFrameTime(float frametime) = 0; // gpGlobals->frametime on client
  ...
  CreatePartitionHandle(IHandleEntity *pEntity,
  ...
  virtual void
  InstallPartitionQueryCallback(IPartitionQueryCallback *pQuery) = 0;
  virtual void
  RemovePartitionQueryCallback(IPartitionQueryCallback *pQuery) = 0;
