...
public:
  virtual int GetToolCount() const { return m_Tools.Count(); }
...
public:
  void RegisterTool(IToolSystem *tool) { m_Tools.AddToTail(tool); }
...
EXPOSE_SINGLE_INTERFACE_GLOBALVAR(IToolDictionary, CToolDictionary,
