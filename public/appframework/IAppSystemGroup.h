...
public:
  ...
  // initialization Then Main() is run Then modules are shut down, disconnected,
  // and unloaded
  int Run();
...
//-----------------------------------------------------------------------------
template <class CBaseClass> class CDefaultAppSystemGroup : public CBaseClass {
public:
...
//		Provided by the application to possibly detect the suggested
//game info 		directory and initialize all the game-info-related systems
//appropriately.
// Parameters:
//		pFsSteamSetupInfo		steam file system setup
//information if available. 		pchPathBuffer			buffer to hold
//game info directory path on return. 		nBufferLength			length
//of the provided buffer to hold game info directory path. 		pbBubbleDirectories
//should contain "true" on return to bubble the directories up searching for
//game info file.
// Return values:
...
// Parameters:
//		pfnNewFn				the new game info
//directory suggestion function.
// Returns:
