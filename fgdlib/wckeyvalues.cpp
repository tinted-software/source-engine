...
//do not require 			unique key names! If you use this function then you should use
//GetCount 			and GetKey/Value by index rather than GetValue by key name.
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
template <class Base> void WCKeyValuesT<Base>::RemoveKey(const char *pszKey) {
...
void WCKeyValuesT<Base>::SetValue(const char *pszKey, const char *pszValue) {
  ...
  if (i == GetInvalidIndex()) {
    ...
    if (pszValue != NULL) {
      V_strncpy(m_KeyValues[i].szValue, szTmpValue,
                sizeof(m_KeyValues[i].szValue));
    }
    //
...
// Purpose:
//-----------------------------------------------------------------------------
template <class Base> void WCKeyValuesT<Base>::RemoveAll(void) {
