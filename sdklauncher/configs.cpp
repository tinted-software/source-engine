...
// NOTE: This code is fairly fragile, it'd be a lot better to have a solid
// solution for adding in a new config

bool AddConfig(const char *pModName, const char *pModDirectory,
               ModType_t modType) {
