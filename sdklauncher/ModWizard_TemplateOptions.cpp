...
CModWizardSubPanel_TemplateOptions::CModWizardSubPanel_TemplateOptions(
  ...
  m_pOptionShootSprinting =
      new CheckButton(this, "OptionShootSprintingButton", "");
  m_pOptionShootOnLadders =
      new CheckButton(this, "OptionShootLaddersButton", "");
...
char *CModWizardSubPanel_TemplateOptions::GetOption(int optionType) {
  ...
  if (true == m_bOptions[optionType]) {
    ...
    // Option is disabled, tack the comment '//' infront of the string, must
    // strdup this
