...
public:
  CCreateModWizard(vgui::Panel *parent, const char *name, KeyValues *pKeyValues,
...
protected:
  KeyValues *m_pKeyValues; // These come from inside the CreateMod command in
                           // the medialist.txt file.
...
// Sets a value in the registry that other apps (like the VS Express edition)
// can look at.
