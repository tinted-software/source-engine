...
// ---------------------------------------------------------------------------------------------------------------------
// // CreateModWizard sub panel 3. This panel asks for the directory to install
// in and the mod name.
// ---------------------------------------------------------------------------------------------------------------------
// //
...
public:
  ...
  void GetReady(const char *pOutputDirName, const char *pOutputModGamedirName,
                const char *modName);
...
protected:
  bool BuildCopyFiles_R(const char *pSourceDir, const char *pMask,
  ...
  bool HandleReplacements_GenericVCProj(CFileCopyInfo *pInfo,
                                        bool &bErrorStatus);
  ...
  virtual bool HandleReplacements_GameProjectFiles(CFileCopyInfo *pInfo,
                                                   bool &bErrorStatus) = 0;
  virtual bool HandleReplacements_Solution(CFileCopyInfo *pInfo,
                                           bool &bErrorStatus) = 0;
  // Right now only one of these files gets modified, but keeping it here for
  // expansion in the future.
  virtual bool HandleReplacements_TemplateOptions(CFileCopyInfo *pInfo,
                                                  bool &bErrorStatus) = 0;
...
class CModWizardSubPanel_CopyFiles_Source2006
    : public CModWizardSubPanel_CopyFiles {
...
private:
  ...
  bool HandleReplacements_GameProjectFiles(CFileCopyInfo *pInfo,
                                           bool &bErrorStatus);
  bool HandleReplacements_Solution(CFileCopyInfo *pInfo, bool &bErrorStatus);
  bool HandleReplacements_TemplateOptions(CFileCopyInfo *pInfo,
                                          bool &bErrorStatus) {
    return false;
  } // Ep1 will never do this.
};

class CModWizardSubPanel_CopyFiles_Source2007
    : public CModWizardSubPanel_CopyFiles {
public:
...
class CModWizardSubPanel_CopyFiles_Source2009
    : public CModWizardSubPanel_CopyFiles {
public:
