...
public:
  /**
   * Default constructor which automatically finds and sets the base directory
   * for all MODs and populates a vector of MOD directory names.
   */
  ModConfigsHelper();
...
protected:
  ...
  /**
   * Searches the parent MOD directory for child MODs and puts their names in
   * the member vector
   */
