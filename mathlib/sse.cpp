...
#define _EPI32_CONST(Name, Val)                                                \
  static const                                                                 \
      __declspec(align(16)) __int32 _epi32_##Name[4] = {Val, Val, Val, Val}
...
#define _EPI32_CONST(Name, Val)                                                \
  static const int32 _epi32_##Name[4]                                          \
      __attribute__((aligned(16))) = {Val, Val, Val, Val}

#define _PS_CONST(Name, Val)                                                   \
  static const float _ps_##Name[4]                                             \
      __attribute__((aligned(16))) = {Val, Val, Val, Val}
#endif
...
float _SSE_InvRSquared(const float *v) {
  float inv_r2 = 1.f;
#if defined(__arm__) || defined(__aarch64__)
  return _SSE_RSqrtAccurate(FLT_EPSILON + v[0] * v[0] + v[1] * v[1] +
                            v[2] * v[2]);
#elif _WIN32
...
#ifdef POSIX
// #define _PS_CONST(Name, Val) static const ALIGN16 float _ps_##Name[4]
// ALIGN16_POST = { Val, Val, Val, Val }
#define _PS_CONST_TYPE(Name, Type, Val)                                        \
  static const ALIGN16 Type _ps_##Name[4] ALIGN16_POST = {Val, Val, Val, Val}

_PS_CONST_TYPE(sign_mask, int, (int)0x80000000);
_PS_CONST_TYPE(inv_sign_mask, int, ~0x80000000);

#define _PI32_CONST(Name, Val)                                                 \
  static const ALIGN16 int _pi32_##Name[4] ALIGN16_POST = {Val, Val, Val, Val}
...
//   NJS: (Nov 1 2002) -NOT- faster.  may time a couple cycles faster in a
//   single function like this, but when inlined, and instruction scheduled, the
//   C version is faster. Verified this via VTune
/*
