...
#if !defined(                                                                  \
    AFX_SYNCFROMMIRRORDLG_H__CCDE7319_F912_4B51_A526_4B718AE8E22A__INCLUDED_)
...
protected:
  ...
  int m_nEditRightMargin; // Distance from the right side of the edit control to
                          // the right side of the client area
  int m_nEditBottomMargin; // Distance from the bottom of the edit control to
                           // the bottom of the client area
  int m_nButtonOffset; // Distance from left side of buttons to the right side
                       // of the client area
