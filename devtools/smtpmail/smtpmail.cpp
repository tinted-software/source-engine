...
//-----------------------------------------------------------------------------
// Purpose: looks for the arg "pName" and returns it's parameter or pDefault
// otherwise Input  : *pName -
//			*pDefault -
// Output : const char *
//-----------------------------------------------------------------------------
...
void Error(const char *pString, ...) {
  ...
  printf("Usage: smtpmail -to <address(-es, ';' separated)> -from <address> "
...
//-----------------------------------------------------------------------------
void MailSendFile(HSOCKET socket, const char *pFrom, const char *pTo[],
                  const char *pSubject, FILE *fp) {
  int i;
  char buf[1024];
