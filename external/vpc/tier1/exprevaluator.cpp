...
//
// Purpose: 	ExprSimplifier builds a binary tree from an infix expression (in
// the
//				form of a character array). Evaluates C style
//infix parenthetic logical 				expressions. Supports !, ||, &&, (). Symbols are
//resolved via callback. 				Syntax is $<name>. $0 evaluates to false. $<number>
//evaluates to true. 				e.g: ( $1 || ( $FOO || $WHATEVER ) && !$BAR )
//===========================================================================//
...
CExpressionEvaluator::CExpressionEvaluator() { m_ExprTree = NULL; }
