...
#pragma optimize("g", off) // variable argument functions seem to screw up stack
                           // walking unless this optimization is disabled
#pragma warning(disable : 4748) // Turn off the warning telling us that
                                // optimizations are off if /GS is on
#endif
