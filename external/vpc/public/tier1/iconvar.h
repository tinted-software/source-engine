...
#define FCVAR_HIDDEN                                                           \
  (1 << 4) // Hidden. Doesn't appear in find or auto complete. Like
...
#define FCVAR_SS                                                               \
  (1 << 15) // causes varnameN where N == 2 through max splitscreen slots for
            // mod to be autogenerated
#define FCVAR_DEMO (1 << 16)       // record this cvar when starting a demo file
#define FCVAR_DONTRECORD (1 << 17) // don't record these command in demofiles
#define FCVAR_SS_ADDED                                                         \
  (1 << 18) // This is one of the "added" FCVAR_SS variables for the splitscreen
            // players
#define FCVAR_RELEASE                                                          \
  (1 << 19) // Cvars tagged with this are the only cvars avaliable to customers
