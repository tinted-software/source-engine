...
template <typename T> inline T RefToVal(const T &item) { return item; }
...
//-----------------------------------------------------------------------------
template <typename T> class CLateBoundPtr {
public:
...
template <class OBJECT_TYPE_PTR = IRefCounted *> class CFuncMemPolicyRefCount {
public:
