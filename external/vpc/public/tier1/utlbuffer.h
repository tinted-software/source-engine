...
template <> FMSTRRETTYPE GetFmtStr<short>(int nRadix, bool bPrint) {
  Assert(nRadix == 10);
  return "%hd";
}
template <> FMSTRRETTYPE GetFmtStr<ushort>(int nRadix, bool bPrint) {
  Assert(nRadix == 10);
  return "%hu";
}
template <> FMSTRRETTYPE GetFmtStr<int>(int nRadix, bool bPrint) {
  Assert(nRadix == 10);
  return "%d";
}
template <> FMSTRRETTYPE GetFmtStr<uint>(int nRadix, bool bPrint) {
  Assert(nRadix == 10 || nRadix == 16);
  return nRadix == 16 ? "%x" : "%u";
}
template <> FMSTRRETTYPE GetFmtStr<int64>(int nRadix, bool bPrint) {
  Assert(nRadix == 10);
  return "%lld";
}
template <> FMSTRRETTYPE GetFmtStr<float>(int nRadix, bool bPrint) {
  Assert(nRadix == 10);
  return "%f";
}
template <> FMSTRRETTYPE GetFmtStr<double>(int nRadix, bool bPrint) {
  Assert(nRadix == 10);
