...
//-----------------------------------------------------------------------------
template <class T, class I> class CUtlMultiList {
protected:
...
template <class T, class I> CUtlMultiList<T, I>::~CUtlMultiList() {
  RemoveAll();
  if (m_pElementList)
    free(m_pElementList);
}

template <class T, class I> void CUtlMultiList<T, I>::ConstructList() {
...
// gets particular elements
//-----------------------------------------------------------------------------
template <class T, class I> inline T &CUtlMultiList<T, I>::Element(I i) {
...
template <class T, class I> inline T &CUtlMultiList<T, I>::operator[](I i) {
  return m_Memory[i].m_Element;
}
...
// list statistics
//-----------------------------------------------------------------------------
template <class T, class I> inline int CUtlMultiList<T, I>::TotalCount() const {
...
template <class T, class I> inline I CUtlMultiList<T, I>::Previous(I i) const {
  Assert(IsValidIndex(i));
  return InternalElement(i).m_Previous;
}

template <class T, class I> inline I CUtlMultiList<T, I>::Next(I i) const {
  Assert(IsValidIndex(i));
...
//-----------------------------------------------------------------------------
template <class T, class I> void CUtlMultiList<T, I>::EnsureCapacity(int num) {
...
// Deallocate memory
//-----------------------------------------------------------------------------
template <class T, class I> void CUtlMultiList<T, I>::Purge() {
  RemoveAll();
  m_List.Purge();
  m_Memory.Purge();
  m_List.Purge();
...
//-----------------------------------------------------------------------------
template <class T, class I> I CUtlMultiList<T, I>::Alloc() {
  I elem;
...
template <class T, class I> void CUtlMultiList<T, I>::Free(I elem) {
...
template <class T, class I> void CUtlMultiList<T, I>::RemoveAll() {
