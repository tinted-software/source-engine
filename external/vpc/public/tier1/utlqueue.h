...
template <class T, class M> inline T &CUtlQueue<T, M>::operator[](int i) {
  return m_heap[i];
}
...
template <class T, class M> inline T &CUtlQueue<T, M>::Element(int i) {
  return m_heap[i];
}
...
template <class T, class M> inline T const &CUtlQueue<T, M>::RemoveAtHead() {
  m_current = m_heap[0];
  m_heap.Remove((int)0);
  return m_current;
}

template <class T, class M> inline T const &CUtlQueue<T, M>::RemoveAtTail() {
  m_current = m_heap[m_heap.Count() - 1];
  m_heap.Remove((int)(m_heap.Count() - 1));
  return m_current;
}

template <class T, class M> inline T const &CUtlQueue<T, M>::Head() {
  m_current = m_heap[0];
  return m_current;
}

template <class T, class M> inline T const &CUtlQueue<T, M>::Tail() {
  m_current = m_heap[m_heap.Count() - 1];
  return m_current;
}
...
template <class T, class M> bool CUtlQueue<T, M>::Check(T const element) {
