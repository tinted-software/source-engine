...
_Warning_AlwaysSpewCallStack_Length(int iMaxCallStackLength);

PLATFORM_INTERFACE void _Error_AlwaysSpewCallStack_Enable(bool bEnable);
PLATFORM_INTERFACE void
_Error_AlwaysSpewCallStack_Length(int iMaxCallStackLength);
...
ClearHardwareBreakpoint(HardwareBreakpointHandle_t handle);
