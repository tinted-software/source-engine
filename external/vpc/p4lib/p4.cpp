...
public:
  ...
  virtual CUtlVector<P4File_t> &
  GetFileListUsingClientSpec(const char *pPath, const char *pClientSpec);
...
public:
  ...
  virtual void HandleError(Error *err) {
    ...
    if (V_strstr(buf.Text(), "can't edit exclusive file already opened")) {
      m_errorSeverity = max(m_errorSeverity,
                            E_WARN); // s_p4 sends this is an info message, even
