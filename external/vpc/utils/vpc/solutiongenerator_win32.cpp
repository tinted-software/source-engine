      ...
      RegStartPoint searchPoints[] = {
          {HKEY_LOCAL_MACHINE,
           "Software\\Microsoft\\VisualStudio\\%d.0\\Projects"}, // Visual
                                                                 ...
                                                                 // Professional
          {HKEY_LOCAL_MACHINE,
           "Software\\Microsoft\\VCExpress\\%d.0\\Projects"}, // VC Express 2010
                                                              // and 2012
          {HKEY_CURRENT_USER, "Software\\Microsoft\\WDExpress\\%d.0_"
                              "Config\\Projects"}, // WinDev Express -- VS
                                                   // Express starting with VS
                                                   // 2013
      };
  ...
  GenerateSolutionFile(const char *pSolutionFilename,
    ...
    if (!g_pVPC->Is2010()) {
      ...
      if (pSolutionItemsFilename[0] != '\0') {
        fprintf(fp, "Project(\"{2150E333-8FDC-42A3-9474-1A3956D46DE8}\") = "
