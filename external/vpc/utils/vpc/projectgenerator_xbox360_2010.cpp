...
const char *
CProjectGenerator_Xbox360_2010::GetKeyNameForFile(CProjectFile *pFile) {
...
bool CProjectGenerator_Xbox360_2010::WriteFolderToSecondaryXML(
  ...
  CUtlString parentPath = CFmtStr(
      "%s%s%s", pParentPath, pParentPath[0] ? "\\" : "", pFolder->m_Name.Get());
...
bool CProjectGenerator_Xbox360_2010::WriteProperty(
  ...
  if (pPropertyState) {
    ...
    default:
      g_pVPC->VPCError(
          "CProjectGenerator_Xbox360_2010: WriteProperty, %s - not implemented",
          pOutputName);
    }
  }
