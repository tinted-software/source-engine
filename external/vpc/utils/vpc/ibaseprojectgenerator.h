...
//as above] 			[also, files can be put in folders with StartFolder/AddFolder]
//	EndProject
//
...
public:
  ...
  virtual void
  GetAllConfigurationNames(CUtlVector<CUtlString> &configurationNames) = 0;
  ...
  virtual void
  FileIsSchema(bool bIsSchema) = 0; // Mark the current file as schema.
  virtual void
  FileIsDynamic(bool bIsDynamic) = 0; // Mark the current file as dynamic.
