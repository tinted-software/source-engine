...
public:
  ...
  bool Is2015() {
    ...
    // similarities
  bool Is2019() {
    return m_eVSVersion == k_EVSVersion_2019;
  } // When this returns true so does Is2010() because of the file format
    // similarities
  ...
  void
  GetProjectDependencies(CUtlVector<CDependency_Project *> &referencedProjects);
...
private:
  ...
  bool m_bP4SCC; // VPC_SCC_INTEGRATION define, or "/srcctl" cmd line option, or
                 // env var VPC_SRCCTL=1
  bool m_b32BitTools; // Normally we prefer the 64-bit toolchain when building a
                      // 64-bit target. This turns that off.
...
extern void
VPC_FakeKeyword_SchemaFolder(class CBaseProjectDataCollector *pDataCollector);
