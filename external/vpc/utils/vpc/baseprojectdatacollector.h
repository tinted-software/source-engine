...
public:
  ...
  virtual void
  GetAllConfigurationNames(CUtlVector<CUtlString> &configurationNames);
  ...
  virtual bool
  RemoveFile(const char *pFilename); // returns ture if a file was removed
...
public:
  ...
  CUtlStack<CFileConfig *>
      m_CurFileConfig; // Either m_BaseConfigData or one of the files.
