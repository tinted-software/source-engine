...
DLL_EXPORT int Java_com_valvesoftware_ValveActivity2_setenv(
  ...
  return setenv(jenv->GetStringUTFChars(env, NULL),
                jenv->GetStringUTFChars(value, NULL), over);
}
...
DLL_EXPORT void Java_com_valvesoftware_ValveActivity2_setArgs(JNIEnv *env,
                                                              jclass *clazz,
                                                              jstring str) {
