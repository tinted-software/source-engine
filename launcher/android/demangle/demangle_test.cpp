...
const char *names[] = {
    ...
    "_Z7ZipWithI7QStringS0_5QListZN4oral6detail16AdaptCreateTableI7AccountEES0_"
    "RKNS3_16CachedFieldsDataEEUlRKS0_SA_E_ET1_IDTclfp1_cvT__EcvT0__EEEERKT1_"
    "ISC_ERKT1_ISD_ET2_",
    NULL};
...
const char *expected[] = {
    ...
    "SkScan::HairLine(SkPoint const&, SkPoint const&, SkRegion const*, "
    "SkBlitter*)",
    "foo(int, int*, int**, int***, int****, int*****, int******, int*******, "
    "int********, int*********, int**********, int***********, "
    "int************, int*************, int**************, int***************)",
    "void f<1, "
    "(char)120>(A<(1)+((int)((double)[810000000000000000703DAD7A370C5]))>)",
    "myspace::foo()::localstruct::f(myspace::foo()::otherlocalstruct)",
    "QList<decltype ({parm#3}((QString)(), (QString)()))> ZipWith<QString, "
    "QString, QList, QString "
    "oral::detail::AdaptCreateTable<Account>(oral::detail::CachedFieldsData "
    "const&)::{lambda(QString const&, QString const&)#1}>(QList<QString "
    "oral::detail::AdaptCreateTable<Account>(oral::detail::CachedFieldsData "
    "const&)::{lambda(QString const&, QString const&)#1}> const&, QList<QList> "
    "const&, QString "
    "oral::detail::AdaptCreateTable<Account>(oral::detail::CachedFieldsData "
    "const&)::{lambda(QString const&, QString const&)#1})",
    ""};
