...
//-----------------------------------------------------------------------------
// Game managers are singleton objects in the game code responsible for various
// tasks The order in which the server systems appear in this list are the order
// in which they are initialized and updated. They are shut down in reverse
// order from which they are initialized.
//-----------------------------------------------------------------------------
...
protected:
  ...
  typedef LevelRetVal_t (IGameManager::*GameManagerLevelFunc_t)(
      bool bFirstCall);
  ...
  static LevelRetVal_t InvokeLevelMethod(GameManagerLevelFunc_t f,
                                         bool bFirstCall);
  static LevelRetVal_t InvokeLevelMethodReverseOrder(GameManagerLevelFunc_t f,
                                                     bool bFirstCall);
...
//-----------------------------------------------------------------------------
template <class BaseClass> inline CGameManager<BaseClass>::~CGameManager() {
  Remove(this);
}
