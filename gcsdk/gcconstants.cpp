...
#ifdef GC
ENUMSTRINGS_START(EForeignKeyAction){k_EForeignKeyActionNoAction, "NO ACTION"},
    ...
    ENUMSTRINGS_REVERSE(EForeignKeyAction, k_EForeignKeyActionNoAction)
        ...
        ENUMSTRINGS_START(EGCSQLType){k_EGCSQLTypeInvalid,
                                      "k_EGCSQLTypeInvalid"},
    ...
    ENUMSTRINGS_REVERSE(EGCSQLType, k_EGCSQLTypeInvalid)
        ...
        ENUMSTRINGS_START(EUniverse){k_EUniverseInvalid, "Invalid"},
    {k_EUniversePublic, "Public"}, {k_EUniverseBeta, "Beta"},
    {k_EUniverseInternal, "Internal"}, {k_EUniverseDev, "Dev"},
