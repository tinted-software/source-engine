...
//								WARNING: pchType
//must be a static (since we keep a copy of it around for a while) 			pvObj -
//Pointer to the object we represent 			pchName -			Name of the
//individual object we represent 								WARNING: pchName must be a static (since we
//keep a copy of it around for a while) 			pValObjectparent-	Our parent
//object (ie, the object that our object is a member of) 			pValObjectPrev -
//Object that precedes us in the linked list (we're 								always added to the end)
//-----------------------------------------------------------------------------
