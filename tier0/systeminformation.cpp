...
public:
  ...
  SYSTEM_CALL_RESULT_t InitializeLoadModule(_TCHAR *pszModule,
                                            char *pszFunction);
  SYSTEM_CALL_RESULT_t InitializeFindModule(_TCHAR *pszModule,
                                            char *pszFunction);
...
CSysCallCacheEntry::CSysCallCacheEntry()
    : m_eResult(SYSCALL_SUCCESS), m_pfnSysCall(NULL), m_hModule(NULL),
      m_bInitialized(false), m_bFreeModule(false) {}
...
CSysCallCacheEntry::InitializeLoadModule(_TCHAR *pszModule, char *pszFunction) {
  m_bInitialized = true;
...
SYSTEM_CALL_RESULT_t
CSysCallCacheEntry::InitializeFindModule(_TCHAR *pszModule, char *pszFunction) {
  m_bInitialized = true;
...
SYSTEM_CALL_RESULT_t CSysCallCacheEntry::InitializeFindProc(HMODULE hModule,
                                                            char *pszFunction) {
  m_bInitialized = true;
...
template <typename FN> FN CSysCallCacheEntry::GetFunction() const {
...
SYSTEM_CALL_RESULT_t Plat_GetPagedPoolInfo(PAGED_POOL_INFO_t *pPPI) {
  ...
  static CSysCallCacheEntry_FindModule qsi(_T( "ntdll.dll" ),
