...
uint64 CalculateCPUFreq() {
...
#else
  // Try to open cpuinfo_max_freq. If the kernel was built with cpu scaling
  // support disabled, this will fail.
  FILE *fp =
  ...
  for (count = 0; count < max_iterations; count++) {
    ...
    // end_time - start_time calls into the overloaded TimeVal operator- way
    // above, and returns a double.
