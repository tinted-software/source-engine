...
CDmePreset *
CDmePresetGroup::FindOrAddPreset(const char *pPresetName,
...
//-----------------------------------------------------------------------------
static int
FindExportedControlIndex(const char *pControlName,
...
//-----------------------------------------------------------------------------
static int
BuildExportedControlList(CDmeAnimationSet *pAnimationSet,
                         const CDmePresetGroup *pPresetGroup,
                         CUtlVector<ExportedControl_t> &uniqueControls) {
  int nGlobalIndex = 0;
  ...
  for (int iPreset = 0; iPreset < nPresetCount; ++iPreset) {
    ...
    for (int i = 0; i < nControlCount; ++i) {
      ...
      if (pAnimationSet) {
        ...
        // don't have one...
        control.m_bIsStereo =
            controls[i]->GetAttribute("balance") ? true : false;
        control.m_bIsMulti =
            controls[i]->GetAttribute("multilevel") ? true : false;
        control.m_nFirstIndex = nGlobalIndex;
        nGlobalIndex += 1 + control.m_bIsStereo + control.m_bIsMulti;
      }
    }
...
//-----------------------------------------------------------------------------
CDmePresetGroup *
CDmeAnimationSet::FindOrAddPresetGroup(const char *pGroupName) {
...
CDmePreset *
CDmeAnimationSet::FindOrAddPreset(const char *pGroupName,
...
CDmElement *
CDmeAnimationSet::FindSelectionGroup(const char *pSelectionGroupName) {
...
CDmElement *
CDmeAnimationSet::FindOrAddSelectionGroup(const char *pSelectionGroupName) {
