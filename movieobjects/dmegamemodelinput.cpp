...
void CDmeGameModelInput::SetBone(uint index, const Vector &pos,
...
void CDmeGameModelInput::SetFlexWeights(uint nFlexWeights,
...
void CDmeGameSpriteInput::GetOutputAttributes(
    CUtlVector<CDmAttribute *> &attrs) {
  attrs.AddToTail(m_visible.GetAttribute());
...
void CDmeGameCameraInput::GetOutputAttributes(
    CUtlVector<CDmAttribute *> &attrs) {
  attrs.AddToTail(m_position.GetAttribute());
  attrs.AddToTail(m_rotation.GetAttribute());
