...
void CDmePackColorOperator::GetInputAttributes(
...
void CDmePackColorOperator::GetOutputAttributes(
    CUtlVector<CDmAttribute *> &attrs) {
...
void CDmePackVector2Operator::GetInputAttributes(
    CUtlVector<CDmAttribute *> &attrs) {
  attrs.AddToTail(m_x.GetAttribute());
  attrs.AddToTail(m_y.GetAttribute());
}

void CDmePackVector2Operator::GetOutputAttributes(
    CUtlVector<CDmAttribute *> &attrs) {
...
void CDmePackVector3Operator::GetInputAttributes(
    CUtlVector<CDmAttribute *> &attrs) {
  attrs.AddToTail(m_x.GetAttribute());
  attrs.AddToTail(m_y.GetAttribute());
...
void CDmePackVector3Operator::GetOutputAttributes(
    CUtlVector<CDmAttribute *> &attrs) {
  attrs.AddToTail(m_vector.GetAttribute());
}
...
void CDmePackVector4Operator::GetInputAttributes(
    CUtlVector<CDmAttribute *> &attrs) {
  attrs.AddToTail(m_x.GetAttribute());
  attrs.AddToTail(m_y.GetAttribute());
  attrs.AddToTail(m_z.GetAttribute());
...
void CDmePackVector4Operator::GetOutputAttributes(
    CUtlVector<CDmAttribute *> &attrs) {
  attrs.AddToTail(m_vector.GetAttribute());
}
...
void CDmePackQAngleOperator::GetInputAttributes(
    CUtlVector<CDmAttribute *> &attrs) {
  attrs.AddToTail(m_x.GetAttribute());
  attrs.AddToTail(m_y.GetAttribute());
  attrs.AddToTail(m_z.GetAttribute());
...
void CDmePackQAngleOperator::GetOutputAttributes(
    CUtlVector<CDmAttribute *> &attrs) {
...
//-----------------------------------------------------------------------------
IMPLEMENT_ELEMENT_FACTORY(DmePackQuaternionOperator,
                          CDmePackQuaternionOperator);
...
void CDmePackQuaternionOperator::GetInputAttributes(
    CUtlVector<CDmAttribute *> &attrs) {
  attrs.AddToTail(m_x.GetAttribute());
  attrs.AddToTail(m_y.GetAttribute());
  attrs.AddToTail(m_z.GetAttribute());
...
void CDmePackQuaternionOperator::GetOutputAttributes(
    CUtlVector<CDmAttribute *> &attrs) {
...
void CDmePackVMatrixOperator::GetInputAttributes(
    CUtlVector<CDmAttribute *> &attrs) {
  for (uint i = 0; i < 16; ++i) {
...
void CDmePackVMatrixOperator::GetOutputAttributes(
    CUtlVector<CDmAttribute *> &attrs) {
