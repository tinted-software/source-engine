...
void CDmeDrawSettings::OnConstruction() {
  ...
  m_cHighlightColor.InitAndSet(this, "highlightColor",
                               Color(0xff, 0x14, 0x93, 0xff)); // Deep Pink
...
void CDmeDrawSettings::BuildKnownDrawableTypes() {
  ...
  s_KnownDrawableTypes.InsertIfNotFound(
      g_pDataModel->GetSymbol("DmeAttachment"));
