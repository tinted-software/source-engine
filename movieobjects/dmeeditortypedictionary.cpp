...
//-----------------------------------------------------------------------------
// Returns the info for a entry in an attribute array, if this attribute is an
// array type
//-----------------------------------------------------------------------------
...
// Gets the choices
//-----------------------------------------------------------------------------
int CDmeEditorChoicesInfo::GetChoiceCount() const { return m_Choices.Count(); }
...
//-----------------------------------------------------------------------------
void CDmeEditorType::AddAttributeInfo(const char *pAttributeName,
...
//-----------------------------------------------------------------------------
CDmeEditorAttributeInfo *
CDmeEditorType::GetAttributeArrayInfo(const char *pAttributeName) {
...
void CDmeEditorTypeDictionary::AddEditorTypesFromFile(const char *pFileName,
                                                      const char *pPathID) {}
...
//-----------------------------------------------------------------------------
CDmeEditorAttributeInfo *
CDmeEditorTypeDictionary::GetAttributeInfo(CDmElement *pElement,
...
//-----------------------------------------------------------------------------
CDmeEditorAttributeInfo *
CDmeEditorTypeDictionary::GetAttributeArrayInfo(CDmElement *pElement,
                                                const char *pAttributeName) {
  CDmeEditorType *pEditorType = GetEditorType(pElement);
  if (!pEditorType)
    return NULL;
