...
//
// The transform operator class - shortcut to setting transform values from
// floats
//
//=============================================================================
...
void CDmeTransformOperator::GetInputAttributes(
...
void CDmeTransformOperator::GetOutputAttributes(
    CUtlVector<CDmAttribute *> &attrs) {
  CDmeTransform *pTransform = m_transform.GetElement();
  if (pTransform == NULL)
    return;
