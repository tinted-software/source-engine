...
void CDmeMDL::GetBoundingSphere(Vector &vecCenter, float &flRadius) {
  ...
  GetMDLBoundingSphere(&vecEngineCenter, &flRadius, m_MDL.GetMDL(),
                       m_nSequence);
...
// Draws the mesh
//-----------------------------------------------------------------------------
void CDmeMDL::Draw(const matrix3x4_t &shapeToWorld,
...
void CDmeMDL::SetUpBones(const matrix3x4_t &shapeToWorld, int nMaxBoneCount,
