...
public:
  ...
  IPhysicsObject *CreatePolyObjectStatic(const CPhysCollide *pCollisionModel,
                                         int materialIndex,
  ...
  virtual IPhysicsObject *UnserializeObjectFromBuffer(void *pGameData,
                                                      unsigned char *pBuffer,
                                                      unsigned int bufferSize,
                                                      bool enableCollisions);

  IPhysicsSpring *CreateSpring(IPhysicsObject *pObjectStart,
                               IPhysicsObject *pObjectEnd,
                               springparams_t *pParams);
  IPhysicsFluidController *CreateFluidController(IPhysicsObject *pFluidObject,
                                                 fluidparams_t *pParams);
  IPhysicsConstraint *
  CreateRagdollConstraint(IPhysicsObject *pReferenceObject,
  ...
  CreateLimitedHingeConstraint(IPhysicsObject *pReferenceObject,
                               IPhysicsObject *pAttachedObject,
                               IPhysicsConstraintGroup *pGroup,
  ...
  virtual IPhysicsConstraint *
  CreateSlidingConstraint(IPhysicsObject *pReferenceObject,
                          IPhysicsObject *pAttachedObject,
                          IPhysicsConstraintGroup *pGroup,
                          const constraint_slidingparams_t &sliding);
  virtual IPhysicsConstraint *
  CreateBallsocketConstraint(IPhysicsObject *pReferenceObject,
                             IPhysicsObject *pAttachedObject,
                             IPhysicsConstraintGroup *pGroup,
  ...
  CreateConstraintGroup(const constraint_groupparams_t &group);
  ...
  virtual void
  SetCollisionEventHandler(IPhysicsCollisionEvent *pCollisionEvents);
  virtual void SetObjectEventHandler(IPhysicsObjectEvent *pObjectEvents);
  virtual void
  SetConstraintEventHandler(IPhysicsConstraintEvent *pConstraintEvents);

  virtual IPhysicsShadowController *
  CreateShadowController(IPhysicsObject *pObject, bool allowTranslation,
                         bool allowRotation);
  ...
  CreatePlayerController(IPhysicsObject *pObject);
  ...
  virtual void SetQuickDelete(bool bQuick) { m_deleteQuick = bQuick; }
  virtual bool ShouldQuickDelete() const { return m_deleteQuick; }
  virtual void TraceBox(trace_t *ptr, const Vector &mins, const Vector &maxs,
  ...
  virtual bool TransferObject(IPhysicsObject *pObject,
                              IPhysicsEnvironment *pDestinationEnvironment);
  ...
  virtual void SweepCollideable(const CPhysCollide *pCollide,
  ...
  // performance tuning
  virtual void
  GetPerformanceSettings(physics_performanceparams_t *pOutput) const;
  virtual void
  SetPerformanceSettings(const physics_performanceparams_t *pSettings);
...
private:
  ...
  IVPhysicsDebugOverlay
      *m_pDebugOverlay; // Interface to use for drawing debug overlays.
...
GetOppositeSynapseObject(IVP_Synapse_Friction *pfriction);
