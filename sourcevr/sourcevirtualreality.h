...
// this is a callback so we can regenerate the distortion texture whenever we
// need to
...
public:
  ...
  virtual ITexture *GetRenderTarget(VREye eEye,
                                    EWhichRenderTarget eWhich) OVERRIDE;
  ...
  // mode
  bool UsingOffscreenRenderTarget() const {
    return m_bUsingOffscreenRenderTarget;
  }
