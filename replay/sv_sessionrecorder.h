...
public:
  ...
  void UpdateSessionLocks(); // Looks at publish managers and unlocks sessions
                             // as needed

  //
  // IReplaySessionRecorder
  //
  virtual void StartRecording(); // Will waiting for recording to stop, then
...
private:
  ...
  typedef CUtlLinkedList<CSessionPublishManager *, int>
      PublishManagerContainer_t;
