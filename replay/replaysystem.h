...
inline IReplayServer *ReplayServer() { return g_pEngine->GetReplayServer(); }
...
const char *Replay_GetBaseDir(); // Returns the replays base dir - eg,
                                 // "/home/user/<...>/replays/"
...
#ifndef DEDICATED
void Replay_HudMsg(const char *pText, const char *pSound = NULL,
                   bool bUrgent = false);
#endif
