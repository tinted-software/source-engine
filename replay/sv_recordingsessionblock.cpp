...
CServerRecordingSessionBlock::CServerRecordingSessionBlock(
    ...
    : CBaseRecordingSessionBlock(pContext), m_nWriteStatus(WRITESTATUS_INVALID),
      m_pPublisher(NULL) {}
...
bool CServerRecordingSessionBlock::Read(KeyValues *pIn) {
  ...
  m_nWriteStatus =
      (WriteStatus_t)pIn->GetInt("write_status", (int)WRITESTATUS_INVALID);
...
void CServerRecordingSessionBlock::OnDelete() {
  ...
  SV_GetFileserverCleaner()->MarkFileForDelete(
