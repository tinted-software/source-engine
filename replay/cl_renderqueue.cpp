...
bool CRenderQueue::GetEntryData(int iIndex, ReplayHandle_t *pHandleOut,
                                int *pPerformanceOut) const {
...
CRenderQueue::RenderInfo_t *CRenderQueue::Find(ReplayHandle_t hReplay,
                                               int iPerformance) {
...
const CRenderQueue::RenderInfo_t *CRenderQueue::Find(ReplayHandle_t hReplay,
                                                     int iPerformance) const {
