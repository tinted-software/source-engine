...
#define LINK_TO_SHARED_REPLAYCONTEXT_IMP()                                     \
  ...
  virtual CBaseRecordingSession *GetRecordingSession(                          \
      ReplayHandle_t hSession) {                                               \
    return static_cast<CBaseRecordingSession *>(                               \
        m_pShared->m_pRecordingSessionManager->Find(hSession));                \
  }                                                                            \
  virtual CBaseRecordingSessionBlockManager *                                  \
  GetRecordingSessionBlockManager() {                                          \
