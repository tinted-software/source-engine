...
public:
  ...
  char
      m_szFileserverIP[16]; // Fileserver's IP, cached any time
                            // "replay_fileserver_offload_hostname" is modified.
  char m_szFileserverProxyIP[16]; // Proxy's IP, cached any time
                                  // "replay_fileserver_offload_proxy_host" is
                                  // modified.
...
inline CServerRecordingSessionManager *SV_GetRecordingSessionManager() {
  return static_cast<CServerRecordingSessionManager *>(
      g_pServerReplayContext->GetRecordingSessionManager());
}

inline CServerRecordingSessionBlockManager *
