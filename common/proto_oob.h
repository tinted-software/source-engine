...
#define S2A_INFO_DETAILED                                                      \
  'm' // New Query protocol, returns dedicated or not, + other performance info.
...
#define A2S_INFO                                                               \
  'T' // generic server info request - this must match the Source engine
...
#define S2C_MAGICVERSION                                                       \
  0x5a4f4933 // Magic used in the S2C_CHALLNGE to detect version differences
