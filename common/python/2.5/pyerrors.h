...
#define PyExceptionClass_Check(x)                                              \
  (PyClass_Check((x)) ||                                                       \
   (PyType_Check((x)) &&                                                       \
    PyType_IsSubtype((PyTypeObject *)(x),                                      \
...
PyAPI_FUNC(PyObject *)
    PyErr_SetFromErrnoWithUnicodeFilename(PyObject *, Py_UNICODE *);
...
PyAPI_FUNC(int)
    PyErr_WarnEx(PyObject *category, const char *msg, Py_ssize_t stack_level);
