...
#define _Py_NewReference(op)                                                   \
  (_Py_INC_TPALLOCS(op)                                                        \
       _Py_COUNT_ALLOCS_COMMA _Py_INC_REFTOTAL _Py_REF_DEBUG_COMMA(op)         \
           ->ob_refcnt = 1)
...
#define _Py_Dealloc(op)                                                        \
  (_Py_INC_TPFREES(op)                                                         \
       _Py_COUNT_ALLOCS_COMMA(*(op)->ob_type->tp_dealloc)((PyObject *)(op)))
#endif /* !Py_TRACE_REFS */

#define Py_INCREF(op) (_Py_INC_REFTOTAL _Py_REF_DEBUG_COMMA(op)->ob_refcnt++)

#define Py_DECREF(op)                                                          \
  if (_Py_DEC_REFTOTAL _Py_REF_DEBUG_COMMA--(op)->ob_refcnt != 0)              \
