...
static const Language_t s_LanguageNames[] = {
    ...
    {"Ukrainian", "ukrainian", "#GameUI_Language_Ukrainian", "uk_UA",
     k_Lang_Ukrainian, 1058},
};
...
const char *GetLanguageShortName(ELanguage eLang) {
  ...
  Assert(!"enum ELanguage order mismatched from Language_t s_LanguageNames, "
          "fix it!");
...
#ifdef _WIN32
  // table for Win32 is here:
  // http://msdn.microsoft.com/en-us/library/hzz3tw78(v=VS.80).aspx shortname
  // works except for chinese
