...
#define STEAM_KEYSIZE                                                          \
  2048 // max size needed to contain a steam authentication key (both server and
       // client)
...
#define PACKET_FLAG_CHALLENGE                                                  \
  (1 << 5) // packet contains challenge number, use to prevent packet injection
...
#define clc_SaveReplay                                                         \
  15 // client is sending a save replay request to the server.
#define clc_CmdKeyValues 16
#define clc_FileMD5Check                                                       \
  17 // client is sending a file's MD5 to the server to be verified.
