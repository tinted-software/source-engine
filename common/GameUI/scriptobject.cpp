...
objtypedesc_t objtypes[] = {
    ...
    {O_STRING, "STRING"},     {O_OBSOLETE, "OBSOLETE"}, {O_SLIDER, "SLIDER"},
    {O_CATEGORY, "CATEGORY"},
};
...
CScriptObject::~CScriptObject() { RemoveAndDeleteAllItems(); }
...
/////////////////////////
CDescription::CDescription(void) { pObjList = NULL; }
