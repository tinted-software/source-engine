...
struct hfxVec3internal
...
#ifndef HFX_INTERNAL
  HFX_INLINE HFX_EXPLICIT hfxVec3(const double &_x, const double &_y,
                                  const double &_z);
  ...
  // HFX_INLINE hfxVec3 &operator /=(const int i){return
  // ((*this)/=((double)i));};
...
struct hfxVec3F : public HFX_vect3Base32 {
  ...
  // HFX_INLINE hfxVec3F &operator /=(const int i){return
  // ((*this)/=(double)i);};
...
struct BoundingBox3 : public _box3Base {
  inline BoundingBox3(const double &left = 0, const double &down = 0,
                      const double &forward = 0, const double &right = 0,
                      const double &up = 0, const double &backward = 0) {
    side.left = left;
    side.down = down;
