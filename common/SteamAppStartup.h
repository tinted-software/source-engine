...
//			so they can be launched indirectly by steam and launch
//steam themselves
//
//=============================================================================//
...
//			Works out if the app is a steam app that is being ran
//outside of steam, 			and if so, launches steam and tells it to run us as a steam
//app
//
//			if it returns true, then exit
//			if it ruturns false, then continue with normal startup
//-----------------------------------------------------------------------------
bool ShouldLaunchAppViaSteam(const char *cmdLine,
