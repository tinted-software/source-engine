...
#ifdef __cplusplus
inline DEFINE_API_C(CalibrateEventUPP)
    NewCalibrateEventUPP(CalibrateEventProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(CanCalibrateUPP)
    NewCanCalibrateUPP(CanCalibrateProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(CalibrateUPP)
    NewCalibrateUPP(CalibrateProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(OldCanCalibrateUPP)
    NewOldCanCalibrateUPP(OldCanCalibrateProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(OldCalibrateUPP)
    NewOldCalibrateUPP(OldCalibrateProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(Boolean)
    InvokeOldCanCalibrateUPP(CMDisplayIDType displayID,
