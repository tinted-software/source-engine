 ...
 */
EXTERN_API_C(OSStatus)
KLGetKeyboardLayoutProperty(KeyboardLayoutRef iKeyboardLayout,
 ...
 */
EXTERN_API_C(OSStatus)
KLGetKeyboardLayoutWithIdentifier(SInt32 iIdentifier,
 ...
 */
EXTERN_API_C(OSStatus)
KLGetKeyboardLayoutWithName(CFStringRef iName,
                            KeyboardLayoutRef *oKeyboardLayout);
