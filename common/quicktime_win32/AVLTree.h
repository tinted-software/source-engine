...
enum { kLeftToRight = 0, kRightToLeft = 1 };
...
#ifdef __cplusplus
inline DEFINE_API_C(AVLCompareItemsUPP)
    NewAVLCompareItemsUPP(AVLCompareItemsProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(AVLItemSizeUPP)
    NewAVLItemSizeUPP(AVLItemSizeProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(AVLDisposeItemUPP)
    NewAVLDisposeItemUPP(AVLDisposeItemProcPtr userRoutine) {
...
inline DEFINE_API_C(OSErr)
    InvokeAVLWalkUPP(AVLTreePtr tree, const void *dataP,
                     AVLVisitStage visitStage, AVLNodeType node, UInt32 level,
