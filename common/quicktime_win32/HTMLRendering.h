...
#ifdef __cplusplus
inline DEFINE_API_C(HRWasURLVisitedUPP)
    NewHRWasURLVisitedUPP(HRWasURLVisitedProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(HRURLToFSSpecUPP)
    NewHRURLToFSSpecUPP(HRURLToFSSpecProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(OSStatus)
    InvokeHRURLToFSSpecUPP(const char *rootURL, const char *linkURL,
                           FSSpec *fsspec, URLSourceType urlSourceType,
