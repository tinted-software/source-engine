...
enum {
  kATSUseGlyphAdvance =
      0x7FFFFFFF, /* assignment to use natural glyph advance value */
  kATSUseLineHeight =
...
typedef TVECTOR_UPP_TYPE(ATSUDirectLayoutOperationOverrideProcPtr)
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(void) DisposeATSUDirectLayoutOperationOverrideUPP(
    ATSUDirectLayoutOperationOverrideUPP) {}
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(OSStatus) InvokeATSUDirectLayoutOperationOverrideUPP(
    ATSULayoutOperationSelector iCurrentOperation, ATSULineRef iLineRef,
    UInt32 iRefCon, void *iOperationCallbackParameterPtr,
    ATSULayoutOperationCallbackStatus *oCallbackStatus,
    ATSUDirectLayoutOperationOverrideUPP userUPP) {
  return (*userUPP)(iCurrentOperation, iLineRef, iRefCon,
                    iOperationCallbackParameterPtr, oCallbackStatus);
}
#else
#define InvokeATSUDirectLayoutOperationOverrideUPP(                            \
    iCurrentOperation, iLineRef, iRefCon, iOperationCallbackParameterPtr,      \
    oCallbackStatus, userUPP)                                                  \
  (*userUPP)(iCurrentOperation, iLineRef, iRefCon,                             \
             iOperationCallbackParameterPtr, oCallbackStatus)
#endif
#endif
