...
#ifdef __cplusplus
inline DEFINE_API_C(EventComparatorUPP)
    NewEventComparatorUPP(EventComparatorProcPtr userRoutine) {
 ...
 *      The data passed into InstallEventLoopTimer.
 */
typedef CALLBACK_API(void, EventLoopIdleTimerProcPtr)(
    EventLoopTimerRef inTimer, EventLoopIdleTimerMessage inState,
    void *inUserData);
...
#ifdef __cplusplus
inline DEFINE_API_C(EventLoopTimerUPP)
    NewEventLoopTimerUPP(EventLoopTimerProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(EventLoopIdleTimerUPP)
    NewEventLoopIdleTimerUPP(EventLoopIdleTimerProcPtr userRoutine) {
  return (EventLoopIdleTimerUPP)NewRoutineDescriptor(
      (ProcPtr)(userRoutine), uppEventLoopIdleTimerProcInfo,
      GetCurrentArchitecture());
}
#else
#define NewEventLoopIdleTimerUPP(userRoutine)                                  \
  (EventLoopIdleTimerUPP) NewRoutineDescriptor((ProcPtr)(userRoutine),         \
                                               uppEventLoopIdleTimerProcInfo,  \
                                               GetCurrentArchitecture())
#endif
#endif
 ...
 */
EXTERN_API_C(void)
InvokeEventLoopIdleTimerUPP(EventLoopTimerRef inTimer,
...
inline DEFINE_API_C(void)
    InvokeEventLoopIdleTimerUPP(EventLoopTimerRef inTimer,
                                ...
                                void *inUserData,
                                EventLoopIdleTimerUPP userUPP) {
  CALL_THREE_PARAMETER_UPP(userUPP, uppEventLoopIdleTimerProcInfo, inTimer,
                           inState, inUserData);
}
#else
#define InvokeEventLoopIdleTimerUPP(inTimer, inState, inUserData, userUPP)     \
  CALL_THREE_PARAMETER_UPP((userUPP), uppEventLoopIdleTimerProcInfo,           \
                           (inTimer), (inState), (inUserData))
#endif
#endif
...
#define NewEventLoopIdleTimerProc(userRoutine)                                 \
 ...
 */
EXTERN_API(OSStatus)
InstallEventLoopIdleTimer(EventLoopRef inEventLoop, EventTimerInterval inDelay,
                          EventTimerInterval inInterval,
                          EventLoopIdleTimerUPP inTimerProc, void *inTimerData,
                          EventLoopTimerRef *outTimer);

/* GOING AWAY!!!! DO NOT CALL THIS API!!!!! USE INSTALLEVENTLOOPIDLETIMER
 * ABOVE!!!! */
/*
 *  InstallIdleTimer()
 *
 ...
 */
EXTERN_API(OSStatus)
InstallIdleTimer(EventLoopRef inEventLoop, EventTimerInterval inDelay,
                 EventTimerInterval inInterval, EventLoopTimerUPP inTimerProc,
...
#ifdef __cplusplus
inline DEFINE_API_C(EventHandlerUPP)
    NewEventHandlerUPP(EventHandlerProcPtr userRoutine) {
...
inline DEFINE_API_C(OSStatus)
    InvokeEventHandlerUPP(EventHandlerCallRef inHandlerCallRef,
                          EventRef inEvent, void *inUserData,
 ...
 */
EXTERN_API_C(OSStatus)
SendEventToEventTargetWithOptions(EventRef inEvent, EventTargetRef inTarget,
