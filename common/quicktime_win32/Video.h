...
enum {
  ...
  kModeStretched =
      11 /* Indicates that the display mode will be stretched/distorted to match
...
/* RawSenseCode
   ...
   sense code hardware is implemented.
    ...
    For 'standard' sense code hardware, the raw sense is obtained as follows:
        o Instruct the frame buffer controller NOT to actively drive any of the
   monitor sense lines o Read the state of the monitor sense lines 2, 1, and 0.
...
/* ExtendedSenseCode
   ...
   '1', and 'C' to '0') o Drive sense line 'A' low and read the values of 'B'
   and 'C'. o Drive sense line 'B' low and read the values of 'A' and 'C'. o
