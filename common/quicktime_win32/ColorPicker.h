/*
     ...
     Copyright:  (c) 2007 (c) 1987-2001 by Apple Computer, Inc., all rights
   reserved
...
#ifdef __cplusplus
inline DEFINE_API_C(ColorChangedUPP)
    NewColorChangedUPP(ColorChangedProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(NColorChangedUPP)
    NewNColorChangedUPP(NColorChangedProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(UserEventUPP)
    NewUserEventUPP(UserEventProcPtr userRoutine) {
