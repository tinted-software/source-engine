 ...
 */
EXTERN_API(ComponentResult)
ClockGetTimesForRateChange(ComponentInstance aClock, Fixed fromRate,
                           Fixed toRate, TimeRecord *currentTime,
 ...
 */
EXTERN_API(ComponentResult)
ClockGetRateChangeConstraints(ComponentInstance aClock,
...
enum {
  ...
  scAvailableCompressionListType =
      FOUR_CHAR_CODE('avai'), /* pointer to OSType Handle*/
  scWindowOptionsType =
      FOUR_CHAR_CODE('shee'), /* pointer to SCWindowSettings struct*/
  ...
  scSoundInputSampleRateType =
      FOUR_CHAR_CODE('ssir'),                      /* pointer to UnsignedFixed*/
...
typedef struct SCVideoMultiPassEncodingSettings
    SCVideoMultiPassEncodingSettings;
...
enum {
  ...
  scVideoAllowFrameReorderingType =
      FOUR_CHAR_CODE('bfra'), /* pointer to Boolean*/

  /*
   * The settings to control multi pass encoding.
   */
  scVideoMultiPassEncodingSettingsType = FOUR_CHAR_CODE(
      'mpes') /* pointer to SCVideoMultiPassEncodingSettings struct*/
};
...
/*
   In StandardCompressionSubTypeAudio, instead of using Get/SetInfo, the
   developer will get and set component properties.
   (QTGetComponentPropertyInfo(), QTGetComponentProperty(),
   QTSetComponentProperty(), QTAddComponentPropertyListener(),
   QTRemoveComponentPropertyListener()) These properties have a class and ID,
   instead of just a single selector. Note that implementers of MovieExport
   "from procedures" getProperty procs (that choose to opt-in to the new
   support; see kQTMovieExporterPropertyID_EnableHighResolutionAudioFeatures in
   this header) will need to support these property IDs as new selectors.  In
   other words, the MovieExporter getProperty proc API is not changing to add a
   class.  The class is implied in that case.  Such procs, of course, do not
   implement any of the list properties, or the non-settable properties, as well
   as some others.  The properties getProperty procs can implement are marked
   below with the word "DataProc".
*/
...
enum {
  ...
  kQTSCAudioPropertyID_HasLegacyCodecOptionsDialog =
      FOUR_CHAR_CODE('opn?'), /* Boolean, Read/Listen */
  ...
  kQTSCAudioPropertyID_ConstantBitRateFormatsOnly =
      FOUR_CHAR_CODE('!vbr'), /* Boolean, Read/Write/Listen */
   ...
   */
  kQTSCAudioPropertyID_ClientRestrictedSampleRateList = FOUR_CHAR_CODE(
      'crr#'), /* C-style array of AudioValueRange's, Read/Write/Listen */
   ...
   */
  kQTSCAudioPropertyID_AvailableSampleRateList = FOUR_CHAR_CODE(
      'avr#'), /* C-style array of AudioValueRange's, Read/Listen*/
   ...
   */
  kQTSCAudioPropertyID_ApplicableSampleRateList = FOUR_CHAR_CODE(
      'apr#'), /* C-style array of AudioValueRanges, Read/Listen*/
  ...
  kQTSCAudioPropertyID_SampleRateIsRecommended =
      FOUR_CHAR_CODE('reco'), /* Boolean, Read/Listen*/
  ...
  kQTSCAudioPropertyID_InputMagicCookie =
      FOUR_CHAR_CODE('ikki'), /* void * (opaque data), Read/Write/Listen */
  ...
  kQTSCAudioPropertyID_MagicCookie =
      FOUR_CHAR_CODE('kuki'), /* void * (opaque data), Read/Write/Listen */
   ...
   */
  kQTSCAudioPropertyID_InputChannelLayout = FOUR_CHAR_CODE(
      'icly'), /* AudioChannelLayout (variable-size), Read/Write/Listen */
  ...
  kQTSCAudioPropertyID_InputChannelLayoutName =
      FOUR_CHAR_CODE('icln'), /* CFStringRef, Read */
   ...
   * discover the number of bytes you should allocate.
   */
  kQTSCAudioPropertyID_ChannelLayout = FOUR_CHAR_CODE(
      'clay'), /* AudioChannelLayout (variable-size), Read/Write/Listen */
  ...
  kQTSCAudioPropertyID_ChannelLayoutName =
      FOUR_CHAR_CODE('clyn'), /* CFStringRef, Read */
   ...
   * discover the number of bytes you should allocate to hold the array.
   */
  kQTSCAudioPropertyID_ClientRestrictedChannelLayoutTagList = FOUR_CHAR_CODE(
      'crl#'), /* C-style array of AudioChannelLayoutTag's, Read/Write*/
   ...
   * bytes you should allocate to hold the array.
   */
  kQTSCAudioPropertyID_AvailableChannelLayoutTagList = FOUR_CHAR_CODE(
      'avl#'), /* C-style array of AudioChannelLayoutTag's, Read/Listen */
  ...
  kQTSCAudioPropertyID_AvailableChannelLayoutTagNamesList =
      FOUR_CHAR_CODE('vln#'), /* CFArrayRef, Read*/
   ...
   * should allocate to hold the array.
   */
  kQTSCAudioPropertyID_ApplicableChannelLayoutTagList = FOUR_CHAR_CODE(
      'apl#'), /* C-style array of AudioChannelLayoutTag's, Read/Listen*/
   ...
   */
  kQTSCAudioPropertyID_ApplicableChannelLayoutTagNamesList =
      FOUR_CHAR_CODE('pln#'), /* CFArrayRef, Read*/
  ...
  kQTSCAudioPropertyID_ClientRestrictedLPCMFlags =
      FOUR_CHAR_CODE('crlp'), /* SCAudioFormatFlagsRestrictions (see below),
                                 Read/Write/Listen */
  ...
  kQTSCAudioPropertyID_InputSoundDescription =
      FOUR_CHAR_CODE('isdh'), /* SoundDescriptionHandle, Read/Write */
  ...
  kQTSCAudioPropertyID_SoundDescription =
      FOUR_CHAR_CODE('osdh'), /* SoundDescriptionHandle, Read/Write */

  /*
   * kQTSCAudioPropertyID_InputBasicDescription: Specifies the current
   * input description as an AudioStreamBasicDescription.
   */
  kQTSCAudioPropertyID_InputBasicDescription = FOUR_CHAR_CODE(
      'isbd'), /* AudioStreamBasicDescription, Read/Write/Listen/DataProc */

  /*
   * kQTSCAudioPropertyID_BasicDescription: Specifies the current
   * output description as an AudioStreamBasicDescription.
   */
  kQTSCAudioPropertyID_BasicDescription = FOUR_CHAR_CODE(
      'osbd'), /* AudioStreamBasicDescription, Read/Write/Listen/DataProc */
  ...
  kQTSCAudioPropertyID_CodecSpecificSettingsArray =
      FOUR_CHAR_CODE('cdst'), /* CFArrayRef, Read/Write */
   ...
   */
  kQTSCAudioPropertyID_BitRate =
      kQTSoundDescriptionPropertyID_BitRate, /* UInt32, Read*/
  ...
  kQTSCAudioPropertyID_SettingsState =
      scSettingsStateType, /* Handle, Read/Write */
  ...
  kQTSCAudioPropertyID_MaximumOutputPacketSize =
      FOUR_CHAR_CODE('xops'), /* UInt32, Read*/
  ...
  kQTSCAudioPropertyID_OutputFormatIsExternallyFramed =
      FOUR_CHAR_CODE('fexf'), /* Boolean, Read*/
  ...
  kQTSCAudioPropertyID_RenderQuality =
      FOUR_CHAR_CODE('qlty'), /* UInt32, Read/Write/Listen*/
  ...
  kQTSCAudioPropertyID_ExtendedProcs =
      scExtendedProcsType, /* SCExtendedProcs struct, Read/Write/Listen */
  ...
  kQTSCAudioPropertyID_PreferenceFlags =
      scPreferenceFlagsType, /* SInt32, Read/Write/Listen */
  ...
  kQTSCAudioPropertyID_WindowOptions =
      scWindowOptionsType, /* SCWindowSettings struct, Read/Write/Listen */
   ...
   */
  kQTSCAudioPropertyID_PreviewSourceMovie =
      FOUR_CHAR_CODE('prmv'), /* Movie, Read/Write*/
   ...
   */
  kQTSCAudioPropertyID_PreviewSourceTrack =
      FOUR_CHAR_CODE('prtk') /* Track, Read/Write*/
};

/*
   These are for movie export getProperty procs only (not SCAudio), so that
   variable size properties can be handled in that API where there is no
   associated size parameter. The getProperty proc can be asked the size first,
   then the caller can allocate memory for the associated SCAudio property and
   call the getProperty proc again to get the property.
*/
enum {
  ...
  movieExportUseHighResolutionAudioProperties =
      FOUR_CHAR_CODE('hrau') /* Boolean. Proc only*/
};
 ...
 */
EXTERN_API(ComponentResult)
SCAudioInvokeLegacyCodecOptionsDialog(ComponentInstance ci)
    FIVEWORDINLINE(0x2F3C, 0x0000, 0x0081, 0x7000, 0xA82A);
...
/*
   ...
   call with the same parameters and behaviors of
   AudioConverterFillComplexBuffer. One important difference between the
   AudioConverter and SCAudio component is that the SCAudio compression API's
   can do mixing as well as n -> n channels conversion.  A client wishes to
   compress/decompress/transcode audio using the SCAudioFillBuffer interface
   configures the StandardCompressionSubTypeAudio component with the desired
   input and output formats (or uses the SCRequestImageSettings API to present a
   dialog and let a user pick an output format), then calls SCAudioFillBuffer,
   providing an SCAudioInputDataProc callback which will be called for audio in
 ...
 */
typedef CALLBACK_API_C(ComponentResult, SCAudioInputDataProc)(
    ComponentInstance ci, UInt32 *ioNumberDataPackets, AudioBufferList *ioData,
 ...
 */
EXTERN_API(ComponentResult)
SCAudioFillBuffer(ComponentInstance ci, SCAudioInputDataProc inInputDataProc,
                  void *inInputDataProcRefCon, UInt32 *ioOutputDataPacketSize,
 ...
 */
EXTERN_API(ComponentResult)
SCAudioReset(ComponentInstance ci)
    FIVEWORDINLINE(0x2F3C, 0x0000, 0x0083, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
SCCopyCompressionSessionOptions(ComponentInstance ci,
 ...
 */
EXTERN_API(HandlerError)
TCGetCurrentFrameAndTimeCodeDef(MediaHandler mh, SInt64 *outFrameNum,
 ...
 */
EXTERN_API(HandlerError)
TCGetFrameAndTimeCodeDefAtTime(MediaHandler mh, const TimeValue64 *mediaTime,
                               SInt64 *outFrameNum, TimeCodeDef *outTCDef)
 ...
 */
EXTERN_API(HandlerError)
TCTimeCodeTimeToString(MediaHandler mh, const TimeCodeDef *tCDef,
                       const SMPTETime *tCTime, CFStringRef *outTCStr)
 ...
 */
EXTERN_API(HandlerError)
TCTimeCodeCounterToString(MediaHandler mh, const TimeCodeDef *tCDef,
                          const TimeCode64Counter *tCCounter,
                          CFStringRef *outTCStr)
    FIVEWORDINLINE(0x2F3C, 0x000C, 0x010F, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(HandlerError)
TCTimeCodeTimeToFrameNumber(MediaHandler mh, const TimeCodeDef *tCDef,
                            const SMPTETime *tCTime, SInt64 *outFrameNum)
 ...
 */
EXTERN_API(HandlerError)
TCTimeCodeCounterToFrameNumber(MediaHandler mh, const TimeCodeDef *tCDef,
                               const TimeCode64Counter *tCCounter,
                               SInt64 *outFrameNum)
    FIVEWORDINLINE(0x2F3C, 0x000C, 0x0111, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(HandlerError)
TCFrameNumberToTimeCodeTime(MediaHandler mh, const SInt64 *frameNumber,
                            const TimeCodeDef *tCDef, SMPTETime *outTCTime)
    FIVEWORDINLINE(0x2F3C, 0x000C, 0x0112, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(HandlerError)
TCFrameNumberToTimeCodeCounter(MediaHandler mh, const SInt64 *frameNumber,
...
enum {
  kQTMediaMIMEInfoHasChanged = (1L << 1), /* the MIME type(s) is(are) new or has
  ...
  kQTMediaConfigCanDoFileAssociation =
      (1L << 26), /* can configure this file association */
  kQTMediaConfigAssociateByDefault =
      (1L << 27), /* Deprecated, use kQTMediaConfigTakeFileAssociationByDefault
                     instead*/
  ...
  kQTMediaConfigHasFileHasQTAtoms =
      (1L << 30) /* the file has a "QuickTime like" file format */
};
...
enum {
  ...
  kQTSettingsDVExportDVFormat = FOUR_CHAR_CODE(
      'dvcf'), /* Exported DV Format, DV('dv  ') or DVCPRO('dvp '). (OSType)*/
  kQTSettingsVideoSize =
      FOUR_CHAR_CODE('isiz'), /* Video size related container*/
  kQTSettingsImageWidth =
      FOUR_CHAR_CODE('iwdt'), /* . Destination width. If this is zero, it means
                                 the source width. (SInt32)*/
  kQTSettingsImageHeight =
      FOUR_CHAR_CODE('ihgt'), /* . Destination height. If this is zero, it means
                                 the source height. (SInt32)*/
  kQTSettingsCleanAperture = FOUR_CHAR_CODE(
      'clap'), /* . Clean aperture for compression sessions. If this is all
                  zeros, it means no clean aperture (i.e. full width and
                  height). (CleanApertureImageDescriptionExtension)*/
  kQTSettingsPixelAspectRatio = FOUR_CHAR_CODE(
      'pasp'), /* . Pixel aspect ratio for compression sessions. If this is all
                  zeros, it means square pixels (i.e. 1:1).
                  (PixelAspectRatioImageDescriptionExtension)*/
  kQTSettingsScalingMode =
      FOUR_CHAR_CODE('scam'), /* . Scaling mode for compression sessions. If
                                 this is zero, it means scaling mode based on
                                 the source aperture mode. (OSType)*/
  kQTSettingsUseCodecEnforcedDimensions =
      FOUR_CHAR_CODE('uenf'), /* . If true, compressor's enforced dimension
                                 overrides the image size settings. (Boolean)*/
  kQTSettingsDeinterlaceSource =
      FOUR_CHAR_CODE('dint') /* . If true, deinterlacing is applied to source
                                frames. (Boolean)*/
};
...
typedef CALLBACK_API(OSErr, MovieExportGetPropertyProcPtr)(void *refcon,
                                                           ...
                                                           OSType propertyType,
                                                           void *propertyValue);
typedef CALLBACK_API(OSErr, MovieExportStageReachedCallbackProcPtr)(
...
typedef STACK_UPP_TYPE(MovieExportStageReachedCallbackProcPtr)
...
#ifdef __cplusplus
inline DEFINE_API_C(SCModalFilterUPP)
    NewSCModalFilterUPP(SCModalFilterProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(SCModalHookUPP)
    NewSCModalHookUPP(SCModalHookProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(MovieExportGetDataUPP)
    NewMovieExportGetDataUPP(MovieExportGetDataProcPtr userRoutine) {
...
inline DEFINE_API_C(MovieExportStageReachedCallbackUPP)
  ...
  return (MovieExportStageReachedCallbackUPP)NewRoutineDescriptor(
      (ProcPtr)(userRoutine), uppMovieExportStageReachedCallbackProcInfo,
      GetCurrentArchitecture());
}
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(void) DisposeMovieExportStageReachedCallbackUPP(
    MovieExportStageReachedCallbackUPP userUPP) {
  DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
}
#else
...
#ifdef __cplusplus
inline DEFINE_API_C(OSErr)
    InvokeMovieExportGetPropertyUPP(void *refcon, long trackID,
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(OSErr) InvokeMovieExportStageReachedCallbackUPP(
    OSType inStage, Movie inMovie, ComponentInstance inDataHandler,
    Handle inDataRef, OSType inDataRefType, void *refCon,
    MovieExportStageReachedCallbackUPP userUPP) {
  return (OSErr)CALL_SIX_PARAMETER_UPP(
      userUPP, uppMovieExportStageReachedCallbackProcInfo, inStage, inMovie,
      inDataHandler, inDataRef, inDataRefType, refCon);
}
#else
#define InvokeMovieExportStageReachedCallbackUPP(                              \
    inStage, inMovie, inDataHandler, inDataRef, inDataRefType, refCon,         \
    userUPP)                                                                   \
  (OSErr) CALL_SIX_PARAMETER_UPP(                                              \
      (userUPP), uppMovieExportStageReachedCallbackProcInfo, (inStage),        \
      (inMovie), (inDataHandler), (inDataRef), (inDataRefType), (refCon))
#endif
#endif
...
#define NewMovieExportStageReachedCallbackProc(userRoutine)                    \
  NewMovieExportStageReachedCallbackUPP(userRoutine)
...
#define CallMovieExportStageReachedCallbackProc(userRoutine, inStage, inMovie, \
                                                inDataHandler, inDataRef,      \
                                                inDataRefType, refCon)         \
  InvokeMovieExportStageReachedCallbackUPP(inStage, inMovie, inDataHandler,    \
                                           inDataRef, inDataRefType, refCon,   \
                                           userRoutine)
#endif /* CALL_NOT_IN_CARBON */
 ...
 */
EXTERN_API(ComponentResult)
MovieImportSetMediaDataRef(MovieImportComponent ci, Handle dataRef,
                           OSType dataRefType)
 ...
 */
EXTERN_API(ComponentResult)
MovieImportDoUserDialogDataRef(MovieImportComponent ci, Handle dataRef,
                               OSType dataRefType, Boolean *canceled)
...
enum {
  ...
  movieExportSourceApertureMode = FOUR_CHAR_CODE(
      'srap') /* pointer to OSType. Source movie's aperture mode..Set the
                 aperture mode on the decompression session.*/
};

/* Component Properties specific to Movie Export components*/
enum {
  kQTMovieExporterPropertyID_StageReachedCallback = FOUR_CHAR_CODE(
      'stgr'), /* value is a MovieExportStageReachedCallbackProcRecord*/
  kQTMovieExporterPropertyID_DeinterlaceVideo =
      FOUR_CHAR_CODE('dint') /* value is a Boolean */
};
...
typedef struct MovieExportStageReachedCallbackProcRecord
    MovieExportStageReachedCallbackProcRecord;
/*
...
enum {
  kQTBrowserInfoCanUseSystemFolderPlugin =
      (1L << 0) /* Mac browser can use plug-in from System "Internet Plug-ins"
                   folder */
};
...
enum {
  kDataHMovieUsageDoAppendMDAT = 1L << 0 /* if set, datahandler should append
                                            wide and mdat atoms in append call*/
};
 ...
 */
EXTERN_API(ComponentResult)
DataHSetMovieUsageFlags(DataHandler dh, long flags)
    FIVEWORDINLINE(0x2F3C, 0x0004, 0x0046, 0x7000, 0xA82A);

enum {
  kDataHTempUseSameDirectory =
      1L << 0, /* temp data ref should be in same directory as current data ref
                  (vs. in temporary directory)*/
  kDataHTempUseSameVolume = 1L
                            << 1, /* temp data ref should be on same volume as
                                     current data ref (vs. find "best" volume)*/
  kDataHTempCreateFile = 1L << 2, /* create the file*/
  kDataHTempOpenFile = 1L << 3    /* open temporary file for write
                                     (kDataHTempCreateFile must be passed, too)*/
};
 ...
 */
EXTERN_API(ComponentResult)
DataHUseTemporaryDataRef(DataHandler dh, long inFlags)
 ...
 */
EXTERN_API(ComponentResult)
DataHRenameFile(DataHandler dh, Handle newDataRef)
 ...
 */
EXTERN_API(ComponentResult)
DataHGetAvailableFileSize64(DataHandler dh, wide *fileSize)
    FIVEWORDINLINE(0x2F3C, 0x0004, 0x004E, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
DataHGetDataAvailability64(DataHandler dh, const wide *offset, long len,
                           wide *missing_offset, long *missing_len)
...
enum {
  ...
  digiOutDoesHorizFlip = 1L
                         << 16, /* digitizer supports horizontal flips Sx < 0 */
...
/*    Note that UInt8* queuedFrameCount replaces Boolean* done. 0(==false) still
   means no frames, and 1(==true) one, but if more than one are available the
   number should be returned here. The value 2 previously meant more than one
   frame, so some VDIGs may return 2 even if more than 2 are available, and some
   will still return 1 as they are using the original definition */
/*
 *  VDCompressDone()
 *
 *  Availability:
 ...
 */
EXTERN_API(VideoDigitizerError)
VDCompressDone(VideoDigitizerComponent ci, UInt8 *queuedFrameCount,
               Ptr *theData, long *dataSize, UInt8 *similarity, TimeRecord *t)
...
/*
   The following call is designed to give the VDIG a little more control over
   how it is presented to the User, to clarify the distinction between Devices
   and Inputs. Historically, the assumption has been that there is one component
   registered per device and the component name is displayed. This change lets a
   component choose its name after registration. vdDeviceFlagShowInputsAsDevices
   is meant for components that register once and support multiple devices The
   UI is clearer if these are presented as device rather than inputs, and this
   allows a VDIG to present itself this way without huge restructuring
   vdDeviceFlagHideDevice is for the kind of VDIG that registers itself, and
   then can register a further VDIG for each device. If no hardware is
   available, returning this flag will omit it from the list. This call being
   made is also a good time to check for hardware and register further VDIG
   components if needed, allowing for lazy initialization when the Application
   needs to find a VDIG rather than on every launch or replug.
*/

enum {
  vdDeviceFlagShowInputsAsDevices =
      (1 << 0), /* Tell the Panel to promote Inputs to Devices*/
 ...
 */
EXTERN_API(VideoDigitizerError)
VDGetDeviceNameAndFlags(VideoDigitizerComponent ci, Str255 outName,
                        UInt32 *outNameFlags)
    FIVEWORDINLINE(0x2F3C, 0x0008, 0x005E, 0x7000, 0xA82A);

enum {
  vdFlagCaptureStarting =
      (1 << 0), /* Capture is about to start; allocate bandwidth */
  vdFlagCaptureStopping =
      (1 << 1), /* Capture is about to stop; stop queuing frames*/
  vdFlagCaptureIsForPreview =
      (1 << 2), /* Capture is just to screen for preview purposes*/
  vdFlagCaptureIsForRecord = (1 << 3), /* Capture is going to be recorded*/
  vdFlagCaptureLowLatency =
      (1 << 4), /* Fresh frames are more important than delivering every frame -
                   don't queue too much*/
  vdFlagCaptureAlwaysUseTimeBase =
      (1 << 5), /* Use the timebase for every frame; don't worry about making
                   durations uniform*/
  vdFlagCaptureSetSettingsBegin =
      (1 << 6), /* A series of calls are about to be made to restore settings.*/
  vdFlagCaptureSetSettingsEnd =
      (1 << 7) /* Finished restoring settings; any set calls after this are from
                  the app or UI*/
};
...
/*
   These UniqueID calls are so that the VDIG can give the SG information
   enabling it to restore a particular configuration - choose a particular
   device and input from those available. For example, restoring the specific
   camera for a set of several hot-plugged FireWire cameras the caller can pass
   nil if it is not interested in one of the IDs returning 0 in an ID means you
   don't have one
*/
 ...
 */
EXTERN_API(VideoDigitizerError)
VDGetUniqueIDs(VideoDigitizerComponent ci, UInt64 *outDeviceID,
               UInt64 *outInputID)
    FIVEWORDINLINE(0x2F3C, 0x0008, 0x0060, 0x7000, 0xA82A);

/*
   Note this is a 'Select' not a 'Set' - the assumption is that the Unique ID is
   a function of the hardware and not modifiable by the calling application.
   Either a nil pointer or 0 an the ID means don't care. return
   vdDontHaveThatUniqueIDErr if your device doesn't have a match.
*/
 ...
 */
EXTERN_API(VideoDigitizerError)
VDSelectUniqueIDs(VideoDigitizerComponent ci, const UInt64 *inDeviceID,
 ...
 */
EXTERN_API(ComponentResult)
VDCopyPreferredAudioDevice(ComponentInstance vdig,
                           CFStringRef *outAudioDeviceUID)
    FIVEWORDINLINE(0x2F3C, 0x0004, 0x0063, 0x7000, 0xA82A);

/*
   IIDC (Instrumentation & Industrial Digital Camera) Video Digitizers
   Video Digitizers of subtype vdSubtypeIIDC support FireWire cameras which
   conform to the "IIDC 1394-based Digital Camera Specification."
*/

enum {
  vdSubtypeIIDC = FOUR_CHAR_CODE(
      'iidc') /* Subtype for IIDC 1394-Digital Camera video digitizer*/
};
...
*/
enum { vdIIDCAtomTypeFeature = FOUR_CHAR_CODE('feat') };

/*
   vdIIDCAtomTypeFeatureAtomTypeAndID
   This atom describes the feature's OSType/group/name and QTAtomType & QTAtomID
   needed to retrieve its settings. The contents of this atom is a
   VDIIDCFeatureAtomTypeAndID structure.
*/
enum {
...
enum {
  vdIIDCFeatureHue = FOUR_CHAR_CODE(
      'hue '), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeatureSaturation = FOUR_CHAR_CODE(
      'satu'), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeatureSharpness = FOUR_CHAR_CODE(
      'shrp'), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeatureBrightness = FOUR_CHAR_CODE(
      'brit'), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeatureGain = FOUR_CHAR_CODE(
      'gain'), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeatureIris = FOUR_CHAR_CODE(
      'iris'), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeatureShutter = FOUR_CHAR_CODE(
      'shtr'), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeatureExposure = FOUR_CHAR_CODE(
      'xpsr'), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeatureWhiteBalanceU = FOUR_CHAR_CODE(
      'whbu'), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeatureWhiteBalanceV = FOUR_CHAR_CODE(
      'whbv'), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeatureGamma = FOUR_CHAR_CODE(
      'gmma'), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeatureTemperature = FOUR_CHAR_CODE(
      'temp'), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeatureZoom = FOUR_CHAR_CODE(
      'zoom'), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeatureFocus = FOUR_CHAR_CODE(
      'fcus'), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeaturePan = FOUR_CHAR_CODE(
      'pan '), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeatureTilt = FOUR_CHAR_CODE(
      'tilt'), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeatureOpticalFilter = FOUR_CHAR_CODE(
      'opft'), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeatureTrigger = FOUR_CHAR_CODE(
      'trgr'), /* Trigger's setttings handled by VDIIDCTriggerSettings*/
  vdIIDCFeatureCaptureSize =
      FOUR_CHAR_CODE('cpsz'), /* Feature's settings is not defined*/
  vdIIDCFeatureCaptureQuality =
      FOUR_CHAR_CODE('cpql'), /* Feature's settings is not defined*/
  vdIIDCFeatureFocusPoint = FOUR_CHAR_CODE(
      'fpnt'), /* Focus Point's settings handled by VDIIDCFocusPointSettings*/
  vdIIDCFeatureEdgeEnhancement = FOUR_CHAR_CODE(
      'eden'), /* Feature's settings handled by VDIIDCFeatureSettings*/
  vdIIDCFeatureLightingHint = FOUR_CHAR_CODE(
      'lhnt') /* Feature's settings handled by VDIIDCLightingHintSettings*/
};

/*
   IIDC Group OSTypes that features are categorized into
   (The values used for the constants cannot be the same as any of the IIDC
   Feature OSTypes constants)
*/
enum {
  vdIIDCGroupImage =
      FOUR_CHAR_CODE('imag'), /* Feature related to camera's image*/
  vdIIDCGroupColor =
      FOUR_CHAR_CODE('colr'), /* Feature related to camera's color control*/
  vdIIDCGroupMechanics =
      FOUR_CHAR_CODE('mech'), /* Feature related to camera's mechanics*/
  vdIIDCGroupTrigger =
      FOUR_CHAR_CODE('trig') /* Feature related to camera's trigger*/
};
...
/*
   ...
   When indicating capabilities, the flag being set indicates that the feature
   can be put into the given state. When indicating/setting state, the flag
   represents the current/desired state. Note that certain combinations of flags
   are valid for capabilities (i.e. vdIIDCFeatureFlagOn | vdIIDCFeatureFlagOff)
...
/*
   ...
   When indicating capabilities, the flag being set indicates that the trigger
   can be put into the given state. When indicating/setting state, the flag
   represents the current/desired state. Note that certain combinations of flags
   are valid for capabilities (i.e. vdIIDCTriggerFlagOn | vdIIDCTriggerFlagOff)
   but are mutually exclusive for state.
*/
enum {
...
/*
   Flags for use in VDIIDCLightingHintSettings.capabilityFlags &
   VDIIDCLightingHintSettings.capabilityFlags When indicating capabilities, the
   flag being set indicates that the hint can be applied. When
   indicating/setting state, the flag represents the current/desired hints
   applied/to apply. Certain combinations of flags are valid for capabilities
   (i.e. vdIIDCLightingHintNormal | vdIIDCLightingHintLow) but are mutually
   exclusive for state.
*/
enum { vdIIDCLightingHintNormal = (1 << 0), vdIIDCLightingHintLow = (1 << 1) };
 ...
 */
EXTERN_API(VideoDigitizerError)
VDIIDCGetCSRData(VideoDigitizerComponent ci, Boolean offsetFromUnitBase,
 ...
 */
EXTERN_API(VideoDigitizerError)
VDIIDCSetCSRData(VideoDigitizerComponent ci, Boolean offsetFromUnitBase,
                 UInt32 offset, UInt32 data)
 ...
 */
EXTERN_API(VideoDigitizerError)
VDIIDCGetFeaturesForSpecifier(VideoDigitizerComponent ci, OSType specifier,
...
enum {
  ...
  xmlParseFlagAllowUppercase =
      1L << 0, /*    Entities and attributes do not have to be lowercase (strict
                  XML), but can be upper or mixed case as in HTML*/
  xmlParseFlagAllowUnquotedAttributeValues =
      1L
      << 1, /*    Attributes values do not have to be enclosed in quotes (strict
               XML), but can be left unquoted if they contain no spaces*/
  xmlParseFlagEventParseOnly = 1L << 2, /*    Do event parsing only*/
  xmlParseFlagPreserveWhiteSpace =
      1L << 3 /*    Preserve whitespace throughout the document*/
};
...
enum {
  ...
  attributeValueKindCaseSensEnum =
      1L
      << 6, /*    one of a number of strings; the enum strings are passed as for
...
typedef CALLBACK_API(ComponentResult, CommentHandler)(const char *comment,
                                                      long refcon);
typedef CALLBACK_API(ComponentResult, CDataHandler)(const char *cdata,
                                                    long refcon);
...
enum {
  ...
  seqGrabDontPreAllocateFileSize =
      512 /* Don't set the size of the file before capture unless the file has
             been pre-extended */
};
...
enum {
  ...
  seqGrabLowLatencyCapture =
      8, /* return the freshest frame possible, for live work
            (videoconferencing, live broadcast, live image processing) */
  seqGrabAlwaysUseTimeBase =
      16, /* Tell VDIGs to use TimebaseTime always, rather than creating uniform
             frame durations, for more accurate live sync with audio */
  seqGrabRecordPreferQualityOverFrameRate =
      32 /* quality is more important than frame rate: client rather drop frame
            instead of lower quality to achieve full frame rate */
};
...
enum { sgDeviceInputNameFlagInputUnavailable = (1 << 0) };
...
SGGetChannelRefCon(SGChannel c, long *refCon)
    FIVEWORDINLINE(0x2F3C, 0x0004, 0x009C, 0x7000, 0xA82A);

/* A utility call to find out the current device and input names, instead of
 * having to call GetDeviceList and walk it yourself */
/*
 ...
 */
EXTERN_API(ComponentResult)
SGGetChannelDeviceAndInputNames(SGChannel c, Str255 outDeviceName,
                                Str255 outInputName, short *outInputNumber)
    FIVEWORDINLINE(0x2F3C, 0x000C, 0x009D, 0x7000, 0xA82A);

/* A media format independent call for this. Inputs start at 0 here (Sound
 * starts at 1, VDIGs at 0 in direct calls) */
/*
 ...
 */
EXTERN_API(ComponentResult)
SGSetChannelDeviceInput(SGChannel c, short inInputNumber)
    FIVEWORDINLINE(0x2F3C, 0x0002, 0x009E, 0x7000, 0xA82A);

/* A call to bracket SetSettings related calls, to give downstream components an
   opportunity to deal with the entire settings change in one go */
enum {
  sgSetSettingsBegin =
      (1 << 0), /* SGSetSettings related set calls about to start*/
  sgSetSettingsEnd = (1 << 1) /* Finished SGSetSettings calls. Get ready to use
                                 the new settings*/
};
...
/*
    SGPanelGetDITLForSize is used to retrieve user interface elements that fit
   within a specified size panel.  The component should return
   badComponentSelector for sizes it does not support.  The component is
   required to support kSGSmallestDITLSize, and it is recommended to support
   kSGLargestDITLSize.

    If SGPanelGetDITLForSize is unimplemented entirely, the panel is assumed to
   not have resizable UI elements.
*/
enum {
  kSGSmallestDITLSize =
      -1, /* requestedSize h and v set to this to retrieve small size*/
  kSGLargestDITLSize =
      -2 /* requestedSize h and v set to this to retrieve large size*/
};
...
typedef CALLBACK_API(ComponentResult, SGGrabCompressCompleteBottleProcPtr)(
    SGChannel c, UInt8 *queuedFrameCount, SGCompressInfo *ci, TimeRecord *t,
    long refCon);
 ...
 */
EXTERN_API(ComponentResult)
SGGrabCompressComplete(SGChannel c, UInt8 *queuedFrameCount, SGCompressInfo *ci,
                       TimeRecord *tr)
...
|
 ------------------------------------------------------------------------------*/
enum { SGAudioMediaType = FOUR_CHAR_CODE('audi') };

/* -----------------------------------------------------------------------------
| | |   COMPONENT PROPERTY CLASSES used by SGAudioChannel | | | |   Note:
QTComponentProperty API's are defined in ImageCompression.h:          | |
...
/* -----------------------------------------------------------------------------
| | |   COMPONENT PROPERTY ID'S used by SGAudioMediaType channel | | | |   In
addition to the Property ID's declared below, SGAudioMediaType channel   | |
...
enum {
  ...
  kQTSGAudioPropertyID_DeviceListWithAttributes =
      FOUR_CHAR_CODE('#dva'), /* Data: CFArrayRef, R/W/L: Read/Listen,
                                 Class(es): kQTPropertyClass_SGAudio  */
   ...
   */
  kQTSGAudioPropertyID_DeviceUID = FOUR_CHAR_CODE(
      'uid '), /* Data: CFStringRef, R/W/L: Read/Write, Class(es):
                  kQTPropertyClass_SGAudioRecordDevice,
                  kQTPropertyClass_SGAudioPreviewDevice */
   ...
   * calling getpid()).
   */
  kQTSGAudioPropertyID_DeviceHogged = FOUR_CHAR_CODE(
      'hogg'), /* Data: pid_t, R/W/L: Read/Write/Listen, Class(es):
                  kQTPropertyClass_SGAudioRecordDevice,
                  kQTPropertyClass_SGAudioPreviewDevice */
  ...
  kQTSGAudioPropertyID_HardwarePlaythruEnabled =
      FOUR_CHAR_CODE('hard'), /* Data: Boolean, R/W/L: Read/Write, Class(es):
                                 kQTPropertyClass_SGAudioRecordDevice */
  ...
  kQTSGAudioPropertyID_ChannelLayout =
      FOUR_CHAR_CODE('clay'), /* Data: AudioChannelLayout, R/W/L: Read/Write,
                                 Class(es): kQTPropertyClass_SGAudio,
                                 kQTPropertyClass_SGAudioRecordDevice,
                                 kQTPropertyClass_SGAudioPreviewDevice */
   ...
   */
  kQTSGAudioPropertyID_ChannelMap = FOUR_CHAR_CODE(
      'cmap'), /* Data: C-style array of SInt32's, R/W/L: Read/Write, Class(es):
                  kQTPropertyClass_SGAudioRecordDevice */
  ...
  kQTSGAudioPropertyID_CodecSpecificSettingsArray =
      FOUR_CHAR_CODE('cdst'), /* Data: CFArrayRef,  Read/Write, Class(es):
  ...
  kQTSGAudioPropertyID_MagicCookie =
      FOUR_CHAR_CODE('kuki'), /* Data: void * (opaque), R/W/L: Read/Write,
                                 Class(es): kQTPropertyClass_SGAudio     */
   ...
   */
  kQTSGAudioPropertyID_StreamFormat = FOUR_CHAR_CODE(
      'frmt'), /* Data: AudioStreamBasicDescription, R/W/L: Read/Write/Listen,
                  Class(es): kQTPropertyClass_SGAudio,
                  kQTPropertyClass_SGAudioRecordDevice,
                  kQTPropertyClass_SGAudioPreviewDevice */
  ...
  kQTSGAudioPropertyID_StreamFormatList = FOUR_CHAR_CODE(
      '#frm'), /* Data: C-style array of AudioStreamBasicDescription's, R/W/L:
                  Read/Listen, Class(es): kQTPropertyClass_SGAudioRecordDevice,
                  kQTPropertyClass_SGAudioPreviewDevice */
  ...
  kQTSGAudioPropertyID_SoundDescription = FOUR_CHAR_CODE(
      'snds'), /* Data: SoundDescriptionHandle, R/W/L: Read/Write, Class(es):
                  kQTPropertyClass_SGAudio */
  ...
  kQTSGAudioPropertyID_InputSelection = FOUR_CHAR_CODE(
      'inpt'), /* Data: OSType, R/W/L: Read/Write/Listen, Class(es):
                  kQTPropertyClass_SGAudioRecordDevice */
  ...
  kQTSGAudioPropertyID_InputListWithAttributes = FOUR_CHAR_CODE(
      '#inp'), /* Data: CFArrayRef, R/W/L: Read/Listen, Class(es):
                  kQTPropertyClass_SGAudioRecordDevice */
  ...
  kQTSGAudioPropertyID_OutputSelection = FOUR_CHAR_CODE(
      'otpt'), /* Data: OSType, R/W/L: Read/Write/Listen, Class(es):
                  kQTPropertyClass_SGAudioPreviewDevice */
  ...
  kQTSGAudioPropertyID_OutputListWithAttributes = FOUR_CHAR_CODE(
      '#otp'), /* Data: CFArrayRef, R/W/L: Read/Listen, Class(es):
                  kQTPropertyClass_SGAudioPreviewDevice */
  ...
  kQTSGAudioPropertyID_LevelMetersEnabled =
      FOUR_CHAR_CODE('lmet'), /* Data: Boolean, R/W/L: Read/Write, Class(es):
                                 kQTPropertyClass_SGAudioRecordDevice,
                                 kQTPropertyClass_SGAudioPreviewDevice,
                                 kQTPropertyClass_SGAudio */
  ...
  kQTSGAudioPropertyID_PeakHoldLevels = FOUR_CHAR_CODE(
      'phlv'), /* Data: C-style array of Float32's, R/W/L: Read, Class(es):
                  kQTPropertyClass_SGAudioRecordDevice,
                  kQTPropertyClass_SGAudioPreviewDevice,
                  kQTPropertyClass_SGAudio */
  ...
  kQTSGAudioPropertyID_AveragePowerLevels = FOUR_CHAR_CODE(
      'aplv'), /* Data: C-style array of Float32's, R/W/L: Read, Class(es):
                  kQTPropertyClass_SGAudioRecordDevice,
                  kQTPropertyClass_SGAudioPreviewDevice,
                  kQTPropertyClass_SGAudio */
  ...
  kQTSGAudioPropertyID_MasterGain =
      FOUR_CHAR_CODE('mgan'), /* Data: Float32, R/W/L: Read/Write, Class(es):
                                 kQTPropertyClass_SGAudio,
                                 kQTPropertyClass_SGAudioRecordDevice,
                                 kQTPropertyClass_SGAudioPreviewDevice */
  ...
  kQTSGAudioPropertyID_PerChannelGain = FOUR_CHAR_CODE(
      'cgan'), /* Data: C-style array of Float32's, R/W/L: Read/Write,
                  Class(es): kQTPropertyClass_SGAudio,
                  kQTPropertyClass_SGAudioRecordDevice,
                  kQTPropertyClass_SGAudioPreviewDevice              */
  ...
  kQTSGAudioPropertyID_GainScalarToDecibels =
      FOUR_CHAR_CODE('gsdb'), /* Data: Float32, R/W/L: Read, Class(es):
                                 kQTPropertyClass_SGAudio,
                                 kQTPropertyClass_SGAudioRecordDevice,
                                 kQTPropertyClass_SGAudioPreviewDevice*/
  ...
  kQTSGAudioPropertyID_MixerCoefficients = FOUR_CHAR_CODE(
      'mixc'), /* Data: C-style array of Float32's, R/W/L: Read/Write,
                  Class(es): kQTPropertyClass_SGAudio*/
  ...
  kQTSGAudioPropertyID_Settings =
      FOUR_CHAR_CODE('setu'), /* Data: UserData, R/W/L: Read/Write, Class(es):
                                 kQTPropertyClass_SGAudio */
  ...
  kQTSGAudioPropertyID_ChunkSize =
      FOUR_CHAR_CODE('chnk'), /* Data: Float32, R/W/L: Read/Write, Class(es):
                                 kQTPropertyClass_SGAudio */
  ...
  kQTSGAudioPropertyID_SoftPreviewLatency =
      FOUR_CHAR_CODE('slat'), /* Data: Float32, R/W/L: Read/Write, Class(es):
                                 kQTPropertyClass_SGAudio */
  ...
  kQTSGAudioPropertyID_PreMixCallback =
      FOUR_CHAR_CODE('_mxc'), /* Data: SGAudioCallbackStruct, R/W/L: Read/Write,
                                 Class(es): kQTPropertyClass_SGAudio */
  ...
  kQTSGAudioPropertyID_PreMixCallbackFormat =
      FOUR_CHAR_CODE('_mcf'), /* Data: AudioStreamBasicDescription, R/W/L: Read,
                                 Class(es): kQTPropertyClass_SGAudio*/
  ...
  kQTSGAudioPropertyID_PostMixCallback =
      FOUR_CHAR_CODE('mx_c'), /* Data: SGAudioCallbackStruct, R/W/L: Read/Write,
                                 Class(es): kQTPropertyClass_SGAudio */
  ...
  kQTSGAudioPropertyID_PostMixCallbackFormat =
      FOUR_CHAR_CODE('m_cf'), /* Data: AudioStreamBasicDescription, R/W/L: Read,
                                 Class(es): kQTPropertyClass_SGAudio*/
  ...
  kQTSGAudioPropertyID_PreConversionCallback =
      FOUR_CHAR_CODE('_cvc'), /* Data: SGAudioCallbackStruct, R/W/L: Read/Write,
                                 Class(es): kQTPropertyClass_SGAudio */
  ...
  kQTSGAudioPropertyID_PreConversionCallbackFormat =
      FOUR_CHAR_CODE('_ccf'), /* Data: AudioStreamBasicDescription, R/W/L: Read,
                                 Class(es): kQTPropertyClass_SGAudio*/
  ...
  kQTSGAudioPropertyID_PostConversionCallback =
      FOUR_CHAR_CODE('cv_c'), /* Data: SGAudioCallbackStruct, R/W/L: Read/Write,
                                 Class(es): kQTPropertyClass_SGAudio */
  ...
  kQTSGAudioPropertyID_PostConversionCallbackFormat =
      FOUR_CHAR_CODE('c_cf') /* Data: AudioStreamBasicDescription, R/W/L: Read,
                                Class(es): kQTPropertyClass_SGAudio*/
};

/* -----------------------------------------------------------------------------
| | |   SGAudioMediaType Channel - Device Attribute Keys | | | |   These
dictionary keys may be used to parse CFDictionaries returned by       | |
kQTSGAudioPropertyID_DeviceListWithAttributes &                             | |
kQTSGAudioPropertyID_DeviceAttributes                                       | |
|
 ------------------------------------------------------------------------------*/
...
enum {
   ...
   * selection)
   */
  kQTAudioDeviceAttribute_InputSelectionKey =
   ...
   */
  kQTAudioDeviceAttribute_InputListWithAttributesKey =
      kQTSGAudioPropertyID_InputListWithAttributes,
  kQTAudioDeviceAttribute_OutputSelectionKey =
   ...
   */
  kQTAudioDeviceAttribute_OutputListWithAttributesKey =
...
enum {
  ...
  sgcAudioCodecSpecificSettingsArray =
      kQTSGAudioPropertyID_CodecSpecificSettingsArray,
  sgcAudioMagicCookie = kQTSGAudioPropertyID_MagicCookie,
  sgcAudioHardwarePlaythruEnabled =
      kQTSGAudioPropertyID_HardwarePlaythruEnabled,
 ...
 */
typedef CALLBACK_API_C(OSStatus, SGAudioCallback)(
    SGChannel c, void *inRefCon, SGAudioCallbackFlags *ioFlags,
...
enum {
  ...
  kQTVODecompressors = FOUR_CHAR_CODE(
      'deco'), /* atom contains other atoms indicating supported decompressors*/
 ...
 */
EXTERN_API(ComponentResult)
QTVideoOutputCopyIndAudioOutputDeviceUID(QTVideoOutputComponent vo, long index,
...
#ifdef __cplusplus
inline DEFINE_API_C(DataHCompletionUPP)
    NewDataHCompletionUPP(DataHCompletionProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(StartDocumentHandlerUPP)
    NewStartDocumentHandlerUPP(StartDocumentHandler userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(EndDocumentHandlerUPP)
    NewEndDocumentHandlerUPP(EndDocumentHandler userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(StartElementHandlerUPP)
    NewStartElementHandlerUPP(StartElementHandler userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(EndElementHandlerUPP)
    NewEndElementHandlerUPP(EndElementHandler userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(CharDataHandlerUPP)
    NewCharDataHandlerUPP(CharDataHandler userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(CommentHandlerUPP)
    NewCommentHandlerUPP(CommentHandler userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(CDataHandlerUPP)
    NewCDataHandlerUPP(CDataHandler userRoutine) {
  return (CDataHandlerUPP)NewRoutineDescriptor((ProcPtr)(userRoutine),
                                               uppCDataHandlerProcInfo,
                                               GetCurrentArchitecture());
}
#else
#define NewCDataHandlerUPP(userRoutine)                                        \
  (CDataHandlerUPP)                                                            \
      NewRoutineDescriptor((ProcPtr)(userRoutine), uppCDataHandlerProcInfo,    \
                           GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
inline DEFINE_API_C(SGModalFilterUPP)
    NewSGModalFilterUPP(SGModalFilterProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(SGGrabBottleUPP)
    NewSGGrabBottleUPP(SGGrabBottleProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(SGGrabCompleteBottleUPP)
    NewSGGrabCompleteBottleUPP(SGGrabCompleteBottleProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(SGDisplayBottleUPP)
    NewSGDisplayBottleUPP(SGDisplayBottleProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(SGCompressBottleUPP)
    NewSGCompressBottleUPP(SGCompressBottleProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(SGCompressCompleteBottleUPP) NewSGCompressCompleteBottleUPP(
...
enum {
  uppSGAddFrameBottleProcInfo = 0x0003FEF0
    ...
    */
#ifdef __cplusplus
inline DEFINE_API_C(SGAddFrameBottleUPP)
    NewSGAddFrameBottleUPP(SGAddFrameBottleProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(SGTransferFrameBottleUPP)
    NewSGTransferFrameBottleUPP(SGTransferFrameBottleProcPtr userRoutine) {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(void) DisposePreprocessInstructionHandlerUPP(
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(void) DisposeSGGrabCompressCompleteBottleUPP(
...
#ifdef __cplusplus
inline DEFINE_API_C(ComponentResult)
    InvokeStartElementHandlerUPP(const char *name, const char **atts,
                                 long refcon, StartElementHandlerUPP userUPP) {
...
InvokePreprocessInstructionHandlerUPP(const char *name,
                                      const char *const atts[], long refcon,
                                      PreprocessInstructionHandlerUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(ComponentResult) InvokePreprocessInstructionHandlerUPP(
    const char *name, const char *const atts[], long refcon,
    PreprocessInstructionHandlerUPP userUPP) {
  return (ComponentResult)CALL_THREE_PARAMETER_UPP(
...
#ifdef __cplusplus
inline DEFINE_API_C(ComponentResult)
    InvokeCDataHandlerUPP(const char *cdata, long refcon,
                          CDataHandlerUPP userUPP) {
  return (ComponentResult)CALL_TWO_PARAMETER_UPP(
      userUPP, uppCDataHandlerProcInfo, cdata, refcon);
}
#else
#define InvokeCDataHandlerUPP(cdata, refcon, userUPP)                          \
  (ComponentResult) CALL_TWO_PARAMETER_UPP((userUPP), uppCDataHandlerProcInfo, \
                                           (cdata), (refcon))
#endif
#endif
...
#ifdef __cplusplus
inline DEFINE_API_C(ComponentResult)
    InvokeSGCompressCompleteBottleUPP(SGChannel c, short bufferNum,
...
#ifdef __cplusplus
inline DEFINE_API_C(ComponentResult)
    InvokeSGTransferFrameBottleUPP(SGChannel c, short bufferNum,
                                   MatrixRecord *mp, RgnHandle clipRgn,
                                   long refCon,
                                   SGTransferFrameBottleUPP userUPP) {
  return (ComponentResult)CALL_FIVE_PARAMETER_UPP(
 ...
 */
EXTERN_API_C(ComponentResult)
InvokeSGGrabCompressCompleteBottleUPP(SGChannel c, UInt8 *queuedFrameCount,
                                      SGCompressInfo *ci, TimeRecord *t,
                                      long refCon,
                                      SGGrabCompressCompleteBottleUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(ComponentResult) InvokeSGGrabCompressCompleteBottleUPP(
    SGChannel c, UInt8 *queuedFrameCount, SGCompressInfo *ci, TimeRecord *t,
    long refCon, SGGrabCompressCompleteBottleUPP userUPP) {
  return (ComponentResult)CALL_FIVE_PARAMETER_UPP(
      userUPP, uppSGGrabCompressCompleteBottleProcInfo, c, queuedFrameCount, ci,
      t, refCon);
}
#else
#define InvokeSGGrabCompressCompleteBottleUPP(c, queuedFrameCount, ci, t,      \
                                              refCon, userUPP)                 \
  (ComponentResult) CALL_FIVE_PARAMETER_UPP(                                   \
      (userUPP), uppSGGrabCompressCompleteBottleProcInfo, (c),                 \
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(ComponentResult) InvokeSGDisplayCompressBottleUPP(
    SGChannel c, Ptr dataPtr, ImageDescriptionHandle desc, MatrixRecord *mp,
...
#define CallCDataHandlerProc(userRoutine, cdata, refcon)                       \
  InvokeCDataHandlerUPP(cdata, refcon, userRoutine)
...
#define CallSGGrabCompressCompleteBottleProc(userRoutine, c, queuedFrameCount, \
                                             ci, t, refCon)                    \
  InvokeSGGrabCompressCompleteBottleUPP(c, queuedFrameCount, ci, t, refCon,    \
                                        userRoutine)
