...
enum {
  ...
  kDVCNTSCCodecType =
      FOUR_CHAR_CODE('dvc '), /* DV - NTSC and DVCPRO NTSC (available in
  ...
  kDVCProPALCodecType =
      FOUR_CHAR_CODE('dvpp'), /* available in QuickTime 6.0 or later*/
  ...
  kTIFFCodecType = FOUR_CHAR_CODE(
      'tiff'), /* NOTE: despite what might seem obvious from the two constants*/
...
enum {
  ...
  k64ARGBPixelFormat =
      FOUR_CHAR_CODE('b64a'), /* ARGB, 16-bit big-endian samples */
  k48RGBPixelFormat =
      FOUR_CHAR_CODE('b48r'), /* RGB, 16-bit big-endian samples */
  k32AlphaGrayPixelFormat =
      FOUR_CHAR_CODE('b32a'), /* AlphaGray, 16-bit big-endian samples */
  k16GrayPixelFormat =
      FOUR_CHAR_CODE('b16g'), /* Grayscale, 16-bit big-endian samples */
  k422YpCbCr8PixelFormat = FOUR_CHAR_CODE(
      '2vuy') /* Component Y'CbCr 8-bit 4:2:2, ordered Cb Y'0 Cr Y'1 */
};

/* Supported by QTNewGWorld in QuickTime 4.1.2 and later */
enum {
  k4444YpCbCrA8PixelFormat = FOUR_CHAR_CODE(
      'v408'), /* Component Y'CbCrA 8-bit 4:4:4:4, ordered Cb Y' Cr A */
  k4444YpCbCrA8RPixelFormat = FOUR_CHAR_CODE(
      'r408') /* Component Y'CbCrA 8-bit 4:4:4:4, rendering format. full range
                 alpha, zero biased yuv, ordered A Y' Cb Cr */
};

/* Supported by QTNewGWorld in QuickTime 6.0 and later */
enum {
  kYUV420PixelFormat = FOUR_CHAR_CODE(
      'y420') /* Planar Component Y'CbCr 8-bit 4:2:0.  PixMap baseAddr points to
                 a big-endian PlanarPixmapInfoYUV420 struct; see ImageCodec.i.
               */
};
...
enum {
  ...
  codecInfoDoesReorder =
      (1L << 19), /* codec can rearrange frames during compression */
  codecInfoDoesWarp = (1L << 20), /* codec can warp arbitrarily on decompress */
  codecInfoDoesMultiPass =
      (1L << 20), /* codec can perform multi-pass compression */
...
enum {
  ...
  codecCompletionDecoded =
      (1 << 10), /* codec has decoded this frame; if it is cancelled and
                    rescheduled, set icmFrameAlreadyDecoded in
                    ICMFrameTimeRecord.flags */
  codecCompletionNotDisplayable =
      (1 << 11), /* the frame may still be scheduled for decode, but will not be
                    able to be displayed because the buffer containing it will
                    need to be recycled to display earlier frames. */
  codecCompletionNotDrawn =
      (1 << 12) /* set in conjunction with codecCompletionDest to indicate that
...
struct CodecInfo {
  ...
  unsigned short decompressionSpeed; /* ( millisecs for decompressing 320x240 on
                                        mac II)(0 if unknown)  */
  ...
  short
      compressPipelineLatency; /* in milliseconds ( for asynchronous codecs ) */
  long privateData;
};
...
struct ICMFrameTimeRecord {
  ...
  TimeValue64 decodeTime; /* suggested decode time, if icmFrameTimeHasDecodeTime
                             is set in flags*/
};
...
#ifdef __cplusplus
inline DEFINE_API_C(ICMCompletionUPP)
    NewICMCompletionUPP(ICMCompletionProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(ICMProgressUPP)
    NewICMProgressUPP(ICMProgressProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(ICMAlignmentUPP)
    NewICMAlignmentUPP(ICMAlignmentProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(ICMCursorShieldedUPP)
    NewICMCursorShieldedUPP(ICMCursorShieldedProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(ICMMemoryDisposedUPP)
    NewICMMemoryDisposedUPP(ICMMemoryDisposedProcPtr userRoutine) {
...
enum {
  uppICMConvertDataFormatProcInfo = 0x003FFFE0
      ...
      4_bytes, 4_bytes) */
#ifdef __cplusplus
inline DEFINE_API_C(ICMConvertDataFormatUPP)
    NewICMConvertDataFormatUPP(ICMConvertDataFormatProcPtr userRoutine) {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(OSErr) InvokeICMDataUPP(Ptr *dataP, long bytesNeeded,
                                            long refcon, ICMDataUPP userUPP) {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(OSErr) InvokeICMFlushUPP(Ptr data, long bytesAdded,
                                             long refcon, ICMFlushUPP userUPP) {
...
#ifdef __cplusplus
inline DEFINE_API_C(void)
    InvokeStdPixUPP(PixMap *src, Rect *srcRect, MatrixRecord *matrix,
...
#ifdef __cplusplus
inline DEFINE_API_C(OSErr)
    InvokeICMConvertDataFormatUPP(void *refCon, long flags,
                                  Handle desiredFormat, Handle sourceDataFormat,
...
/* For video compression, consider using ICMCompressionSessionCreate etc.
 * instead of CompressSequenceBegin etc. */
/*
...
/* For video decompression, consider using ICMDecompressionSessionCreate etc.
 * instead of DecompressSequenceBegin etc. */
/*
...
/* For video decompression, consider using ICMDecompressionSessionCreate etc.
 * instead of DecompressSequenceBeginS etc. */
/*
 ...
 */
EXTERN_API(OSErr)
ICMSequenceSetInfo(ImageSequence seqID, OSType which, void *data,
                   Size dataSize);
 ...
 */
EXTERN_API(OSErr)
NewImageGWorld(GWorldPtr *gworld, ImageDescriptionHandle idh,
               GWorldFlags flags);
...
enum {
  kICMPixelFormatIsPlanarMask =
      0x0F, /* these bits in formatFlags indicate how many planes there are;
               they're 0 if chunky*/
...
struct ICMPixelFormatInfo {
  long size; /* caller MUST fill this in with sizeof(ICMPixelFormatInfo) before
                calling ICMGet/SetPixelFormatInfo*/
  unsigned long formatFlags;
  short bitsPerPixel[14]; /* list each plane's bits per pixel separately if
                             planar*/
                          /* new field for QuickTime 4.1*/
  Fixed defaultGammaLevel;
  /* new fields for QuickTime 6.0*/
  short horizontalSubsampling[14]; /* per plane; use 1 if plane is not
                                      subsampled*/
  short
      verticalSubsampling[14]; /* per plane; use 1 if plane is not subsampled*/
...
/* IMPORTANT: Fill in theInfo->size with sizeof(ICMPixelFormatInfo) before
 * calling ICMGetPixelFormatInfo */
/*
 ...
 */
EXTERN_API(OSErr)
SetDSequenceNonScheduledDisplayTime(ImageSequence sequence,
 ...
 */
EXTERN_API(OSErr)
GetDSequenceNonScheduledDisplayTime(ImageSequence sequence,
                                    TimeValue64 *displayTime,
...
enum {
  kQTUsePlatformDefaultGammaLevel =
      0, /* When decompressing into this PixMap, gamma-correct to the platform's
            standard gamma. */
...
enum {
  ...
  kGraphicsImporterDontUseColorMatching =
      1L
      << 3 /* set this flag (*before* calling GraphicsImportGetColorSyncProfile)
...
enum {
  kQTTIFFUserDataPrefix =
      0x74690000, /* Added to some tag values in TIFF IFDs to generate user data
                     codes.  (0x7469 is 'ti'.) */
...
enum {
  ...
  kQTExifUserDataUserComment =
      0x65789286, /* n bytes (Note: this constant was erroneously 0x6578928C)*/
...
/* Note: these were wrong in the QuickTime 6.0 headers -- the high two bytes
 * were 0x677 instead of 0x6770. */
enum {
 ...
 */
EXTERN_API(ComponentResult)
GraphicsImportCreateCGImage(GraphicsImportComponent ci, CGImageRef *imageRefOut,
                            UInt32 flags)
 ...
 */
EXTERN_API(ComponentResult)
GraphicsImportSaveAsPictureToDataRef(GraphicsImportComponent ci, Handle dataRef,
                                     OSType dataRefType)
 ...
 */
EXTERN_API(ComponentResult)
GraphicsImportSaveAsQuickTimeImageFileToDataRef(GraphicsImportComponent ci,
                                                Handle dataRef,
                                                OSType dataRefType)
 ...
 */
EXTERN_API(ComponentResult)
GraphicsImportExportImageFileToDataRef(GraphicsImportComponent ci,
...
EXTERN_API(ComponentResult)
GraphicsImportDoExportImageFileToDataRefDialog(
    GraphicsImportComponent ci, Handle inDataRef, OSType inDataRefType,
    CFStringRef prompt, ModalFilterYDUPP filterProc, OSType *outExportedType,
    Handle *outDataRef, OSType *outDataRefType)
    FIVEWORDINLINE(0x2F3C, 0x001C, 0x0043, 0x7000, 0xA82A);

#if TARGET_API_MAC_OSX
/* NOTE: If the source override ColorSync profile is NULL, then the image's
 * ColorSync profile may be used if available, otherwise a generic ColorSync
 * profile may be used. */
/*
...
/* NOTE: If the destination ColorSync profile is NULL, then a generic ColorSync
 * profile may be used. */
/*
...
EXTERN_API(ComponentResult)
GraphicsImportSetDestinationColorSyncProfileRef(
    GraphicsImportComponent ci, CMProfileRef newDestinationProfileRef)
...
EXTERN_API(ComponentResult)
GraphicsImportGetDestinationColorSyncProfileRef(
    GraphicsImportComponent ci, CMProfileRef *destinationProfileRef)
 ...
 */
EXTERN_API(ComponentResult)
GraphicsImportWillUseColorMatching(GraphicsImportComponent ci,
                                   Boolean *outWillMatch)
    FIVEWORDINLINE(0x2F3C, 0x0004, 0x0048, 0x7000, 0xA82A);

#if TARGET_API_MAC_OSX
/* This convenience API is implemented by the base graphics importer for
 ...
 */
EXTERN_API(ComponentResult)
GraphicsImportGetGenericColorSyncProfile(GraphicsImportComponent ci,
                                         OSType pixelFormat,
                                         void *reservedSetToNULL, UInt32 flags,
                                         Handle *genericColorSyncProfileOut)
    FIVEWORDINLINE(0x2F3C, 0x0010, 0x0049, 0x7000, 0xA82A);

#endif /* TARGET_API_MAC_OSX */

/* Format-specific importers that implement GetColorSyncProfile and that want
   the base graphics importer to automatically support ColorSync matching
   should: (a) implement GraphicsImportSetReturnGenericColorSyncProfile; when it
   is called, set an internal flag (b) change GraphicsImportGetColorSyncProfile
   so that, if this internal flag is set, when the source image file contains a
   profile and the kGraphicsImporterDontUseColorMatching flag is NOT set, it
   returns a generic profile of the appropriate colorspace instead. Other
   importers should *not* implement
   GraphicsImportSetReturnGenericColorSyncProfile. */
/* WARNING: Applications should not call this API; it is internal graphics
   importer plumbing. Set kGraphicsImporterDontUseColorMatching instead. */
/*
 *  GraphicsImportSetReturnGenericColorSyncProfile()
 *
 *  Availability:
...
/* Used for internal communication between the base and format-specific graphics
 * exporter: */
/*
 ...
 */
EXTERN_API(ComponentResult)
GraphicsExportGetInputCGImage(GraphicsExportComponent ci,
 ...
 */
EXTERN_API(ComponentResult)
GraphicsExportSetInputCGBitmapContext(GraphicsExportComponent ci,
 ...
 */
EXTERN_API(ComponentResult)
GraphicsExportGetInputCGBitmapContext(GraphicsExportComponent ci,
...
enum {
  kComponentPropertyClassPropertyInfo =
      FOUR_CHAR_CODE('pnfo'), /* property info class */
                              /* property info property IDs */
  kComponentPropertyInfoList =
      FOUR_CHAR_CODE('list'), /* array of ComponentPropertyInfo (CFData), one
                                 for each property */
  kComponentPropertyCacheSeed =
      FOUR_CHAR_CODE('seed'), /* property cache seed value */
  kComponentPropertyCacheFlags =
      FOUR_CHAR_CODE('flgs'), /* see kComponentPropertyCache flags */
  kComponentPropertyExtendedInfo = FOUR_CHAR_CODE(
      'meta') /* CFDictionary with extended property information*/
};

/* values for kComponentPropertyClassPropertyInfo/kComponentPropertyCacheFlags
 * standard component property */
enum {
  ...
  kComponentPropertyCacheFlagIsDynamic =
      (1L << 1) /* property metadata should not cached at all*/
};
...
typedef CALLBACK_API(void, QTComponentPropertyListenerProcPtr)(
    ComponentInstance inComponent, ComponentPropertyClass inPropClass,
    ComponentPropertyID inPropID, void *inUserData);
typedef STACK_UPP_TYPE(QTComponentPropertyListenerProcPtr)
...
QTGetComponentPropertyInfo(
    ...
    UInt32 *outPropertyFlags) /* can be NULL */ FIVEWORDINLINE(0x2F3C, 0x0014,
                                                               0xFFF5, 0x7000,
                                                               0xA82A);
...
QTGetComponentProperty(
    ...
    ByteCount *outPropValueSizeUsed) /* can be NULL */ FIVEWORDINLINE(0x2F3C,
                                                                      0x0014,
                                                                      0xFFF4,
                                                                      0x7000,
                                                                      0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
QTSetComponentProperty(ComponentInstance inComponent,
...
QTAddComponentPropertyListener(
    ...
    void *inUserData) /* can be NULL */ FIVEWORDINLINE(0x2F3C, 0x0010, 0xFFF2,
                                                       0x7000, 0xA82A);
...
QTRemoveComponentPropertyListener(
    ComponentInstance inComponent, ComponentPropertyClass inPropClass,
    ComponentPropertyID inPropID, QTComponentPropertyListenerUPP inDispatchProc,
    void *inUserData) /* can be NULL */ FIVEWORDINLINE(0x2F3C, 0x0010, 0xFFF1,
                                                       0x7000, 0xA82A);

/* == "QT" prefixed Component Property Listener helpers == */

typedef CFTypeRef QTComponentPropertyListenersRef;
typedef struct QTComponentPropertyListenerCollectionContext
...
typedef STACK_UPP_TYPE(QTComponentPropertyListenerFilterProcPtr)
    QTComponentPropertyListenerFilterUPP;
...
NewQTComponentPropertyListenerUPP(
    QTComponentPropertyListenerProcPtr userRoutine);
#if !OPAQUE_UPP_TYPES
enum {
...
inline DEFINE_API_C(QTComponentPropertyListenerUPP)
  ...
  return (QTComponentPropertyListenerUPP)NewRoutineDescriptor(
      (ProcPtr)(userRoutine), uppQTComponentPropertyListenerProcInfo,
      GetCurrentArchitecture());
}
#else
#define NewQTComponentPropertyListenerUPP(userRoutine)                         \
  (QTComponentPropertyListenerUPP) NewRoutineDescriptor(                       \
      (ProcPtr)(userRoutine), uppQTComponentPropertyListenerProcInfo,          \
      GetCurrentArchitecture())
#endif
#endif
...
NewQTComponentPropertyListenerFilterUPP(
    QTComponentPropertyListenerFilterProcPtr userRoutine);
#if !OPAQUE_UPP_TYPES
enum {
...
inline DEFINE_API_C(QTComponentPropertyListenerFilterUPP)
  ...
  return (QTComponentPropertyListenerFilterUPP)NewRoutineDescriptor(
      (ProcPtr)(userRoutine), uppQTComponentPropertyListenerFilterProcInfo,
      GetCurrentArchitecture());
}
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(void) DisposeQTComponentPropertyListenerUPP(
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(void) DisposeQTComponentPropertyListenerFilterUPP(
    QTComponentPropertyListenerFilterUPP userUPP) {
  DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
}
#else
 ...
 */
EXTERN_API_C(void)
InvokeQTComponentPropertyListenerUPP(ComponentInstance inComponent,
                                     ComponentPropertyClass inPropClass,
                                     ComponentPropertyID inPropID,
                                     void *inUserData,
                                     QTComponentPropertyListenerUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(void) InvokeQTComponentPropertyListenerUPP(
    ComponentInstance inComponent, ComponentPropertyClass inPropClass,
    ComponentPropertyID inPropID, void *inUserData,
    QTComponentPropertyListenerUPP userUPP) {
  CALL_FOUR_PARAMETER_UPP(userUPP, uppQTComponentPropertyListenerProcInfo,
                          inComponent, inPropClass, inPropID, inUserData);
}
#else
#define InvokeQTComponentPropertyListenerUPP(inComponent, inPropClass,         \
                                             inPropID, inUserData, userUPP)    \
  CALL_FOUR_PARAMETER_UPP((userUPP), uppQTComponentPropertyListenerProcInfo,   \
                          (inComponent), (inPropClass), (inPropID),            \
                          (inUserData))
#endif
#endif
...
inline DEFINE_API_C(Boolean) InvokeQTComponentPropertyListenerFilterUPP(
    ...
    const void *inListenerProcRefCon, const void *inFilterProcRefCon,
    QTComponentPropertyListenerFilterUPP userUPP) {
  return (Boolean)CALL_EIGHT_PARAMETER_UPP(
      userUPP, uppQTComponentPropertyListenerFilterProcInfo, inCollection,
...
#define InvokeQTComponentPropertyListenerFilterUPP(                            \
    inCollection, inCollectionContext, inNotifier, inPropClass, inPropID,      \
    inListenerCallbackProc, inListenerProcRefCon, inFilterProcRefCon, userUPP) \
  (Boolean) CALL_EIGHT_PARAMETER_UPP(                                          \
      (userUPP), uppQTComponentPropertyListenerFilterProcInfo, (inCollection), \
      (inCollectionContext), (inNotifier), (inPropClass), (inPropID),          \
      (inListenerCallbackProc), (inListenerProcRefCon), (inFilterProcRefCon))
#endif
...
#if CALL_NOT_IN_CARBON || OLDROUTINENAMES
/* support for pre-Carbon UPP routines: New...Proc and Call...Proc */
#define NewQTComponentPropertyListenerProc(userRoutine)                        \
  NewQTComponentPropertyListenerUPP(userRoutine)
#define NewQTComponentPropertyListenerFilterProc(userRoutine)                  \
  NewQTComponentPropertyListenerFilterUPP(userRoutine)
#define CallQTComponentPropertyListenerProc(userRoutine, inComponent,          \
                                            inPropClass, inPropID, inUserData) \
  InvokeQTComponentPropertyListenerUPP(inComponent, inPropClass, inPropID,     \
                                       inUserData, userRoutine)
#define CallQTComponentPropertyListenerFilterProc(                             \
    userRoutine, inCollection, inCollectionContext, inNotifier, inPropClass,   \
...
EXTERN_API_C(OSStatus)
QTComponentPropertyListenerCollectionNotifyListeners(
    QTComponentPropertyListenersRef inCollection, ComponentInstance inNotifier,
    ComponentPropertyClass inPropClass, ComponentPropertyID inPropID,
...
/* DRM properties*/
enum { kQTPropertyClass_DRM = FOUR_CHAR_CODE('drm ') };
...
enum {
  ...
  kICMImageDescriptionPropertyID_EncodedWidth =
      FOUR_CHAR_CODE('encw'), /* SInt32, Read/Write */
  ...
  kICMImageDescriptionPropertyID_EncodedHeight =
      FOUR_CHAR_CODE('ench'), /* SInt32, Read/Write */
   ...
   */
  kICMImageDescriptionPropertyID_CleanAperture = FOUR_CHAR_CODE(
      'clap'), /* Native-endian CleanApertureImageDescriptionExtension,
                  Read/Write */
   ...
   * returned.
   */
  kICMImageDescriptionPropertyID_PixelAspectRatio = FOUR_CHAR_CODE(
      'pasp'), /* Native-endian PixelAspectRatioImageDescriptionExtension,
                  Read/Write */
  ...
  kICMImageDescriptionPropertyID_CleanApertureDisplayDimensions =
      FOUR_CHAR_CODE('cadi'), /* FixedPoint, Read */
  ...
  kICMImageDescriptionPropertyID_EncodedPixelsDimensions =
      FOUR_CHAR_CODE('endi'), /* FixedPoint, Read */
  ...
  kICMImageDescriptionPropertyID_CleanApertureDisplayWidth =
      FOUR_CHAR_CODE('disw'), /* SInt32, Read */
   ...
   */
  kICMImageDescriptionPropertyID_CleanApertureDisplayHeight =
      FOUR_CHAR_CODE('dish'), /* SInt32, Read */
  ...
  kICMImageDescriptionPropertyID_ProductionApertureDisplayWidth =
      FOUR_CHAR_CODE('pdsw'), /* SInt32, Read */
   ...
   */
  kICMImageDescriptionPropertyID_ProductionApertureDisplayHeight =
      FOUR_CHAR_CODE('pdsh'), /* SInt32, Read */
   ...
   */
  kICMImageDescriptionPropertyID_NCLCColorInfo = FOUR_CHAR_CODE(
      'nclc'), /* Native-endian NCLCColorInfoImageDescriptionExtension,
                  Read/Write */
  ...
  kICMImageDescriptionPropertyID_CGColorSpace =
      FOUR_CHAR_CODE('cgcs'), /* CGColorSpaceRef, Read -- caller of GetProperty
                                 must call CGColorSpaceRelease */
  ...
  kICMImageDescriptionPropertyID_ICCProfile =
      FOUR_CHAR_CODE('iccp'), /* CFDataRef, Read/Write -- caller of GetProperty
                                 must call CFRelease */
  ...
  kICMImageDescriptionPropertyID_GammaLevel =
      FOUR_CHAR_CODE('gama'), /* Fixed, Read/Write */

  /*
   * Information about the number and order of fields, if available.
   */
  kICMImageDescriptionPropertyID_FieldInfo = FOUR_CHAR_CODE(
      'fiel'), /* FieldInfoImageDescriptionExtension2, Read/Write */
  ...
  kICMImageDescriptionPropertyID_RowBytes =
      FOUR_CHAR_CODE('rowb'), /* SInt32, Read/Write */
  ...
  kICMImageDescriptionPropertyID_ClassicTrackWidth =
      FOUR_CHAR_CODE('claw'), /* Fixed, Read */
  ...
  kICMImageDescriptionPropertyID_ClassicTrackHeight =
      FOUR_CHAR_CODE('clah'), /* Fixed, Read */
  ...
  kICMImageDescriptionPropertyID_CleanApertureClipRect =
      FOUR_CHAR_CODE('cacr'), /* FixedRect, Read */
  ...
  kICMImageDescriptionPropertyID_CleanApertureMatrix =
      FOUR_CHAR_CODE('camx'), /* MatrixRecord, Read */
  ...
  kICMImageDescriptionPropertyID_ProductionApertureMatrix =
      FOUR_CHAR_CODE('pamx'), /* MatrixRecord, Read */
   ...
   */
  kICMImageDescriptionPropertyID_SummaryString = FOUR_CHAR_CODE(
      'isum') /* CFStringRef, Read - caller of GetProperty must call CFRelease*/
};
...
EXTERN_API_C(OSStatus)
ICMImageDescriptionGetPropertyInfo(
    ImageDescriptionHandle inDesc, ComponentPropertyClass inPropClass,
    ComponentPropertyID inPropID,
    ComponentValueType *outPropType, /* can be NULL */
    ByteCount *outPropValueSize,     /* can be NULL */
 ...
 */
EXTERN_API_C(OSStatus)
ICMImageDescriptionSetProperty(ImageDescriptionHandle inDesc,
                               ComponentPropertyClass inPropClass,
                               ComponentPropertyID inPropID,
 ...
 */
typedef struct OpaqueICMDecompressionSessionOptions
    *ICMDecompressionSessionOptionsRef;
 ...
 */
typedef struct OpaqueICMDecompressionFrameOptions
    *ICMDecompressionFrameOptionsRef;
...
typedef CALLBACK_API_C(void, ICMDecompressionTrackingCallback)(
    void *decompressionTrackingRefCon, OSStatus result,
...
typedef struct ICMDecompressionTrackingCallbackRecord
    ICMDecompressionTrackingCallbackRecord;
/*
...
EXTERN_API_C(OSStatus)
ICMDecompressionSessionDecodeFrame(
    ICMDecompressionSessionRef session, const UInt8 *data, ByteCount dataSize,
...
EXTERN_API_C(OSStatus)
ICMDecompressionSessionGetPropertyInfo(
    ICMDecompressionSessionRef session, ComponentPropertyClass inPropClass,
    ComponentPropertyID inPropID,
    ComponentValueType *outPropType, /* can be NULL */
    ByteCount *outPropValueSize,     /* can be NULL */
    UInt32 *outPropertyFlags);       /* can be NULL */
 ...
 */
EXTERN_API_C(OSStatus)
ICMDecompressionSessionSetProperty(ICMDecompressionSessionRef session,
                                   ComponentPropertyClass inPropClass,
                                   ComponentPropertyID inPropID,
                                   ByteCount inPropValueSize,
                                   ConstComponentValuePtr inPropValueAddress);
...
enum {
  ...
  kICMDecompressionSessionPropertyID_PixelBufferPool =
      FOUR_CHAR_CODE('pool'), /* CVPixelBufferPoolRef, Read */
  ...
  kICMDecompressionSessionPropertyID_PixelBufferPoolIsShared =
      FOUR_CHAR_CODE('plsh') /* Boolean, Read */
};
...
EXTERN_API_C(OSStatus)
ICMDecompressionSessionSetNonScheduledDisplayTime(
    ICMDecompressionSessionRef session, TimeValue64 displayTime,
    TimeScale displayTimeScale, UInt32 flags);
...
EXTERN_API_C(OSStatus)
ICMDecompressionSessionSetNonScheduledDisplayDirection(
    ICMDecompressionSessionRef session, Fixed rate);
...
enum {
  ...
  kICMDecompressionSessionOptionsPropertyID_Accuracy =
      FOUR_CHAR_CODE('acur'), /* CodecQ, Read/Write */
  ...
  kICMDecompressionSessionOptionsPropertyID_FieldMode =
      FOUR_CHAR_CODE('fiel'), /* ICMFieldMode, Read/Write */
  ...
  kICMDecompressionSessionOptionsPropertyID_MaxBufferCount =
      FOUR_CHAR_CODE('m#bf'), /* UInt32, Read/Write */
  ...
  kICMDecompressionSessionOptionsPropertyID_OutputAheadTime =
      FOUR_CHAR_CODE('futu'), /* TimeRecord, Read/Write */
   ...
   */
  kICMDecompressionSessionOptionsPropertyID_ApertureMode =
      FOUR_CHAR_CODE('apmd') /* OSType, Read/Write */
};
...
EXTERN_API_C(OSStatus)
ICMDecompressionFrameOptionsGetPropertyInfo(
    ICMDecompressionFrameOptionsRef options, ComponentPropertyClass inPropClass,
    ComponentPropertyID inPropID,
    ComponentValueType *outPropType, /* can be NULL */
    ByteCount *outPropValueSize,     /* can be NULL */
    UInt32 *outPropertyFlags);       /* can be NULL */
 ...
 *    session.
 */
typedef struct OpaqueICMCompressionSessionOptions
    *ICMCompressionSessionOptionsRef;
 ...
 */
typedef CALLBACK_API_C(OSStatus, ICMEncodedFrameOutputCallback)(
    void *encodedFrameOutputRefCon, ICMCompressionSessionRef session,
 ...
 *      Reserved for future use.  Ignore the value of this parameter.
 */
typedef CALLBACK_API_C(void, ICMSourceTrackingCallback)(
    void *sourceTrackingRefCon, ICMSourceTrackingFlags sourceTrackingFlags,
...
EXTERN_API_C(OSStatus)
ICMCompressionSessionGetPropertyInfo(
    ICMCompressionSessionRef session, ComponentPropertyClass inPropClass,
    ComponentPropertyID inPropID,
    ComponentValueType *outPropType, /* can be NULL */
    ByteCount *outPropValueSize,     /* can be NULL */
    UInt32 *outPropertyFlags);       /* can be NULL */
 ...
 */
EXTERN_API_C(OSStatus)
ICMCompressionSessionSetProperty(ICMCompressionSessionRef session,
                                 ComponentPropertyClass inPropClass,
                                 ComponentPropertyID inPropID,
                                 ByteCount inPropValueSize,
                                 ConstComponentValuePtr inPropValueAddress);
...
enum {
  ...
  kICMCompressionSessionPropertyID_TimeScale =
      FOUR_CHAR_CODE('tscl'), /* TimeScale, Read */
  ...
  kICMCompressionSessionPropertyID_ImageDescription =
      FOUR_CHAR_CODE('idsc') /* ImageDescriptionHandle, Read */
};
 ...
 */
EXTERN_API_C(OSStatus)
ICMCompressionSessionGetImageDescription(ICMCompressionSessionRef session,
...
EXTERN_API_C(OSStatus)
ICMCompressionSessionEncodeFrame(
    ICMCompressionSessionRef session, CVPixelBufferRef pixelBuffer,
 ...
 */
EXTERN_API_C(OSStatus)
ICMCompressionSessionCompleteFrames(ICMCompressionSessionRef session,
 ...
 */
EXTERN_API_C(OSStatus)
ICMCompressionSessionBeginPass(ICMCompressionSessionRef session,
...
EXTERN_API_C(OSStatus)
ICMCompressionSessionProcessBetweenPasses(
    ICMCompressionSessionRef session, UInt32 flags,
...
EXTERN_API_C(OSStatus)
ICMCompressionSessionOptionsGetPropertyInfo(
    ICMCompressionSessionOptionsRef options, ComponentPropertyClass inPropClass,
    ComponentPropertyID inPropID,
    ComponentValueType *outPropType, /* can be NULL */
    ByteCount *outPropValueSize,     /* can be NULL */
    UInt32 *outPropertyFlags);       /* can be NULL */
...
enum {
  ...
  kICMCompressionSessionOptionsPropertyID_AllowFrameReordering =
      FOUR_CHAR_CODE('b ok'), /* Boolean, Read/Write */
  ...
  kICMCompressionSessionOptionsPropertyID_DurationsNeeded =
      FOUR_CHAR_CODE('need'), /* Boolean, Read/Write */
  ...
  kICMCompressionSessionOptionsPropertyID_MaxKeyFrameInterval =
      FOUR_CHAR_CODE('kyfr'), /* SInt32, Read/Write */
  ...
  kICMCompressionSessionOptionsPropertyID_AllowAsyncCompletion =
      FOUR_CHAR_CODE('asok'), /* Boolean, Read/Write */
  ...
  kICMCompressionSessionOptionsPropertyID_MaxFrameDelayCount =
      FOUR_CHAR_CODE('cwin'), /* SInt32, Read/Write */
  ...
  kICMCompressionSessionOptionsPropertyID_CompressorSettings =
      FOUR_CHAR_CODE('cost'), /* Handle, Read/Write */
  ...
  kICMCompressionSessionOptionsPropertyID_Depth =
      FOUR_CHAR_CODE('deep'), /* UInt32, Read/Write */
  ...
  kICMCompressionSessionOptionsPropertyID_ColorTable =
      FOUR_CHAR_CODE('clut'), /* CTabHandle, Read/Write*/
  ...
  kICMCompressionSessionOptionsPropertyID_Quality =
      FOUR_CHAR_CODE('qual'), /* CodecQ, Read/Write */
  ...
  kICMCompressionSessionOptionsPropertyID_AverageDataRate =
      FOUR_CHAR_CODE('aver'), /* SInt32, Read/Write */
  ...
  kICMCompressionSessionOptionsPropertyID_WasCompressed =
      FOUR_CHAR_CODE('wasc'), /* Boolean, Read/Write */
  ...
  kICMCompressionSessionOptionsPropertyID_CPUTimeBudget =
      FOUR_CHAR_CODE('cput'), /* UInt32, Read/Write */
  ...
  kICMCompressionSessionOptionsPropertyID_SourceFrameCount =
      FOUR_CHAR_CODE('frco'), /* UInt64, Read/Write */
  ...
  kICMCompressionSessionOptionsPropertyID_ExpectedFrameRate =
      FOUR_CHAR_CODE('fran'), /* Fixed, Read/Write */
  ...
  kICMCompressionSessionOptionsPropertyID_ScalingMode =
      FOUR_CHAR_CODE('scam'), /* OSType, Read/Write */
   ...
   */
  kICMCompressionSessionOptionsPropertyID_CleanAperture = FOUR_CHAR_CODE(
      'clap'), /* Native-endian CleanApertureImageDescriptionExtension,
                  Read/Write */
   ...
   * default, this is all zeros, meaning unset.
   */
  kICMCompressionSessionOptionsPropertyID_PixelAspectRatio = FOUR_CHAR_CODE(
      'pasp'), /* Native-endian PixelAspectRatioImageDescriptionExtension,
                  Read/Write */
   ...
   * default, this is all zeros, meaning unset.
   */
  kICMCompressionSessionOptionsPropertyID_FieldInfo = FOUR_CHAR_CODE(
      'fiel'), /* FieldInfoImageDescriptionExtension2, Read/Write */
  ...
  kICMCompressionSessionOptionsPropertyID_SimpleBoundaryConditions =
      FOUR_CHAR_CODE(
          'ends'), /* ICMSimpleBoundaryConditions struct, Read/Write */
...
EXTERN_API_C(OSStatus)
ICMCompressionSessionOptionsSetAllowTemporalCompression(
    ICMCompressionSessionOptionsRef options, Boolean allowTemporalCompression);
...
EXTERN_API_C(OSStatus)
ICMCompressionSessionOptionsSetAllowFrameReordering(
    ICMCompressionSessionOptionsRef options, Boolean allowFrameReordering);
...
EXTERN_API_C(OSStatus)
ICMCompressionSessionOptionsSetDurationsNeeded(
    ICMCompressionSessionOptionsRef options, Boolean decodeDurationsNeeded);
...
EXTERN_API_C(OSStatus)
ICMCompressionSessionOptionsSetMaxKeyFrameInterval(
    ICMCompressionSessionOptionsRef options, SInt32 maxKeyFrameInterval);
...
EXTERN_API_C(OSStatus)
ICMCompressionSessionOptionsSetAllowFrameTimeChanges(
    ICMCompressionSessionOptionsRef options, Boolean allowFrameTimeChanges);
 ...
 */
typedef CALLBACK_API_C(OSStatus, ICMMultiPassSetDataAtTimeStampCallback)(
    void *storageRefCon, TimeValue64 timeStamp, long index, CFDataRef data);
 ...
 */
typedef CALLBACK_API_C(OSStatus, ICMMultiPassGetTimeStampCallback)(
    void *storageRefCon, TimeValue64 fromTimeStamp,
 ...
 */
typedef CALLBACK_API_C(OSStatus, ICMMultiPassCopyDataAtTimeStampCallback)(
    void *storageRefCon, TimeValue64 timeStamp, long index,
...
typedef CALLBACK_API_C(OSStatus,
                       ICMMultiPassReleaseCallback)(void *storageRefCon);
...
enum { kICMMultiPassStorageCallbacksVersionOne = 1 };
...
EXTERN_API_C(OSStatus)
ICMCompressionFrameOptionsGetPropertyInfo(
    ICMCompressionFrameOptionsRef options, ComponentPropertyClass inPropClass,
    ComponentPropertyID inPropID,
    ComponentValueType *outPropType, /* can be NULL */
    ByteCount *outPropValueSize,     /* can be NULL */
    UInt32 *outPropertyFlags);       /* can be NULL */
...
enum {
  ...
  kICMCompressionFrameOptionsPropertyID_ForceKeyFrame =
      FOUR_CHAR_CODE('keyf'), /* Boolean, Read/Write */
  ...
  kICMCompressionFrameOptionsPropertyID_FrameType =
      FOUR_CHAR_CODE('frty') /* ICMFrameType, Read/Write */
};
...
EXTERN_API_C(OSStatus)
ICMCompressionFrameOptionsSetForceKeyFrame(
    ICMCompressionFrameOptionsRef options, Boolean forceKeyFrame);
 ...
 */
EXTERN_API_C(OSStatus)
ICMCompressionFrameOptionsSetFrameType(ICMCompressionFrameOptionsRef options,
 ...
 */
EXTERN_API_C(OSStatus)
ICMEncodedFrameGetImageDescription(ICMEncodedFrameRef frame,
                                   ImageDescriptionHandle *imageDescOut);
 ...
 */
EXTERN_API_C(OSStatus)
ICMEncodedFrameSetValidTimeFlags(ICMMutableEncodedFrameRef frame,
                                 ICMValidTimeFlags validTimeFlags);
 ...
 */
EXTERN_API_C(OSStatus)
ICMEncodedFrameSetDecodeTimeStamp(ICMMutableEncodedFrameRef frame,
 ...
 */
EXTERN_API_C(OSStatus)
ICMEncodedFrameSetDisplayTimeStamp(ICMMutableEncodedFrameRef frame,
 ...
 */
EXTERN_API_C(OSStatus)
ICMEncodedFrameSetDecodeDuration(ICMMutableEncodedFrameRef frame,
 ...
 */
EXTERN_API_C(OSStatus)
ICMEncodedFrameSetDisplayDuration(ICMMutableEncodedFrameRef frame,
 ...
 */
EXTERN_API_C(OSStatus)
ICMEncodedFrameSetMediaSampleFlags(ICMMutableEncodedFrameRef frame,
 ...
 */
EXTERN_API_C(OSStatus)
ICMEncodedFrameSetFrameType(ICMMutableEncodedFrameRef frame,
                            ICMFrameType frameType);
 ...
 */
EXTERN_API_C(OSStatus)
ICMEncodedFrameSetSimilarity(ICMMutableEncodedFrameRef frame,
                             Float32 similarity);
 ...
 */
EXTERN_API_C(OSStatus)
ICMCompressorSessionDropFrame(ICMCompressorSessionRef session,
                              ICMCompressorSourceFrameRef sourceFrame);
...
EXTERN_API_C(OSStatus)
ICMCompressorSessionEmitEncodedFrame(
    ICMCompressorSessionRef session, ICMMutableEncodedFrameRef encodedFrame,
 ...
 */
EXTERN_API_C(OSStatus)
ICMEncodedFrameCreateMutable(ICMCompressorSessionRef session,
                             ICMCompressorSourceFrameRef sourceFrame,
 ...
 */
EXTERN_API_C(OSStatus)
ICMMultiPassStorageSetDataAtTimeStamp(ICMMultiPassStorageRef multiPassStorage,
 ...
 */
EXTERN_API_C(OSStatus)
ICMMultiPassStorageGetTimeStamp(ICMMultiPassStorageRef multiPassStorage,
 ...
 */
EXTERN_API_C(OSStatus)
ICMMultiPassStorageCopyDataAtTimeStamp(ICMMultiPassStorageRef multiPassStorage,
                                       TimeValue64 timeStamp, long index,
                                       CFMutableDataRef *dataOut);
 ...
 */
EXTERN_API_C(OSStatus)
QTVisualContextSetAttribute(QTVisualContextRef visualContext,
 ...
 */
EXTERN_API_C(OSStatus)
QTVisualContextGetAttribute(QTVisualContextRef visualContext,
                            CFStringRef attributeKey,
 ...
 */
typedef CALLBACK_API_C(void, QTVisualContextImageAvailableCallback)(
    QTVisualContextRef visualContext, const CVTimeStamp *timeStamp,
    void *refCon);
/*
 *  QTVisualContextSetImageAvailableCallback()
 *
...
QTVisualContextSetImageAvailableCallback(
    QTVisualContextRef visualContext,
    QTVisualContextImageAvailableCallback
        imageAvailableCallback, /* can be NULL */
 ...
 */
EXTERN_API_C(OSStatus)
QTVisualContextCopyImageForTime(QTVisualContextRef visualContext,
                                CFAllocatorRef allocator,     /* can be NULL */
                                const CVTimeStamp *timeStamp, /* can be NULL */
...
QTDirect3DTextureContextCreate(CFAllocatorRef allocator, /* can be NULL */
                               void *d3dDevice, UInt32 d3dPixelFormat,
                               CFDictionaryRef attributes, /* can be NULL */
                               QTVisualContextRef *newTextureContext);
