 ...
 */
EXTERN_API(OSStatus)
LSCopyKindStringForTypeInfo(OSType inType, OSType inCreator,
 ...
 */
EXTERN_API(OSStatus)
LSCopyApplicationForMIMEType(CFStringRef inMIMEType, LSRolesMask inRoleMask,
                             CFURLRef *outAppURL);
 ...
 */
EXTERN_API(OSStatus)
LSGetApplicationForURL(CFURLRef inURL, LSRolesMask inRoleMask,
                       FSRef *outAppRef,     /* can be NULL */
                       CFURLRef *outAppURL); /* can be NULL */
