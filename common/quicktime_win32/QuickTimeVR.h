...
#ifdef __cplusplus
inline DEFINE_API_C(QTVRLeavingNodeUPP)
    NewQTVRLeavingNodeUPP(QTVRLeavingNodeProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(QTVREnteringNodeUPP)
    NewQTVREnteringNodeUPP(QTVREnteringNodeProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(QTVRMouseOverHotSpotUPP)
    NewQTVRMouseOverHotSpotUPP(QTVRMouseOverHotSpotProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(QTVRImagingCompleteUPP)
    NewQTVRImagingCompleteUPP(QTVRImagingCompleteProcPtr userRoutine) {
...
enum {
  uppQTVRBackBufferImagingProcInfo = 0x0003FBE0
    ...
    */
#ifdef __cplusplus
inline DEFINE_API_C(QTVRBackBufferImagingUPP)
    NewQTVRBackBufferImagingUPP(QTVRBackBufferImagingProcPtr userRoutine) {
...
inline DEFINE_API_C(OSErr)
    InvokeQTVRLeavingNodeUPP(QTVRInstance qtvr, UInt32 fromNodeID,
...
#ifdef __cplusplus
inline DEFINE_API_C(OSErr)
    InvokeQTVRMouseOverHotSpotUPP(QTVRInstance qtvr, UInt32 hotSpotID,
...
#ifdef __cplusplus
inline DEFINE_API_C(QTVRInterceptUPP)
    NewQTVRInterceptUPP(QTVRInterceptProcPtr userRoutine) {
