...
#if TYPE_LONGLONG
#ifdef __cplusplus
inline DEFINE_API_C(SInt64)
    S64Divide(SInt64 dividend, SInt64 divisor, SInt64 *remainder) {
  return ((void)((remainder) && (*((SInt64 *)(remainder)) =
                                     ((SInt64)(dividend) % (SInt64)(divisor)))),
          ((SInt64)(dividend) / (SInt64)(divisor)));
}
#else
#define S64Divide(dividend, divisor, remainder)                                \
  (((void)((remainder) && (*((SInt64 *)(remainder)) =                          \
                               ((SInt64)(dividend) % (SInt64)(divisor)))),     \
    ((SInt64)(dividend) / (SInt64)(divisor))))
#endif
#endif
...
#if TYPE_LONGLONG
#ifdef __cplusplus
inline DEFINE_API_C(UInt64)
    U64Divide(UInt64 dividend, UInt64 divisor, UInt64 *remainder) {
  return ((void)((remainder) && (*((UInt64 *)(remainder)) =
                                     ((UInt64)(dividend) % (UInt64)(divisor)))),
          ((UInt64)(dividend) / (UInt64)(divisor)));
}
#else
#define U64Divide(dividend, divisor, remainder)                                \
  (((void)((remainder) && (*((UInt64 *)(remainder)) =                          \
                               ((UInt64)(dividend) % (UInt64)(divisor)))),     \
    ((UInt64)(dividend) / (UInt64)(divisor))))
#endif
#endif
...
/*
   ...
   WideToSInt64
               ...
               Converts a wide struct into a SInt64.  If SInt64 is implemented
                as a typedef of wide, the macro does nothing. If SInt64 is
                implemented as a long long, it reads the struct into a long
   long.
*/
#if TYPE_LONGLONG
