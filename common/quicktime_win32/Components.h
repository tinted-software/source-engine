/*
     ...
     Copyright:  (c) 2007 (c) 1990-2003 by Apple Computer, Inc., all rights
   reserved
...
/* Note: GetComponentResource returns a Handle, not a resource.  The caller must
 * dispose it with DisposeHandle. */
/*
...
#ifdef __cplusplus
inline DEFINE_API_C(ComponentRoutineUPP)
    NewComponentRoutineUPP(ComponentRoutineProcPtr userRoutine) {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(void) DisposeGetMissingComponentResourceUPP(
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(ComponentResult) InvokeComponentMPWorkFunctionUPP(
    void *globalRefCon, ComponentMPWorkFunctionHeaderRecordPtr header,
    ComponentMPWorkFunctionUPP userUPP) {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(OSErr) InvokeGetMissingComponentResourceUPP(
    Component c, OSType resType, short resID, void *refCon, Handle *resource,
    GetMissingComponentResourceUPP userUPP) {
