...
enum {
  ...
  kHMCFStringLocalizedContent =
      FOUR_CHAR_CODE('cfsl'), /* CFStringRef; name of a localized string.
                                 Supported by Jaguar and later.*/
  kHMPascalStrContent = FOUR_CHAR_CODE('pstr'),
  kHMStringResContent = FOUR_CHAR_CODE('str#'),
  kHMTEHandleContent =
      FOUR_CHAR_CODE('txth'), /* Supported by CarbonLib and Jaguar and later*/
  kHMTextResContent =
      FOUR_CHAR_CODE('text'), /* Supported by CarbonLib and Jaguar and later*/
...
#ifdef __cplusplus
inline DEFINE_API_C(HMControlContentUPP)
    NewHMControlContentUPP(HMControlContentProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(HMWindowContentUPP)
    NewHMWindowContentUPP(HMWindowContentProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(HMMenuTitleContentUPP)
    NewHMMenuTitleContentUPP(HMMenuTitleContentProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(HMMenuItemContentUPP)
    NewHMMenuItemContentUPP(HMMenuItemContentProcPtr userRoutine) {
