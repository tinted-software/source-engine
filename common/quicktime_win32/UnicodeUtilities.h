/*
     ...
     Contains:   Types, constants, prototypes for Unicode Utilities (Unicode
   input and text utils)
...
struct UCKeySequenceDataIndex {
  ...
  /* UCKeySequenceDataIndex to a sequence of UniChars; the next offset indicates
   * the*/
