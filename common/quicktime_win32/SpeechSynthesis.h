...
enum {
  uppSpeechTextDoneProcInfo = 0x0000FFC0
    ...
    */
#ifdef __cplusplus
inline DEFINE_API_C(SpeechTextDoneUPP)
    NewSpeechTextDoneUPP(SpeechTextDoneProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(SpeechDoneUPP)
    NewSpeechDoneUPP(SpeechDoneProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(SpeechSyncUPP)
    NewSpeechSyncUPP(SpeechSyncProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(SpeechErrorUPP)
    NewSpeechErrorUPP(SpeechErrorProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(SpeechPhonemeUPP)
    NewSpeechPhonemeUPP(SpeechPhonemeProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(SpeechWordUPP)
    NewSpeechWordUPP(SpeechWordProcPtr userRoutine) {
...
inline DEFINE_API_C(void)
    InvokeSpeechTextDoneUPP(SpeechChannel chan, long refCon,
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(void) InvokeSpeechDoneUPP(SpeechChannel chan, long refCon,
