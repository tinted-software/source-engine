...
extern CFStringRef
    kWSStreamErrorMessage; /* A CFString (for debug purposes only) */
...
/*
   ...
   CFHTTPMessageRef previously specified.
*/
...
extern CFStringRef kWSSOAPBodyEncodingStyle;  /* CFStringRef { kWSSOAPStyleDoc,
                                                 kWSSOAPStyleRPC } */
...
/*
    ...
    forces the deserializer to alias the named output parameter to
...
WSMethodInvocationCreate(CFURLRef url, CFStringRef methodName,
...
WSMethodInvocationCopyParameters(WSMethodInvocationRef invocation,
                                 CFArrayRef *parameterOrder); /* can be NULL */
 ...
 */
EXTERN_API_C(void)
WSMethodInvocationSetProperty(WSMethodInvocationRef invocation,
...
WSMethodInvocationCopyProperty(WSMethodInvocationRef invocation,
                               CFStringRef propertyName);
...
/*
    These calls implemented the asynchronous variant of the
   WSMethodInvocationInvoke.
...
EXTERN_API_C(void)
WSMethodInvocationAddSerializationOverride(
    WSMethodInvocationRef invocation, CFTypeID objType,
...
typedef CALLBACK_API(CFTypeRef, WSMethodInvocationDeserializationProcPtr)(
    WSMethodInvocationRef invocation, CFXMLTreeRef msgRoot,
...
EXTERN_API_C(void)
WSMethodInvocationAddDeserializationOverride(
    WSMethodInvocationRef invocation, CFStringRef typeNamespace,
