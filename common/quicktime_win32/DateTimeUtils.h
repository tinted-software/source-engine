/*
     ...
     Contains:   International Date and Time Interfaces (previously in
   TextUtils)
...
UCConvertUTCDateTimeToCFAbsoluteTime(const UTCDateTime *iUTCDate,
 ...
 */
EXTERN_API_C(OSStatus)
UCConvertLongDateTimeToCFAbsoluteTime(LongDateTime iLongTime,
                                      CFAbsoluteTime *oCFTime);
 ...
 */
EXTERN_API_C(OSStatus)
UCConvertCFAbsoluteTimeToUTCDateTime(CFAbsoluteTime iCFTime,
 ...
 */
EXTERN_API_C(OSStatus)
UCConvertCFAbsoluteTimeToLongDateTime(CFAbsoluteTime iCFTime,
