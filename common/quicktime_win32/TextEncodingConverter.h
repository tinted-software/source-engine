...
/* fill in an array of type TextEncodingPair passed in by the user with types of
 * encoding pairs the current configuration of the encoder can handle. */
/*
...
/* fill in an array of type TextEncodingPair passed in by the user with types of
 * encodings pairs the current configuration of the encoder can handle. */
/*
