...
enum {
  ...
  errFSQuotaExceeded =
      -1425, /* The user's quota of disk blocks has been exhausted. */
...
enum {
  ...
  rgnTooBigErr =
      -500, /* should have never been added! (cf. rgnTooBigError = 147) */
...
enum {
  ...
  tsmDocPropertyNotFoundErr =
      -2528, /* Requested TSM Document property not found */
  tsmDocPropertyBufferTooSmallErr =
      -2529, /* Buffer passed in for property value is too small */
  tsmCantChangeForcedClassStateErr =
      -2530 /* Enabled state of a TextService class has been forced and cannot
               be changed */
};
...
enum {
  ...
  kQDNoColorHWCursorSupport =
      -3951, /* CGSSystemSupportsColorHardwareCursors() returned false*/
  kQDCursorAlreadyRegistered =
      -3952, /* can be returned from QDRegisterNamedPixMapCursor()*/
  kQDCursorNotRegistered =
      -3953, /* can be returned from QDSetNamedPixMapCursor()*/
...
/*
   kATSUInvalidFontFallbacksErr, which had formerly occupied -8810 has been
   relocated to error code -8900. See below in this range for additional error
   codes.
*/
...
enum {
  kATSUInvalidFontFallbacksErr = -8900, /*    An attempt was made to use a
                                           ATSUFontFallbacks which hadn't */
  /*    been initialized or is otherwise in an invalid state. */
  kATSUUnsupportedStreamFormatErr =
      -8901, /*    An attempt was made to use a ATSUFlattenedDataStreamFormat*/
  /*    which is invalid is not compatible with this version of ATSUI.*/
  kATSUBadStreamErr =
      -8902, /*    An attempt was made to use a stream which is incorrectly*/
             /*    structured, contains bad or out of range values or is*/
             /*    missing required information.*/
  kATSUOutputBufferTooSmallErr = -8903, /*    An attempt was made to use an
                                           output buffer which was too small*/
                                        /*    for the requested operation.*/
  kATSUInvalidCallInsideCallbackErr =
      -8904, /*    A call was made within the context of a callback that could*/
...
enum {
  ...
  themeNoAppropriateBrushErr =
      -30568 /* theme brush has no corresponding theme text color */
};
