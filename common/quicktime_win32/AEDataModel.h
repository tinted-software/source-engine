...
enum {
  ...
  kAEDontExecute = 0x00002000, /* don't send the event for recording - available
                                  only in vers 1.0.1 and greater */
...
#ifdef __cplusplus
inline DEFINE_API_C(AECoerceDescUPP)
    NewAECoerceDescUPP(AECoerceDescProcPtr userRoutine) {
...
enum {
  uppAECoercePtrProcInfo = 0x0003FFE0
    ...
    */
#ifdef __cplusplus
inline DEFINE_API_C(AECoercePtrUPP)
    NewAECoercePtrUPP(AECoercePtrProcPtr userRoutine) {
 ...
 */
EXTERN_API(OSErr)
AECoercePtr(DescType typeCode, const void *dataPtr, Size dataSize,
 ...
 */
EXTERN_API(OSErr)
AECreateDesc(DescType typeCode, const void *dataPtr, Size dataSize,
 ...
 * actual memory copy.
 */
typedef CALLBACK_API(void, AEDisposeExternalProcPtr)(const void *dataPtr,
                                                     Size dataLength,
                                                     long refcon);
...
AECreateDescFromExternalPtr(OSType descriptorType, const void *dataPtr,
                            Size dataLength,
                            AEDisposeExternalUPP disposeCallback,
                            long disposeRefcon, AEDesc *theDesc);
 ...
 */
EXTERN_API(OSErr)
AEPutParamPtr(AppleEvent *theAppleEvent, AEKeyword theAEKeyword,
...
/**************************************************************************
 The following calls are necessary to deal with opaque data in AEDescs, because
 ...
 */
EXTERN_API_C(OSStatus)
AEGetDescDataRange(const AEDesc *dataDesc, void *buffer, Size offset,
                   Size length);
...
#ifdef __cplusplus
inline DEFINE_API_C(AEDisposeExternalUPP)
    NewAEDisposeExternalUPP(AEDisposeExternalProcPtr userRoutine) {
  return (AEDisposeExternalUPP)NewRoutineDescriptor(
      (ProcPtr)(userRoutine), uppAEDisposeExternalProcInfo,
      GetCurrentArchitecture());
}
#else
#define NewAEDisposeExternalUPP(userRoutine)                                   \
  (AEDisposeExternalUPP) NewRoutineDescriptor((ProcPtr)(userRoutine),          \
                                              uppAEDisposeExternalProcInfo,    \
                                              GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
inline DEFINE_API_C(AEEventHandlerUPP)
    NewAEEventHandlerUPP(AEEventHandlerProcPtr userRoutine) {
 ...
 */
EXTERN_API_C(void)
InvokeAEDisposeExternalUPP(const void *dataPtr, Size dataLength, long refcon,
                           AEDisposeExternalUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(void)
    InvokeAEDisposeExternalUPP(const void *dataPtr, Size dataLength,
                               long refcon, AEDisposeExternalUPP userUPP) {
  CALL_THREE_PARAMETER_UPP(userUPP, uppAEDisposeExternalProcInfo, dataPtr,
                           dataLength, refcon);
}
#else
...
#if CALL_NOT_IN_CARBON || OLDROUTINENAMES
/* support for pre-Carbon UPP routines: New...Proc and Call...Proc */
#define NewAEDisposeExternalProc(userRoutine)                                  \
  NewAEDisposeExternalUPP(userRoutine)
