/*
     ...
     Copyright:  (c) 2007 (c) 1998-2001 by Apple Computer, Inc., all rights
   reserved
...
/*
 * SPECIAL AVAILABILITY note: This routine is available in
 * ApplicationsServices.framework in Mac OS X version 10.0 and later. On Mac OS
 * X it is available to CFM applications through CarbonLib starting with Mac OS
 ...
 */
EXTERN_API(OSStatus)
PMSessionBeginPageNoDialog(PMPrintSession printSession, PMPageFormat pageFormat,
...
PMCGImageCreateWithEPSDataProvider(CGDataProviderRef epsDataProvider,
