...
enum {
  uppOSLAccessorProcInfo = 0x000FFFE0
      ...
      4_bytes) */
#ifdef __cplusplus
inline DEFINE_API_C(OSLAccessorUPP)
    NewOSLAccessorUPP(OSLAccessorProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(OSLCompareUPP)
    NewOSLCompareUPP(OSLCompareProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(OSLDisposeTokenUPP)
    NewOSLDisposeTokenUPP(OSLDisposeTokenProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(OSLGetMarkTokenUPP)
    NewOSLGetMarkTokenUPP(OSLGetMarkTokenProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(OSLGetErrDescUPP)
    NewOSLGetErrDescUPP(OSLGetErrDescProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(OSLAdjustMarksUPP)
    NewOSLAdjustMarksUPP(OSLAdjustMarksProcPtr userRoutine) {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(OSErr) InvokeOSLAdjustMarksUPP(long newStart, long newStop,
                                                   const AEDesc *markToken,
                                                   OSLAdjustMarksUPP userUPP) {
