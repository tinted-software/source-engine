...
#ifdef __cplusplus
inline DEFINE_API_C(InitPickMethodUPP)
    NewInitPickMethodUPP(InitPickMethodProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(RecordColorsUPP)
    NewRecordColorsUPP(RecordColorsProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(CalcColorTableUPP)
    NewCalcColorTableUPP(CalcColorTableProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(OSErr)
    InvokeRecordColorsUPP(UInt32 dataRef, RGBColor *colorsArray,
