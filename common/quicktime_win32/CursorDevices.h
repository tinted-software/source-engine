/*
     ...
     Copyright:  (c) 2007 (c) 1993-1999 by Apple Computer, Inc., all rights
   reserved.
...
#ifdef __cplusplus
inline DEFINE_API_C(CursorDeviceCustomButtonUPP) NewCursorDeviceCustomButtonUPP(
    CursorDeviceCustomButtonProcPtr userRoutine) {
