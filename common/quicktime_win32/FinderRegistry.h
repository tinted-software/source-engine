/*
     ...
     Copyright:  (c) 2007 (c) 1991-2001 by Apple Computer, Inc., all rights
   reserved.
...
enum {
  pShowFolderSize =
      FOUR_CHAR_CODE('sfsz'), /* Moved to a per-folder basis in Finder 8.0 HIS*/
  pShowComment =
      FOUR_CHAR_CODE('scom'), /* Moved to a per-folder basis in Finder 8.0 HIS*/
  pShowDate =
      FOUR_CHAR_CODE('sdat'), /* Moved to a per-folder basis in Finder 8.0 HIS*/
  pShowCreationDate =
      FOUR_CHAR_CODE('scda'), /* Moved to a per-folder basis in Finder 8.0 HIS*/
  pShowKind =
      FOUR_CHAR_CODE('sknd'), /* Moved to a per-folder basis in Finder 8.0 HIS*/
  pShowLabel =
      FOUR_CHAR_CODE('slbl'), /* Moved to a per-folder basis in Finder 8.0 HIS*/
  pShowSize =
      FOUR_CHAR_CODE('ssiz'), /* Moved to a per-folder basis in Finder 8.0 HIS*/
  pShowVersion =
      FOUR_CHAR_CODE('svrs'), /* Moved to a per-folder basis in Finder 8.0 HIS*/
  pSortDirection = FOUR_CHAR_CODE('sord'),
  pShowDiskInfo = FOUR_CHAR_CODE('sdin'), /* Always on in Finder 8.0 HIS*/
  pListViewIconSize =
      FOUR_CHAR_CODE('lvis'), /* Moved to a per-folder basis in Finder 8.0 HIS*/
  pGridIcons =
      FOUR_CHAR_CODE('fgrd'), /* Moved to a per-folder basis in Finder 8.0 HIS*/
  pStaggerIcons =
...
enum {
  ...
  /*    pGridIcons                    = 'fgrd',         // defined above for
     Views CP*/
  /*    pStaggerIcons                 = 'fstg',       // defined above for Views
     CP*/
  /*    pViewFont                    = 'vfnt',        // defined above for Views
     CP*/
  /*    pViewFontSize                 = 'vfsz',       // defined above for Views
     CP*/
  pUseRelativeDate =
      FOUR_CHAR_CODE('urdt'), /* Moved to a per-folder basis in Finder 8.0 HIS*/
...
enum {
  /*    pName                      = 'pnam',         // defined in
     AERegistry.r*/
  pFile =
      cFile, /*    pCreatorType                = 'fcrt',      // defined above*/
...
enum {
  ...
  /*    pVersion                    = 'vers',       // defined in AERegistry.r*/
  pViewPreferences =
      FOUR_CHAR_CODE('pvwp'), /*    pVisible                    = 'pvis', //
                                 defined in AERegistry.r*/
