/*
     ...
     Copyright:  (c) 2007 (c) 1990-2001 by Apple Computer, Inc. All rights
   reserved
...
#ifdef __cplusplus
inline DEFINE_API_C(IconActionUPP)
    NewIconActionUPP(IconActionProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(IconGetterUPP)
    NewIconGetterUPP(IconGetterProcPtr userRoutine) {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(Handle)
    InvokeIconGetterUPP(ResType theType, void *yourDataPtr,
