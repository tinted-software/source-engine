/*
     ...
     Copyright:  (c) 2007 (c) 1985-1999 by Apple Computer, Inc., all rights
   reserved
...
#ifdef __cplusplus
inline DEFINE_API_C(ATalkTransitionEventUPP)
    NewATalkTransitionEventUPP(ATalkTransitionEventProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(MPPCompletionUPP)
    NewMPPCompletionUPP(MPPCompletionProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(ATPCompletionUPP)
    NewATPCompletionUPP(ATPCompletionProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(XPPCompletionUPP)
    NewXPPCompletionUPP(XPPCompletionProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(AttnRoutineUPP)
    NewAttnRoutineUPP(AttnRoutineProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(MPPProtocolHandlerUPP)
    NewMPPProtocolHandlerUPP(MPPProtocolHandlerProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(DDPSocketListenerUPP)
    NewDDPSocketListenerUPP(DDPSocketListenerProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(void)
    InvokeAttnRoutineUPP(short sessRefnum, short attnBytes,
...
InvokeDDPSocketListenerUPP(Ptr SCCAddr1, Ptr SCCAddr2, Ptr MPPLocalVars,
    ...
    (!TARGET_OS_MAC || !TARGET_CPU_68K || TARGET_RT_MAC_CFM)
#ifdef __cplusplus
inline DEFINE_API_C(Boolean) InvokeDDPSocketListenerUPP(
