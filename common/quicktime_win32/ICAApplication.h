...
enum {
  kICAProperty = FOUR_CHAR_CODE('prop'), /* */
                                         /*    file properties */
                                         /* */
  /* for images, refer to 'Digital Still Camera Image File Format Standard' Exif
     Version 2.1 section 2.6.4. and 2.6.5.*/
 ...
 */
EXTERN_API(OSErr)
ICAScannerOpenSession(ICAScannerOpenSessionPB *pb,
                      ICACompletion completion); /* can be NULL */
 ...
 */
EXTERN_API(OSErr)
ICAScannerCloseSession(ICAScannerCloseSessionPB *pb,
                       ICACompletion completion); /* can be NULL */
 ...
 */
EXTERN_API(OSErr)
ICAScannerInitialize(ICAScannerInitializePB *pb,
                     ICACompletion completion); /* can be NULL */
 ...
 */
EXTERN_API(OSErr)
ICAScannerGetParameters(ICAScannerGetParametersPB *pb,
                        ICACompletion completion); /* can be NULL */
 ...
 */
EXTERN_API(OSErr)
ICAScannerSetParameters(ICAScannerSetParametersPB *pb,
                        ICACompletion completion); /* can be NULL */
 ...
 */
EXTERN_API(OSErr)
ICAScannerStatus(ICAScannerStatusPB *pb,
                 ICACompletion completion); /* can be NULL */
 ...
 */
EXTERN_API(OSErr)
ICAScannerStart(ICAScannerStartPB *pb,
                ICACompletion completion); /* can be NULL */
