...
#ifdef __cplusplus
inline DEFINE_API_C(CaretHookUPP)
    NewCaretHookUPP(CaretHookProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(WidthHookUPP)
    NewWidthHookUPP(WidthHookProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(TextWidthHookUPP)
    NewTextWidthHookUPP(TextWidthHookProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(NWidthHookUPP)
    NewNWidthHookUPP(NWidthHookProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(HitTestHookUPP)
    NewHitTestHookUPP(HitTestHookProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(TEFindWordUPP)
    NewTEFindWordUPP(TEFindWordProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(TEClickLoopUPP)
    NewTEClickLoopUPP(TEClickLoopProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(WordBreakUPP)
    NewWordBreakUPP(WordBreakProcPtr userRoutine) {
...
inline DEFINE_API_C(Boolean)
    InvokeEOLHookUPP(char theChar, TEPtr pTE, TEHandle hTE,
                     EOLHookUPP userUPP) {
...
inline DEFINE_API_C(unsigned short)
    InvokeNWidthHookUPP(unsigned short styleRunLen,
                        unsigned short styleRunOffset, short slop,
                        short direction, void *textBufferPtr, short *lineStart,
                        TEPtr pTE, TEHandle hTE, NWidthHookUPP userUPP) {
...
inline DEFINE_API_C(Boolean)
    InvokeHitTestHookUPP(unsigned short styleRunLen,
                         unsigned short styleRunOffset, unsigned short slop,
                         void *textBufferPtr, TEPtr pTE, TEHandle hTE,
                         unsigned short *pixelWidth, unsigned short *charOffset,
                         Boolean *pixelInChar, HitTestHookUPP userUPP) {
...
#ifdef __cplusplus
inline DEFINE_API_C(void)
    InvokeTEDoTextUPP(TEPtr pTE, unsigned short firstChar,
                      unsigned short lastChar, short selector,
