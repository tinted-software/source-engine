...
struct CMProfileIterateData {
  ...
  CMProfileMD5 *digest; /* Derived from the RSA Data Security, Inc. MD5
...
#ifdef __cplusplus
inline DEFINE_API_C(CMProfileIterateUPP)
    NewCMProfileIterateUPP(CMProfileIterateProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(CMMIterateUPP)
    NewCMMIterateUPP(CMMIterateProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(OSErr)
    InvokeCMMIterateUPP(CMMInfo *iterateData, void *refCon,
...
/*
  ...
  using the kCMPrefsChangedNotification key. This notification will be sent if
  the user changes ColorSync preferences such as: the default profile by colors
  space, (CMSetDefaultProfileBySpace) the default profile by device useage,
  (CMSetDefaultProfileByUse) or the preferred CMM. See <CMDeviceIntegration.h>
  for more notifications that can be sent.
*/
 ...
 */
EXTERN_API(CMError)
CWMatchHBITMAP(CMWorldRef cw, void *hBitmap, CMBitmapCallBackUPP progressProc,
               void *refCon);
