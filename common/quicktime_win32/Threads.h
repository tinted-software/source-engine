...
#ifdef __cplusplus
inline DEFINE_API_C(ThreadEntryUPP)
    NewThreadEntryUPP(ThreadEntryProcPtr userRoutine) {
  return userRoutine;
}
#else
...
#ifdef __cplusplus
inline DEFINE_API_C(ThreadSchedulerUPP)
    NewThreadSchedulerUPP(ThreadSchedulerProcPtr userRoutine) {
  return userRoutine;
}
#else
...
#ifdef __cplusplus
inline DEFINE_API_C(ThreadSwitchUPP)
    NewThreadSwitchUPP(ThreadSwitchProcPtr userRoutine) {
  return userRoutine;
}
#else
...
#ifdef __cplusplus
inline DEFINE_API_C(ThreadTerminationUPP)
    NewThreadTerminationUPP(ThreadTerminationProcPtr userRoutine) {
  return userRoutine;
}
#else
...
#ifdef __cplusplus
inline DEFINE_API_C(DebuggerNewThreadUPP)
    NewDebuggerNewThreadUPP(DebuggerNewThreadProcPtr userRoutine) {
  return userRoutine;
}
#else
...
#ifdef __cplusplus
inline DEFINE_API_C(DebuggerDisposeThreadUPP)
    NewDebuggerDisposeThreadUPP(DebuggerDisposeThreadProcPtr userRoutine) {
  return userRoutine;
}
#else
...
inline DEFINE_API_C(void)
    DisposeDebuggerDisposeThreadUPP(DebuggerDisposeThreadUPP) {}
#else
...
#ifdef __cplusplus
inline DEFINE_API_C(void)
    DisposeDebuggerThreadSchedulerUPP(DebuggerThreadSchedulerUPP) {}
#else
