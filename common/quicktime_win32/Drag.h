/*
     ...
     Copyright:  (c) 2007 (c) 1992-2001 by Apple Computer, Inc., all rights
   reserved.
...
enum {
  ...
  kFlavorTypeUnicodeClippingName = FOUR_CHAR_CODE(
      'ucln'), /* unicode name hint for clipping file (preferred over 'uclf')*/
  kFlavorTypeUnicodeClippingFilename =
      FOUR_CHAR_CODE('uclf'), /* unicode name for clipping file*/
...
#ifdef __cplusplus
inline DEFINE_API_C(DragTrackingHandlerUPP)
    NewDragTrackingHandlerUPP(DragTrackingHandlerProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(DragReceiveHandlerUPP)
    NewDragReceiveHandlerUPP(DragReceiveHandlerProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(DragSendDataUPP)
    NewDragSendDataUPP(DragSendDataProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(DragInputUPP)
    NewDragInputUPP(DragInputProcPtr userRoutine) {
...
enum {
  uppDragDrawingProcInfo = 0x000FFFA0
      ...
      4_bytes) */
#ifdef __cplusplus
inline DEFINE_API_C(DragDrawingUPP)
    NewDragDrawingUPP(DragDrawingProcPtr userRoutine) {
...
inline DEFINE_API_C(OSErr)
    InvokeDragDrawingUPP(DragRegionMessage message, RgnHandle showRegion,
                         Point showOrigin, RgnHandle hideRegion,
                         Point hideOrigin, void *dragDrawingRefCon,
                         DragRef theDrag, DragDrawingUPP userUPP) {
...
SetDragImageWithCGImage(DragRef inDrag, CGImageRef inCGImage,
 ...
 */
EXTERN_API_C(OSStatus)
GetStandardDropLocation(DragRef theDrag, StandardDropLocation *outDropLocation)
    TWOWORDINLINE(0x7017, 0xABED);
 ...
 */
EXTERN_API_C(OSStatus)
SetStandardDropLocation(DragRef theDrag, StandardDropLocation dropLocation)
    TWOWORDINLINE(0x7018, 0xABED);
