...
/*!
    ...
    @discussion On Mac OS X, the host time base for CoreVideo and CoreAudio are
   identical, and the values returned from either API may be used
   interchangeably.
    @result     The current host time.
*/
extern uint64_t
CVGetCurrentHostTime() AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
extern double
CVGetHostClockFrequency() AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
extern uint32_t
CVGetHostClockMinimumTimeDelta() AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
