...
enum {
  ...
  kQTSInfo_Authentication =
      FOUR_CHAR_CODE('auup'), /* QTSAuthenticationParams */
...
enum {
  ...
  kQTSInstantOnFlag_Permitted =
      (1L << 1) /* instant on is possible (read only)*/
};
...
enum {
  ...
  kQTSSOCKSProxyPrefsType =
      FOUR_CHAR_CODE('sock'), /*     socks proxy settings*/
...
#ifdef __cplusplus
inline DEFINE_API_C(QTSNotificationUPP)
    NewQTSNotificationUPP(QTSNotificationProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(QTSPanelFilterUPP)
    NewQTSPanelFilterUPP(QTSPanelFilterProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(QTSModalFilterUPP)
    NewQTSModalFilterUPP(QTSModalFilterProcPtr userRoutine) {
