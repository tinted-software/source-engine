...
#ifdef __cplusplus
inline DEFINE_API_C(AENCallbackUPP)
    NewAENCallbackUPP(AENCallbackProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(SIMActionUPP)
    NewSIMActionUPP(SIMActionProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(SCSIMakeCallbackUPP)
    NewSCSIMakeCallbackUPP(SCSIMakeCallbackProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(SCSIInterruptPollUPP)
    NewSCSIInterruptPollUPP(SCSIInterruptPollProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(SCSIInterruptUPP)
    NewSCSIInterruptUPP(SCSIInterruptProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(SCSICallbackUPP)
    NewSCSICallbackUPP(SCSICallbackProcPtr userRoutine) {
