...
#ifdef __cplusplus
inline DEFINE_API_C(TSMTEPreUpdateUPP)
    NewTSMTEPreUpdateUPP(TSMTEPreUpdateProcPtr userRoutine) {
...
enum {
  uppTSMTEPostUpdateProcInfo = 0x000FFFC0
      ...
      4_bytes, 4_bytes) */
#ifdef __cplusplus
inline DEFINE_API_C(TSMTEPostUpdateUPP)
    NewTSMTEPostUpdateUPP(TSMTEPostUpdateProcPtr userRoutine) {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(void) InvokeTSMTEPreUpdateUPP(TEHandle textH, long refCon,
