...
HIObjectRegisterSubclass(CFStringRef inClassID, CFStringRef inBaseClassID,
                         OptionBits inOptions, EventHandlerUPP inConstructProc,
 ...
 */
EXTERN_API_C(OSStatus)
HIObjectCreate(CFStringRef inClassID, EventRef inConstructData,
