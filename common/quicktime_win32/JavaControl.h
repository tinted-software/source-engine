...
enum {
  ...
  errJavaEmbeddingIntializationFailed =
      -9962, /* previously errClassConstructorNotFound, errClassNotFound, and
                errMethodNotFound*/
  errJavaEmbeddingMissingURL = -9955, /* previously errMissingURL*/
  errJavaEmbeddingCouldNotCreateApplet =
      -9956, /* previously errCouldNotCreateApplet*/
  errJavaEmbeddingCouldNotEmbedFrame =
      -9957, /* previously errCouldNotEmbedFrame   */
  errJavaEmbeddingCouldNotConvertURL =
      -9958,                         /* previously errCouldNotConvertURL*/
  errJavaEmbeddingNotAFrame = -9959, /* previously errNotAFrame*/
  errJavaEmbeddingControlNotEmbedded =
      -9960,                               /* previously errControlNotEmbedded*/
...
MoveAndClipJavaControl(JNIEnv *env, ControlRef theControl, int posX, int posY,
 ...
 */
EXTERN_API_C(OSStatus)
GetJavaWindowFromWindow(JNIEnv *env, WindowRef inMacWindow,
 ...
 */
EXTERN_API_C(OSStatus)
GetWindowFromJavaWindow(JNIEnv *env, jobject inJavaWindow,
 ...
 */
EXTERN_API_C(OSStatus)
GetJavaFrameFromControl(JNIEnv *env, ControlRef inMacControl,
 ...
 */
EXTERN_API_C(OSStatus)
GetControlFromJavaFrame(JNIEnv *env, jobject inJavaFrame,
 ...
 */
EXTERN_API_C(OSStatus)
CreateJavaControl(JNIEnv *env, WindowRef inNativeWindow, const Rect *inBounds,
                  jobject inAppletFrame, Boolean inVisible,
