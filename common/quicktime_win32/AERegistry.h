...
enum {
  ...
  typeISO8601DateTime = FOUR_CHAR_CODE(
      'isot'), /*  0x69736f74  data is ascii text of an ISO8601 date */
...
enum {
  ...
  keyAETextServiceEncoding = FOUR_CHAR_CODE(
      'tsen'), /* Text Service encoding, mac or Unicode in UpdateActiveInputArea
                  or GetSelectedText events. */
  ...
  typeGlyphInfoArray = FOUR_CHAR_CODE(
      'glia'), /* Glyph/FMFont info array for sub ranges of Unicode text.  See
                  GlyphInfoArray in TextServices.h  */
...
enum {
  ...
  keyAERegionClass = FOUR_CHAR_CODE(
      'rgnc'), /* typeShortInteger for System 7, typeRegionClass for System 8 */
