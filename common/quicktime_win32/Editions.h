/*
     ...
     Copyright:  (c) 2007 (c) 1989-1999 by Apple Computer, Inc., all rights
   reserved
...
typedef CALLBACK_API(Boolean, ExpModalFilterProcPtr)(DialogPtr theDialog,
...
#ifdef __cplusplus
inline DEFINE_API_C(ExpModalFilterUPP)
    NewExpModalFilterUPP(ExpModalFilterProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(ExpDlgHookUPP)
    NewExpDlgHookUPP(ExpDlgHookProcPtr userRoutine) {
...
InvokeExpModalFilterUPP(DialogPtr theDialog, EventRecord *theEvent,
 ...
 */
EXTERN_API_C(short)
InvokeExpDlgHookUPP(short itemOffset, short itemHit, DialogPtr theDialog,
...
#ifdef __cplusplus
inline DEFINE_API_C(EditionOpenerUPP)
    NewEditionOpenerUPP(EditionOpenerProcPtr userRoutine) {
