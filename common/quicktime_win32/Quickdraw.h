/*
     ...
     Copyright:  (c) 2007 (c) 1985-2003 by Apple Computer, Inc., all rights
   reserved
...
#ifdef __cplusplus
inline DEFINE_API_C(QDCommentUPP)
    NewQDCommentUPP(QDCommentProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(QDStdGlyphsUPP)
    NewQDStdGlyphsUPP(QDStdGlyphsProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(QDJShieldCursorUPP)
    NewQDJShieldCursorUPP(QDJShieldCursorProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(void)
    InvokeQDTextUPP(short byteCount, const void *textBuf, Point numer,
...
#ifdef __cplusplus
inline DEFINE_API_C(void)
    InvokeQDArcUPP(GrafVerb verb, const Rect *r, short startAngle,
...
#ifdef __cplusplus
inline DEFINE_API_C(void)
    InvokeQDBitsUPP(const BitMap *srcBits, const Rect *srcRect,
...
#ifdef __cplusplus
inline DEFINE_API_C(void)
    InvokeQDPutPicUPP(const void *dataPtr, short byteCount,
                      QDPutPicUPP userUPP) {
...
inline DEFINE_API_C(OSStatus)
    InvokeQDStdGlyphsUPP(void *dataStream, ByteCount size,
...
#ifdef __cplusplus
inline DEFINE_API_C(DragGrayRgnUPP)
    NewDragGrayRgnUPP(DragGrayRgnProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(ColorSearchUPP)
    NewColorSearchUPP(ColorSearchProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(ColorComplementUPP)
    NewColorComplementUPP(ColorComplementProcPtr userRoutine) {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(Boolean) InvokeColorSearchUPP(RGBColor *rgb, long *position,
...
#ifdef __cplusplus
inline DEFINE_API_C(QDPrinterStatusUPP)
    NewQDPrinterStatusUPP(QDPrinterStatusProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(DeviceLoopDrawingUPP)
    NewDeviceLoopDrawingUPP(DeviceLoopDrawingProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(RegionToRectsUPP)
    NewRegionToRectsUPP(RegionToRectsProcPtr userRoutine) {
 ...
 */
EXTERN_API_C(OSStatus)
QDRegisterNamedPixMapCursor(PixMapHandle crsrData, PixMapHandle crsrMask,
                            Point hotSpot, const char name[128]);
...
enum {
  kQDUseDefaultTextRendering =
      0, /* Sets whatever is specified in system defaults.*/
  ...
  kQDDontChangeFlags = (long)0xFFFFFFFF /* to request the current state, without
                                           changing anything*/
};
