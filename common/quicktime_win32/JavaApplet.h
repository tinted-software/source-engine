...
/*
    kUniqueArena is the value to pass to CreateJavaApplet if you want the applet
   to be created in a unique arena. A unique arena is one which is guaranteed
   not to be shared with any other applet running in this Java VM. This is the
   appropriate default value to pass to CreateJavaApplet.
*/
 ...
 */
typedef CALLBACK_API_C(void, JE_ShowDocumentCallback)(jobject applet,
                                                      CFURLRef url,
 ...
 */
typedef CALLBACK_API_C(void, JE_SetStatusCallback)(jobject applet,
 ...
 */
EXTERN_API_C(OSStatus)
CreateJavaApplet(JNIEnv *env, AppletDescriptor applet, Boolean trusted,
 ...
 */
EXTERN_API_C(OSStatus)
RegisterStatusCallback(JNIEnv *env, jobject inJavaFrame,
                       JE_SetStatusCallback showStatusFunction, void *userData);
 ...
 */
EXTERN_API_C(OSStatus)
RegisterShowDocumentCallback(JNIEnv *env, jobject inJavaFrame,
