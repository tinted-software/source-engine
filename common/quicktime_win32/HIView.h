/*
     ...
     Copyright:  (c) 2007 (c) 2001-2002 by Apple Computer, Inc., all rights
   reserved.
 ...
 */
EXTERN_API_C(OSStatus)
HIViewSetZOrder(HIViewRef inView, HIViewZOrderOp inOp,
 ...
 */
EXTERN_API_C(OSStatus)
HIViewGetViewForMouseEvent(HIViewRef inView, EventRef inEvent,
                           HIViewRef *outView);
 ...
 */
EXTERN_API_C(OSStatus)
HIViewSimulateClick(HIViewRef inView, HIViewPartCode inPartToClick,
                    UInt32 inModifiers, ControlPartCode *outPartClicked);
 ...
 */
EXTERN_API_C(OSStatus)
HIViewGetPartHit(HIViewRef inView, const HIPoint *inPoint,
 ...
 */
EXTERN_API_C(OSStatus)
HIViewGetSubviewHit(HIViewRef inView, const HIPoint *inPoint, Boolean inDeep,
                    HIViewRef *outView);
 ...
 */
EXTERN_API_C(OSStatus)
HIViewSetNeedsDisplayInRegion(HIViewRef inView, RgnHandle inRgn,
 ...
 */
EXTERN_API_C(OSStatus)
HIViewGetSizeConstraints(HIViewRef inView, HISize *outMinSize,
                         HISize *outMaxSize);
 ...
 */
EXTERN_API_C(OSStatus)
HIViewConvertPoint(HIPoint *ioPoint, HIViewRef inSourceView,
 ...
 */
EXTERN_API_C(OSStatus)
HIViewConvertRegion(RgnHandle ioRgn, HIViewRef inSourceView,
                    HIViewRef inDestView);
 ...
 */
EXTERN_API_C(OSStatus)
HIViewSetFirstSubViewFocus(HIViewRef inParent,
 ...
 */
EXTERN_API_C(OSStatus)
HIViewChangeAttributes(HIViewRef inView, OptionBits inAttrsToSet,
 ...
 */
EXTERN_API_C(OSStatus)
HIViewCreateOffscreenImage(HIViewRef inView, OptionBits inOptions,
 ...
 */
EXTERN_API_C(OSStatus)
HIViewDrawCGImage(CGContextRef inContext, const HIRect *inBounds,
                  CGImageRef inImage);
...
/*  HIScrollView */
/*==============================================================================*/
enum { kEventClassScrollable = FOUR_CHAR_CODE('scrl') };
...
enum {
  kHIImageViewImageTag = FOUR_CHAR_CODE(
      'imag') /* CGImageRef (THIS TAG IS GOING AWAY!!! USE THE APIS BELOW!)*/
};
...
enum {
  ...
  kHIComboBoxStandardAttributes =
      (kHIComboBoxAutoCompletionAttribute | kHIComboBoxAutoDisclosureAttribute |
       kHIComboBoxAutoSizeListAttribute)
};

/* ControlKind*/
enum { kControlKindHIComboBox = FOUR_CHAR_CODE('cbbx') };

/* ComboBox Part codes*/
enum { kHIComboBoxEditTextPart = 5, kHIComboBoxDisclosurePart = 28 };
...
enum {
   ...
   */
  kHIComboBoxListTag = FOUR_CHAR_CODE(
      'cbls'), /* CFArrayRef; bumps the refCount on get/retains on set*/
 ...
 */
EXTERN_API_C(OSStatus)
HIComboBoxInsertTextItemAtIndex(HIViewRef inComboBox, CFIndex inIndex,
                                CFStringRef inText);
 ...
 */
EXTERN_API_C(OSStatus)
HIComboBoxAppendTextItem(HIViewRef inComboBox, CFStringRef inText,
 ...
 */
EXTERN_API_C(OSStatus)
HIComboBoxCopyTextItemAtIndex(HIViewRef inComboBox, CFIndex inIndex,
 ...
 */
EXTERN_API_C(OSStatus)
HIComboBoxChangeAttributes(HIViewRef inComboBox, OptionBits inAttributesToSet,
