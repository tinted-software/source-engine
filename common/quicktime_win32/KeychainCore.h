...
enum {
  ...
  kIssuerKCItemAttr =
      FOUR_CHAR_CODE('issu'), /* Issuer distinguished name (DER-encoded data) */
  kSerialNumberKCItemAttr =
      FOUR_CHAR_CODE('snbr'), /* Certificate serial number (DER-encoded data) */
  kEMailKCItemAttr =
...
#ifdef __cplusplus
inline DEFINE_API_C(KCCallbackUPP)
    NewKCCallbackUPP(KCCallbackProcPtr userRoutine) {
