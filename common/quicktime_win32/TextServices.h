...
enum {
  kTextService =
      FOUR_CHAR_CODE('tsvc'), /* component type for the component description */
...
enum {
  kTSMDocumentPropertySupportGlyphInfo =
      FOUR_CHAR_CODE('dpgi') /*  property value is arbitrary*/
};
...
struct ScriptLanguageSupport {
  short fScriptLanguageCount; /* number of entries in the 'fScriptLanguageArray'
                                 array */
 ...
 */
EXTERN_API(OSStatus)
GetDefaultInputMethodOfClass(Component *aComp, ScriptLanguageRecord *slRecPtr,
 ...
 */
EXTERN_API(OSStatus)
SetDefaultInputMethodOfClass(Component aComp, ScriptLanguageRecord *slRecPtr,
                             TextServiceClass tsClass);
 ...
 */
EXTERN_API(OSStatus)
TSMSetDocumentProperty(TSMDocumentID docID, OSType propertyTag,
                       UInt32 propertySize, void *propertyData);
 ...
 */
EXTERN_API(OSStatus)
TSMGetDocumentProperty(TSMDocumentID docID, OSType propertyTag,
                       UInt32 bufferSize, UInt32 *actualSize,
...
#if OLDROUTINENAMES
enum { kInputMethodService = kKeyboardInputMethodClass };
