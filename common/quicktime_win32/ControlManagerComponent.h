/*
     ...
     Copyright:  (c) 2007 (c) 1990-2002 by Apple Computer, Inc., all rights
   reserved
...
CTRLGetCookie(ComponentInstance ctrl, void *cookie)
 ...
 */
EXTERN_API(ComponentResult)
CTRLSetCookie(ComponentInstance ctrl, long cookie)
 ...
 */
EXTERN_API(ComponentResult)
CTRLCreate(ComponentInstance ctrl, ControlHandle hControl)
 ...
 */
EXTERN_API(ComponentResult)
CTRLHaveFocus(ComponentInstance ctrl, short *haveFocus)
 ...
 */
EXTERN_API(ComponentResult)
CTRLSetText(ComponentInstance ctrl, StringPtr str)
 ...
 */
EXTERN_API(ComponentResult)
CTRLGetText(ComponentInstance ctrl, StringPtr str)
 ...
 */
EXTERN_API(ComponentResult)
CTRLSetDefaultItem(ComponentInstance ctrl)
 ...
 */
EXTERN_API(ComponentResult)
CTRLTrackControl(ComponentInstance ctrl, ControlHandle hControl, Point localPt,
 ...
 */
EXTERN_API(ComponentResult)
CTRLSetFocus(ComponentInstance ctrl, ControlHandle hControl)
 ...
 */
EXTERN_API(ComponentResult)
CTRLSetControlData(ComponentInstance ctrl, ControlHandle hControl,
                   ControlPartCode part, ResType tagName, Size size, Ptr data)
    FIVEWORDINLINE(0x2F3C, 0x0012, 0x001B, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
CTRLGetControlData(ComponentInstance ctrl, ControlHandle hControl,
                   ControlPartCode part, ResType tagName, Size bufferSize,
                   Ptr buffer, Size *actualSize)
