...
enum { kEmptyPurgableChunksOverAllowance = 1 };
 ...
 */
EXTERN_API(ComponentResult)
MediaGetChunkManagementFlags(MediaHandler mh, UInt32 *flags)
    FIVEWORDINLINE(0x2F3C, 0x0004, 0x0416, 0x7000, 0xA82A);
...
MediaEmptyAllPurgeableChunks(MediaHandler mh)
    FIVEWORDINLINE(0x2F3C, 0x0000, 0x0419, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
MediaRefConSetProperty(MediaHandler mh, long refCon, long propertyType,
                       void *propertyValue)
 ...
 */
EXTERN_API(ComponentResult)
MediaRefConGetProperty(MediaHandler mh, long refCon, long propertyType,
                       void *propertyValue)
...
MediaGGetIdleManager(MediaHandler mh, IdleManager *pim)
    FIVEWORDINLINE(0x2F3C, 0x0004, 0x056C, 0x7000, 0xA82A);
...
MediaGSetIdleManager(MediaHandler mh, IdleManager im)
    FIVEWORDINLINE(0x2F3C, 0x0004, 0x056D, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
MediaGGetLatency(MediaHandler mh, TimeRecord *latency)
    FIVEWORDINLINE(0x2F3C, 0x0004, 0x0571, 0x7000, 0xA82A);
...
EXTERN_API(ComponentResult)
MediaSetTrackApertureModeDimensionsUsingSampleDescription(
    MediaHandler mh, SampleDescriptionHandle sampleDesc)
...
EXTERN_API(ComponentResult)
MediaGetApertureModeClipRectForSampleDescriptionIndex(
    MediaHandler mh, long sampleDescIndex, FixedRect *clipFixedRectOut)
 ...
 */
EXTERN_API(ComponentResult)
MediaGetApertureModeMatrixForSampleDescriptionIndex(MediaHandler mh,
 ...
 */
EXTERN_API(ComponentResult)
MediaGenerateApertureModeDimensions(MediaHandler mh)
    FIVEWORDINLINE(0x2F3C, 0x0000, 0x057C, 0x7000, 0xA82A);
...
#ifdef __cplusplus
inline DEFINE_API_C(PrePrerollCompleteUPP)
    NewPrePrerollCompleteUPP(PrePrerollCompleteProcPtr userRoutine) {
