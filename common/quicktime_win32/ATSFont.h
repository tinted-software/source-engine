/*
     ...
     Contains:   Public interface to the font access and data management
   functions of ATS.

     Version:    QuickTime 7.3

     Copyright:  (c) 2007 (C) 2000-2002 by Apple Computer, Inc., all rights
   reserved.
...
enum {
  kATSOptionFlagsDoNotNotify =
      0x00000001 << 8, /* Do not notify after global activation/deactivation */
  kATSOptionFlagsIterationScopeMask =
      0x00000007 << 12, /* Mask option bits 12-14 for iteration scopes */
...
enum { kATSOptionFlagsIterateByPrecedenceMask = 0x00000001 << 5 };
...
typedef CALLBACK_API_C(void,
                       ATSNotificationCallback)(ATSFontNotificationInfoRef info,
                                                void *refCon);
/* -----------------------------------------------------------------------------------------
 */
/* Font container */
...
EXTERN_API_C(OSStatus)
ATSFontNotificationSubscribe(
    ATSNotificationCallback callback, ATSFontNotifyOption options,
 ...
 */
typedef CALLBACK_API_C(CFPropertyListRef,
                       ATSFontQueryCallback)(ATSFontQueryMessageID msgid,
...
ATSCreateFontQueryRunLoopSource(
    CFIndex queryOrder, CFIndex sourceOrder, ATSFontQueryCallback callout,
