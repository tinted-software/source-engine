...
#ifdef __cplusplus
inline DEFINE_API_C(ControlUserPaneDrawUPP)
    NewControlUserPaneDrawUPP(ControlUserPaneDrawProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(ControlUserPaneIdleUPP)
    NewControlUserPaneIdleUPP(ControlUserPaneIdleProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(ControlUserPaneFocusUPP)
    NewControlUserPaneFocusUPP(ControlUserPaneFocusProcPtr userRoutine) {
...
enum {
  ...
  kControlEditTextSelectionTag =
      FOUR_CHAR_CODE('sele'), /* ControlEditTextSelectionRec*/
...
enum { kControlEditTextSingleLineTag = FOUR_CHAR_CODE('sglc') };
