...
#ifdef __cplusplus
inline DEFINE_API_C(ControlActionUPP)
    NewControlActionUPP(ControlActionProcPtr userRoutine) {
...
/*  o Activate/DoNotActivate indicates whether or not to change the owning
...
/*  o Ignore/Handle Click indicates whether or not to call an appropriate click
 * handling API (like      */
...
#ifdef __cplusplus
inline DEFINE_API_C(ControlDefUPP)
    NewControlDefUPP(ControlDefProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(ControlKeyFilterUPP)
    NewControlKeyFilterUPP(ControlKeyFilterProcPtr userRoutine) {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline DEFINE_API_C(OSStatus) InvokeControlCNTLToCollectionUPP(
    const Rect *bounds, SInt16 value, Boolean visible, SInt16 max, SInt16 min,
...
#ifdef __cplusplus
inline DEFINE_API_C(ControlColorUPP)
    NewControlColorUPP(ControlColorProcPtr userRoutine) {
...
/* NOTE: Passing NULL for the outPart parameter of FindControlUnderMouse is
 * only*/
...
EXTERN_API(ControlRef)
FindControlUnderMouse(
    Point inWhere, WindowRef inWindow,
    ControlPartCode *outPart) /* can be NULL */ THREEWORDINLINE(0x303C, 0x0009,
                                                                0xAA73);
...
GetControlProperty(ControlRef control, OSType propertyCreator,
                   OSType propertyTag, UInt32 bufferSize,
...
GetControlData(ControlRef inControl, ControlPartCode inPart, ResType inTagName,
               Size inBufferSize, void *inBuffer,
               Size *outActualSize) /* can be NULL */ THREEWORDINLINE(0x303C,
                                                                      0x0013,
                                                                      0xAA73);
 ...
 */
EXTERN_API(OSStatus)
SetAutomaticControlDragTrackingEnabledForWindow(WindowRef inWindow,
                                                Boolean inTracks);
 ...
 */
EXTERN_API(OSStatus)
IsAutomaticControlDragTrackingEnabledForWindow(WindowRef inWindow,
                                               Boolean *outTracks);
