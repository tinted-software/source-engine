/*
     ...
     Copyright:  (c) 2007 (c) 1995-2001 by Apple Computer, Inc., all rights
   reserved.
...
enum {
  ...
  /* Folder Domains - Carbon only.  The constants above can continue to be used,
     but the folder/volume returned will*/
...
enum {
  ...
  kDesktopFolderType =
      FOUR_CHAR_CODE('desk'), /* the desktop folder; objects in this folder show
                                 on the desk top. */
...
enum {
  ...
  kOpenDocEditorsFolderType =
      0xC46F6466, /* OpenDoc subfolder of Editors folder */
  kOpenDocLibrariesFolderType =
      FOUR_CHAR_CODE('odlb'), /* OpenDoc libraries folder */
  kGenEditorsFolderType =
      0xC4656469, /* CKH general editors folder at root level of Sys folder */
  kHelpFolderType =
      0xC4686C70, /* CKH help folder currently at root of system folder */
  kInternetPlugInFolderType =
      0xC46E6574, /* CKH internet plug ins for browsers and stuff */
  kModemScriptsFolderType =
      0xC46D6F64, /* CKH modem scripts, get 'em OUT of the Extensions folder */
  kPrinterDescriptionFolderType = FOUR_CHAR_CODE(
      'ppdf'), /* CKH new folder at root of System folder for printer descs. */
  kPrinterDriverFolderType = 0xC4707264, /* CKH new folder at root of System
                                            folder for printer drivers */
  ...
  kAssistantsFolderType =
      0x617374C4, /* SJF for Assistants (MacOS Setup Assistant, etc) */
  ...
  kColorSyncProfilesFolderType =
      FOUR_CHAR_CODE('prof'),                 /* for ColorSync(tm) Profiles */
  ...
  kInternetFolderType =
      0x696E74C4, /* Internet folder (root level of startup volume) */
  ...
  kDesktopPicturesFolderType =
      0x647470C4, /* Desktop Pictures folder (in Appearance folder) */
...
enum {
  ...
  kMusicDocumentsFolderType =
      0xB5646F63, /* Refers to the "Music" folder in a users home directory*/
  ...
  kAudioComponentsFolderType =
      FOUR_CHAR_CODE('acmp'), /* Refers to the Components subfolder of the Audio
                                 Plug-ins Folder    */
  ...
  kKeyboardLayoutsFolderType =
      FOUR_CHAR_CODE('klay'), /* Refers to the [domain]/Library/KeyboardLayouts
                                 folder in Mac OS X*/
  kIndexFilesFolderType = FOUR_CHAR_CODE(
      'indx'), /* Refers to the [domain]/Library/Indexes folder in Mac OS X*/
  kFindByContentIndexesFolderType = FOUR_CHAR_CODE(
      'fbcx'), /* Refers to the [domain]/Library/Indexes/FindByContent folder in
                  Mac OS X*/
  kManagedItemsFolderType = FOUR_CHAR_CODE(
      'mang'), /* Refers to the Managed Items folder for Mac OS X */
  kBootTimeStartupItemsFolderType = FOUR_CHAR_CODE(
      'empz') /* Refers to the "StartupItems" folder of Mac OS X */
};
...
enum {
  ...
  kCurrentUserFolderType =
      FOUR_CHAR_CODE('cusr'), /* The folder for the currently logged on user. */
  kCurrentUserRemoteFolderLocation = FOUR_CHAR_CODE(
      'rusf'), /* The remote folder for the currently logged on user */
  kCurrentUserRemoteFolderType = FOUR_CHAR_CODE(
      'rusr'), /* The remote folder location for the currently logged on user */
...
inline DEFINE_API_C(OSStatus)
    InvokeFolderManagerNotificationUPP(OSType message, void *arg,
                                       void *userRefCon,
                                       FolderManagerNotificationUPP userUPP) {
...
enum {
  kFolderManagerNotificationMessageUserLogIn = FOUR_CHAR_CODE(
      'log+'), /*    Sent by system & third party software after a user logs in.
                  arg should point to a valid FindFolderUserRedirectionGlobals
                  structure or nil for the owner*/
  kFolderManagerNotificationMessagePreUserLogIn =
      FOUR_CHAR_CODE('logj'), /*    Sent by system & third party software before
  ...
  kFolderManagerNotificationMessageUserLogOut =
      FOUR_CHAR_CODE('log-'), /*    Sent by system & third party software before
  ...
  kFolderManagerNotificationMessageLoginStartup =
      FOUR_CHAR_CODE('stup') /*    Sent by 'Login' application the first time it
                                starts up after each boot*/
};
...
struct MultiUserGestalt {
  ...
  long
      giPrefsDirID; /* dirID of the At Ease Items folder on preferences volume*/
  unsigned long giUserLogInTime; /* time in seconds we've been logged in (0 or 1
                                    mean not logged in)*/
  Boolean
