/*
        ...
        Copyright:	© 2002-2006 by Apple Computer, Inc., all rights
   reserved.

        Set of utility functions for loading of QuickTime libraries, and finding
   of the QuickTime directories.
