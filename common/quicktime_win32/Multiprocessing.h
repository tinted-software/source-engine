/*
     ...
     Copyright:  (c) 2007 (c) 1996-2001 by Apple Computer, Inc. and (c)
   1995-1997 DayStar Digital, Inc.
...
/*
   ===========================================================================================
   This is the header file for version 2.2 of the Mac OS multiprocessing
   ...
   must be called to see if the MP API is ReallyTruly(tm) usable.)  New code and
...
enum {
  ...
  MPLibrary_MinorVersion =
      3, /* !  used in the startup check in MPInitializeAPI!*/
  MPLibrary_Release = 1,
 ...
 */
EXTERN_API_C(OSStatus)
MPWaitOnQueue(MPQueueID queue, void **param1, void **param2, void **param3,
              Duration timeout);
 ...
 */
EXTERN_API_C(void)
_MPLibraryVersion(const char **versionCString, UInt32 *major, UInt32 *minor,
