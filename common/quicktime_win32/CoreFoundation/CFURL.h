...
CF_EXPORT
CFURLRef CFURLCreateWithBytes(CFAllocatorRef allocator, const UInt8 *URLBytes,
...
CF_EXPORT
CFURLRef CFURLCreateWithString(CFAllocatorRef allocator, CFStringRef URLString,
                               CFURLRef baseURL);
...
CFURLRef CFURLCreateAbsoluteURLWithBytes(
    CFAllocatorRef alloc, const UInt8 *relativeURLBytes, CFIndex length,
...
CFURLRef CFURLCreateFromFileSystemRepresentationRelativeToBase(
    CFAllocatorRef allocator, const UInt8 *buffer, CFIndex bufLen,
    Boolean isDirectory, CFURLRef baseURL);
...
SInt32 CFURLGetPortNumber(
    CFURLRef anURL); /* Returns -1 if no port number is specified */
...
CF_EXPORT
CFStringRef CFURLCopyParameterString(CFURLRef anURL,
                                     CFStringRef charactersToLeaveEscaped);

CF_EXPORT
CFStringRef CFURLCopyQueryString(CFURLRef anURL,
                                 CFStringRef charactersToLeaveEscaped);

CF_EXPORT
CFStringRef CFURLCopyFragment(CFURLRef anURL,
                              CFStringRef charactersToLeaveEscaped);
...
CF_EXPORT
CFURLRef CFURLCreateCopyAppendingPathExtension(CFAllocatorRef allocator,
                                               CFURLRef url,
                                               CFStringRef extension);

CF_EXPORT
CFURLRef CFURLCreateCopyDeletingPathExtension(CFAllocatorRef allocator,
                                              CFURLRef url);
...
*/
CF_EXPORT
CFRange CFURLGetByteRangeForComponent(CFURLRef url,
...
#if MAC_OS_X_VERSION_10_3 <= MAC_OS_X_VERSION_MAX_ALLOWED
/* As above, but allows you to specify the encoding to use when interpreting
 * percent escapes */
CF_EXPORT
...
/* newString = CFURLCreateStringByAddingPercentEscapes(NULL, origString, NULL,
...
CF_EXPORT
CFURLRef CFURLCreateFromFSRef(CFAllocatorRef allocator,
