...
#define kCFBooleanTrue                                                         \
  (*((const CFBooleanRef *)QTGetCFConstant("kCFBooleanTrue")))
#define kCFBooleanFalse                                                        \
  (*((const CFBooleanRef *)QTGetCFConstant("kCFBooleanFalse")))
#else
CF_EXPORT
...
#define kCFNumberPositiveInfinity                                              \
  (*((const CFNumberRef *)QTGetCFConstant("kCFNumberPositiveInfinity")))
#define kCFNumberNegativeInfinity                                              \
  (*((const CFNumberRef *)QTGetCFConstant("kCFNumberNegativeInfinity")))
...
*/
CF_EXPORT
CFComparisonResult CFNumberCompare(CFNumberRef number, CFNumberRef otherNumber,
                                   void *context);
