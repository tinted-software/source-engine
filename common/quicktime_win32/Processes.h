...
/*
   ...
   'quit' ( 0 ) will be quit at kQuitAtNormalTime mask. These options only
   function on Mac OS 9.x at this time.
*/
enum {
...
ProcessInformationCopyDictionary(const ProcessSerialNumber *PSN,
                                 UInt32 infoToReturn);
...
SetFrontProcessWithOptions(const ProcessSerialNumber *inProcess,
