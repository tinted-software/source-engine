/*
     ...
     Copyright:  (c) 2007 (c) 1994-2000 by Apple Computer, Inc., all rights
   reserved.
...
enum { sizeof_sfntCMapExtendedSubHeader = 12 };
...
enum { kFontNoNameCode = (unsigned long)(-1) };
...
/*   Deprecated "don't care" values - use kFontNoPlatformCode,
   kFontNoScriptCode, kFontNoLanguageCode, kFontNoName instead
*/
enum {
  kFontNoPlatform = -1,
  kFontNoScript = -1,
