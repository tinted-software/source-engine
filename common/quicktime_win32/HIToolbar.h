...
#define kHIToolbarSeparatorIdentifier                                          \
  CFSTR("com.apple.hitoolbox.toolbar.separator")
#define kHIToolbarSpaceIdentifier CFSTR("com.apple.hitoolbox.toolbar.space")
#define kHIToolbarFlexibleSpaceIdentifier                                      \
  CFSTR("com.apple.hitoolbox.toolbar.flexiblespace")
#define kHIToolbarCustomizeIdentifier                                          \
  CFSTR("com.apple.hitoolbox.toolbar.customize")
...
HIToolbarCreate(CFStringRef inIdentifier, OptionBits inAttributes,
 ...
 */
EXTERN_API_C(OSStatus)
HIToolbarChangeAttributes(HIToolbarRef inToolbar, OptionBits inAttrsToSet,
 ...
 */
EXTERN_API_C(OSStatus)
HIToolbarGetDisplayMode(HIToolbarRef inToolbar,
 ...
 */
EXTERN_API_C(OSStatus)
HIToolbarSetDisplayMode(HIToolbarRef inToolbar,
 ...
 */
EXTERN_API_C(OSStatus)
HIToolbarCreateItemWithIdentifier(HIToolbarRef inToolbar,
 ...
 */
EXTERN_API_C(OSStatus)
HIToolbarInsertItemAtIndex(HIToolbarRef inToolbar, HIToolbarItemRef inItem,
                           CFIndex inIndex);
 ...
 */
EXTERN_API_C(OSStatus)
HIToolbarItemCreate(CFStringRef inIdentifier, OptionBits inOptions,
                    HIToolbarItemRef *outItem);
 ...
 */
EXTERN_API_C(OSStatus)
HIToolbarItemCopyIdentifier(HIToolbarItemRef inItem,
 ...
 */
EXTERN_API_C(OSStatus)
HIToolbarItemChangeAttributes(HIToolbarItemRef inItem, OptionBits inAttrsToSet,
                              OptionBits inAttrsToClear);
 ...
 */
EXTERN_API_C(OSStatus)
HIToolbarItemCopyHelpText(HIToolbarItemRef inItem,
