 ...
 */
enum { kEventMovieViewOptimalBoundsChanged = 1 };
...
enum {
  ...
  kHIMovieViewStandardAttributes =
      (kHIMovieViewControllerVisibleAttribute |
       kHIMovieViewAutoIdlingAttribute | kHIMovieViewAcceptsFocusAttribute)
};
...
HIMovieViewCreate(Movie inMovie, OptionBits inAttributes,
 ...
 */
EXTERN_API_C(OSStatus)
HIMovieViewChangeAttributes(HIViewRef inView, OptionBits inAttributesToSet,
