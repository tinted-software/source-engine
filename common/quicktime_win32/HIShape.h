 ...
 */
EXTERN_API_C(OSStatus)
HIShapeIntersect(HIShapeRef inShape1, HIShapeRef inShape2,
 ...
 */
EXTERN_API_C(OSStatus)
HIShapeDifference(HIShapeRef inShape1, HIShapeRef inShape2,
                  HIMutableShapeRef outResult);
 ...
 */
EXTERN_API_C(OSStatus)
HIShapeUnion(HIShapeRef inShape1, HIShapeRef inShape2,
             HIMutableShapeRef outResult);
