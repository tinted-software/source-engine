/*
     ...
     Copyright:  (c) 2007 (c) 2000-2001 by Apple Computer, Inc., all rights
   reserved.
 ...
 */
EXTERN_API_C(void)
ctozD(const DSPDoubleComplex C[], SInt32 strideC, DSPDoubleSplitComplex *Z,
      SInt32 strideZ, UInt32 size);
 ...
 */
EXTERN_API_C(void)
ztocD(const DSPDoubleSplitComplex *Z, SInt32 strideZ, DSPDoubleComplex C[],
      SInt32 strideC, UInt32 size);
 ...
 */
EXTERN_API_C(void)
fft_zipD(FFTSetupD setup, DSPDoubleSplitComplex *ioData, SInt32 stride,
 ...
 */
EXTERN_API_C(void)
fft_ziptD(FFTSetupD setup, DSPDoubleSplitComplex *ioData, SInt32 stride,
          DSPDoubleSplitComplex *bufferTemp, UInt32 log2n,
          FFTDirection direction);
 ...
 */
EXTERN_API_C(void)
fft_zopD(FFTSetupD setup, DSPDoubleSplitComplex *signal, SInt32 signalStride,
         DSPDoubleSplitComplex *result, SInt32 strideResult, UInt32 log2n,
         FFTDirection direction);
 ...
 */
EXTERN_API_C(void)
fft_zoptD(FFTSetupD setup, DSPDoubleSplitComplex *signal, SInt32 signalStride,
          DSPDoubleSplitComplex *result, SInt32 strideResult,
          DSPDoubleSplitComplex *bufferTemp, UInt32 log2n,
          FFTDirection direction);
 ...
 */
EXTERN_API_C(void)
fft_zripD(FFTSetupD setup, DSPDoubleSplitComplex *ioData, SInt32 stride,
          UInt32 log2n, FFTDirection flag);
 ...
 */
EXTERN_API_C(void)
fft_zriptD(FFTSetupD setup, DSPDoubleSplitComplex *ioData, SInt32 stride,
           DSPDoubleSplitComplex *bufferTemp, UInt32 log2n, SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fft_zropD(FFTSetupD setup, DSPDoubleSplitComplex *signal, SInt32 signalStride,
          DSPDoubleSplitComplex *result, SInt32 strideResult, UInt32 log2n,
          SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fft_zroptD(FFTSetupD setup, DSPDoubleSplitComplex *signal, SInt32 signalStride,
           DSPDoubleSplitComplex *result, SInt32 strideResult,
           DSPDoubleSplitComplex *bufferTemp, UInt32 log2n, SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fft2d_zipD(FFTSetupD setup, DSPDoubleSplitComplex *ioData, SInt32 strideInRow,
           SInt32 strideInCol, UInt32 log2nInCol, UInt32 log2nInRow,
           FFTDirection direction);
 ...
 */
EXTERN_API_C(void)
fft2d_ziptD(FFTSetupD setup, DSPDoubleSplitComplex *ioData, SInt32 strideInRow,
            SInt32 strideInCol, DSPDoubleSplitComplex *bufferTemp,
 ...
 */
EXTERN_API_C(void)
fft2d_zopD(FFTSetupD setup, DSPDoubleSplitComplex *signal,
           SInt32 signalStrideInRow, SInt32 signalStrideInCol,
           DSPDoubleSplitComplex *result, SInt32 strideResultInRow,
           SInt32 strideResultInCol, UInt32 log2nInCol, UInt32 log2nInRow,
           SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fft2d_zoptD(FFTSetupD setup, DSPDoubleSplitComplex *signal,
            SInt32 signalStrideInRow, SInt32 signalStrideInCol,
            DSPDoubleSplitComplex *result, SInt32 strideResultInRow,
            SInt32 strideResultInCol, DSPDoubleSplitComplex *bufferTemp,
 ...
 */
EXTERN_API_C(void)
fft2d_zripD(FFTSetupD setup, DSPDoubleSplitComplex *signal, SInt32 strideInRow,
            SInt32 strideInCol, UInt32 log2nInCol, UInt32 log2nInRow,
            SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fft2d_zriptD(FFTSetupD setup, DSPDoubleSplitComplex *signal, SInt32 strideInRow,
             SInt32 strideInCol, DSPDoubleSplitComplex *bufferTemp,
             UInt32 log2nInCol, UInt32 log2nInRow, SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fft2d_zropD(FFTSetupD setup, DSPDoubleSplitComplex *ioData, SInt32 Kr,
            SInt32 Kc, DSPDoubleSplitComplex *ioData2, SInt32 Ir, SInt32 Ic,
            UInt32 log2nc, UInt32 log2nr, SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fft2d_zroptD(FFTSetupD setup, DSPDoubleSplitComplex *ioData, SInt32 Kr,
             SInt32 Kc, DSPDoubleSplitComplex *ioData2, SInt32 Ir, SInt32 Ic,
             DSPDoubleSplitComplex *temp, UInt32 log2nc, UInt32 log2nr,
             SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fftm_zip(FFTSetup setup, DSPSplitComplex *signal, SInt32 signalStride,
         SInt32 fftStride, UInt32 log2n, UInt32 numFFT, SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fftm_zipt(FFTSetup setup, DSPSplitComplex *signal, SInt32 signalStride,
          SInt32 fftStride, DSPSplitComplex *temp, UInt32 log2n, UInt32 numFFT,
          SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fftm_zipD(FFTSetupD setup, DSPDoubleSplitComplex *signal, SInt32 signalStride,
          SInt32 fftStride, UInt32 log2n, UInt32 numFFT, SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fftm_ziptD(FFTSetupD setup, DSPDoubleSplitComplex *signal, SInt32 signalStride,
           SInt32 fftStride, DSPDoubleSplitComplex *temp, UInt32 log2n,
 ...
 */
EXTERN_API_C(void)
fftm_zop(FFTSetup setup, DSPSplitComplex *signal, SInt32 signalStride,
         SInt32 fftStride, DSPSplitComplex *result, SInt32 resultStride,
         SInt32 rfftStride, UInt32 log2n, UInt32 numFFT, SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fftm_zopt(FFTSetup setup, DSPSplitComplex *signal, SInt32 signalStride,
          SInt32 fftStride, DSPSplitComplex *result, SInt32 resultStride,
          SInt32 rfftStride, DSPSplitComplex *temp, UInt32 log2n, UInt32 numFFT,
          SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fftm_zopD(FFTSetupD setup, DSPDoubleSplitComplex *signal, SInt32 signalStride,
          SInt32 fftStride, DSPDoubleSplitComplex *result, SInt32 resultStride,
          SInt32 rfftStride, UInt32 log2n, UInt32 numFFT, SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fftm_zoptD(FFTSetupD setup, DSPDoubleSplitComplex *signal, SInt32 signalStride,
           SInt32 fftStride, DSPDoubleSplitComplex *result, SInt32 resultStride,
           SInt32 rfftStride, DSPDoubleSplitComplex *temp, UInt32 log2n,
           UInt32 numFFT, SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fftm_zrip(FFTSetup setup, DSPSplitComplex *signal, SInt32 signalStride,
          SInt32 fftStride, UInt32 log2n, UInt32 numFFT, SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fftm_zript(FFTSetup setup, DSPSplitComplex *signal, SInt32 signalStride,
           SInt32 fftStride, DSPSplitComplex *temp, UInt32 log2n, UInt32 numFFT,
           SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fftm_zripD(FFTSetupD setup, DSPDoubleSplitComplex *signal, SInt32 signalStride,
           SInt32 fftStride, UInt32 log2n, UInt32 numFFT, SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fftm_zriptD(FFTSetupD setup, DSPDoubleSplitComplex *signal, SInt32 signalStride,
            SInt32 fftStride, DSPDoubleSplitComplex *temp, UInt32 log2n,
            UInt32 numFFT, SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fftm_zrop(FFTSetup setup, DSPSplitComplex *signal, SInt32 signalStride,
          SInt32 fftStride, DSPSplitComplex *result, SInt32 resultStride,
          SInt32 rfftStride, UInt32 log2n, UInt32 numFFT, SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fftm_zropt(FFTSetup setup, DSPSplitComplex *signal, SInt32 signalStride,
           SInt32 fftStride, DSPSplitComplex *result, SInt32 resultStride,
           SInt32 rfftStride, DSPSplitComplex *temp, UInt32 log2n,
           UInt32 numFFT, SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fftm_zropD(FFTSetupD setup, DSPDoubleSplitComplex *signal, SInt32 signalStride,
           SInt32 fftStride, DSPDoubleSplitComplex *result, SInt32 resultStride,
           SInt32 rfftStride, UInt32 log2n, UInt32 numFFT, SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fftm_zroptD(FFTSetupD setup, DSPDoubleSplitComplex *signal, SInt32 signalStride,
            SInt32 fftStride, DSPDoubleSplitComplex *result,
            SInt32 resultStride, SInt32 rfftStride, DSPDoubleSplitComplex *temp,
 ...
 */
EXTERN_API_C(void)
fft3_zop(FFTSetup setup, DSPSplitComplex *signal, SInt32 signalStride,
         DSPSplitComplex *result, SInt32 resultStride, UInt32 log2n,
         SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fft5_zop(FFTSetup setup, DSPSplitComplex *signal, SInt32 signalStride,
         DSPSplitComplex *result, SInt32 resultStride, UInt32 log2n,
         SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fft3_zopD(FFTSetupD setup, DSPDoubleSplitComplex *ioData, SInt32 K,
          DSPDoubleSplitComplex *ioData2, SInt32 L, UInt32 log2n, SInt32 flag);
 ...
 */
EXTERN_API_C(void)
fft5_zopD(FFTSetupD setup, DSPDoubleSplitComplex *ioData, SInt32 K,
          DSPDoubleSplitComplex *ioData2, SInt32 L, UInt32 log2n, SInt32 flag);
 ...
 */
EXTERN_API_C(void)
convD(const double signal[], SInt32 signalStride, const double filter[],
      SInt32 strideFilter, double result[], SInt32 strideResult,
 ...
 */
EXTERN_API_C(void)
f3x3(float *signal, SInt32 rowStride, SInt32 colStride, float *filter,
     float *result);
 ...
 */
EXTERN_API_C(void)
f3x3D(double *signal, SInt32 rowStride, SInt32 colStride, double *filter,
      double *result);
 ...
 */
EXTERN_API_C(void)
f5x5(float *signal, SInt32 rowStride, SInt32 colStride, float *filter,
     float *result);
 ...
 */
EXTERN_API_C(void)
f5x5D(double *signal, SInt32 rowStride, SInt32 colStride, double *filter,
      double *result);
 ...
 */
EXTERN_API_C(void)
imgfir(float *signal, SInt32 numRow, SInt32 numCol, float *filter,
       float *result, SInt32 fnumRow, SInt32 fnumCol);
 ...
 */
EXTERN_API_C(void)
imgfirD(double *signal, SInt32 numRow, SInt32 numCol, double *filter,
        double *result, SInt32 fnumRow, SInt32 fnumCol);
 ...
 */
EXTERN_API_C(void)
mtransD(double *a, SInt32 aStride, double *c, SInt32 cStride, SInt32 M,
        SInt32 N);
 ...
 */
EXTERN_API_C(void)
mmul(float *a, SInt32 aStride, float *b, SInt32 bStride, float *c,
     SInt32 cStride, SInt32 M, SInt32 N, SInt32 P);
 ...
 */
EXTERN_API_C(void)
mmulD(double *a, SInt32 aStride, double *b, SInt32 bStride, double *c,
      SInt32 cStride, SInt32 M, SInt32 N, SInt32 P);
...
_______________________________________________________________________________
      ...
      Single and Double Precision Complex Split Matrix mul/add, mul/sub,
sub/mul, and mul
 ...
 */
EXTERN_API_C(void)
zmma(DSPSplitComplex *a, SInt32 i, DSPSplitComplex *b, SInt32 j,
     DSPSplitComplex *c, SInt32 k, DSPSplitComplex *d, SInt32 l, SInt32 M,
     SInt32 N, SInt32 P);
 ...
 */
EXTERN_API_C(void)
zmmaD(DSPDoubleSplitComplex *a, SInt32 i, DSPDoubleSplitComplex *b, SInt32 j,
      DSPDoubleSplitComplex *c, SInt32 k, DSPDoubleSplitComplex *d, SInt32 l,
 ...
 */
EXTERN_API_C(void)
zmms(DSPSplitComplex *a, SInt32 i, DSPSplitComplex *b, SInt32 j,
     DSPSplitComplex *c, SInt32 k, DSPSplitComplex *d, SInt32 l, SInt32 M,
     SInt32 N, SInt32 P);
 ...
 */
EXTERN_API_C(void)
zmmsD(DSPDoubleSplitComplex *a, SInt32 i, DSPDoubleSplitComplex *b, SInt32 j,
      DSPDoubleSplitComplex *c, SInt32 k, DSPDoubleSplitComplex *d, SInt32 l,
      SInt32 M, SInt32 N, SInt32 P);
 ...
 */
EXTERN_API_C(void)
zmsm(DSPSplitComplex *a, SInt32 i, DSPSplitComplex *b, SInt32 j,
     DSPSplitComplex *c, SInt32 k, DSPSplitComplex *d, SInt32 l, SInt32 M,
     SInt32 N, SInt32 P);
 ...
 */
EXTERN_API_C(void)
zmsmD(DSPDoubleSplitComplex *a, SInt32 i, DSPDoubleSplitComplex *b, SInt32 j,
      DSPDoubleSplitComplex *c, SInt32 k, DSPDoubleSplitComplex *d, SInt32 l,
      SInt32 M, SInt32 N, SInt32 P);
 ...
 */
EXTERN_API_C(void)
zmmul(DSPSplitComplex *a, SInt32 i, DSPSplitComplex *b, SInt32 j,
      DSPSplitComplex *c, SInt32 k, SInt32 M, SInt32 N, SInt32 P);
 ...
 */
EXTERN_API_C(void)
zmmulD(DSPDoubleSplitComplex *a, SInt32 i, DSPDoubleSplitComplex *b, SInt32 j,
       DSPDoubleSplitComplex *c, SInt32 k, SInt32 M, SInt32 N, SInt32 P);
 ...
 */
EXTERN_API_C(void)
vaddD(const double input1[], SInt32 stride1, const double input2[],
      SInt32 stride2, double result[], SInt32 strideResult, UInt32 size);
 ...
 */
EXTERN_API_C(void)
vsubD(const double input1[], SInt32 stride1, const double input2[],
      SInt32 stride2, double result[], SInt32 strideResult, UInt32 size);
 ...
 */
EXTERN_API_C(void)
vmulD(const double input1[], SInt32 stride1, const double input2[],
      SInt32 stride2, double result[], SInt32 strideResult, UInt32 size);
 ...
 */
EXTERN_API_C(void)
vsmulD(const double input1[], SInt32 stride1, const double *input2,
       double result[], SInt32 strideResult, UInt32 size);
 ...
 */
EXTERN_API_C(void)
vsqD(const double input[], SInt32 strideInput, double result[],
     SInt32 strideResult, UInt32 size);
 ...
 */
EXTERN_API_C(void)
vssqD(const double input[], SInt32 strideInput, double result[],
      SInt32 strideResult, UInt32 size);
 ...
 */
EXTERN_API_C(void)
dotprD(const double input1[], SInt32 stride1, const double input2[],
       SInt32 stride2, double *result, UInt32 size);
 ...
 */
EXTERN_API_C(void)
vamD(const double input1[], SInt32 stride1, const double input2[],
     SInt32 stride2, const double input3[], SInt32 stride3, double result[],
     SInt32 strideResult, UInt32 size);
 ...
 */
EXTERN_API_C(void)
zconvD(DSPDoubleSplitComplex *signal, SInt32 signalStride,
       DSPDoubleSplitComplex *filter, SInt32 strideFilter,
       DSPDoubleSplitComplex *result, SInt32 strideResult, SInt32 lenResult,
       SInt32 lenFilter);
 ...
 */
EXTERN_API_C(void)
zvaddD(DSPDoubleSplitComplex *input1, SInt32 stride1,
       DSPDoubleSplitComplex *input2, SInt32 stride2,
 ...
 */
EXTERN_API_C(void)
zvsubD(DSPDoubleSplitComplex *input1, SInt32 stride1,
       DSPDoubleSplitComplex *input2, SInt32 stride2,
       DSPDoubleSplitComplex *result, SInt32 strideResult, UInt32 size);
 ...
 */
EXTERN_API_C(void)
zvmulD(DSPDoubleSplitComplex *input1, SInt32 stride1,
       DSPDoubleSplitComplex *input2, SInt32 stride2,
       DSPDoubleSplitComplex *result, SInt32 strideResult, UInt32 size,
       SInt32 conjugate);
 ...
 */
EXTERN_API_C(void)
zdotprD(DSPDoubleSplitComplex *input1, SInt32 stride1,
        DSPDoubleSplitComplex *input2, SInt32 stride2,
 ...
 */
EXTERN_API_C(void)
zidotprD(DSPDoubleSplitComplex *input1, SInt32 stride1,
         DSPDoubleSplitComplex *input2, SInt32 stride2,
         DSPDoubleSplitComplex *result, UInt32 size);
 ...
 */
EXTERN_API_C(void)
zrdotprD(DSPDoubleSplitComplex *input1, SInt32 stride1, const double input2[],
         SInt32 stride2, DSPDoubleSplitComplex *result, UInt32 size);
 ...
 */
EXTERN_API_C(void)
zvcmaD(DSPDoubleSplitComplex *input1, SInt32 stride1,
       DSPDoubleSplitComplex *input2, SInt32 stride2,
       DSPDoubleSplitComplex *input3, SInt32 stride3,
       DSPDoubleSplitComplex *result, SInt32 strideResult, UInt32 size);
 ...
 */
EXTERN_API_C(void)
zrvaddD(DSPDoubleSplitComplex *input1, SInt32 stride1, const double input2[],
        SInt32 stride2, DSPDoubleSplitComplex *result, SInt32 strideResult,
        UInt32 size);
 ...
 */
EXTERN_API_C(void)
zrvsubD(DSPDoubleSplitComplex *input1, SInt32 stride1, const double input2[],
        SInt32 stride2, DSPDoubleSplitComplex *result, SInt32 strideResult,
        UInt32 size);
 ...
 */
EXTERN_API_C(void)
zrvmulD(DSPDoubleSplitComplex *input1, SInt32 stride1, const double input2[],
        SInt32 stride2, DSPDoubleSplitComplex *result, SInt32 strideResult,
        UInt32 size);
