/*
     ...
     Copyright:  (c) 2007 (c) 1986-1998 by Apple Computer, Inc., all rights
   reserved
...
enum {
  ...
  drHwHPV =
      0x002C, /* High performance Video (HPV) PDS card for original PowerMacs */
  ...
  TNTBoardID = 0x0670, /*Board ID for TNT/Alchemy/Hipclipper CPUs (did Nano just
                          make this up?)*/
