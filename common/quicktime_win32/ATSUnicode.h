/*
     ...
     Copyright:  (c) 2007 (c) 1997-2001 by Apple Computer, Inc., all rights
   reserved.
...
enum {
  ...
  /*    Default value: Maximum typographical ascent of all fonts used on line or
     textLayout*/
  kATSULineDescentTag = 9L, /*    Type:       ATSUTextMeasurement >= 0*/
  /*    Default value: Maximum typographical descent+leading of all fonts used
     on line or textLayout*/
  ...
  kATSULayoutOperationOverrideTag =
      15L, /*    Type:       ATSULayoutOperationOverrideSpecifier (MacOS 10.2 or
              later) */
           /*    Default value:     NULL*/
  kATSUMaxLineTag = 16L, /*    This is just for convenience - the upper limit of
                            the ATSUTextLayout attribute tags*/
                         /* Obsolete layout tags */
  kATSULineLanguageTag = 10L, /*    Use kATSULineLangRegionTag           */
                              /* Special layout tags */
  kATSUCGContextTag =
      32767L, /*    Type:       CGContextRef (MacOS X systems only)*/
              /*    Default value: NULL*/
  ...
  /*    Default value: kATSUseGlyphAdvance - all glyphs use their own font
     defined advance widths*/
  ...
  kATSUStyleRenderingOptionsTag =
      283L, /*    Type:       ATSStyleRenderingOptions (see ATSLayoutTypes.h)*/
            /*    Default value: kATSStyleNoOptions - other options listed in
               ATSLayoutTypes.h*/
  kATSUAscentTag =
      284L, /*    Type:       ATSUTextMeasurement >= 0  (MacOS 10.2 or later)*/
  /*    Default value: Ascent value of style's font with current pointSize*/
  kATSUDescentTag =
      285L, /*    Type:       ATSUTextMeasurement >= 0  (MacOS 10.2 or later)*/
  /*    Default value: Descent value of style's font with current pointSize*/
  kATSULeadingTag =
      286L, /*    Type:       ATSUTextMeasurement >= 0  (MacOS 10.2 or later)*/
  /*    Default value: Leading value of style's font with current pointSize
     (usually value 0)*/
  kATSUGlyphSelectorTag =
      287L, /*    Type:       ATSUGlyphSelector  (MacOS 10.2 or later)*/
            /*    Default value: 0 - use the glyphs derived by ATSUI layout*/
  kATSURGBAlphaColorTag =
      288L, /*    Type:       ATSURGBAlphaColor  (MacOS 10.2 or later)*/
            /*    Default value: (0, 0, 0, 1)*/
  kATSUFontMatrixTag =
      289L, /*    Type:       CGAffineTransform  (MacOS 10.2 or later)*/
  /*    Default value: [1, 0, 0, 1, 0, 0] ==> CGAffineTransformIdentity*/
  kATSUMaxStyleTag = 290L, /*    This is just for convenience - the upper limit
...
/*
    ATSUGlyphSelector can direct ATSUI to use a specific glyph instead of the
   one that ATSUI normally derives.  The glyph can be specified either as a
   glyphID (specific to the font used) or CID from a specfic collection defined
...
/*
    ...
    Use their replacements, ATSUFlattenStyleRunsToStream and , instead if
   available or perform your own flattening
*/
/*
 *  ATSUCopyToHandle()
 *
 ...
 */
EXTERN_API_C(OSStatus)
ATSUGetUnjustifiedBounds(ATSUTextLayout iTextLayout,
                         UniCharArrayOffset iLineStart,
 ...
 */
EXTERN_API_C(OSStatus)
ATSUHighlightInactiveText(ATSUTextLayout iTextLayout,
                          ATSUTextMeasurement iTextBasePointX,
                          ATSUTextMeasurement iTextBasePointY,
                          UniCharArrayOffset iHighlightStart,
                          UniCharCount iHighlightLength);
 ...
 */
EXTERN_API_C(OSStatus)
ATSUBatchBreakLines(ATSUTextLayout iTextLayout, UniCharArrayOffset iRangeStart,
                    UniCharCount iRangeLength, ATSUTextMeasurement iLineWidth,
 ...
 */
EXTERN_API_C(OSStatus)
ATSUSetTabArray(ATSUTextLayout iTextLayout, const ATSUTab iTabs[],
                ItemCount iTabCount);
 ...
 */
EXTERN_API_C(OSStatus)
ATSUGetTabArray(ATSUTextLayout iTextLayout, ItemCount iMaxTabCount,
                ATSUTab oTabs[], ItemCount *oTabCount);
...
#ifdef __cplusplus
inline DEFINE_API_C(ATSQuadraticLineUPP)
    NewATSQuadraticLineUPP(ATSQuadraticLineProcPtr userRoutine) {
  return userRoutine;
}
#else
...
#ifdef __cplusplus
inline DEFINE_API_C(ATSQuadraticCurveUPP)
    NewATSQuadraticCurveUPP(ATSQuadraticCurveProcPtr userRoutine) {
  return userRoutine;
}
#else
...
#ifdef __cplusplus
inline DEFINE_API_C(ATSQuadraticNewPathUPP)
    NewATSQuadraticNewPathUPP(ATSQuadraticNewPathProcPtr userRoutine) {
  return userRoutine;
}
#else
...
#ifdef __cplusplus
inline DEFINE_API_C(ATSQuadraticClosePathUPP)
    NewATSQuadraticClosePathUPP(ATSQuadraticClosePathProcPtr userRoutine) {
  return userRoutine;
}
#else
...
inline DEFINE_API_C(void)
    DisposeATSQuadraticNewPathUPP(ATSQuadraticNewPathUPP) {}
#else
...
#ifdef __cplusplus
inline DEFINE_API_C(void)
    DisposeATSQuadraticClosePathUPP(ATSQuadraticClosePathUPP) {}
#else
...
#ifdef __cplusplus
inline DEFINE_API_C(ATSCubicMoveToUPP)
    NewATSCubicMoveToUPP(ATSCubicMoveToProcPtr userRoutine) {
  return userRoutine;
}
#else
...
#ifdef __cplusplus
inline DEFINE_API_C(ATSCubicLineToUPP)
    NewATSCubicLineToUPP(ATSCubicLineToProcPtr userRoutine) {
  return userRoutine;
}
#else
...
#ifdef __cplusplus
inline DEFINE_API_C(ATSCubicCurveToUPP)
    NewATSCubicCurveToUPP(ATSCubicCurveToProcPtr userRoutine) {
  return userRoutine;
}
#else
...
#ifdef __cplusplus
inline DEFINE_API_C(ATSCubicClosePathUPP)
    NewATSCubicClosePathUPP(ATSCubicClosePathProcPtr userRoutine) {
  return userRoutine;
}
#else
...
#ifdef __cplusplus
inline DEFINE_API_C(OSStatus)
    InvokeATSCubicClosePathUPP(void *callBackDataPtr,
