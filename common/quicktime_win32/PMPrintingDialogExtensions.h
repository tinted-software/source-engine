...
/*
    ...
    When sent to the this event is sent to the PageSetup or Print Dialog, the
   PDE pane will be resized to match the new height.  The
   kEventParamDirectObject needs to be the embedderUserPane that is passed into
   Initialize
*/
enum {
...
#define kPMCopiesAndPagesPDEKindID                                             \
  CFSTR("com.apple.print.pde.CopiesAndPagesKind")
...
#define kPMRotationScalingPDEKindID                                            \
  CFSTR("com.apple.print.pde.RotationScalingKind")
...
#define kPMQualityMediaPDEKindID                                               \
  CFSTR("com.apple.print.pde.QualityMediaPDEKind")
/*  These constants are used by PDE's to obtain the PMTicketRef data for the
...
#define kGeneralPageSetupDialogTypeIDStr                                       \
  CFSTR("6E6ED964-B738-11D3-952F-0050E4603277")
#define kGeneralPrintDialogTypeIDStr                                           \
  CFSTR("C1BF838E-B72A-11D3-9644-0050E4603277")
...
typedef CALLBACK_API_C(OSStatus, PMPDEPrologueProcPtr)(
    PMPDEContext *context, OSType *creator, CFStringRef *userOptionKind,
    CFStringRef *title, UInt32 *maxH, UInt32 *maxV);
typedef CALLBACK_API_C(OSStatus,
                       PMPDEInitializeProcPtr)(PMPDEContext context,
                                               PMPDEFlags *flags, PMPDERef ref,
                                               ControlRef embedderUserPane,
                                               PMPrintSession printSession);
typedef CALLBACK_API_C(OSStatus, PMPDESyncProcPtr)(PMPDEContext context,
                                                   PMPrintSession printSession,
                                                   Boolean reinitializePlugIn);
typedef CALLBACK_API_C(OSStatus,
                       PMPDEGetSummaryTextProcPtr)(PMPDEContext context,
...
typedef CALLBACK_API_C(OSStatus, PMPDETerminateProcPtr)(PMPDEContext context,
                                                        OSStatus status);
...
PMCreateLocalizedPaperSizeCFString(PMTicketRef listofPaperTickets,
                                   UInt16 paperToUse);

/* Lower level version of the same function, this time passing the single
 * PaperInfo.*/
/*
