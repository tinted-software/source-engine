...
enum {
  ...
  fontPanelFontSelectionQDStyleVersionErr =
      -8882 /* Unsupported record version.*/
};
...
enum {
  kFontSelectionATSUIType =
      FOUR_CHAR_CODE('astl'), /* Use ATSUIStyle collection.*/
  kFontSelectionQDType =
      FOUR_CHAR_CODE('qstl') /* Use FontSelectionQDStyle record.*/
};
...
*/
enum { kFontSelectionQDStyleVersionZero = 0 };
 ...
 */
EXTERN_API_C(OSStatus)
SetFontInfoForSelection(OSType iStyleType, UInt32 iNumStyles, void *iStyles,
