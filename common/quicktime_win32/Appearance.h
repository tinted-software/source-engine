/*
     ...
     Copyright:  (c) 2007 (c) 1994-2001 by Apple Computer, Inc., all rights
   reserved
...
enum {
  ...
  kThemeBrushAlertBackgroundActive =
      3, /* use with kAlertWindowClass and kMovableAlertWindowClass */
  kThemeBrushAlertBackgroundInactive =
      4, /* use with kAlertWindowClass and kMovableAlertWindowClass */
  kThemeBrushModelessDialogBackgroundActive =
      5, /* use with kDocumentWindowClass */
  kThemeBrushModelessDialogBackgroundInactive =
      6, /* use with kDocumentWindowClass */
  kThemeBrushUtilityWindowBackgroundActive =
      7, /* use with kFloatingWindowClass and kUtilityWindowClass */
  kThemeBrushUtilityWindowBackgroundInactive =
      8, /* use with kFloatingWindowClass and kUtilityWindowClass */
...
enum {
  kThemeBrushMovableModalBackground =
      49, /* use with kMovableModalWindowClass; available in Mac OS X, and
             CarbonLib 1.3 and later */
  kThemeBrushSheetBackgroundOpaque =
      50, /* use with kSheetWindowClass and kSheetAlertWindowClass; available in
             Mac OS X, and CarbonLib 1.3 and later */
  kThemeBrushDrawerBackground = 51, /* use with kDrawerWindowClass; available in
                                       Mac OS X, and CarbonLib 1.3 and later */
  kThemeBrushToolbarBackground =
      52, /* use with kToolbarWindowClass; available in Mac OS X, and
             CarbonLib 1.6 and later */
  kThemeBrushSheetBackgroundTransparent =
      53, /* use with kSheetWindowClass and kSheetAlertWindowClass; available in
             Mac OS X 10.1 and CarbonLib 1.6, and later */
  kThemeBrushMenuBackground =
      54, /* available in Mac OS X 10.1 and CarbonLib 1.6, and later */
  kThemeBrushMenuBackgroundSelected =
      55 /* available in Mac OS X 10.1 and CarbonLib 1.6, and later */
};
...
enum {
  ...
  kThemeBrushPrimaryHighlightColor =
      -3, /* available in Mac OS 10.1 and CarbonLib 1.6, and later*/
  kThemeBrushSecondaryHighlightColor =
      -4 /* available in Mac OS 10.1 and CarbonLib 1.6, and later*/
};
...
enum {
  uppThemeTabTitleDrawProcInfo = 0x00036AC0
      ...
      4_bytes) */
#ifdef __cplusplus
inline DEFINE_API_C(ThemeTabTitleDrawUPP)
    NewThemeTabTitleDrawUPP(ThemeTabTitleDrawProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(ThemeEraseUPP)
    NewThemeEraseUPP(ThemeEraseProcPtr userRoutine) {
...
enum {
  uppThemeButtonDrawProcInfo = 0x0001BEC0
      ...
      1_byte) */
#ifdef __cplusplus
inline DEFINE_API_C(ThemeButtonDrawUPP)
    NewThemeButtonDrawUPP(ThemeButtonDrawProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(WindowTitleDrawingUPP)
    NewWindowTitleDrawingUPP(WindowTitleDrawingProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(ThemeIteratorUPP)
    NewThemeIteratorUPP(ThemeIteratorProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(MenuTitleDrawingUPP)
    NewMenuTitleDrawingUPP(MenuTitleDrawingProcPtr userRoutine) {
...
#ifdef __cplusplus
inline DEFINE_API_C(MenuItemDrawingUPP)
    NewMenuItemDrawingUPP(MenuItemDrawingProcPtr userRoutine) {
 ...
 */
EXTERN_API(OSStatus)
SetThemeTextColorForWindow(WindowRef inWindow, Boolean inActive, SInt16 inDepth,
                           Boolean inColorDev);
