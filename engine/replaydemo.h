...
private:
  friend class CReplayServer; // Calls to Start/StopRecording() should be
                              // funneled through CReplayServer
...
public:
  ...
  char m_szDumpFilename[MAX_OSPATH]; // The name of the file name to which we
                                     // are currently (or will eventually) write
                                     // the demo, depending on cvar,
                                     // "replay_record_directly_to_disk"
  bool m_bIsRecording;
