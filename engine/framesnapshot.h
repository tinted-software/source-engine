...
public:
  ...
  CHLTVEntityData *m_pHLTVEntityData; // is NULL if not in HLTV mode or array of
                                      // m_pValidEntities entries
  CReplayEntityData *m_pReplayEntityData; // is NULL if not in replay mode or
                                          // array of m_pValidEntities entries
