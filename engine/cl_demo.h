...
public:
  ...
  unsigned m_nSkipPacketsPlayed; // Track consecutive skip packets returned to
                                 // avoid excess
...
public:
  ...
  void RecordServerClasses(ServerClass *pClasses); // packet finished, write all
                                                   // recorded stuff to file
