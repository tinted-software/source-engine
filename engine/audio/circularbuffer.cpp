...
//			memory allocation, it simply informs the buffer of its
//size. Author  : DSpeyrer
//------------------------------------------------------------------------------
...
//calls to 			Read or Peek. Input   : pchDest - destination buffer. 			m_nCount -
//number of bytes to place in destination buffer. Output  : Returns the number
// of bytes placed in the destination buffer. Author  : DSpeyrer
//------------------------------------------------------------------------------
