...
VoiceRecord_OpenAL::~VoiceRecord_OpenAL() { ReleaseInterfaces(); }

void VoiceRecord_OpenAL::Release() { delete this; }
...
bool VoiceRecord_OpenAL::InitalizeInterfaces() {
  m_Device = alcCaptureOpenDevice(NULL, m_nSampleRate, AL_FORMAT_MONO16,
                                  m_nSampleRate * 10 * 2);
  const ALenum error = alcGetError(m_Device);
...
void VoiceRecord_OpenAL::ClearInterfaces() { m_Device = NULL; }
