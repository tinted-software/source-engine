...
static bool FindExtraDependency(unsigned short *pDependencies,
                                int nDependencies, int iDisp) {
...
VertexFormat_t
ComputeDisplacementStaticMeshVertexFormat(const IMaterial *pMaterial,
                                          const CDispGroup *pCombo,
