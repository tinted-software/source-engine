...
void NET_OutOfBandPrintf(int sock, const netadr_t &adr,
...
const char *
NET_ErrorString(int code); // translate a socket error into a friendly string
...
// Some hackery to avoid using va() in constructor since we cache off the
// pointer to the string in the ConVar!!!
