...
// FLASHLIGHTFIXME: Make all of the buckets share the same m_Elements (ie. make
// m_Elements static)

template <class Element_t> class CMaterialsBuckets {
public:
...
private:
  struct MaterialSortInfo_t {
    MaterialSortInfo_t()
        : m_FlushCount(-1), m_Head((unsigned short)-1) // i.e., InvalidIndex()
    {}
