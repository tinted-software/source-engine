...
public:
  ...
  bool SpawnServer(const char *szMapName, const char *szMapFile,
...
public:
  ...
  int num_edicts;
  int max_edicts;
  int free_edicts; // how many edicts in num_edicts are free, in use is
                   // num_edicts - free_edicts
...
private:
  ...
  bool m_bHibernating; // Are we hibernating.  Hibernation makes server process
                       // consume approx 0 CPU when no clients are connected
};
