...
void CDemoUIPanel2::GetDriveViewPoint(Vector &origin, QAngle &angle) { NULL; }
...
void CDemoUIPanel2::OnVDMChanged(void) { NULL; }
...
void CDemoUIPanel2::DrawDebuggingInfo() { NULL; }
...
static ConCommand demoui2("demoui2", DemoUI2_f,
                          ...
                          FCVAR_DONTRECORD);
static ConCommand
    demoui2_on("+demoui2", DemoUI2_on,
               "Bring the advanced demo player UI (demoui2) to foreground.",
               FCVAR_DONTRECORD);
static ConCommand
    demoui2_off("-demoui2", DemoUI2_off,
