...
private:
  ...
  static bool HandleUpload(dataFragments_t *data,
...
public:
  ...
  CUtlVector<dataFragments_t *>
      m_WaitingList[MAX_STREAMS]; // waiting list for reliable data and file
                                  // transfer
  ...
  int m_nProtocolVersion; // PROTOCOL_VERSION if we're not playing a demo -
                          // otherwise, whatever was in the demo header's
                          // networkprotocol if the CNetChan instance was
                          // created by a demo player.
};
