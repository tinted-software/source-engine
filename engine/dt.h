...
FORCEINLINE void CDeltaBitsReader::CopyPropData(bf_write *pOut,
...
FORCEINLINE int CDeltaBitsReader::ComparePropData(CDeltaBitsReader *pInReader,
                                                  const SendProp *pProp) {
...
inline CDeltaBitsWriter::~CDeltaBitsWriter() { m_pBuf->WriteOneBit(0); }
