...
public:
  ...
  }; // network channel is being closed by remote site
  ...
  }; // called each time a new packet arrived
  virtual void FileRequested(const char *fileName, unsigned int transferID) {
  }; // other side request a file for download
  ...
  }; // a file request was denied by other side
...
private:
  ...
  void SetPreventFullServerStartup(bool bState,
