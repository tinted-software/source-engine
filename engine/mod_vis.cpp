...
//usually 1, can be 0 if forcenovis is true ) 			origins[][3] - array of origins to
//merge together 			forcenovis - if set to true, ignore all origins and just mark
//everything as visible ( SLOW rendering!!! )
//-----------------------------------------------------------------------------
