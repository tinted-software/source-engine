...
// ------------------------------------------------------------------ //
template <class DataType> inline void SetToZero(DataType &data) { data = 0; }
...
template <class DataType, int nSamples> class CLowPassStream {
public:
  CLowPassStream();
...
template <class DataType, int nSamples>
inline void
CLowPassStream<DataType, nSamples>::AddSample(DataType const &data) {
