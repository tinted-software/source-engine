...
ConVar enable_debug_overlays("enable_debug_overlays", "1",
...
void AddCoordFrameOverlay(const matrix3x4_t &frame, float flScale,
                          int vColorTable[3][3] /*=NULL*/) {
  ...
  for (int k = 0; k < 3; k++) {
    ...
    AddLineOverlay(startPt, endPt, vColorTable[k][0], vColorTable[k][1],
                   vColorTable[k][2], 255, true,
...
// Output  :
//------------------------------------------------------------------------------
void AddScreenTextOverlay(float flXPos, float flYPos, int line_offset,
