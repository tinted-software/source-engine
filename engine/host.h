...
struct engineparms_t {
  char *basedir; // Executable directory ("c:/program files/half-life 2", for
                 // example)
...
void Host_EndGame(bool bShowMainMenu, PRINTF_FORMAT_STRING const char *message,
                  ...) FMTFUNCTION(2, 3);
...
bool Host_AllowLoadModule(const char *pFilename, const char *pPathID,
                          bool bAllowUnknown, bool bIsServerOnly = false);
