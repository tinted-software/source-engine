...
//
// Purpose: Handles loading/unloading of different vgui modules into a shared
// context
//
//=============================================================================//
...
public:
  ...
  bool LoadPlatformModules(CreateInterfaceFn *factorylist, int factorycount,
  ...
  // Deactivates all the modules (puts them into in inactive but recoverable
  // state)
