...
CPlayerItem::CPlayerItem(CDialogMenu *pParent, const char *pTitleLabel,
                         int64 nId, byte bVoice, bool bReady)
...
CAchievementItem::CAchievementItem(CDialogMenu *pParent, const wchar_t *pName,
                                   const wchar_t *pDesc, uint points,
                                   bool bUnlocked,
  ...
  if (IsX360()) {
    wchar_t *wzFormat =
        g_pVGuiLocalize->Find("#GameUI_Achievement_Points"); // "%s1G"
    wchar_t wzPoints[10];
    V_snwprintf(wzPoints, ARRAYSIZE(wzPoints), L"%d", points);
    wchar_t wzPointsLayout[10];
    g_pVGuiLocalize->ConstructString(wzPointsLayout, sizeof(wzPointsLayout),
                                     wzFormat, 1, wzPoints);
...
CAchievementItem *
CDialogMenu::AddAchievementItem(const wchar_t *pName, const wchar_t *pDesc,
                                uint points, bool bUnlocked,
                                IAchievement *pSourceAchievement) {
...
CPlayerItem *CDialogMenu::AddPlayerItem(const char *pTitleLabel, int64 nId,
                                        byte bVoice, bool bReady) {
