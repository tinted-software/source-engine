...
struct CommentaryItem_t {
  char
      szMapFileName[COMMENTARY_MAPFILENAME_MAX_LEN]; // file location of the map
  char szMapName[COMMENTARY_MAPNAME_MAX_LEN];   // clean name of the map, eg
                                                // "dod_kalt"
  char szPrintName[COMMENTARY_MAPNAME_MAX_LEN]; // printable name "Kalt"
  char
      szDescription[COMMENTARY_DESCRIP_MAX_LEN]; // track description "This map
                                                 // is fun, and people like it!"

  // int iChannel;		// TODO: multiple channels within a single map,
  // loaded into separate commentary tracks
};
