...
//--------------------------------------------------------------------------------------------------------------
CTextEntryBox::CTextEntryBox(const char *title, const char *queryText,
                             const char *entryText, bool isCvar,
                             vgui::Panel *parent)
...
//--------------------------------------------------------------------------------------------------------------
CTextEntryBox::~CTextEntryBox() { delete m_pEntry; }
...
void CTextEntryBox::PerformLayout() {
  ...
  m_pEntry->SetPos(borderW + m_pMessageLabel->GetWide() + borderW,
                   y - (entryH - labelH));
}
