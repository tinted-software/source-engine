...
public:
  VScrollBarReversedButtons(Panel *parent, const char *panelName,
                            bool vertical);
  virtual void ApplySchemeSettings(IScheme *pScheme);
};

VScrollBarReversedButtons::VScrollBarReversedButtons(Panel *parent,
...
void VScrollBarReversedButtons::ApplySchemeSettings(IScheme *pScheme) {
  ...
  Button *pButton;
  pButton = GetButton(0);
  pButton->SetArmedColor(pButton->GetSchemeColor("DimBaseText", pScheme),
                         pButton->GetBgColor());
  pButton->SetDepressedColor(pButton->GetSchemeColor("DimBaseText", pScheme),
                             pButton->GetBgColor());
...
// Output :
//-----------------------------------------------------------------------------
CPanelListPanel::CPanelListPanel(vgui::Panel *parent, char const *panelName,
                                 bool inverseButtons)
...
// Output :
//-----------------------------------------------------------------------------
int CPanelListPanel::GetItemCount(void) { return _dataItems.GetCount(); }
...
// Purpose:
//-----------------------------------------------------------------------------
void CPanelListPanel::PaintBackground() { Panel::PaintBackground(); }
...
void CPanelListPanel::ApplySchemeSettings(IScheme *pScheme) {
  ...
  //	_selectionFgColor = GetSchemeColor("ListSelectionFgColor",
  //_labelFgColor);
}
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void CPanelListPanel::SetSliderYOffset(int pixels) { _sliderYOffset = pixels; }
