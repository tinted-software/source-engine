...
void CSaveGameDialogXbox::OnDoneScanningSaveGames(void) {
  ...
  // We only allow 10 save games minus the number of autosaves,
  // autosavedangerous, and autosave0?'s at once
  ...
  SaveGameDescription_t bogusDesc = {"#GameUI_SaveGame_NewSavedGame",
                                     ...
                                     0,
                                     0};
  CGameSavePanel *newSavePanel =
      SETUP_PANEL(new CGameSavePanel(this, &bogusDesc, true));
