...
CDmElementDictionary::InsertElement(CDmElement *pElement) {
...
DmElementHandle_t CDmElementDictionary::SetElementId(
  ...
  if (idConflictResolution == CR_FORCE_COPY) {
    m_idmap.Insert(DmIdPair_t(
        newId, oldId)); // map the newId back to the old id, and keep the old id
    return hElement;
  }
...
//-----------------------------------------------------------------------------
DmElementDictHandle_t
CDmElementSerializationDictionary::Find(CDmElement *pElement) {
  ElementInfo_t find;
...
//-----------------------------------------------------------------------------
DmElementDictHandle_t
CDmElementSerializationDictionary::FirstRootElement() const {
...
CDmElement *
CDmElementSerializationDictionary::GetRootElement(DmElementDictHandle_t h) {
