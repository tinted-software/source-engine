...
public:
  ...
  GetVideoSystemFeatures(VideoSystem_t videoSystem);
  ...
  virtual const char *GetSupportedFileExtension(VideoSystem_t videoSystem,
                                                int extNum = 0);
  virtual VideoSystemFeature_t
  GetSupportedFileExtensionFeatures(VideoSystem_t videoSystem, int extNum = 0);
...
private:
  ...
  CUtlVector<VideoFileExtensionInfo_t>
      m_ExtInfo; // info about supported file extensions
...
public:
  ...
  virtual bool CalculateVideoDimensions(int videoWidth, int videoHeight,
                                        int displayWidth, int displayHeight,
                                        VideoPlaybackFlags_t playbackFlags,
                                        int *pOutputWidth, int *pOutputHeight,
                                        int *pXOffset, int *pYOffset);

  virtual float GetSystemVolume();

  virtual VideoResult_t
  InitFullScreenPlaybackInputHandler(VideoPlaybackFlags_t playbackFlags,
                                     float forcedMinTime, bool windowed);

  virtual bool ProcessFullScreenInput(bool &bAbortEvent, bool &bPauseEvent,
                                      bool &bQuitEvent);
