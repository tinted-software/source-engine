...
EXPOSE_SINGLE_INTERFACE_GLOBALVAR(CBinkVideoSubSystem, IVideoSubSystem,
...
CBinkVideoSubSystem::CBinkVideoSubSystem()
    : m_bBinkInitialized(false), m_LastResult(VideoResult::SUCCESS),
...
bool CBinkVideoSubSystem::Connect(CreateInterfaceFn factory) {
  ...
  if (g_pFullFileSystem == nullptr || materials == nullptr) {
    Msg("Bink video subsystem failed to connect to missing a required "
        "system\n");
    return false;
  }
  return true;
...
void CBinkVideoSubSystem::Disconnect() { BaseClass::Disconnect(); }
...
// ===========================================================================
VideoSystem_t CBinkVideoSubSystem::GetSystemID() { return VideoSystem::BINK; }
...
const char *CBinkVideoSubSystem::GetVideoSystemName() { return "BINK"; }

// ===========================================================================
// IVideoSubSystem setup and shutdown services
// ===========================================================================
bool CBinkVideoSubSystem::InitializeVideoSystem(
...
VideoResult_t
CBinkVideoSubSystem::VideoSoundDeviceCMD(VideoSoundDeviceOperation_t operation,
...
const char *CBinkVideoSubSystem::GetSupportedFileExtension(int num) {
  return (num < 0 || num >= s_BinkExtensionCount)
             ? nullptr
             : s_BinkExtensions[num].m_FileExtension;
}

VideoSystemFeature_t
CBinkVideoSubSystem::GetSupportedFileExtensionFeatures(int num) {
  return (num < 0 || num >= s_BinkExtensionCount)
             ? VideoSystemFeature::NO_FEATURES
             : s_BinkExtensions[num].m_VideoFeatures;
}

// ===========================================================================
// IVideoSubSystem Video Playback and Recording Services
// ===========================================================================
VideoResult_t CBinkVideoSubSystem::PlayVideoFileFullScreen(
...
// ===========================================================================
IVideoMaterial *
CBinkVideoSubSystem::CreateVideoMaterial(const char *pMaterialName,
...
VideoResult_t
CBinkVideoSubSystem::DestroyVideoMaterial(IVideoMaterial *pVideoMaterial) {
...
VideoResult_t
CBinkVideoSubSystem::DestroyVideoRecorder(IVideoRecorder *pRecorder) {
  return SetResult(VideoResult::FEATURE_NOT_AVAILABLE);
}

VideoResult_t
CBinkVideoSubSystem::CheckCodecAvailability(VideoEncodeCodec_t codec) {
  AssertExitV(m_CurrentStatus == VideoSystemStatus::OK,
              SetResult(VideoResult::SYSTEM_NOT_AVAILABLE));
...
// Status support
// ===========================================================================
VideoResult_t CBinkVideoSubSystem::GetLastResult() { return m_LastResult; }
