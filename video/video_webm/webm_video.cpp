...
EXPOSE_SINGLE_INTERFACE_GLOBALVAR(CWebMVideoSubSystem, IVideoSubSystem,
...
const VideoSystemFeature_t CWebMVideoSubSystem::DEFAULT_FEATURE_SET =
    VideoSystemFeature::FULL_ENCODE;

// ===========================================================================
// CWebMVideoSubSystem class
// ===========================================================================
CWebMVideoSubSystem::CWebMVideoSubSystem()
    : m_bWebMInitialized(false), m_LastResult(VideoResult::SUCCESS),
...
bool CWebMVideoSubSystem::Connect(CreateInterfaceFn factory) {
  ...
  if (g_pFullFileSystem == nullptr || materials == nullptr) {
    Msg("WebM video subsystem failed to connect to missing a required "
        "system\n");
    return false;
  }
  return true;
...
void CWebMVideoSubSystem::Disconnect() { BaseClass::Disconnect(); }
...
// ===========================================================================
VideoSystem_t CWebMVideoSubSystem::GetSystemID() { return VideoSystem::WEBM; }
...
const char *CWebMVideoSubSystem::GetVideoSystemName() { return "WebM"; }
...
VideoResult_t
CWebMVideoSubSystem::VideoSoundDeviceCMD(VideoSoundDeviceOperation_t operation,
...
const char *CWebMVideoSubSystem::GetSupportedFileExtension(int num) {
  return (num < 0 || num >= s_WebMExtensionCount)
             ? nullptr
             : s_WebMExtensions[num].m_FileExtension;
}

VideoSystemFeature_t
CWebMVideoSubSystem::GetSupportedFileExtensionFeatures(int num) {
  return (num < 0 || num >= s_WebMExtensionCount)
...
// ===========================================================================
VideoResult_t CWebMVideoSubSystem::PlayVideoFileFullScreen(
...
// ===========================================================================
IVideoMaterial *
CWebMVideoSubSystem::CreateVideoMaterial(const char *pMaterialName,
...
VideoResult_t
CWebMVideoSubSystem::DestroyVideoMaterial(IVideoMaterial *pVideoMaterial) {
  return SetResult(VideoResult::FEATURE_NOT_AVAILABLE);
}
...
VideoResult_t
CWebMVideoSubSystem::DestroyVideoRecorder(IVideoRecorder *pRecorder) {
...
VideoResult_t
CWebMVideoSubSystem::CheckCodecAvailability(VideoEncodeCodec_t codec) {
  AssertExitV(m_CurrentStatus == VideoSystemStatus::OK,
              SetResult(VideoResult::SYSTEM_NOT_AVAILABLE));
...
// Status support
// ===========================================================================
VideoResult_t CWebMVideoSubSystem::GetLastResult() { return m_LastResult; }
