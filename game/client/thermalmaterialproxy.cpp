...
// $ThermalVar : name of variable to run Thermal wave on (can either be a color
// or a float) $ThermalPeriod: time that it takes to go through whole Thermal
// wave in seconds (default: 1.0f) $ThermalMax : the max value for the Thermal
// wave (default: 1.0f ) $ThermalMin: the min value for the Thermal wave
// (default: 0.0f )
...
EXPOSE_INTERFACE(CThermalMaterialProxy, IMaterialProxy,
                 "Thermal" IMATERIAL_PROXY_INTERFACE_VERSION);
