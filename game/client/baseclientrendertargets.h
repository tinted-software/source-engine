...
// games.
//			Mods who wish to make their own render targets can
//inherit from this class 			and in the 'InitClientRenderTargets' interface called
//by the engine, set up 			their own render targets as well as calling the init
//functions for various 			common render targets provided by this class.
//
...
public:
  ...
  virtual void
  InitClientRenderTargets(IMaterialSystem *pMaterialSystem,
                          IMaterialSystemHardwareConfig *pHardwareConfig,
                          int iWaterTextureSize = 1024,
