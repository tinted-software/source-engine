...
public:
  ...
  void MuzzleFlash(const Vector &pos1, const QAngle &angles, int type,
                   ClientEntityHandle_t hEntity, bool firstPerson = false);
...
void CHL1TempEnts::LevelInit() {
  ...
  m_pSpriteMuzzleFlash[0] =
      (model_t *)engine->LoadModel("sprites/muzzleflash1.vmt");
  m_pSpriteMuzzleFlash[1] =
      (model_t *)engine->LoadModel("sprites/muzzleflash2.vmt");
  m_pSpriteMuzzleFlash[2] =
      (model_t *)engine->LoadModel("sprites/muzzleflash3.vmt");
}
...
void CHL1TempEnts::MuzzleFlash(const Vector &pos1, const QAngle &angles,
                               int type, ClientEntityHandle_t hEntity,
                               bool firstPerson) {
