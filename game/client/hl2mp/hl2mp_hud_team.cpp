...
CTeamPlayHud::CTeamPlayHud(const char *pElementName)
  ...
  m_pWarmupLabel = new vgui::Label(
      this, "RoundState_warmup",
      "test label" /*g_pVGuiLocalize->Find( "#Clan_warmup_mode" )*/);
...
void CTeamPlayHud::OnThink() {
  ...
  if (pTeam) {
    ...
    g_pVGuiLocalize->ConstructString(
        string1, sizeof(string1), g_pVGuiLocalize->Find("#Team"), 1, TeamName);
