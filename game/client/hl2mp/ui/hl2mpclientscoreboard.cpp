...
void CHL2MPClientScoreBoardDialog::AddHeader() {
  ...
  //SectionedListPanel::COLUMN_CENTER, scheme()->GetProportionalScaledValueEx(
  //GetScheme(), CSTRIKE_VOICE_WIDTH ) ); 	m_pPlayerList->AddColumnToSection(0,
  //"tracker", "#PlayerTracker", SectionedListPanel::COLUMN_IMAGE |
  //SectionedListPanel::HEADER_TEXT, scheme()->GetProportionalScaledValueEx(
  ...
  if (teamType == TYPE_TEAM) {
    ...
    m_pPlayerList->AddColumnToSection(sectionID, "class", "", 0,
                                      scheme()->GetProportionalScaledValueEx(
                                          GetScheme(), CSTRIKE_CLASS_WIDTH));
    m_pPlayerList->AddColumnToSection(sectionID, "frags", "",
                                      SectionedListPanel::COLUMN_RIGHT,
                                      scheme()->GetProportionalScaledValueEx(
                                          GetScheme(), CSTRIKE_SCORE_WIDTH));
    m_pPlayerList->AddColumnToSection(sectionID, "deaths", "",
                                      SectionedListPanel::COLUMN_RIGHT,
                                      scheme()->GetProportionalScaledValueEx(
                                          GetScheme(), CSTRIKE_DEATH_WIDTH));
    m_pPlayerList->AddColumnToSection(sectionID, "ping", "",
                                      SectionedListPanel::COLUMN_RIGHT,
                                      scheme()->GetProportionalScaledValueEx(
                                          GetScheme(), CSTRIKE_PING_WIDTH));
...
//-----------------------------------------------------------------------------
bool CHL2MPClientScoreBoardDialog::GetPlayerScoreInfo(int playerIndex,
                                                      KeyValues *kv) {
