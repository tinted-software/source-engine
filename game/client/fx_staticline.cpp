...
CFXStaticLine::CFXStaticLine(const char *name, const Vector &start,
                             const Vector &end, float scale, float life,
...
CFXStaticLine::~CFXStaticLine(void) { Destroy(); }
...
bool CFXStaticLine::IsActive(void) { return (m_fLife > 0.0) ? true : false; }
...
void CFXStaticLine::Update(double frametime) { m_fLife -= frametime; }
