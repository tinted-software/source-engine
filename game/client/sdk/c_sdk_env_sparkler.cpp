...
public:
  ...
  virtual void OnDataChanged(
      DataUpdateType_t updateType); // Called when data changes on the server
...
private:
  ...
  PMaterialHandle
      m_hMaterial; // Material handle used for this entity's particles
...
void SparkleCallback(const CEffectData &data) {
  ...
  PMaterialHandle hMaterial =
      pSparkleEmitter->GetPMaterial("effects/yellowflare");
