...
//-----------------------------------------------------------------------------
// Purpose:  Draws information about one achievement (name, description,
// progress)
//-----------------------------------------------------------------------------
...
protected:
  ...
  CPanelAnimationVarAliasType(
      int, m_iPadding, "Padding", "1",
      "proportional_int"); // space between description and bar
};

//---------------------------------------------------------------------------------------------
// Purpose:  Scrolls a floating number up the screen to indicate achievement
// progression
//---------------------------------------------------------------------------------------------
...
public:
  CFloatingAchievementNumber(int iProgress, int x, int y,
...
protected:
  ...
  CPanelAnimationVarAliasType(
      ...
      "proportional_int"); // how far the floating number will scroll up before
...
//-----------------------------------------------------------------------------
class CHudBaseAchievementTracker : public CHudElement,
                                   public vgui::EditablePanel {
...
protected:
  ...
  CPanelAnimationVarAliasType(
      int, m_iItemPadding, "ItemPadding", "8",
