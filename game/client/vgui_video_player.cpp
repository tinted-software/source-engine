...
VideoPlayerPanel::VideoPlayerPanel(vgui::Panel *parent, const char *panelName,
                                   int nXpos, int nYpos, int nWidth,
                                   int nHeight, const char *pVideoFile)
    : BaseClass(parent, panelName), m_VideoMaterial(NULL),
      m_VideoFileName(NULL), m_VideoLoaded(false), m_VideoPlaying(false) {
  ...
  // "resource/VideoPlayerPanelScheme.res", "VideoPlayerPanelScheme"));
...
bool VideoPlayerPanel::SetVideo(const char *pVideoFile) {
  ...
  m_VideoMaterial = g_pVideo->CreateVideoMaterial(
      "VideoPlayerMaterial", pVideoFile, "GAME",
