...
protected:
  virtual void TestForPlane(const Vector &start, const Vector &dir, float speed,
                            float gravity);
...
public:
  ...
  virtual bool MoveParticle(Vector &origin, Vector &velocity, float *rollDelta,
                            float timeDelta, trace_t *pTrace);
