...
CConveyorMaterialProxy::CConveyorMaterialProxy() { m_pTextureScrollVar = NULL; }
...
EXPOSE_INTERFACE(CConveyorMaterialProxy, IMaterialProxy,
                 "ConveyorScroll" IMATERIAL_PROXY_INTERFACE_VERSION);
