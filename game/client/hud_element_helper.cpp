...
//			depth - determines position in the creation list, 100 is
//farthest into the screen 					0 is nearest, default is 50
//
//-----------------------------------------------------------------------------
CHudElementHelper::CHudElementHelper(CHudElement *(*pfnCreate)(void),
                                     int depth) {
