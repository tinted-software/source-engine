...
wchar_t *
ReadLocalizedString(bf_read &msg, OUT_Z_BYTECAP(outSizeInBytes) wchar_t *pOut,
                    int outSizeInBytes, bool bStripNewline,
                    OUT_Z_CAP(originalSize) char *originalString = NULL,
                    int originalSize = 0);
...
public:
  ...
  virtual void
  Colorize(int alpha = 255); ///< Re-inserts the text in the appropriate colors
                             ///< at the given alpha
