...
public:
  CPortalgunEffect(void)
      : m_vecColor(255, 255, 255), m_bVisibleViewModel(true),
        m_bVisible3rdPerson(true), m_nAttachment(-1) {}
...
private:
  ...
  CNetworkVar(
      float,
      m_fCanPlacePortal1OnThisSurface); // Tells the gun if it can place on the
                                        // surface it's pointing at
  CNetworkVar(
      float,
      m_fCanPlacePortal2OnThisSurface); // Tells the gun if it can place on the
                                        // surface it's pointing at
...
public:
  ...
  void Spawn(void);
  void DoEffectCreate(Vector &vDir, Vector &ptStart, Vector &ptEnd,
                      bool bPortal1, bool bPlayer);
...
#define NUM_GLOW_SPRITES                                                       \
  ((C_WeaponPortalgun::PORTALGUN_GLOW6 - C_WeaponPortalgun::PORTALGUN_GLOW1) + \
   1)
#define NUM_GLOW_SPRITES_WORLD                                                 \
  ((C_WeaponPortalgun::PORTALGUN_GLOW6_WORLD -                                 \
    C_WeaponPortalgun::PORTALGUN_GLOW1_WORLD) +                                \
   1)
#define NUM_ENDCAP_SPRITES                                                     \
  ((C_WeaponPortalgun::PORTALGUN_ENDCAP3 -                                     \
    C_WeaponPortalgun::PORTALGUN_ENDCAP1) +                                    \
   1)
#define NUM_ENDCAP_SPRITES_WORLD                                               \
  ((C_WeaponPortalgun::PORTALGUN_ENDCAP3_WORLD -                               \
    C_WeaponPortalgun::PORTALGUN_ENDCAP1_WORLD) +                              \
   1)
#define NUM_TUBE_BEAM_SPRITES                                                  \
  ((C_WeaponPortalgun::PORTALGUN_TUBE_BEAM5 -                                  \
    C_WeaponPortalgun::PORTALGUN_TUBE_BEAM1) +                                 \
   1)
#define NUM_TUBE_BEAM_SPRITES_WORLD                                            \
  ((C_WeaponPortalgun::PORTALGUN_TUBE_BEAM5_WORLD -                            \
    C_WeaponPortalgun::PORTALGUN_TUBE_BEAM1_WORLD) +                           \
   1)
...
#define NUM_PORTALGUN_BEAMS 6
  ...
  CPortalgunEffect
      m_Parameters[NUM_PORTALGUN_PARAMETERS]; // Interpolated parameters for the
                                              // effects
