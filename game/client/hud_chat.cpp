...
void CHudChat::MsgFunc_TextMsg(bf_read &msg) {
  ...
  StripEndNewlineFromString(
      sstr1); // these strings are meant for subsitution into the main strings,
              // so cull the automatic end newlines
  msg.ReadString(szString, sizeof(szString));
  ...
  case HUD_PRINTNOTIFY:
    ...
    Q_snprintf(psz + 1, sizeof(szBuf[5]) - 1, msg_text, sstr1, sstr2, sstr3,
               sstr4);
