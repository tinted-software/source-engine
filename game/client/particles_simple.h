...
protected:
  ...
  enum {
    FLAG_ALLOCATED = (1 << 1), // Most of the CParticleEffects are dynamically
                               // allocated but some are member variables of a
                               // class. If they're member variables.
...
public:
  ...
  SimpleParticle *AddSimpleParticle(PMaterialHandle hMaterial,
                                    const Vector &vOrigin, float flDieTime = 3,
