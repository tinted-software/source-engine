...
//
// Purpose: Particles which are simulated locally to some space (attachment,
// bone, etc)
//
//=============================================================================//
...
//-----------------------------------------------------------------------------
CSmartPtr<CLocalSpaceEmitter>
CLocalSpaceEmitter::Create(const char *pDebugName, ClientEntityHandle_t hEntity,
...
//-----------------------------------------------------------------------------
void CLocalSpaceEmitter::Update(float flTimeDelta) { SetupTransformMatrix(); }

extern void FormatViewModelAttachment(Vector &vOrigin, bool bInverse);

void CLocalSpaceEmitter::SimulateParticles(
...
void CLocalSpaceEmitter::RenderParticles(CParticleRenderIterator *pIterator) {
  ...
  while (pParticle) {
    ...
    RenderParticle_ColorSizeAngle(
        pIterator->GetParticleDraw(), screenPos, UpdateColor(pParticle),
...
void CLocalSpaceEmitter::SetupTransformMatrix(void) {
  ...
  // We preapply the local transform because we need to squash it for viewmodel
  // FOV.
