...
static ConVar mat_showcamerarendertarget("mat_showcamerarendertarget", "0",
                                         FCVAR_CHEAT);
static ConVar
    mat_camerarendertargetoverlaysize("mat_camerarendertargetoverlaysize",
                                      "256", FCVAR_CHEAT);
...
#ifdef _X360
static ConVar
    mat_drawColorRamp("mat_drawColorRamp", "0", 0,
                      "Draw color test pattern (0=Off, 1=[0..255], 2=[0..127]");
#endif
...
ConVar
    mat_showlightmappage("mat_showlightmappage",
                         "-1"); // set this to the lightmap page that you want
                                // to see on screen, set to -1 to show nothing.
