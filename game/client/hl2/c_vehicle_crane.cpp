...
RecvPropEHandle(RECVINFO(m_hPlayer)), RecvPropBool(RECVINFO(m_bMagnetOn)),
...
//-----------------------------------------------------------------------------
void C_PropCrane::GetVehicleViewPosition(int nRole, Vector *pAbsOrigin,
                                         QAngle *pAbsAngles,
                                         float *pFOV /*=NULL*/) {
...
void C_PropCrane::GetRenderBounds(Vector &theMins, Vector &theMaxs) {
  // This is kind of hacky:( Add 660.0 to the y coordinate of the bounding box
  // to allow for the full extension of the crane arm.
