...
bool CHeliBladeMaterialProxy::Init(IMaterial *pMaterial,
...
EXPOSE_INTERFACE(CHeliBladeMaterialProxy, IMaterialProxy,
                 "HeliBlade" IMATERIAL_PROXY_INTERFACE_VERSION);
