...
IMPLEMENT_CLIENTCLASS_DT(C_CitadelEnergyCore, DT_CitadelEnergyCore,
                         CCitadelEnergyCore)
...
void C_CitadelEnergyCore::UpdateDischarging(void) {
  ...
  for (int i = 0; i < 4; i++) {
    ...
    dist =
        RemapValClamped(dist, 4.0f * m_flScale, 64.0f * m_flScale, 6.0f, 1.0f);
    offset += right * random->RandomFloat(-2.0f * dist * m_flScale,
                                          2.0f * dist * m_flScale);
    offset += up * random->RandomFloat(-2.0f * dist * m_flScale,
                                       2.0f * dist * m_flScale);
