...
struct DeathNoticeItem {
  ...
  wchar_t
      wzInfoTextEnd[32]; // any additional text to display next to victim name
...
protected:
  ...
  enum EDeathNoticeIconFormat {
    ...
    kDeathNoticeIcon_Inverted, // used for display on lighter background when
                               // kill involved the local player
  };
