...
public:
  ...
  void ForceShadowCastType(bool bForce,
                           ShadowType_t forcedShadowType = SHADOWS_NONE) {
...
private:
  C_NextBotCombatCharacter(
      const C_NextBotCombatCharacter &); // not defined, not accessible
};
...
private:
  ...
  CUtlVector<C_NextBotCombatCharacter *>
      m_botList; ///< list of all active NextBots
