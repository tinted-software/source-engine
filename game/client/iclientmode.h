...
public:
  ...
  // Note that Enable and Disable are called when the DLL initializes and shuts
  // down.
  ...
  virtual void DisplayReplayMessage(const char *pLocalizeName, float flDuration,
                                    bool bUrgent, const char *pSound,
                                    bool bDlg) = 0;
