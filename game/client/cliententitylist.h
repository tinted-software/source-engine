...
template <class T> class C_EntityClassList : public C_BaseEntityClassList {
public:
...
public:
  ...
  GetClientNetworkableFromHandle(ClientEntityHandle_t hEnt);
...
//-----------------------------------------------------------------------------
inline bool
CClientEntityList::IsHandleValid(ClientEntityHandle_t handle) const {
  return handle.Get() != 0;
}
...
inline IClientUnknown *
CClientEntityList::GetClientUnknownFromHandle(ClientEntityHandle_t hEnt) {
