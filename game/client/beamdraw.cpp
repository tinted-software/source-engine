...
void DrawSegs(int noise_divisions, float *prgNoise, const model_t *spritemodel,
  ...
  vLast =
      fmod(freq * speed, 1); // Scroll speed 3.5 -- initial texture position,
                             // scrolls 3.5/sec (1.0 is entire texture)
...
void BeamDrawHalo(const model_t *spritemodel, float frame, int rendermode,
  ...
  DrawHalo(pSprite->GetMaterial((RenderMode_t)rendermode), source, scale, color,
           flHDRColorScale);
}
