...
// Recording
//-----------------------------------------------------------------------------
static inline void RecordMetalSparks(const Vector &start,
...
// Recording
//-----------------------------------------------------------------------------
static inline void RecordArmorRicochet(const Vector &start,
                                       const Vector &direction) {
  if (!ToolsEnabled())
    return;
...
RecvPropVector(RECVINFO(m_vecPos)), RecvPropVector(RECVINFO(m_vecDir)),
    END_RECV_TABLE()
        ...
        IMPLEMENT_CLIENTCLASS_EVENT(C_TEArmorRicochet, DT_TEArmorRicochet,
                                    CTEArmorRicochet);
