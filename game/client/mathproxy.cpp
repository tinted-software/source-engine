...
EXPOSE_INTERFACE(CAddProxy, IMaterialProxy,
                 "Add" IMATERIAL_PROXY_INTERFACE_VERSION);
...
EXPOSE_INTERFACE(CSubtractProxy, IMaterialProxy,
                 "Subtract" IMATERIAL_PROXY_INTERFACE_VERSION);
...
EXPOSE_INTERFACE(CMultiplyProxy, IMaterialProxy,
                 "Multiply" IMATERIAL_PROXY_INTERFACE_VERSION);
...
EXPOSE_INTERFACE(CDivideProxy, IMaterialProxy,
                 "Divide" IMATERIAL_PROXY_INTERFACE_VERSION);
...
EXPOSE_INTERFACE(CClampProxy, IMaterialProxy,
                 "Clamp" IMATERIAL_PROXY_INTERFACE_VERSION);

//-----------------------------------------------------------------------------
// Creates a sinusoid
//-----------------------------------------------------------------------------

// sinePeriod: time that it takes to go through whole sine wave in seconds
// (default: 1.0f) sineMax : the max value for the sine wave (default: 1.0f )
...
void CSineProxy::OnBind(void *pC_BaseEntity) {
  ...
  // get a value in [0,1]
  flValue = (sin(2.0f * M_PI * (gpGlobals->curtime - flSineTimeOffset) /
                 flSinePeriod) *
             0.5f) +
            0.5f;
...
EXPOSE_INTERFACE(CSineProxy, IMaterialProxy,
                 "Sine" IMATERIAL_PROXY_INTERFACE_VERSION);
...
EXPOSE_INTERFACE(CEqualsProxy, IMaterialProxy,
                 "Equals" IMATERIAL_PROXY_INTERFACE_VERSION);
...
EXPOSE_INTERFACE(CFracProxy, IMaterialProxy,
                 "Frac" IMATERIAL_PROXY_INTERFACE_VERSION);
...
EXPOSE_INTERFACE(CIntProxy, IMaterialProxy,
                 "Int" IMATERIAL_PROXY_INTERFACE_VERSION);
...
EXPOSE_INTERFACE(CLinearRampProxy, IMaterialProxy,
                 "LinearRamp" IMATERIAL_PROXY_INTERFACE_VERSION);
...
void CUniformNoiseProxy::OnBind(void *pC_BaseEntity) {
  SetFloatResult(
      random->RandomFloat(m_flMinVal.GetFloat(), m_flMaxVal.GetFloat()));
...
EXPOSE_INTERFACE(CUniformNoiseProxy, IMaterialProxy,
                 "UniformNoise" IMATERIAL_PROXY_INTERFACE_VERSION);
...
EXPOSE_INTERFACE(CGaussianNoiseProxy, IMaterialProxy,
                 "GaussianNoise" IMATERIAL_PROXY_INTERFACE_VERSION);
...
void CExponentialProxy::OnBind(void *pC_BaseEntity) {
  float flVal =
      m_Scale.GetFloat() * exp(m_pSrc1->GetFloatValue() + m_Offset.GetFloat());
...
EXPOSE_INTERFACE(CExponentialProxy, IMaterialProxy,
                 "Exponential" IMATERIAL_PROXY_INTERFACE_VERSION);
...
EXPOSE_INTERFACE(CAbsProxy, IMaterialProxy,
                 "Abs" IMATERIAL_PROXY_INTERFACE_VERSION);
...
EXPOSE_INTERFACE(CEmptyProxy, IMaterialProxy,
                 "Empty" IMATERIAL_PROXY_INTERFACE_VERSION);
...
EXPOSE_INTERFACE(CLessOrEqualProxy, IMaterialProxy,
                 "LessOrEqual" IMATERIAL_PROXY_INTERFACE_VERSION);
...
void CWrapMinMaxProxy::OnBind(void *pC_BaseEntity) {
  ...
  if (m_flMaxVal.GetFloat() <=
      m_flMinVal.GetFloat()) // Bad input, just return the min
  {
    SetFloatResult(m_flMinVal.GetFloat());
  } else {
    float flResult = (m_pSrc1->GetFloatValue() - m_flMinVal.GetFloat()) /
                     (m_flMaxVal.GetFloat() - m_flMinVal.GetFloat());
...
EXPOSE_INTERFACE(CWrapMinMaxProxy, IMaterialProxy,
                 "WrapMinMax" IMATERIAL_PROXY_INTERFACE_VERSION);
...
bool CSelectFirstIfNonZeroProxy::Init(IMaterial *pMaterial,
...
EXPOSE_INTERFACE(CSelectFirstIfNonZeroProxy, IMaterialProxy,
                 "SelectFirstIfNonZero" IMATERIAL_PROXY_INTERFACE_VERSION);