...
//
// Purpose: To display the player's health with the use of one graphic over
// another.  A cross in this case
...
// Purpose:
//-----------------------------------------------------------------------------
CCSHudPlayerHealth::CCSHudPlayerHealth(Panel *parent, const char *name)
...
// Purpose:
//-----------------------------------------------------------------------------
void CCSHudPlayerHealth::SetHealth(int iNewHealth, int iMaxHealth,
                                   int iMaxBuffedHealth) {
...
// Purpose:
//-----------------------------------------------------------------------------
CCSHealthPanel::CCSHealthPanel(Panel *parent, const char *name)
  ...
  surface()->DrawSetTextureFile(m_iMaterialIndex, "hud/health_color", true,
                                false);
  ...
  surface()->DrawSetTextureFile(m_iDeadMaterialIndex, "hud/health_dead", true,
                                false);
}
