...
protected:
  ...
  struct TeamDisplayInfo {
    ...
    CUtlVector<PlayerScoreInfo *>
        playerScores; // For sorting team members outside of the listboxes
  ...
  static int PlayerSortFunction(PlayerScoreInfo *const *pPS1,
                                PlayerScoreInfo *const *pPS2);
