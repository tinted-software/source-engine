...
// ------------------------------------------------------------------------------------------
// // CPlantedC4 class. For now to show the planted c4 on the radar - client
// proxy to remove the CBaseAnimating network vars?
// ------------------------------------------------------------------------------------------
// //
...
public:
  ...
  CNewParticleEffect
      *m_pC4Explosion; // client side explosion particle effect for the bomb
};
