 ...
 */
class C_CHostage : public C_BaseCombatCharacter,
...
private:
  ...
  static void RecvProxy_Rescued(const CRecvProxyData *pData, void *pStruct,
                                void *pOut);
  ...
  void
  UpdateLookAt(CStudioHdr *pStudioHdr); // orient head and eyes towards m_lookAt
