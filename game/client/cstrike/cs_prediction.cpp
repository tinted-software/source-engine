...
// Purpose:
//-----------------------------------------------------------------------------
void CCSPrediction::SetupMove(C_BasePlayer *player, CUserCmd *ucmd,
                              IMoveHelper *pHelper, CMoveData *move) {
...
// Purpose:
//-----------------------------------------------------------------------------
void CCSPrediction::FinishMove(C_BasePlayer *player, CUserCmd *ucmd,
                               CMoveData *move) {
...
EXPOSE_SINGLE_INTERFACE_GLOBALVAR(CCSPrediction, IPrediction,
