...
void CStrike_EjectBrass(int shell, const CEffectData &data) {
  ...
  tempents->CSEjectBrass(data.m_vOrigin, data.m_vAngles, data.m_fFlags, shell,
                         pPlayer);
}
...
DECLARE_CLIENT_EFFECT("EjectBrass_12Gauge",
                      CStrike_FX_EjectBrass_12Gauge_Callback);
...
DECLARE_CLIENT_EFFECT("EjectBrass_762Nato",
                      CStrike_FX_EjectBrass_762Nato_Callback);
DECLARE_CLIENT_EFFECT("EjectBrass_338Mag",
