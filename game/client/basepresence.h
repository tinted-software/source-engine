...
public:
  ...
  // IPresence Interface
  virtual void UserSetContext(unsigned int nUserIndex, unsigned int nContextId,
                              unsigned int nContextValue, bool bAsync = false);
...
protected:
  ...
  CON_COMMAND_MEMBER_F(
      CBasePresence, "user_context", DebugUserSetContext,
