...
public:
  ...
  virtual bool
  Weapon_Switch(C_BaseCombatWeapon *pWeapon,
                int viewmodelindex =
...
public:
  ...
  EHANDLE m_hZoomOwner; // This is a pointer to the entity currently controlling
                        // the player's zoom Only this entity can change the
                        // zoom state once it has ownership
