...
void C_PropVehicleChoreoGeneric::UpdateViewAngles(C_BasePlayer *pLocalPlayer,
  ...
  flAngleDiff = clamp(flAngleDiff, (float)m_vehicleView.flYawMin,
                      (float)m_vehicleView.flYawMax);
  ...
  flAngleDiff = clamp(flAngleDiff, (float)m_vehicleView.flPitchMin,
                      (float)m_vehicleView.flPitchMax);
