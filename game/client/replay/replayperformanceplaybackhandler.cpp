...
class CReplayPerformancePlaybackHandler
    : public IReplayPerformancePlaybackHandler {
public:
...
private:
  ...
  virtual void OnEvent_Camera_SetView(const SetViewParams_t &params) {
    ReplayCamera()->OverrideView(params.m_pOrigin, params.m_pAngles,
                                 params.m_flFov);
...
IReplayPerformancePlaybackHandler *g_pReplayPerformancePlaybackHandler =
    &s_ReplayPerformancePlaybackHandler;
