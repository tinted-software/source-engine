...
public:
  ...
  FindReplayItemThumbnailRow(const IQueryableReplayItem *pReplayItem);
...
private:
  ...
  CReplayListPanel *m_pParentListPanel; // Parent gets altered so we keep this
                                        // cached ptr around
};
...
public:
  CMovieThumbnailCollection(CReplayListPanel *pParent, const char *pName,
                            ...
                            int nMonth, int nYear, bool bShowSavedMoviesLabel);
  CMovieThumbnailCollection(CReplayListPanel *pParent, const char *pName,
                            IReplayItemManager *pReplayItemManager,
