...
void CReplayReminderPanel::SetupText() {
  ...
  g_pVGuiLocalize->ConstructString(
      wLabel, sizeof(wLabel), g_pVGuiLocalize->Find("#Replay_freezecam_replay"),
      1, wKey);
...
// Purpose:
//-----------------------------------------------------------------------------
int CReplayReminderPanel::HudElementKeyInput(int down, ButtonCode_t keynum,
...
void CReplayReminderPanel::OnThink() {
  ...
  if (m_flShowTime) {
    ...
    float flShowLength = replay_postwinreminderduration.IsValid()
                             ? replay_postwinreminderduration.GetFloat()
                             : 5.0f;
...
// Purpose:
//-----------------------------------------------------------------------------
bool CReplayReminderPanel::ShouldDraw() { return m_bShouldDraw; }
