...
public:
  ...
  // A generic info struct used for dominations, assisted dominations, revenges,
  // assisted revenged... Not all data members are necessarily used
...
protected:
  ...
  RoundStats_t
      m_lifeStats; // Stats for this life, based on reference stats (m_refStats)
...
inline CGenericClassBasedReplay *
ToGenericClassBasedReplay(CReplay *pClientReplay) {
  return static_cast<CGenericClassBasedReplay *>(pClientReplay);
}

inline const CGenericClassBasedReplay *
ToGenericClassBasedReplay(const CReplay *pClientReplay) {
  return static_cast<const CGenericClassBasedReplay *>(pClientReplay);
}

inline CGenericClassBasedReplay *
GetGenericClassBasedReplay(ReplayHandle_t hReplay) {
