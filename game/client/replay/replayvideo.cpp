...
static ReplayQualityPreset_t s_QualityPresets[] = {
    ...
    {"#Replay_RenderSetting_Medium", VideoEncodeCodec::WEBM_CODEC, 50, false,
     1},
...
static ReplayQualityPreset_t s_QualityPresets[] = {
    ...
    {"#Replay_RenderSetting_Medium", VideoEncodeCodec::MJPEG_A_CODEC, 50, false,
     1},
    {"#Replay_RenderSetting_High", VideoEncodeCodec::MJPEG_A_CODEC, 100, true,
     2},
...
int ReplayVideo_GetVideoModeCount() { return VIDEO_MODE_COUNT; }
...
int ReplayVideo_GetDefaultQualityPreset() { return s_DefaultQualityPreset; }

int ReplayVideo_GetQualityInterval() { return s_QualityInterval; }

int ReplayVideo_GetQualityRange() { return s_QualityRange; }

int ReplayVideo_GetQualityPresetCount() { return s_NumQualityPresets; }

const ReplayQualityPreset_t &ReplayVideo_GetQualityPreset(int i) {
  return s_QualityPresets[i];
}

int ReplayVideo_GetCodecCount() { return s_nNumCodecs; }
