...
public:
  ...
  // Write the bindings to a cfg file that can be loaded from the console or at
  // startup (defaults to sixense_bindings.cfg)
  ...
  // allows the caller to prevent new bindings from being triggered, while still
  // allowing enabled gestures to disable.
