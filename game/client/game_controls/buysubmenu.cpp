...
CBuySubMenu::CBuySubMenu(vgui::Panel *parent, const char *name)
  ...
  m_pPanel =
      new EditablePanel(this, "ItemInfo"); // info window about these items
...
CBuySubMenu *CBuySubMenu::CreateNewSubMenu() { return new CBuySubMenu(this); }

MouseOverPanelButton *
CBuySubMenu::CreateNewMouseOverPanelButton(EditablePanel *panel) {
...
//-----------------------------------------------------------------------------
vgui::WizardSubPanel *CBuySubMenu::GetNextSubPanel() { return m_NextPanel; }
