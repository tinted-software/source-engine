...
template <class T> class CImageMouseOverButton : public MouseOverButton<T> {
private:
...
template <class T> void CImageMouseOverButton<T>::RecalculateImageSizes(void) {
...
template <class T> void CImageMouseOverButton<T>::Paint() {
  this->SetActiveImage(m_pActiveImage);
  this->SetInactiveImage(m_pInactiveImage);
...
template <class T> void CImageMouseOverButton<T>::ShowPage(void) {
...
template <class T> void CImageMouseOverButton<T>::HidePage(void) {
