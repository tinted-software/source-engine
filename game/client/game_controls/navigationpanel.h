...
//
// A generic panel containing a list of buttons which can be displayed
// vertically or horizontally.  One button at a time can be selected, and
// messages are sent to the parent by default.
//
...
public:
  CNavigationPanel(vgui::Panel *pParent, const char *pName,
...
protected:
  ...
  bool m_bAutoLayout;
  bool m_bAutoScale; // Auto-scale buttons to proportionally match height (for
                     // horizontal display) or width (for vertical display)
  ...
  */
  ...
  CPanelAnimationVarAliasType(int, m_nHorizontalBuffer,
                              "auto_layout_horizontal_buffer", "5",
                              "proportional_xpos");
  CPanelAnimationVarAliasType(int, m_nVerticalBuffer,
                              "auto_layout_vertical_buffer", "5",
                              "proportional_ypos");
  CPanelAnimationVar(int, m_iSelectedButtonDefault, "selected_button_default",
                     "-1");
};
