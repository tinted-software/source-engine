...
void CFXLine::Draw(double frametime) {
  ...
  float alpha =
      ...
      ((m_FXData.m_flEndAlpha - m_FXData.m_flStartAlpha) * scaleTimePerc);
...
void CFXLine::Update(double frametime) {
  ...
  // Move our end points
  VectorMA(m_FXData.m_vecStart, frametime, m_FXData.m_vecStartVelocity,
           m_FXData.m_vecStart);
  VectorMA(m_FXData.m_vecEnd, frametime, m_FXData.m_vecEndVelocity,
           m_FXData.m_vecEnd);
}
