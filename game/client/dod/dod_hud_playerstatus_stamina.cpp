...
void CDoDHudStaminaProgressBar::ApplySchemeSettings(vgui::IScheme *pScheme) {
  ...
  m_clrInactiveLow =
      pScheme->GetColor("HudStaminaBar.InActiveLow", GetFgColor());
}
...
// Purpose:
//-----------------------------------------------------------------------------
CDoDHudStaminaIcon::CDoDHudStaminaIcon(vgui::Panel *parent, const char *name)
...
void CDoDHudStaminaIcon::ApplySettings(KeyValues *inResourceData) {
  ...
  Q_strncpy(m_szIcon, inResourceData->GetString("stamina_icon", "stamina_icon"),
            sizeof(m_szIcon));
}
...
// Purpose:
//-----------------------------------------------------------------------------
CDoDHudStamina::CDoDHudStamina(vgui::Panel *parent, const char *name)
