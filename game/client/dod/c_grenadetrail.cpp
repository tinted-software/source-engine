...
RecvPropFloat(RECVINFO(m_SpawnRate)),
    ...
    RecvPropFloat(RECVINFO(m_StopEmitTime)), RecvPropInt(RECVINFO(m_bEmit)),
...
// Purpose:
//-----------------------------------------------------------------------------
void C_GrenadeTrail::GetAimEntOrigin(IClientEntity *pAttachedTo,
...
// Input  : bEmit -
//-----------------------------------------------------------------------------
void C_GrenadeTrail::SetEmit(bool bEmit) { m_bEmit = bEmit; }
...
//			*pArgs -
//-----------------------------------------------------------------------------
void C_GrenadeTrail::Start(CParticleMgr *pParticleMgr,
...
void C_GrenadeTrail::Update(float fTimeDelta) {
  ...
  // Grenades thrown out of the PVS should not draw particles at the world
  // origin
  if (IsDormant())
    return;
