...
bool CHudAreaCapIcon::ShouldDraw() { return false; }
...
void CHudAreaCapIcon::Paint() {
  ...
  C_DODPlayer *pPlayer = C_DODPlayer::GetLocalDODPlayer();
          ...
          // draw the icon
          vgui::surface()->DrawSetTextureFile( m_iAreaTexture, szMatName , true,
  bForceReload); vgui::surface()->DrawSetColor( m_clrIcon );
