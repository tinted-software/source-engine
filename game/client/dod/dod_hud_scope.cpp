...
void CHudScope::Init(void) {
  ...
  vgui::surface()->DrawSetTextureFile(
      m_iScopeSpringfield[0], "sprites/scopes/scope_spring_ul", true, false);
  vgui::surface()->DrawSetTextureFile(
      m_iScopeSpringfield[1], "sprites/scopes/scope_spring_ur", true, false);
  vgui::surface()->DrawSetTextureFile(
      m_iScopeSpringfield[2], "sprites/scopes/scope_spring_lr", true, false);
  vgui::surface()->DrawSetTextureFile(
      m_iScopeSpringfield[3], "sprites/scopes/scope_spring_ll", true, false);

  vgui::surface()->DrawSetTextureFile(
      m_iScopeK98[0], "sprites/scopes/scope_k43_ul", true, false);
  vgui::surface()->DrawSetTextureFile(
      m_iScopeK98[1], "sprites/scopes/scope_k43_ur", true, false);
  vgui::surface()->DrawSetTextureFile(
      m_iScopeK98[2], "sprites/scopes/scope_k43_lr", true, false);
  vgui::surface()->DrawSetTextureFile(
      m_iScopeK98[3], "sprites/scopes/scope_k43_ll", true, false);
}
...
void CHudScope::Paint(void) {
  ...
  if (pPlayer->GetFOV() < 90 &&
    ...
    // width of the drawn scope. in widescreen, we draw the sides with
    // primitives
