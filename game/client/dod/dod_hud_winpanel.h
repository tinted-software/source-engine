...
protected:
  ...
  vgui::Label
      *m_pTimerStatusLabel; // shows time remaining or elapsed at round end
...
private:
  CPanelAnimationVarAliasType(int, m_iIconY, "icon_ypos", "0",
                              "proportional_int");
  CPanelAnimationVarAliasType(int, m_iIconX_left, "icon_xpos_left", "0",
                              "proportional_int");
  CPanelAnimationVarAliasType(int, m_iIconX_right, "icon_xpos_right", "0",
                              "proportional_int");
  ...
  CPanelAnimationVarAliasType(int, m_iIconSize, "icon_stat_size", "0",
                              "proportional_int");
  CPanelAnimationVarAliasType(int, m_iIconLeftX, "icon_left_stat_x", "0",
                              "proportional_int");
  CPanelAnimationVarAliasType(int, m_iIconLeftY1, "icon_left_stat_y1", "0",
                              "proportional_int");
  CPanelAnimationVarAliasType(int, m_iIconLeftY2, "icon_left_stat_y2", "0",
                              "proportional_int");
  CPanelAnimationVarAliasType(int, m_iIconLeftY3, "icon_left_stat_y3", "0",
                              "proportional_int");
  CPanelAnimationVarAliasType(int, m_iIconRightX, "icon_right_stat_x", "0",
                              "proportional_int");
  CPanelAnimationVarAliasType(int, m_iIconRightY1, "icon_right_stat_y1", "0",
                              "proportional_int");
  CPanelAnimationVarAliasType(int, m_iIconRightY2, "icon_right_stat_y2", "0",
                              "proportional_int");
  CPanelAnimationVarAliasType(int, m_iIconRightY3, "icon_right_stat_y3", "0",
                              "proportional_int");
