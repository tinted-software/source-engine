...
IMPLEMENT_CLIENTCLASS_DT(C_DOD_PlayerResource, DT_DODPlayerResource,
                         CDODPlayerResource)
RecvPropArray3(RECVINFO_ARRAY(m_iObjScore),
               RecvPropInt(RECVINFO(m_iObjScore[0]))),
    RecvPropArray3(RECVINFO_ARRAY(m_iPlayerClass),
                   RecvPropInt(RECVINFO(m_iPlayerClass[0]))),
    END_RECV_TABLE()
