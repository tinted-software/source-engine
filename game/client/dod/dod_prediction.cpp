...
// Purpose:
//-----------------------------------------------------------------------------
void CDODPrediction::SetupMove(C_BasePlayer *player, CUserCmd *ucmd,
                               IMoveHelper *pHelper, CMoveData *move) {
...
// Purpose:
//-----------------------------------------------------------------------------
void CDODPrediction::FinishMove(C_BasePlayer *player, CUserCmd *ucmd,
                                CMoveData *move) {
...
EXPOSE_SINGLE_INTERFACE_GLOBALVAR(CDODPrediction, IPrediction,
