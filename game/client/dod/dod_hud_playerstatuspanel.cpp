...
class CDoDHudPlayerStatusPanel : public CHudElement,
...
CDoDHudPlayerStatusPanel::CDoDHudPlayerStatusPanel(const char *pElementName)
  ...
  m_pCurrentWeapon =
      new CDoDHudCurrentWeapon(this, "PlayerStatusCurrentWeapon");
...
void CDoDHudPlayerStatusPanel::PerformLayout() {
  ...
  if (w != ScreenWidth()) {
    // doing this because of the 16:9 and 16:10 resolutions (VGUI doesn't scale
    // properly for them)
