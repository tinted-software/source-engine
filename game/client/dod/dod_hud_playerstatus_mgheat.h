...
public:
  CDoDHudMGHeatProgressBar(vgui::Panel *parent, const char *name)
...
private:
  ...
  CPanelAnimationVarAliasType(float, m_flSliceWidth, "slice_width", "5",
                              "proportional_float");
  CPanelAnimationVarAliasType(float, m_flSliceSpacer, "slice_spacer", "2",
                              "proportional_float");
...
public:
  CDoDHudMGHeatIcon(vgui::Panel *parent, const char *name)
