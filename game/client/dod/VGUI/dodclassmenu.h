...
public:
  ...
  virtual const char *GetName(void) { return PANEL_CLASS_ALLIES; }

  virtual int GetTeamNumber(void) { return TEAM_ALLIES; }
};
...
public:
  ...
  virtual const char *GetName(void) { return PANEL_CLASS_AXIS; }

  virtual int GetTeamNumber(void) { return TEAM_AXIS; }
};
