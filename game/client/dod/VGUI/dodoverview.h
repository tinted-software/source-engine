...
class CDODMapOverview : public CMapOverview {
  ...
  void DrawBombTimerSwipeIcon(Vector pos, int scale, int textureID,
                              float flPercentRemaining);
  void DrawHorizontalSwipe(Vector pos, int scale, int textureID,
                           float flCapPercentage, bool bSwipeLeft);
