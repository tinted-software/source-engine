...
private:
  ...
  static bool DODPlayerSortFunc(vgui::SectionedListPanel *list, int itemID1,
                                int itemID2);
  ...
  CPanelAnimationVarAliasType(int, m_iStatusWidth, "status_width", "35",
                              "proportional_int");
  CPanelAnimationVarAliasType(int, m_iFragsWidth, "frags_width", "30",
                              "proportional_int");
  CPanelAnimationVarAliasType(int, m_iProportionalAvatarWidth,
                              "avatar_width_prop", "34", "proportional_int");
