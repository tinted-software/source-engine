    ...
    if (g_pObjectiveResource->IsCPVisible(index)) {
      ...
      if (iBombsRequired > 0) {
        ...
        case 1: {
          ...
          case 0:
            m_pExplodedIcon->DrawSelf(xMid - iIconHalfWidth, yIcon, iIconWidth,
                                      iIconWidth, c);
            break;
          case 1:
            if (bBombPlanted) {
        ...
        case 2: {
          ...
          switch (iBombsRemaining) {
          case 0:
            m_pExplodedIcon->DrawSelf(xMid1 - iIconHalfWidth, yIcon, iIconWidth,
                                      iIconWidth, c);
            m_pExplodedIcon->DrawSelf(xMid2 - iIconHalfWidth, yIcon, iIconWidth,
                                      iIconWidth, c);
            break;
          case 1:
            if (bBombPlanted) {
              ...
              int alpha =
                  (float)(abs(sin(2 * gpGlobals->curtime)) * 205.0 + 50.0);
              m_pC4PlantedBG->DrawSelf(
                  xMid1 - iIconWidth, yIcon - iIconHalfWidth, iIconWidth * 2,
                  iIconWidth * 2, Color(255, 255, 255, alpha));
            }
          ...
          case 2:
            if (bBombPlanted) {
              ...
              int alpha =
                  (float)(abs(sin(2 * gpGlobals->curtime)) * 205.0 + 50.0);
              m_pC4PlantedBG->DrawSelf(
                  xMid2 - iIconWidth, yIcon - iIconHalfWidth, iIconWidth * 2,
                  iIconWidth * 2, Color(255, 255, 255, alpha));
            }
            m_pC4Icon->DrawSelf(xMid1 - iIconHalfWidth, yIcon, iIconWidth,
                                iIconWidth, c);
          ...
          if (iBombsRemaining > 0) {
            ...
            if (bBombPlanted) {
              ...
              int alpha =
                  (float)(abs(sin(2 * gpGlobals->curtime)) * 205.0 + 50.0);
              m_pC4PlantedBG->DrawSelf(
                  xpos - iIconHalfWidth, yIcon - iIconHalfWidth, iIconWidth * 2,
                  iIconWidth * 2, Color(255, 255, 255, alpha));
            }
