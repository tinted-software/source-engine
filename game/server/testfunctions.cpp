...
void Test_CreateEntity(const CCommand &args) {
  ...
  // Require a player entity or that the command was entered from the dedicated
  // server console
...
ConCommand cc_Test_CreateEntity("Test_CreateEntity", Test_CreateEntity, 0,
                                FCVAR_CHEAT);
ConCommand cc_Test_RandomPlayerPosition("Test_RandomPlayerPosition",
                                        Test_RandomPlayerPosition, 0,
                                        FCVAR_CHEAT);
