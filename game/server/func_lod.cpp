...
public:
  ...
  // (0 and m_fNonintrusiveDist):					the
  // bmodel is forced to be visible (m_fNonintrusiveDist and m_fDisappearDist):
  // the bmodel is trying to appear or disappear nonintrusively
  //												(waits
  //until it's out of the view frustrum or until there's a lot of motion)
  // (m_fDisappearDist+):
  // the bmodel is forced to be invisible
