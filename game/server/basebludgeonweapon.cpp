...
int CBaseHLBludgeonWeapon::WeaponMeleeAttack1Condition(float flDot,
                                                       float flDist) {
  if (flDist > 64) {
...
void CBaseHLBludgeonWeapon::Hit(trace_t &traceHit, Activity nHitActivity,
  ...
  CSoundEnt::InsertSound(SOUND_BULLET_IMPACT, traceHit.endpos, 400, 0.2f,
                         pPlayer);
...
Activity CBaseHLBludgeonWeapon::ChooseIntersectionPointAndActivity(
...
// Input  : &traceHit -
//-----------------------------------------------------------------------------
bool CBaseHLBludgeonWeapon::ImpactWater(const Vector &start,
                                        const Vector &end) {
