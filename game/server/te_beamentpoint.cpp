...
//			*current_angles -
//-----------------------------------------------------------------------------
void CTEBeamEntPoint::Test(const Vector &current_origin,
...
void TE_BeamEntPoint(IRecipientFilter &filter, float delay, int nStartEntity,
                     ...
                     int a, int speed) {
  g_TEBeamEntPoint.m_nStartEntity =
      (nStartEntity > 0) ? (nStartEntity & 0x0FFF) | ((1 & 0xF) << 12) : 0;
  g_TEBeamEntPoint.m_nEndEntity =
      (nEndEntity > 0) ? (nEndEntity & 0x0FFF) | ((1 & 0xF) << 12) : 0;
