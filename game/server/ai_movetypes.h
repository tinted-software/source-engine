...
struct AIMoveTrace_t {
  ...
  Vector vHitNormal; // The normal of a hit, if any. vec3_origin if none. Can be
                     // none even if "hit"
...
public:
  ...
  //---------------------------------
  //
  // Local navigation notifications, each allows services provider to overridde
  // default result
  //
...
inline bool
CAI_ProxyMovementSink::OnMoveStalled(const AILocalMoveGoal_t &move) {
