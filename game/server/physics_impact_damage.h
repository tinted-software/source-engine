...
struct impactdamagetable_t {
  ...
  float largeMassFallingScale; // emphasize downward impacts so that this will
                               // kill instead of stress (we have more
                               // information here than there)
  float myMinVelocity; // filter out any energy lost by me unless my velocity is
                       // greater than this
};
