...
//
//			This entity listens as though it is an NPC, meaning it
//will only 			hear sounds that were emitted using the CSound::InsertSound
//function.
//
//			It does not hear danger sounds since they are not
//technically sounds.
//
//=============================================================================
...
void CEnvMicrophone::SetSpeakerName(string_t iszSpeakerName) {
  ...
  // Set the speaker to null. This will force it to find the speaker next time a
  // sound is routed.
  m_hSpeaker = NULL;
  ActivateSpeaker();
}
...
//-----------------------------------------------------------------------------
MicrophoneResult_t
CEnvMicrophone::SoundPlayed(int entindex, const char *soundname,
