...
//
// Purpose: 'Button' which activates after a specified amount of weight is
// touching it.
//
//=============================================================================//
...
public:
  ...
  COutputEvent m_OnReleased; // After weight has been removed to go below weight
                             // threshold
  ...
  bool m_bHasBeenPressed;    // Once the button has been pressed, fire one
                             // output until the weight is reduced below the
                             // threshold
...
// reached
//			our threshold. If the stress is relieved below our
//threshold, fire a different output.
//-----------------------------------------------------------------------------
