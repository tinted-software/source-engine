...
public:
  ...
  bool HasBeenContested(
      void) const; // return true if this point has ever been contested, false
                   // if the enemy has never contested this point yet
...
private:
  ...
  string_t m_iszWarnSound; // Sound played if the team needs to be warned about
                           // this point being captured
