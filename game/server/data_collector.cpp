...
ConCommand data_collection_start("data_collection_start", StartDataCollection,
                                 "Start collecting game event data.");
...
ConCommand data_collection_stop("data_collection_stop", StopDataCollection,
                                "Stop collecting game event data.");
...
//----------------------------------------------------------------------------------------------------------------------
CDataCollector::~CDataCollector() { gameeventmanager->RemoveListener(this); }
