...
public:
  ...
  virtual void Ignite(float flFlameLifetime, bool bNPCOnly, float flSize = 0.0f,
  ...
  void StickAtPosition(const Vector &stickPosition, const Vector &savePosition,
...
private:
  ...
  COutputEvent
      m_OnPhysCannonAnimatePreStarted; // Started playing the pre-pull animation
  ...
  COutputEvent m_OnPhysCannonAnimatePostStarted; // Started playing the
                                                 // post-pull animation
  COutputEvent m_OnPhysCannonPullAnimFinished;   // We've had our pull anim
                                               // finished, or the post-pull has
                                               // finished if there is one
  float m_flDefaultFadeScale; // Things may temporarily change the fade scale,
...
public:
  virtual void OnParentCollisionInteraction(parentCollisionInteraction_t eType,
                                            int index,
