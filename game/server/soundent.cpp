...
DEFINE_KEYFIELD(m_iSoundType, FIELD_INTEGER, "soundtype"),
  ...
  if (m_iszProxyEntityName != NULL_STRING) {
    ...
    if (pProxy) {
      ...
      DevWarning("Warning- ai_sound cannot find proxy entity named '%s'. Using "
                 "self.\n",
