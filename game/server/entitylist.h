...
template <class T> class CEntityClassList : public CBaseEntityClassList {
public:
...
public:
  ...
  // returns the next entity after pCurrentEnt;  if pCurrentEnt is NULL, return
  // the first entity
  ...
  template <class T> T *NextEntByClass(T *start) {
  ...
  CBaseEntity *FindEntityByNameNearest(const char *szName, const Vector &vecSrc,
                                       float flRadius,
                                       CBaseEntity *pSearchingEntity = NULL,
                                       CBaseEntity *pActivator = NULL,
                                       CBaseEntity *pCaller = NULL);
  CBaseEntity *FindEntityByNameWithin(CBaseEntity *pStartEntity,
                                      const char *szName, const Vector &vecSrc,
                                      float flRadius,
                                      CBaseEntity *pSearchingEntity = NULL,
                                      CBaseEntity *pActivator = NULL,
                                      CBaseEntity *pCaller = NULL);
  ...
  CBaseEntity *FindEntityGeneric(CBaseEntity *pStartEntity, const char *szName,
                                 CBaseEntity *pSearchingEntity = NULL,
                                 CBaseEntity *pActivator = NULL,
                                 CBaseEntity *pCaller = NULL);
  ...
  CBaseEntity *FindEntityByNetname(CBaseEntity *pStartEntity,
                                   const char *szModelName);
...
inline CBaseNetworkable *
CGlobalEntityList::GetBaseNetworkable(CBaseHandle hEnt) const {
  IServerUnknown *pUnk = static_cast<IServerUnknown *>(LookupEntity(hEnt));
  if (pUnk)
...
inline IServerNetworkable *
CGlobalEntityList::GetServerNetworkable(CBaseHandle hEnt) const {
  IServerUnknown *pUnk = static_cast<IServerUnknown *>(LookupEntity(hEnt));
  if (pUnk)
...
public:
  ...
  // System events don't make sense as inputs, so are handled through a generic
  // notify function
  ...
  inline void ReportTeleportEvent(
      CBaseEntity * pEntity, const Vector &prevOrigin, const QAngle &prevAngles,
      bool physicsRotate) {
