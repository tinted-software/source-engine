...
public:
  ...
  void ConnectTo(
      ...
      float flObstacleEndDist); ///< create a connection FROM this node TO the
...
private:
  ...
  CNavNode *m_to[NUM_DIRECTIONS]; ///< links to north, south, east, and west.
                                  ///< NULL if no link
  float m_obstacleHeight[NUM_DIRECTIONS]; ///< obstacle height (delta from nav
                                          ///< node z position) that must be
                                          ///< climbed to reach next node in
                                          ///< this direction
  float m_obstacleStartDist[NUM_DIRECTIONS]; ///< distance along this direction
                                             ///< to reach the beginning of the
                                             ///< obstacle
  float m_obstacleEndDist[NUM_DIRECTIONS]; ///< distance along this direction to
                                           ///< reach the end of the obstacle
