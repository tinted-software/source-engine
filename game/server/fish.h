...
private:
  friend void SendProxy_FishOriginX(const SendProp *pProp, const void *pStruct,
                                    const void *pData, DVariant *pOut,
                                    int iElement, int objectID);
  friend void SendProxy_FishOriginY(const SendProp *pProp, const void *pStruct,
                                    const void *pData, DVariant *pOut,
                                    int iElement, int objectID);
  ...
  CNetworkVar(
      float,
      m_x); ///< have to send position coordinates separately since Z is unused
  CNetworkVar(
      float,
      m_y); ///< have to send position coordinates separately since Z is unused
  CNetworkVar(float,
  ...
  bool m_turnClockwise; ///< if true this fish prefers to turn clockwise, else
                        ///< CCW
...
public:
  ...
  float
  GetWaterLevel(void) const; ///< return Z coordinate of water in world coords
