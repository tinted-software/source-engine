...
public:
  ...
  virtual void SaveCustomData(CUtlBuffer &fileBuffer)
      const; // store custom mesh data for derived classes
...
protected:
  ...
  virtual void
  PostCustomAnalysis(void); // invoked when custom analysis step is complete
