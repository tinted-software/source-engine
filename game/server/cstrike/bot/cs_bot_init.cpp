...
ConVar cv_bot_quota_mode(
    "bot_quota_mode", "normal", FCVAR_REPLICATED,
    "Determines the type of quota.\nAllowed values: 'normal', 'fill', and "
    "'match'.\nIf 'fill', the server will adjust bots to keep N players in the "
    "game, where N is bot_quota.\nIf 'match', the server will maintain a 1:N "
    "ratio of humans to bots, where N is bot_quota.");
...
ConVar cv_bot_allow_rogues(
    ...
    "If nonzero, bots may occasionally go 'rogue'. Rogue bots do not obey "
    "radio commands, nor pursue scenario goals.");
...
ConVar
    cv_bot_allow_sub_machine_guns("bot_allow_sub_machine_guns", "1",
                                  FCVAR_REPLICATED,
...
ConVar cv_bot_flipout(
    "bot_flipout", "0", FCVAR_REPLICATED | FCVAR_CHEAT,
