 ...
 * NOTE: This state assumes we are standing in range of the door to be opened,
...
void OpenDoorState::OnUpdate(CCSBot *me) {
  ...
  if (m_funcDoor) {
    ...
    isDoorMoving = m_funcDoor->m_toggle_state == TS_GOING_UP ||
                   m_funcDoor->m_toggle_state == TS_GOING_DOWN;
  } else {
