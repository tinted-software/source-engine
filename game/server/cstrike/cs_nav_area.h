...
public:
  ...
  virtual void
  CustomAnalysis(bool isIncremental = false); // for game-specific analysis
  ...
  void ComputeApproachAreas(
      void); ///< determine the set of "approach areas" - for map learning
...
protected:
  NavErrorType LoadLegacy(CUtlBuffer &fileBuffer, unsigned int version,
