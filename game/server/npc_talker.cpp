...
DEFINE_AUTO_ARRAY(m_szMonologSentence, FIELD_CHARACTER),
    ...
    END_DATADESC()
        ...
        BEGIN_DATADESC(CNPCSimpleTalker) DEFINE_FIELD(m_useTime, FIELD_TIME),
...
DEFINE_SCHEDULE(SCHED_TALKER_IDLE_RESPONSE,
                ...
                "		TASK_WAIT				"
                "		0.5" // Wait until sure it's me they are talking
                                     // to
                "		TASK_TALKER_IDEALYAW			0" // look
                                                                           // at
                                                                           // who
                                                                           // I'm
                                                                           // talking
                ...
                "		TASK_TALKER_EYECONTACT			0" // Wait
                                                                           ...
                                                                           // done
                "		TASK_TALKER_RESPOND			"
                "	0" // Wait and then say my response
                "		TASK_TALKER_IDEALYAW			0" // look
                                                                           // at
                                                                           // who
                                                                           // I'm
...
DEFINE_SCHEDULE(
    ...
    "		COND_HEAVY_DAMAGE"
    "		COND_PROVOKED"
    "		COND_HEAR_COMBAT" // sound flags - change these and you'll break
                                  // the talking code.
    "		COND_HEAR_DANGER"
    "		COND_SMELL"
    "		COND_PLAYER_PUSHING"
...
DEFINE_SCHEDULE(
    ...
    "		TASK_SET_ACTIVITY				"
    "ACTIVITY:ACT_SIGNAL3"
    "		TASK_TALKER_EYECONTACT			0" // Wait until speaker
                                                           // is done
    ""
    "	Interrupts"
    "		COND_NEW_ENEMY"
