...
public:
  ...
  void CavernBounceThink(); ///< an alternative style of bouncing used for the
                            ///< citizen modded bouncers
  ...
  void UpdateLight(bool bTurnOn, unsigned int r, unsigned int g, unsigned int b,
                   unsigned int a);
