...
//			combine while constantly having to help his idiot
//assistant Gordon
//
//=============================================================================//
...
// relationship table.
//-----------------------------------------------------------------------------
Class_T CNPC_Kleiner::Classify(void) { return CLASS_PLAYER_ALLY_VITAL; }
...
//-----------------------------------------------------------------------------
int CNPC_Kleiner::GetSoundInterests(void) { return NULL; }
