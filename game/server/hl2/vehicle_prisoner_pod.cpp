...
public:
  ...
  CPropVehiclePrisonerPod(void) { m_ServerVehicle.SetVehicle(this); }
...
DEFINE_INPUTFUNC(FIELD_VOID, "Lock", InputLock),
    ...
    END_DATADESC()
        ...
        IMPLEMENT_SERVERCLASS_ST(CPropVehiclePrisonerPod,
...
// Purpose:
//-----------------------------------------------------------------------------
void CPropVehiclePrisonerPod::TraceAttack(const CTakeDamageInfo &info,
...
// Purpose:
//-----------------------------------------------------------------------------
void CPropVehiclePrisonerPod::Use(CBaseEntity *pActivator, CBaseEntity *pCaller,
                                  USE_TYPE useType, float value) {
...
//-----------------------------------------------------------------------------
void CPropVehiclePrisonerPod::GetVectors(Vector *pForward, Vector *pRight,
                                         Vector *pUp) const {
...
// Purpose:
//-----------------------------------------------------------------------------
CBaseEntity *CPropVehiclePrisonerPod::GetDriver(void) { return m_hPlayer; }
...
void CPropVehiclePrisonerPod::InputEnterVehicle(inputdata_t &inputdata) {
  ...
  CBaseCombatCharacter *pPassenger =
      ToBaseCombatCharacter(inputdata.pActivator);
  if (pPassenger == NULL) {
...
// Input  : &inputdata -
//-----------------------------------------------------------------------------
void CPropVehiclePrisonerPod::InputEnterVehicleImmediate(
...
// Purpose:
//-----------------------------------------------------------------------------
void CPrisonerPodServerVehicle::GetVehicleViewPosition(int nRole,
                                                       Vector *pAbsOrigin,
                                                       QAngle *pAbsAngles,
                                                       float *pFOV /*= NULL*/) {
  ...
  *pAbsAngles = pPlayer->EyeAngles(); // yuck. this is an in/out parameter.
  ...
  GetPod()->GetAttachment("vehicle_driver_eyes", vehicleEyeOrigin,
                          vehicleEyeAngles);
