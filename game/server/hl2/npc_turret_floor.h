...
public:
  ...
  Vector EyePosition(void) {
    ...
    // Note: We back up into the model to avoid an edge case where the eyes clip
...
protected:
  ...
  float m_flKnockOverFailedTime; // Time at which we should tell the NPC that he
                                 // failed to knock me over
