...
private:
  ...
  bool m_bLiftingPrey; // true when the prey's on the tongue and being lifted to
                       // the mouth
  bool m_bSwallowingPrey; // if it's a human, true while the barnacle chews it
                          // and swallows it whole.
  float m_flDigestFinish; // time at which we've finished digesting something we
                          // chewed
