...
void CNPC_Fisherman::Spawn(void) {
  ...
  //	m_iszIdleExpression =
  //MAKE_STRING("scenes/Expressions/FishermanIdle.vcd"); 	m_iszAlertExpression =
  //MAKE_STRING("scenes/Expressions/FishermanAlert.vcd"); 	m_iszCombatExpression
  //= MAKE_STRING("scenes/Expressions/FishermanCombat.vcd");
