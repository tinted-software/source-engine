...
public:
  ...
  virtual int RangeAttack2Conditions(float flDot,
                                     float flDist); // Concussive zap (larger)
...
private:
  ...
  bool m_bPlayerRequestedHeal; // This adds some priority to our heal (allows it
                               // to happen in combat, etc)
