...
DEFINE_FIELD(m_iAmmoType, FIELD_INTEGER),
    ...
    DEFINE_THINKFUNC(AutoSearchThink), DEFINE_THINKFUNC(DeathThink),
...
void CNPC_CeilingTurret::Spawn(void) {
  ...
  m_pEyeGlow = CSprite::SpriteCreate(CEILING_TURRET_GLOW_SPRITE,
...
//-----------------------------------------------------------------------------
bool CNPC_CeilingTurret::FVisible(CBaseEntity *pEntity, int traceMask,
...
void CNPC_CeilingTurret::ActiveThink(void) {
  ...
  bool bEnemyVisible =
      FInViewCone(GetEnemy()) && FVisible(GetEnemy()) && GetEnemy()->IsAlive();
...
// Purpose: Fire!
//-----------------------------------------------------------------------------
void CNPC_CeilingTurret::Shoot(const Vector &vecSrc,
                               const Vector &vecDirToEnemy) {
  if (m_spawnflags & SF_CEILING_TURRET_OUT_OF_AMMO) {
