...
//			near certain doom, all while fighting off the clumsy
//advances of her 			misogynistic colleges.
//=============================================================================//
...
//	DEFINE_FIELD( m_FollowBehavior, FIELD_EMBEDDED ),	(auto saved by
//AI)
END_DATADESC()
...
// relationship table.
//-----------------------------------------------------------------------------
Class_T CNPC_Mossman::Classify(void) { return CLASS_PLAYER_ALLY_VITAL; }
...
//-----------------------------------------------------------------------------
int CNPC_Mossman::GetSoundInterests(void) { return NULL; }
