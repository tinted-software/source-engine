...
//faster) check 			in UTIL_IsCombineBall() can never identify a combine ball held
//by 			the physcannon because the physcannon changes the held entity's 			collision
//group.
...
#define SF_COMBINE_BALL_LAUNCHER_COLLIDE_PLAYER 0x00000002
        ...
        LINK_ENTITY_TO_CLASS(point_combine_ball_launcher,
...
// Keyfields
DEFINE_KEYFIELD(m_iBallType, FIELD_INTEGER, "balltype"), END_DATADESC()
