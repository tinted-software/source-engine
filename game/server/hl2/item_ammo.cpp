...
public:
  ...
  void Precache(void) { PrecacheModel("models/items/boxsrounds.mdl"); }
...
public:
  ...
  void Precache(void) { PrecacheModel("models/items/boxmrounds.mdl"); }
  bool MyTouch(CBasePlayer *pPlayer) {
...
public:
  ...
  void Precache(void) { PrecacheModel("models/items/357ammo.mdl"); }
  void Spawn(void) {
    Precache();
...
public:
  ...
  void Precache(void) { PrecacheModel("models/items/357ammobox.mdl"); }
  void Spawn(void) {
    Precache();
...
public:
  ...
  void Precache(void) { PrecacheModel("models/items/flare.mdl"); }
  bool MyTouch(CBasePlayer *pPlayer) {
...
public:
  ...
  void Precache(void) { PrecacheModel("models/items/boxflares.mdl"); }
  bool MyTouch(CBasePlayer *pPlayer) {
...
public:
  ...
  void Precache(void) { PrecacheModel("models/weapons/w_missile_closed.mdl"); }
  bool MyTouch(CBasePlayer *pPlayer) {
...
public:
  ...
  void Precache(void) { PrecacheModel("models/items/ar2_grenade.mdl"); }
  bool MyTouch(CBasePlayer *pPlayer) {
...
public:
  ...
  void Precache(void) { PrecacheModel("models/items/boxsniperrounds.mdl"); }
  bool MyTouch(CBasePlayer *pPlayer) {
...
public:
  ...
  void Precache(void) { PrecacheModel("models/items/boxbuckshot.mdl"); }
  bool MyTouch(CBasePlayer *pPlayer) {
...
const char *CItem_AmmoCrate::m_lpzAmmoNames[NUM_AMMO_CRATE_TYPES] = {
    "Pistol",  "SMG1", "AR2",      "RPG_Round",  "Buckshot",
    "Grenade", "357",  "XBowBolt", "AR2AltFire", "SMG1_Grenade",
};
...
//			value -
//-----------------------------------------------------------------------------
void CItem_AmmoCrate::Use(CBaseEntity *pActivator, CBaseEntity *pCaller,
  ...
  if (GetSequence() != iSequence) {
    ...
    UTIL_TraceHull(vOrigin, vOrigin, mins, maxs, MASK_SOLID, this,
...
void CItem_AmmoCrate::HandleAnimEvent(animevent_t *pEvent) {
  if (pEvent->event == AE_AMMOCRATE_PICKUP_AMMO) {
    if (m_hActivator) {
      if (m_pGiveWeapon[m_nAmmoType] &&
          !m_hActivator->Weapon_OwnsThisType(m_pGiveWeapon[m_nAmmoType])) {
      ...
      if (m_hActivator->GiveAmmo(m_nAmmoAmounts[m_nAmmoType], m_nAmmoIndex) !=
          0) {
        SetBodygroup(1, false);
      }
      m_hActivator = NULL;
