...
void CGrenadePathfollower::Detonate(void) {
  ...
  te->Explosion(filter, 0.0, &GetAbsOrigin(), g_sModelIndexFireball, 0.5, 15,
...
// Output  :
//------------------------------------------------------------------------------
CGrenadePathfollower *CGrenadePathfollower::CreateGrenadePathfollower(
  ...
  CGrenadePathfollower *pGrenade =
      (CGrenadePathfollower *)CreateEntityByName("grenade_pathfollower");
  if (!pGrenade) {
