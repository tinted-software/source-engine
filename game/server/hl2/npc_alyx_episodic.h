...
public:
  ...
  void HolsterPistol();
  void DrawPistol();
  void Weapon_Drop(CBaseCombatWeapon *pWeapon, const Vector *pvecTarget = NULL,
...
private:
  enum {
    ...
    COND_ALYX_CAN_INTERACT_WITH_TARGET, // Hack target is in a suitable state
                                        // and location to hack
