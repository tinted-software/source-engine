...
public:
  ...
  void (CDODBombTarget::*pfnUse)(CBaseEntity *pActivator, CBaseEntity *pCaller,
...
public:
  ...
  // Set these flags so players can use the bomb target ( for planting or
  // defusing )
  ...
  void State_Leave();
  void State_Think();
  void State_Use(CBaseEntity *pActivator, CBaseEntity *pCaller,
                 USE_TYPE useType, float value);
  ...
  // Use
  void State_Use_ACTIVE(CBaseEntity *pActivator, CBaseEntity *pCaller,
                        USE_TYPE useType, float value);
  void State_Use_ARMED(CBaseEntity *pActivator, CBaseEntity *pCaller,
                       USE_TYPE useType, float value);
  ...
  bool CanPlayerContinueDefusing(CDODPlayer *pPlayer,
