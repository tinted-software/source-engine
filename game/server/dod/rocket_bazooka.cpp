...
CBazookaRocket *CBazookaRocket::Create(const Vector &vecOrigin,
                                       const QAngle &vecAngles,
                                       CBaseEntity *pOwner) {
  return static_cast<CBazookaRocket *>(
      CDODBaseRocket::Create("rocket_bazooka", vecOrigin, vecAngles, pOwner));
}