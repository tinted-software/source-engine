...
void CNPC_Zombie::HandleAnimEvent(animevent_t *pEvent) {
  ...
  case ZOMBIE_AE_ATTACK_RIGHT: {
    ...
    CBaseEntity *pHurt = CheckTraceHullAttack(
        70, vecMins, vecMaxs, sk_zombie_dmg_one_slash.GetFloat(), DMG_SLASH);
  ...
  case ZOMBIE_AE_ATTACK_BOTH: {
    ...
    CBaseEntity *pHurt = CheckTraceHullAttack(
        70, vecMins, vecMaxs, sk_zombie_dmg_both_slash.GetFloat(), DMG_SLASH);
...
void CNPC_Zombie::RemoveIgnoredConditions(void) {
  ...
  if ((GetActivity() == ACT_SMALL_FLINCH) ||
      (GetActivity() == ACT_BIG_FLINCH)) {
