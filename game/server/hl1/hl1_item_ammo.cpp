...
public:
  ...
  void Precache(void) { PrecacheModel(AMMO_CROSSBOW_MODEL); }
...
public:
  ...
  void Precache(void) { PrecacheModel(AMMO_EGON_MODEL); }
  bool MyTouch(CBasePlayer *pPlayer) {
...
public:
  ...
  void Precache(void) { PrecacheModel(AMMO_GAUSS_MODEL); }
  bool MyTouch(CBasePlayer *pPlayer) {
...
public:
  ...
  void Precache(void) { PrecacheModel(AMMO_GLOCK_MODEL); }
  bool MyTouch(CBasePlayer *pPlayer) {
...
public:
  ...
  void Precache(void) { PrecacheModel(AMMO_MP5_MODEL); }
  bool MyTouch(CBasePlayer *pPlayer) {
...
public:
  ...
  void Precache(void) { PrecacheModel(AMMO_MP5CHAIN_MODEL); }
  bool MyTouch(CBasePlayer *pPlayer) {
...
public:
  ...
  void Precache(void) { PrecacheModel(AMMO_MP5GRENADE_MODEL); }
  bool MyTouch(CBasePlayer *pPlayer) {
...
public:
  ...
  void Precache(void) { PrecacheModel(AMMO_357_MODEL); }
  bool MyTouch(CBasePlayer *pPlayer) {
...
public:
  ...
  void Precache(void) { PrecacheModel(AMMO_RPG_MODEL); }
  bool MyTouch(CBasePlayer *pPlayer) {
    int nGive;
...
public:
  ...
  void Precache(void) { PrecacheModel(AMMO_SHOTGUN_MODEL); }
  bool MyTouch(CBasePlayer *pPlayer) {
