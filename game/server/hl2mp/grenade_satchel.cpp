...
ConVar sk_plr_dmg_satchel("sk_plr_dmg_satchel",
                          "150"); // commented lines in hl2/skill.cfg
...
void CSatchelCharge::CreateEffects(void) {
  ...
  m_hGlowSprite->SetTransparency(kRenderTransAdd, 255, 255, 255, 255,
                                 kRenderFxStrobeFast);
...
void CSatchelCharge::InputExplode(inputdata_t &inputdata) {
  ExplosionCreate(GetAbsOrigin() + Vector(0, 0, 16), GetAbsAngles(),
                  GetThrower(), GetDamage(), GetDamageRadius(),
