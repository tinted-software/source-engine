...
// Gamestats was built for ep1, so this file is going to be amazingly short
// seeing as how ep1 set the standard
...
CBaseGameStats *CEP1GameStats::OnInit(CBaseGameStats *pCurrentGameStats,
                                      char const *gamedir) {
...
const char *CEP1GameStats::GetStatSaveFileName(void) {
  return "ep1_gamestats.dat"; // overriding the default for backwards
                              // compatibility with release stat tracking code
}

const char *CEP1GameStats::GetStatUploadRegistryKeyName(void) {
  return "GameStatsUpload_Ep1"; // overriding the default for backwards
                                // compatibility with release stat tracking code
}

static char const *ep1Maps[] = {
    "ep1_citadel_00", "ep1_citadel_01", "ep1_citadel_02", "ep1_citadel_02b",
    "ep1_citadel_03", "ep1_citadel_04", "ep1_c17_00",     "ep1_c17_00a",
