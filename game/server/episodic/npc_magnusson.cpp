...
//			at the White Forest missile silo. Instantly unlikeable,
//he is also 			the inventor of the Magnusson Device aka "strider buster", which 			is
//purported to resemble his cantelope-like head.
//
//=============================================================================
...
// relationship table.
//-----------------------------------------------------------------------------
Class_T CNPC_Magnusson::Classify(void) { return CLASS_PLAYER_ALLY_VITAL; }
...
//-----------------------------------------------------------------------------
int CNPC_Magnusson::GetSoundInterests(void) { return NULL; }
...
void CNPC_Magnusson::Spawn() {
  ...
  CapabilitiesAdd(bits_CAP_MOVE_GROUND | bits_CAP_OPEN_DOORS |
                  bits_CAP_ANIMATEDFACE | bits_CAP_TURN_HEAD);
