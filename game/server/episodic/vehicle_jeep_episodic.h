...
private:
  ...
  float m_flNextAvoidBroadcastTime; // Next time we'll warn entity to move out
                                    // of us

  COutputEvent m_OnCompanionEnteredVehicle; // Passenger has completed entering
                                            // the vehicle
  COutputEvent
      m_OnCompanionExitedVehicle; // Passenger has completed exited the vehicle
  COutputEvent
      m_OnHostileEnteredVehicle; // Passenger has completed entering the vehicle
  COutputEvent
  ...
  bool m_bBusterHopperVisible; // is the hopper assembly visible on the vehicle?
                               // please do not set this directly - use the
                               // accessor funct.
