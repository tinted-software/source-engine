...
Ep2LevelStats_t::EntityDeathsLump_t *
CEP2GameStats::FindDeathsLump(char const *npcName) {
  if (!m_pCurrentMap)
    return NULL;
...
Ep2LevelStats_t::WeaponLump_t *
CEP2GameStats::FindWeaponsLump(char const *pchWeaponName, bool bPrimary) {
  if (!m_pCurrentMap)
    return NULL;
...
Ep2LevelStats_t::GenericStatsLump_t *
CEP2GameStats::FindGenericLump(char const *pchStatName) {
  if (!m_pCurrentMap)
    return NULL;
