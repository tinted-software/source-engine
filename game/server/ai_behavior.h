...
//
//			Intended to be used as an organizational tool as well as
//a way 			for various NPCs to share behaviors without sharing an inheritance
//			relationship, and without cramming those behaviors into
//the base 			NPC class.
//-----------------------------------------------------------------------------
...
inline bool
CAI_BehaviorBase::BridgeSelectFailSchedule(int failedSchedule, int failedTask,
                                           AI_TaskFailureCode_t taskFailCode,
                                           int *pResult) {
  m_fOverrode = true;
...
inline Activity
CAI_BehaviorBase::BridgeNPC_TranslateActivity(Activity activity) {
...
inline void
CAI_BehaviorBase::BridgeOnFriendDamaged(CBaseCombatCharacter *pSquadmate,
                                        CBaseEntity *pAttacker) {
...
inline bool
CAI_BehaviorBase::BridgeCanRunAScriptedNPCInteraction(bool bForced) {
...
inline int
CAI_BehaviorBase::BridgeOnTakeDamage_Alive(const CTakeDamageInfo &info) {
...
inline void
CAI_BehaviorBase::BridgeOnChangeActiveWeapon(CBaseCombatWeapon *pOldWeapon,
                                             CBaseCombatWeapon *pNewWeapon) {
...
inline bool
CAI_BehaviorBase::BridgeSpeakMapmakerInterruptConcept(string_t iszConcept) {
...
inline void
CAI_BehaviorBase::BridgeModifyOrAppendCriteria(AI_CriteriaSet &criteriaSet) {
...
template <class BASE_NPC>
inline void
CAI_BehaviorHost<BASE_NPC>::ChangeBehaviorTo(CAI_BehaviorBase *pNewBehavior) {
...
template <class BASE_NPC>
inline int
CAI_BehaviorHost<BASE_NPC>::BackBridge_TranslateSchedule(int scheduleType) {
...
template <class BASE_NPC> inline void CAI_BehaviorHost<BASE_NPC>::AimGun(void) {
...
template <class BASE_NPC>
inline CAI_Schedule *
CAI_BehaviorHost<BASE_NPC>::GetSchedule(int localScheduleID) {
...
template <class BASE_NPC>
inline Activity
CAI_BehaviorHost<BASE_NPC>::NPC_TranslateActivity(Activity activity) {
  if (m_pCurBehavior) {
...
template <class BASE_NPC>
inline bool
CAI_BehaviorHost<BASE_NPC>::BackBridge_IsValidEnemy(CBaseEntity *pEnemy) {
...
template <class BASE_NPC>
inline bool
CAI_BehaviorHost<BASE_NPC>::BackBridge_IsValidCover(const Vector &vLocation,
                                                    CAI_Hint const *pHint) {
...
template <class BASE_NPC>
inline bool
CAI_BehaviorHost<BASE_NPC>::BackBridge_ShouldIgnoreSound(CSound *pSound) {
...
template <class BASE_NPC>
inline void
CAI_BehaviorHost<BASE_NPC>::BackBridge_OnSeeEntity(CBaseEntity *pEntity) {
...
template <class BASE_NPC>
inline bool
CAI_BehaviorHost<BASE_NPC>::BackBridge_IsCrouchedActivity(Activity activity) {
...
template <class BASE_NPC>
inline bool
CAI_BehaviorHost<BASE_NPC>::BackBridge_QueryHearSound(CSound *pSound) {
...
template <class BASE_NPC>
inline float
CAI_BehaviorHost<BASE_NPC>::BackBridge_GetReasonableFacingDist(void) {
...
template <class BASE_NPC>
inline Activity
CAI_BehaviorHost<BASE_NPC>::BackBridge_GetFlinchActivity(bool bHeavyDamage,
                                                         bool bGesture) {
...
template <class BASE_NPC>
inline void
CAI_BehaviorHost<BASE_NPC>::BackBridge_Teleport(const Vector *newPosition,
                                                const QAngle *newAngles,
                                                const Vector *newVelocity) {
...
template <class BASE_NPC>
inline void
CAI_BehaviorHost<BASE_NPC>::BackBridge_HandleAnimEvent(animevent_t *pEvent) {
...
template <class BASE_NPC>
inline bool
CAI_BehaviorHost<BASE_NPC>::SpeakMapmakerInterruptConcept(string_t iszConcept) {
  for (int i = 0; i < m_Behaviors.Count(); i++) {
...
template <class BASE_NPC> inline void CAI_BehaviorHost<BASE_NPC>::OnRestore() {
  for (int i = 0; i < m_Behaviors.Count(); i++) {
...
template <class BASE_NPC>
inline void
CAI_BehaviorHost<BASE_NPC>::OnFriendDamaged(CBaseCombatCharacter *pSquadmate,
                                            CBaseEntity *pAttacker) {
  if (m_pCurBehavior)
...
template <class BASE_NPC>
inline bool
CAI_BehaviorHost<BASE_NPC>::CanRunAScriptedNPCInteraction(bool bForced) {
  if (m_pCurBehavior)
...
template <class BASE_NPC>
inline int
CAI_BehaviorHost<BASE_NPC>::OnTakeDamage_Alive(const CTakeDamageInfo &info) {
  if (m_pCurBehavior)
...
template <class BASE_NPC> inline void CAI_BehaviorHost<BASE_NPC>::Precache() {
  BaseClass::Precache();
  for (int i = 0; i < m_Behaviors.Count(); i++) {
...
template <class BASE_NPC> inline void CAI_BehaviorHost<BASE_NPC>::NPCInit() {
  BaseClass::NPCInit();
  for (int i = 0; i < m_Behaviors.Count(); i++) {
...
template <class BASE_NPC>
inline void
CAI_BehaviorHost<BASE_NPC>::Event_Killed(const CTakeDamageInfo &info) {
  for (int i = 0; i < m_Behaviors.Count(); i++) {
...
template <class BASE_NPC>
inline bool
CAI_BehaviorHost<BASE_NPC>::OnBehaviorChangeStatus(CAI_BehaviorBase *pBehavior,
                                                   bool fCanFinishSchedule) {
...
template <class BASE_NPC>
inline void
CAI_BehaviorHost<BASE_NPC>::AddBehavior(CAI_BehaviorBase *pBehavior) {
#ifdef DEBUG
