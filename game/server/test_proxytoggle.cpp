...
public:
  ...
  ~CTest_ProxyToggle_Networkable() { g_pTestObj = NULL; }
...
void *SendProxy_TestProxyToggle(const SendProp *pProp, const void *pStructBase,
                                const void *pData,
...
BEGIN_SEND_TABLE_NOBASE(CTest_ProxyToggle_Networkable,
...
SendPropInt(SENDINFO(m_WithProxy)) END_SEND_TABLE()
    ...
    IMPLEMENT_SERVERCLASS_ST(CTest_ProxyToggle_Networkable, DT_ProxyToggle)
        SendPropDataTable("blah", 0,
                          &REFERENCE_SEND_TABLE(DT_ProxyToggle_ProxiedData),
                          SendProxy_TestProxyToggle) END_SEND_TABLE()
...
ConCommand cc_Test_ProxyToggle_EnableProxy("Test_ProxyToggle_EnableProxy",
                                           Test_ProxyToggle_EnableProxy, 0,
                                           FCVAR_CHEAT);
ConCommand cc_Test_ProxyToggle_SetValue("Test_ProxyToggle_SetValue",
                                        Test_ProxyToggle_SetValue, 0,
                                        FCVAR_CHEAT);
