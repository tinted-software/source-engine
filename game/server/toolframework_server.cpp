...
//-----------------------------------------------------------------------------
// Purpose: This is an autogame system which is used to call back into the
// engine at appropriate points so that IToolSystems can get these hooks at the
// correct time
//-----------------------------------------------------------------------------
class CToolFrameworkServer : public CAutoGameSystemPerFrame,
                             public IToolFrameworkServer {
public:
  virtual bool Init();
  // Level init, shutdown
...
bool ToolsEnabled() {
  return g_ToolFrameworkServer.m_pTools &&
         g_ToolFrameworkServer.m_pTools->InToolMode() &&
...
bool CToolFrameworkServer::Init() {
  ...
  m_pTools = (IServerEngineTools *)list.engineFactory(
