...
//			Events can be posted with a nonzero delay, which
//determines how long 			they are held before being dispatched to their recipients.
//
...
public:
  ...
  void AddEvent(const char *target, const char *action, variant_t Value,
                float fireDelay, CBaseEntity *pActivator, CBaseEntity *pCaller,
                int outputID = 0);
