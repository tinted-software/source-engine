...
public:
  ...
  CNetworkVector(m_vecNormal); // NOTENOTE: In a multi-play setup we'll probably
                               // want non-oriented effects for bandwidth
...
//			*current_angles -
//-----------------------------------------------------------------------------
void CTEImpact::Test(const Vector &current_origin,
                     const Vector &current_normal) {}
