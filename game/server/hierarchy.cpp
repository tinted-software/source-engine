...
//-----------------------------------------------------------------------------
// Purpose: Does the linked list work of removing a child object from the
// hierarchy. Input  : pParent -
//			pChild -
//-----------------------------------------------------------------------------
...
void TransferChildren(CBaseEntity *pOldParent, CBaseEntity *pNewParent) {
  ...
  while (pChild) {
    ...
    // FIXME: This is a hack to guarantee update of the local origin, angles,
    // etc.
...
static void GetAllChildren_r(CBaseEntity *pEntity,
