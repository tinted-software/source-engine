...
//			pSearchingEntity -
//			pActivator - The activator entity if this was called
//from an input 				or Use handler.
//-----------------------------------------------------------------------------
...
//			flRadius - Search radius for classname search, 0 to
//search everywhere. 			pSearchingEntity - The entity that is doing the search.
//			pActivator - The activator entity if this was called
...
// Input  : pStartEntity - The entity to start from when doing the search.
//			szName - Entity name to search for. Treated as a target
//name first, 				then as an entity class name, ie "info_target". 			vecSrc - Center of
