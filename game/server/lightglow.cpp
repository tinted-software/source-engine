...
#define LIGHTGLOW_OUTERMAXDIST_MAX_VALUE                                       \
  ((1 << LIGHTGLOW_OUTERMAXDIST_BITS) - 1)
...
SendPropInt(SENDINFO(m_clrRender), 32, SPROP_UNSIGNED, SendProxy_Color32ToInt),
    ...
    SendPropInt(SENDINFO(m_nOuterMaxDist), LIGHTGLOW_OUTERMAXDIST_BITS,
                SPROP_UNSIGNED),
...
//			or leave PVS. Done because we often have many glows in
//an area.
//-----------------------------------------------------------------------------
