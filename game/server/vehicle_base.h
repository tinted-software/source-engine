...
#ifdef HL2_EPISODIC
  CUtlVector<EHANDLE> m_hPhysicsChildren; // List of entities who wish to get
                                          // physics callbacks from the vehicle
#endif                                    // HL2_EPISODIC
...
protected:
  // Entering / Exiting
  bool m_bEngineLocked; // Mapmaker override on whether the vehicle's allowed to
                        // be turned on/off
  bool m_bLocked;
