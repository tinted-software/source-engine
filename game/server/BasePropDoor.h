...
//			open or close the door is not dictated by this class,
//only that 			the door has open, closed, opening, and closing states.
//
...
private:
  ...
  DoorState_t m_eDoorState; // Holds whether the door is open, closed, opening,
                            // or closing.
  ...
  // float m_flSpeed;			// Rotation speed when opening or
  // closing in degrees per second.
