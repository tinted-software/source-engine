...
public:
  ...
  float m_flOcclusionScale; // How loud the sound is when occluded by the world.
                            // (volume * occlusionscale)
  int m_iType;              // what type of sound this is
  int m_iNextAudible; // temporary link that NPCs use to build a list of audible
                      // sounds
