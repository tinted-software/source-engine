...
void CEnvTonemapController::InputBlendTonemapScale(inputdata_t &inputdata) {
  ...
  if (!pszParam || !pszParam[0]) {
    Warning("%s (%s) received BlendTonemapScale input without a target tonemap "
  ...
  if (!pszParam || !pszParam[0]) {
    Warning("%s (%s) received BlendTonemapScale input without a blend time. "
...
void CEnvTonemapController::InputSetBloomScaleRange(inputdata_t &inputdata) {
  ...
  if (nargs != 2) {
    Warning("%s (%s) received SetBloomScaleRange input without 2 arguments. "
