...
public:
  CPassengerInfo(void)
      : m_nRole(-1), m_nSeat(-1), m_strRoleName(NULL_STRING),
...
public:
  ...
  virtual bool
  IsPassengerUsingStandardWeapons(int nRole = VEHICLE_ROLE_DRIVER) {
    return false;
  }
...
public:
  ...
  virtual float
  Weapon_PrimaryCanFireAt(void); // Return the time at which this vehicle's
                                 // primary weapon can fire again
  virtual float
  Weapon_SecondaryCanFireAt(void); // Return the time at which this vehicle's
                                   // secondary weapon can fire again
...
public:
  ...
  virtual bool
  NPC_GetPassengerSeatPositionLocal(CBaseCombatCharacter *pPassenger,
                                    Vector *vecResultPos,
  ...
  virtual const PassengerSeatAnims_t *
  NPC_GetPassengerSeatAnims(CBaseCombatCharacter *pPassenger,
