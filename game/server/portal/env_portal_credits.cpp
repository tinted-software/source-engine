...
DEFINE_INPUTFUNC(FIELD_VOID, "RollCredits", InputRollCredits),
    ...
    DEFINE_INPUTFUNC(FIELD_VOID, "RollPortalOutroCredits",
    ...
    DEFINE_FIELD(m_flLogoLength, FIELD_FLOAT) END_DATADESC()
...
static void CreditsDone_f(void) {
  CPortalCredits *pCredits =
      (CPortalCredits *)gEntList.FindEntityByClassname(NULL, "env_credits");
