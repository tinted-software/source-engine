...
//-----------------------------------------------------------------------------
bool CNeurotoxinCountdown::KeyValue(const char *szKeyName,
                                    const char *szValue) {
...
void CNeurotoxinCountdown::SetTransmit(CCheckTransmitInfo *pInfo,
                                       bool bAlways) {
...
void CNeurotoxinCountdown::GetControlPanelInfo(int nPanelIndex,
                                               const char *&pPanelName) {
  pPanelName = "neurotoxin_countdown_screen";
}

void CNeurotoxinCountdown::GetControlPanelClassName(int nPanelIndex,
                                                    const char *&pPanelName) {
