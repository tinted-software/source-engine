...
public:
  ...
  virtual void ClientSetupVisibility(edict_t *pViewEntity, edict_t *pClient,
                                     unsigned char *pvs, int pvssize) OVERRIDE;
...
public:
  ...
  virtual void GameFrame(bool simulating)
      OVERRIDE; // could be called multiple times before sending data to clients
  virtual void PreClientUpdate(
      bool simulating) OVERRIDE; // called after all GameFrame() calls, before
  ...
  virtual ePrepareLevelResourcesResult
