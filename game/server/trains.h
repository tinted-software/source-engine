...
private:
  ...
  Vector m_lastBlockPos; // These are used to build a heuristic decision about
  ...
  string_t m_iszSoundMove; // Looping sound to play while moving. Pitch shifted
                           // based on speed.
  ...
  float m_flMoveSoundMinTime; // The most often to play the move 'ping' sound
                              // (used at max speed)
  float m_flMoveSoundMaxTime; // The least often to play the move 'ping' sound
                              // (used approaching zero speed)
