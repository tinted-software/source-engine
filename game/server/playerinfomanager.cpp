...
EXPOSE_SINGLE_INTERFACE_GLOBALVAR(CPlayerInfoManager_V1, IPlayerInfoManager_V1,
...
CGlobalVars *CPlayerInfoManager::GetGlobalVars() { return gpGlobals; }
...
EXPOSE_SINGLE_INTERFACE_GLOBALVAR(CPlayerInfoManager, IPlayerInfoManager,
