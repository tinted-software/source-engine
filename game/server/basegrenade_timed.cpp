...
void CBaseGrenadeTimed::Spawn(void) {
  ...
  // Take one second off of the desired detonation time and set the think to
  // PreDetonate. PreDetonate will insert a DANGER sound into the world sound
  // list and delay detonation for one second so that the grenade explodes after
  // the exact amount of time specified in the call to ShootTimed().
