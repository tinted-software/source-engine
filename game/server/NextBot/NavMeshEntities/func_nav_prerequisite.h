...
// NextBot paths that go through this entity must fulfill the given
// prerequisites to pass Michael Booth, August 2009
...
/**
 * NextBot paths that pass through this entity must fulfill the given
