...
public:
  ...
  virtual bool IsUseableEntity(CBaseEntity *entity,
  ...
  GetLastAttacker(void) const; // return the character who last attacked me
...
inline CBaseCombatCharacter *
NextBotCombatCharacter::GetLastAttacker(void) const {
  return (m_lastAttacker.Get() == NULL)
             ? NULL
             : m_lastAttacker->MyCombatCharacterPointer();
}
