...
public:
  ...
  virtual void
  SetMinimumSpeedLimit(float limit); // speed cannot drop below this
  virtual void
  SetMaximumSpeedLimit(float limit); // speed cannot rise above this
  ...
  GetFeet(void) const; // return position of "feet" - point below centroid of
                       // bot at feet level
...
inline float PlayerLocomotion::GetStepHeight(void) const { return 18.0f; }

inline float PlayerLocomotion::GetMaxJumpHeight(void) const { return 57.0f; }

inline float PlayerLocomotion::GetDeathDropHeight(void) const { return 200.0f; }

inline float PlayerLocomotion::GetMaxAcceleration(void) const { return 100.0f; }

inline float PlayerLocomotion::GetMaxDeceleration(void) const { return 200.0f; }

inline void PlayerLocomotion::Run(void) { m_desiredSpeed = GetRunSpeed(); }

inline void PlayerLocomotion::Walk(void) { m_desiredSpeed = GetWalkSpeed(); }

inline void PlayerLocomotion::Stop(void) { m_desiredSpeed = 0.0f; }

inline bool PlayerLocomotion::IsRunning(void) const { return true; }
...
inline bool PlayerLocomotion::IsAbleToAutoCenterOnLadder(void) const {
  return IsUsingLadder() && (m_ladderState == ASCENDING_LADDER ||
...
inline bool PlayerLocomotion::IsAscendingOrDescendingLadder(void) const {
  ...
  default:
    ...
    // warning: enumeration values 'NO_LADDER', 'APPROACHING_ASCENDING_LADDER',
    // and 'APPROACHING_DESCENDING_LADDER' not handled in switch [-Wswitch-enum]
    break;
  }
