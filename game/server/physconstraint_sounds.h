...
public:
  ...
  */
  ...
  GetRelativeAngularVelocity(IPhysicsObject *pObj,
                             IPhysicsObject *pReferenceFrame);
...
public:
  ...
  /// Constraint should have a think function that calls this. It should pass in
  /// relative velocity between child and parent. (This need not be linear
  ...
  Vector m_forwardAxis; ///< velocity in this direction is forward. The opposite
...
Vector
VelocitySampler::GetRelativeAngularVelocity(IPhysicsObject *pObj,
                                            IPhysicsObject *pReferenceFrame) {
  Assert(pObj);
