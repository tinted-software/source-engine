...
private:
  ...
  AI_SuggestorResult_t GenerateObstacleSuggestion(const AILocalMoveGoal_t &goal,
                                                  float yawScanCenter,
                                                  float probeDist,
                                                  float spanPerProbe,
                                                  int probeOffset);
  ...
  void CalcYawsFromOffset(float yawScanCenter, float spanPerProbe,
                          int probeOffset, float *pYawTest, float *pYawCenter);
  ...
  bool RunMoveSolver(const AILocalMoveGoal_t &goal,
                     const AIMoveTrace_t &directTrace, float degreesPositiveArc,
  ...
  struct CircleObstacles_t {
    CircleObstacles_t(const Vector &center, float radius, CBaseEntity *pEntity,
