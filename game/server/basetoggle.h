...
//			only old entities that need it for
//backwards-compatibility should 			include this file
//=============================================================================//
...
public:
  ...
  string_t m_sMaster; // If this button has a master switch, this is the
                      // targetname. A master switch must be of the multisource
                      // type. If all of the switches in the multisource have
                      // been triggered, then the button will be allowed to
                      // operate. Otherwise, it will be deactivated.
};
