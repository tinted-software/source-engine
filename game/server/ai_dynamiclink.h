...
// links
//				dyanimc links must be entities so they and
//receive messages. 				They update the state of the actual links.  Allows us to
//save 				a lot of memory by not making all links into entities
//
// $Workfile:     $
// $Date:         $
//
...
public:
  ...
  CAI_DynamicLink
      *m_pNextDynamicLink; // The next dynamic link in the list of dynamic links
