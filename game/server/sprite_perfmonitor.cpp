...
//
// Purpose: an entity which turns on and off counting and display of the
// particle performance metric
//
//=============================================================================
...
LINK_ENTITY_TO_CLASS(env_particle_performance_monitor,
...
DEFINE_FIELD(m_bDisplayPerf, FIELD_BOOLEAN),
    ...
    END_DATADESC()
        ...
        IMPLEMENT_SERVERCLASS_ST(CParticlePerformanceMonitor,
