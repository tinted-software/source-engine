...
enum pathType_t {
  ...
  // PATH_FLANK,				//Path that will take us to a
  // flanking position of our goal PATH_FLANK_LOS,			//Path
  // that will take us to within line of sight to the flanking position of our
  // goal
  PATH_COVER, // Path that will give us cover from our goal
  // PATH_COVER_LOS,			//Path that will give us line of sight
  // to cover from our goal
};
...
private:
  ...
  // static bool	LoadSchedules( char* prefix,	int taskIDOffset,
  // int taskENOffset, 											int schedIDOffset,  int schedENOffset, 											int condIDOffset,
  //int condENOffset);
