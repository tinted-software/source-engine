...
public:
  ...
  // Called at startup to allow temp entities to precache any models/sounds that
  // they need
  static void PrecacheTempEnts(void);

  void NetworkStateChanged() {
  } // TE's are sent out right away so we don't track whether state changes or
    // not, but we want to allow CNetworkVars.
