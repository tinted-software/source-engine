...
// Smoke grenade particles should always transmitted to clients.  If not, a
// client who enters the PVS late will see the smoke start billowing from then,
// allowing better vision.
