...
private:
  ...
  CNetworkVar(bool, m_bRedraw); // Draw the weapon again after throwing a
                                // grenade
...
acttable_t CWeaponFrag::m_acttable[] = {
    ...
    {ACT_HL2MP_GESTURE_RANGE_ATTACK, ACT_HL2MP_GESTURE_RANGE_ATTACK_GRENADE,
     false},
...
CWeaponFrag::CWeaponFrag(void) : CBaseHL2MPCombatWeapon() { m_bRedraw = false; }
