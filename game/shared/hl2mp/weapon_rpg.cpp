...
void CMissile::IgniteThink(void) {
  SetMoveType(MOVETYPE_FLY);
  SetModel("models/weapons/w_missile.mdl");
  // UTIL_SetSize( this, vec3_origin, vec3_origin ); //This cause weird no
  // damage dealing on stairs
...
SendPropBool(SENDINFO(m_bInitialStateUpdate)),
    ...
    END_PREDICTION_DATA()
        ...
        acttable_t CWeaponRPG::m_acttable[] = {
            ...
            {ACT_HL2MP_GESTURE_RANGE_ATTACK, ACT_HL2MP_GESTURE_RANGE_ATTACK_RPG,
             false},
