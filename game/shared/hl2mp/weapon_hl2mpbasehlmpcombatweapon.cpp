...
DEFINE_FIELD(m_bLowered, FIELD_BOOLEAN),
    ...
    END_DATADESC()
        ...
        BEGIN_PREDICTION_DATA(CBaseHL2MPCombatWeapon) END_PREDICTION_DATA()
...
//			viewmodelindex -
//-----------------------------------------------------------------------------
void CBaseHL2MPCombatWeapon::AddViewmodelBob(CBaseViewModel *viewmodel,
...
//-----------------------------------------------------------------------------
Vector
CBaseHL2MPCombatWeapon::GetBulletSpread(WeaponProficiency_t proficiency) {
...
// Server stubs
float CBaseHL2MPCombatWeapon::CalcViewmodelBob(void) { return 0.0f; }
...
CBaseHL2MPCombatWeapon::GetDefaultProficiencyValues() {
