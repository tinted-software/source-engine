...
#define DEFINE_PHYSPTR(name)                                                   \
  {FIELD_CUSTOM,                                                               \
   ...
   FTYPEDESC_SAVE,                                                             \
   NULL,                                                                       \
   GetPhysObjSaveRestoreOps(GetPhysIID(&(((classNameTypedef *)0)->name))),     \
   NULL}
...
#define DEFINE_PHYSPTR_ARRAY(name)                                             \
  {FIELD_CUSTOM,                                                               \
   #name,                                                                      \
   {offsetof(classNameTypedef, name), 0},                                      \
   ARRAYSIZE(((classNameTypedef *)0)->name),                                   \
   FTYPEDESC_SAVE,                                                             \
   NULL,                                                                       \
   GetPhysObjSaveRestoreOps(GetPhysIID(&(((classNameTypedef *)0)->name[0]))),  \
   NULL}
