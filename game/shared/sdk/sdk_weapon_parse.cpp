...
FileWeaponInfo_t *CreateWeaponInfo() { return new CSDKWeaponInfo; }

CSDKWeaponInfo::CSDKWeaponInfo() {}

void CSDKWeaponInfo::Parse(KeyValues *pKeyValuesData,
  ...
  const char *pAnimEx =
      pKeyValuesData->GetString("PlayerAnimationExtension", "mp5");
