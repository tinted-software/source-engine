...
public:
  ...
  char szWorldModel[MAX_WEAPON_STRING]; // Model of this weapon seen carried by
                                        // the player
  ...
  bool m_bAllowFlipping; // False to disallow flipping the model, regardless of
                         // whether it is built left or right handed.
  ...
  // TF2 specific
  bool bShowUsageHint; // if true, then when you receive the weapon, show a hint
                       // about it
