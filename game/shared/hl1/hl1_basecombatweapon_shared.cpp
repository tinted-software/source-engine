...
float CBaseHL1CombatWeapon::CalcViewmodelBob(void) {
  ...
  cycle =
      bobtime - (int)(bobtime / HL1_BOB_CYCLE_MAX * 2) * HL1_BOB_CYCLE_MAX * 2;
...
//			viewmodelindex -
//-----------------------------------------------------------------------------
void CBaseHL1CombatWeapon::AddViewmodelBob(CBaseViewModel *viewmodel,
...
Vector CBaseHL1CombatWeapon::GetSoundEmissionOrigin() const {
  ...
  //	DevMsg("SoundEmissionOrigin: Owner: %4.1f,%4.1f,%4.1f
  //Default:%4.1f,%4.1f,%4.1f\n", 			vecOwner.x, vecOwner.y, vecOwner.z, 			vecThis.x,
  //vecThis.y, vecThis.z );

  // TEMP fix for HL1MP... sounds are sometimes beeing emitted underneath the
  // ground
