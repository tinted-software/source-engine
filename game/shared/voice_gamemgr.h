...
public:
  ...
  virtual bool CanPlayerHearPlayer(CBasePlayer * pListener,
                                   CBasePlayer * pTalker, bool &bProximity) = 0;
};
...
public:
  ...
  // other. If gameplay mode is teamplay, then only players on the same team can
  // hear each other. Player masks are always applied.
