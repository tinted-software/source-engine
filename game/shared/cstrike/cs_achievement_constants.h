...
// Desc: 		Declare contants used by achievements (mostly) in one
// location for simpler tweaking Author: 		Peter Freese
// <peter@hiddenpath.com> Date: 		2009/03/11 Copyright:	© 2009
...
const float KillInAir_MinimumHeight =
    100.0f; // 100-120 is probably best. Also used for killing while in the air
