...
IMPLEMENT_NETWORKCLASS_ALIASED(BaseCSGrenadeProjectile,
...
void CBaseCSGrenadeProjectile::Spawn() {
  ...
  BaseClass::Spawn();
                        ...
                        void CBaseCSGrenadeProjectile::PostConstructor(
...
void CBaseCSGrenadeProjectile::ResolveFlyCollisionCustom(trace_t &trace,
                                                         Vector &vecVelocity) {
...
void CBaseCSGrenadeProjectile::SetupInitialTransmittedGrenadeVelocity(
...
void CBaseCSGrenadeProjectile::Splash() {
  ...
  UTIL_TraceLine(centerPoint, centerPoint + vecTrace, MASK_WATER, NULL,
