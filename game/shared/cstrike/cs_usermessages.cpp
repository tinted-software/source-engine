...
void RegisterUserMessages() {
  ...
  usermessages->Register(
      "CloseCaption",
      -1); // Show a caption (by string id number)(duration in 10th of a second)
  ...
  usermessages->Register("PlayerAnimEvent",
                         -1); // jumping, firing, reload, etc.
  ...
  usermessages->Register("PlayerStatsUpdate_DEPRECATED",
                         -1); // Protocol changed, this message replaced below
  usermessages->Register("AchievementEvent", -1);
  usermessages->Register(
      "MatchEndConditions",
      -1); // The end conditions for the match.  long frag limit, long max
