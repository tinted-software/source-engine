...
public:
  ...
  static CPlantedC4 *ShootSatchelCharge(CCSPlayer *pevOwner, Vector vecStart,
                                        QAngle vecAngles);
...
private:
  ...
  // This becomes the think function when the timer has expired and it is about
  // to explode.
  void DetonateThink();
  ...
  CNetworkVar(float, m_flDefuseLength); // How long does the defuse take?
                                        // Depends on if a defuser was used
  CNetworkVar(float, m_flDefuseCountDown); // What time does the defuse
                                           // complete?
  ...
  // [tj] We need to store who planted the bomb so we can track who deserves
...
private:
  ...
  //=============================================================================
  // HPE_BEGIN:
  // [tj] we want to store if this bomb was dropped because the original owner
  // was killed
  //=============================================================================
