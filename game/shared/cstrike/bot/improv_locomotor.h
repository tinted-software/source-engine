...
// TODO: Remove duplicate methods from CImprov, and update CImprov to use this
// class
...
public:
  ...
  GetFeet(void) const = 0; ///< return position of "feet" - point below centroid
                           ///< of improv at feet level
  ...
  virtual bool GetSimpleGroundHeightWithFloor(
      ...
      Vector *normal = NULL) = 0; ///< find "simple" ground height, treating
                                  ///< current nav area as part of the floor
  ...
  virtual void StartLadder(
      ...
      const Vector &departPos) = 0; ///< invoked when a ladder is encountered
  ...
  virtual bool TraverseLadder(const CNavLadder *ladder, NavTraverseType how,
                              ...
                              float deltaT) = 0; ///< traverse given ladder
  ...
  TrackPath(const Vector &pathGoal,
            float deltaT) = 0; ///< move along path by following "pathGoal"
