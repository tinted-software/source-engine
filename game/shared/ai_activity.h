...
typedef enum {
  ...
  ACT_RANGE_ATTACK1,
  ACT_RANGE_ATTACK2,
  ACT_RANGE_ATTACK1_LOW, // FIXME: not used yet, crouched versions of the range
                         // attack
  ACT_RANGE_ATTACK2_LOW, // FIXME: not used yet, crouched versions of the range
                         // attack
  ACT_DIESIMPLE,
  ACT_DIEBACKWARD,
  ACT_DIEFORWARD,
  ...
  ACT_STAND, // FIXME: obsolete? should be transition (the act of standing from
             // a crouched position)
  ACT_USE,
  ACT_SIGNAL1,
  ACT_SIGNAL2,
  ...
  ACT_IDLE_ANGRY, // FIXME: being used as an combat ready idle?  alternate idle
                  // animation in which the monster is clearly agitated. (loop)
  ...
  // doesn't actually have an activity. The AI will reset the NPC's sequence to
  // whatever its IDEAL activity is, though. So if you set ideal activity to
  // DO_NOT_DISTURB, the AI will not interfere with the NPC's current sequence.
  // (SJB)
  ACT_DO_NOT_DISTURB,
  ...
  ACT_PHYSCANNON_DETACH,  // An activity to be played if we're picking this up
                          // with the physcannon
  ACT_PHYSCANNON_ANIMATE, // An activity to be played by an object being picked
                          // up with the physcannon, but has different behavior
                          // to DETACH
  ACT_PHYSCANNON_ANIMATE_PRE,  // An activity to be played by an object being
                               // picked up with the physcannon, before playing
                               // the ACT_PHYSCANNON_ANIMATE
  ACT_PHYSCANNON_ANIMATE_POST, // An activity to be played by an object being
                               // picked up with the physcannon, after playing
                               // the ACT_PHYSCANNON_ANIMATE
