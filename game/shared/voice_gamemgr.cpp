...
CPlayerBitVec g_PlayerModEnable; // Set to 1 for each player if the player wants
                                 // to use voice in this mod. (If it's zero,
                                 // then the server reports that the game rules
                                 // are saying the player can't hear anyone).
