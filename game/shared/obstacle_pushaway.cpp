...
ConVar sv_pushaway_force(
    "sv_pushaway_force", "30000", SV_PUSH_CONVAR_FLAGS,
...
ConVar sv_pushaway_max_force(
    "sv_pushaway_max_force", "1000", SV_PUSH_CONVAR_FLAGS,
    "Maximum amount of force applied to physics objects by players.");
ConVar sv_pushaway_clientside(
    "sv_pushaway_clientside", "0", SV_PUSH_CONVAR_FLAGS,
...
ConVar sv_pushaway_max_player_force(
    "sv_pushaway_max_player_force", "10000", SV_PUSH_CONVAR_FLAGS | FCVAR_CHEAT,
