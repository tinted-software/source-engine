...
public:
  ...
  void ResetTimers(void); // reset all the flags, timers that would cause us to
                          // re-zoom or unzoom
...
protected:
  bool m_bShouldRezoomAfterShot; // if the gun zooms out after a shot, does it
                                 // zoom back in automatically?
