...
void CDODPlayerClassInfo::Parse(KeyValues *pKeyValuesData,
  ...
  const char *pszHelmetModel =
      pKeyValuesData->GetString("drophelmet", "HELMET_ALLIES");
  ...
  Q_strncpy(m_szClassHealthImage,
            pKeyValuesData->GetString("healthimage", "white"),
            sizeof(m_szClassHealthImage));
  Q_strncpy(m_szClassHealthImageBG,
