...
public:
  ...
  virtual void EmitGrenade(Vector vecSrc, QAngle vecAngles, Vector vecVel,
    ...
    CDODRifleGrenadeGER::Create(vecSrc, vecNewAngles, vecVel, angNewImpulse,
...
IMPLEMENT_NETWORKCLASS_ALIASED(WeaponRifleGrenadeGER_Live,
                               DT_WeaponRifleGrenadeGER_Live)
