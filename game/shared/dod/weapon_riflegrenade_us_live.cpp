...
public:
  ...
  virtual void EmitGrenade(Vector vecSrc, QAngle vecAngles, Vector vecVel,
    ...
    CDODRifleGrenadeUS::Create(vecSrc, vecNewAngles, vecVel, angNewImpulse,
...
IMPLEMENT_NETWORKCLASS_ALIASED(WeaponRifleGrenadeUS_Live,
                               DT_WeaponRifleGrenadeUS_Live)
