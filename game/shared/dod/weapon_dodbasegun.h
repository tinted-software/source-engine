...
public:
  ...
  // Derived classes must call this from inside their Spawn() function instead
  // of just chaining the Spawn() call down.
  void DODBaseGunSpawn(void);

  // Derived classes call this to fire a bullet.
  bool DODBaseGunFire(void);

  // Usually plays the shot sound. Guns with silencers can play different
  // sounds.
