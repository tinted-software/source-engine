...
//--------------------------------------------------------------------------------------------------------------
CHintMessage::CHintMessage(const char *hintString,
                           CUtlVector<const char *> *args, float duration) {
...
//--------------------------------------------------------------------------------------------------------------
bool CHintMessage::IsEquivalent(const char *hintString,
...
#ifdef GAME_DLL
  // Custom hint text sending to allow for arguments.  This is OK because the
  // client has a custom message parser for hint text that can read the
  // arguments.
...
//--------------------------------------------------------------------------------------------------------------
bool CHintMessageQueue::AddMessage(const char *message, float duration,
...
// Input  : *pPlayer -
//-----------------------------------------------------------------------------
CHintMessageTimers::CHintMessageTimers(CHintSystem *pSystem,
                                       CHintMessageQueue *pQueue) {
...
//			timer_duration - the total time the timer should run for
//until it fires the hint message 			message_duration - the duration passed into
//the hint message system when the hint fires 			args - the arguments passed into
//the hint message system when the hint fires
//-----------------------------------------------------------------------------
void CHintMessageTimers::AddTimer(int iHintID, float timer_duration,
