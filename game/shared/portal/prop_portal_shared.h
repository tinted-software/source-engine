...
class CProp_Portal_Shared // defined as a class to make intellisense more
                          // intelligent
{
public:
...
#ifdef CLIENT_DLL
  static CUtlVector<C_Prop_Portal *>
      AllPortals; // an array of existing portal entities
#else
  static CUtlVector<CProp_Portal *>
      AllPortals; // an array of existing portal entities
