...
class CPortalGameAccountClient
    : public GCSDK::CSchemaSharedObject<CSchGameAccountClient> {
public:
  CPortalGameAccountClient()
      : GCSDK::CSchemaSharedObject<CSchGameAccountClient>() {}
  CPortalGameAccountClient(uint32 unAccountID)
      : GCSDK::CSchemaSharedObject<CSchGameAccountClient>() {
