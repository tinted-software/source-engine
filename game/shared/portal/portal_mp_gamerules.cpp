...
IMPLEMENT_NETWORKCLASS_ALIASED(PortalMPGameRulesProxy,
...
#ifdef CLIENT_DLL
void RecvProxy_PortalMPRules(const RecvProp *pProp, void **pOut, void *pData,
                             int objectID) {
...
RecvPropDataTable("portalmp_gamerules_data", 0, 0,
                  &REFERENCE_RECV_TABLE(DT_PortalMPGameRules),
                  RecvProxy_PortalMPRules) END_RECV_TABLE()
#else
void *SendProxy_PortalMPRules(const SendProp *pProp, const void *pStructBase,
                              const void *pData,
...
SendPropDataTable("portalmp_gamerules_data", 0,
                  &REFERENCE_SEND_TABLE(DT_PortalMPGameRules),
                  SendProxy_PortalMPRules) END_SEND_TABLE()
#endif
...
void CPortalMPGameRules::PlayerKilled(CBasePlayer *pVictim,
...
#pragma message(__FILE__                                                       \
                "(" __LINE__AS_STRING                                          \
                ") : warning custom: Disabled weapon respawn location code")
#if 0
#ifndef CLIENT_DLL
...
#pragma message(__FILE__ "(" __LINE__AS_STRING                                 \
                         ") : warning custom: Disabled rest time code")
#if 0
...
//=========================================================
bool CPortalMPGameRules::CanHavePlayerItem(CBasePlayer *pPlayer,
...
// Deathnotice.
//=========================================================
void CPortalMPGameRules::DeathNotice(CBasePlayer *pVictim,
                                     const CTakeDamageInfo &info) {
#ifndef CLIENT_DLL
...
#pragma message(__FILE__ "(" __LINE__AS_STRING                                 \
                         ") : warning custom: Disabled model change code")
#if 0
...
int CPortalMPGameRules::PlayerRelationship(CBaseEntity *pPlayer,
                                           CBaseEntity *pTarget) {
#ifndef CLIENT_DLL
...
const char *CPortalMPGameRules::GetGameDescription(void) { return "PMP Test"; }
...
float CPortalMPGameRules::GetMapRemainingTime() {
  ...
  float timeleft =
      (m_flGameStartTime + mp_timelimit.GetInt() * 60.0f) - gpGlobals->curtime;
...
bool CPortalMPGameRules::ShouldCollide(int collisionGroup0,
                                       int collisionGroup1) {
...
bool CPortalMPGameRules::ClientCommand(CBaseEntity *pEdict,
                                       const CCommand &args) {
...
CAmmoDef *GetAmmoDef() {
  ...
  if (!bInitted) {
    ...
    def.AddAmmoType("HunterGun", DMG_BULLET, TRACER_LINE, "sk_hunter_dmg",
                    "sk_hunter_dmg", "sk_hunter_max_round",
                    BULLET_IMPULSE(200, 1225), 0);
    def.AddAmmoType(
        "CombineHeavyCannon", DMG_BLAST, TRACER_LINE, 40, 40, NULL,
        1.5 * 750 * 12,
...
bool CPortalMPGameRules::FShouldSwitchWeapon(CBasePlayer *pPlayer,
...
#pragma message(__FILE__ "(" __LINE__AS_STRING                                 \
                         ") : warning custom: Disabled player reset")
#if 0
		pPlayer->Reset();
#endif
  }
...
#pragma message(__FILE__ "(" __LINE__AS_STRING                                 \
                         ") : warning custom: Disabled entity parsing")
#if 0
...
#pragma message(__FILE__ "(" __LINE__AS_STRING                                 \
                         ") : warning custom: Disabled ready restart")
#if 0
