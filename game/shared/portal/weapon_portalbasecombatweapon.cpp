...
IMPLEMENT_NETWORKCLASS_ALIASED(BasePortalCombatWeapon,
...
DEFINE_FIELD(m_bLowered, FIELD_BOOLEAN),
    ...
    END_DATADESC()
        ...
        BEGIN_PREDICTION_DATA(CBasePortalCombatWeapon) END_PREDICTION_DATA()
...
//			viewmodelindex -
//-----------------------------------------------------------------------------
void CBasePortalCombatWeapon::AddViewmodelBob(CBaseViewModel *viewmodel,
...
//-----------------------------------------------------------------------------
Vector
CBasePortalCombatWeapon::GetBulletSpread(WeaponProficiency_t proficiency) {
...
CBasePortalCombatWeapon::GetDefaultProficiencyValues() {
