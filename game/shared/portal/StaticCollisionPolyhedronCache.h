...
//
// Purpose: Portals use polyhedrons to clip and carve their custom collision
// areas.
//			This file should provide caches of polyhedrons with the
//initial conversion 			processes already completed.
//
// $NoKeywords: $
//=====================================================================================//
...
public:
  ...
  int GetStaticPropPolyhedrons(ICollideable *pStaticProp,
...
private:
  ...
  struct StaticPropPolyhedronCacheInfo_t {
    int iStartIndex;
    int iNumPolyhedrons;
    int iStaticPropIndex; // helps us remap ICollideable pointers when the map
                          // is restarted
  };

  CUtlVector<CPolyhedron *> m_StaticPropPolyhedrons;
  CUtlMap<ICollideable *, StaticPropPolyhedronCacheInfo_t>
      m_CollideableIndicesMap;
