...
DEFINE_PRED_FIELD(m_hAttachedToEntity, FIELD_EHANDLE, FTYPEDESC_INSENDTABLE),
    ...
    //FIELD_INTEGER ),		//Starting brightness 	DEFINE_FIELD(
    //m_nDestBrightness, FIELD_INTEGER ),		//Destination brightness
    //	DEFINE_FIELD( m_flBrightnessTimeStart, FIELD_FLOAT ),	//Real time for
    //brightness
