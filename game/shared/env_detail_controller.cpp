...
CEnvDetailController *GetDetailController() { return s_detailController; }

CEnvDetailController::CEnvDetailController() { s_detailController = this; }
...
bool CEnvDetailController::KeyValue(const char *szKeyName,
                                    const char *szValue) {
