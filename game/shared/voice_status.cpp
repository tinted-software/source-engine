...
void CVoiceStatus::SetHeadLabelOffset(float offset) { g_flHeadOffset = offset; }

float CVoiceStatus::GetHeadLabelOffset(void) const { return g_flHeadOffset; }
...
bool CVoiceStatus::IsInSquelchMode() { return m_bInSquelchMode; }
