...
ISpTokenUI_IsUISupported_Proxy(ISpTokenUI *This,
                               /* [in] */ const WCHAR *pszTypeOfUI,
                               /* [in] */ void *pvExtraData,
                               /* [in] */ ULONG cbExtraData,
                               /* [in] */ IUnknown *punkObject,
...
/* [local] */ HRESULT STDMETHODCALLTYPE
ISpTokenUI_DisplayUI_Proxy(ISpTokenUI *This,
                           /* [in] */ HWND hwndParent,
                           /* [in] */ const WCHAR *pszTitle,
                           /* [in] */ const WCHAR *pszTypeOfUI,
                           /* [in] */ void *pvExtraData,
...
void __RPC_STUB ISpTokenUI_DisplayUI_Stub(IRpcStubBuffer *This,
...
public:
  virtual HRESULT STDMETHODCALLTYPE SetAttribs(const WCHAR *pszReqAttribs,
                                               const WCHAR *pszOptAttribs) = 0;

  virtual HRESULT STDMETHODCALLTYPE AddTokens(ULONG cTokens,
                                              ISpObjectToken * *pToken) = 0;

  virtual HRESULT STDMETHODCALLTYPE AddTokensFromDataKey(
      ISpDataKey * pDataKey, const WCHAR *pszSubKey,
      const WCHAR *pszCategoryId) = 0;

  virtual HRESULT STDMETHODCALLTYPE AddTokensFromTokenEnum(IEnumSpObjectTokens *
                                                           pTokenEnum) = 0;
...
typedef struct ISpObjectTokenEnumBuilderVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *AddTokens)(ISpObjectTokenEnumBuilder *This,
                                        ULONG cTokens, ISpObjectToken **pToken);

  HRESULT(STDMETHODCALLTYPE *AddTokensFromDataKey)(
      ISpObjectTokenEnumBuilder *This, ISpDataKey *pDataKey,
      const WCHAR *pszSubKey, const WCHAR *pszCategoryId);
...
HRESULT STDMETHODCALLTYPE ISpObjectTokenEnumBuilder_SetAttribs_Proxy(
    ISpObjectTokenEnumBuilder *This, const WCHAR *pszReqAttribs,
    const WCHAR *pszOptAttribs);
...
ISpObjectTokenEnumBuilder_AddTokensFromTokenEnum_Proxy(
    ISpObjectTokenEnumBuilder *This, IEnumSpObjectTokens *pTokenEnum);
...
HRESULT STDMETHODCALLTYPE ISpObjectTokenEnumBuilder_Sort_Proxy(
    ISpObjectTokenEnumBuilder *This, const WCHAR *pszTokenIdToListFirst);
...
public:
  virtual HRESULT STDMETHODCALLTYPE AddError(
      const long lLineNumber, HRESULT hr, const WCHAR *pszDescription,
...
typedef struct ISpErrorLogVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *AddError)(ISpErrorLog *This,
                                       const long lLineNumber, HRESULT hr,
...
#define ISpErrorLog_AddError(This, lLineNumber, hr, pszDescription,            \
  ...
  (This)->lpVtbl->AddError(This, lLineNumber, hr, pszDescription, pszHelpFile, \
                           dwHelpContext)
...
HRESULT STDMETHODCALLTYPE ISpErrorLog_AddError_Proxy(
    ISpErrorLog *This, const long lLineNumber, HRESULT hr,
    const WCHAR *pszDescription, const WCHAR *pszHelpFile, DWORD dwHelpContext);

void __RPC_STUB ISpErrorLog_AddError_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
...
public:
  virtual HRESULT STDMETHODCALLTYPE CompileStream(
      IStream * pSource, IStream * pDest, IStream * pHeader,
...
HRESULT STDMETHODCALLTYPE ISpGrammarCompiler_CompileStream_Proxy(
    ISpGrammarCompiler *This, IStream *pSource, IStream *pDest,
    IStream *pHeader, IUnknown *pReserved, ISpErrorLog *pErrorLog,
    /* [in] */ DWORD dwFlags);
...
public:
  virtual HRESULT STDMETHODCALLTYPE SetSaveObjects(IStream * pStream,
...
typedef struct ISpGramCompBackendVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *ResetGrammar)(ISpGramCompBackend *This,
                                           /* [in] */ WORD NewLanguage);
  ...
  HRESULT(STDMETHODCALLTYPE *ClearRule)(ISpGramCompBackend *This,
                                        SPSTATEHANDLE hState);

  HRESULT(STDMETHODCALLTYPE *CreateNewState)(ISpGramCompBackend *This,
                                             SPSTATEHANDLE hState,
                                             SPSTATEHANDLE *phState);

  HRESULT(STDMETHODCALLTYPE *AddWordTransition)(
      ISpGramCompBackend *This, SPSTATEHANDLE hFromState,
      SPSTATEHANDLE hToState, const WCHAR *psz, const WCHAR *pszSeparators,
      SPGRAMMARWORDTYPE eWordType, float Weight,
      const SPPROPERTYINFO *pPropInfo);

  HRESULT(STDMETHODCALLTYPE *AddRuleTransition)(
      ISpGramCompBackend *This, SPSTATEHANDLE hFromState,
      SPSTATEHANDLE hToState, SPSTATEHANDLE hRule, float Weight,
      const SPPROPERTYINFO *pPropInfo);
  ...
  HRESULT(STDMETHODCALLTYPE *Commit)(ISpGramCompBackend *This,
                                     DWORD dwReserved);

  HRESULT(STDMETHODCALLTYPE *SetSaveObjects)(ISpGramCompBackend *This,
                                             IStream *pStream,
                                             ISpErrorLog *pErrorLog);
...
HRESULT STDMETHODCALLTYPE
ISpITNProcessor_LoadITNGrammar_Proxy(ISpITNProcessor *This, WCHAR *pszCLSID);
...
HRESULT STDMETHODCALLTYPE ISpITNProcessor_ITNPhrase_Proxy(
    ISpITNProcessor *This, ISpPhraseBuilder *pPhrase);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE AddElements(
      ULONG cElements, const SPPHRASEELEMENT *pElement) = 0;

  virtual HRESULT STDMETHODCALLTYPE AddRules(const SPPHRASERULEHANDLE hParent,
                                             const SPPHRASERULE *pRule,
                                             SPPHRASERULEHANDLE *phNewRule) = 0;

  virtual HRESULT STDMETHODCALLTYPE AddProperties(
      const SPPHRASEPROPERTYHANDLE hParent, const SPPHRASEPROPERTY *pProperty,
      SPPHRASEPROPERTYHANDLE *phNewProperty) = 0;

  virtual HRESULT STDMETHODCALLTYPE AddReplacements(
      ULONG cReplacements, const SPPHRASEREPLACEMENT *pReplacements) = 0;
};
...
typedef struct ISpPhraseBuilderVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *InitFromPhrase)(ISpPhraseBuilder *This,
  ...
  HRESULT(STDMETHODCALLTYPE *AddElements)(ISpPhraseBuilder *This,
                                          ULONG cElements,
                                          const SPPHRASEELEMENT *pElement);

  HRESULT(STDMETHODCALLTYPE *AddRules)(ISpPhraseBuilder *This,
                                       const SPPHRASERULEHANDLE hParent,
                                       const SPPHRASERULE *pRule,
                                       SPPHRASERULEHANDLE *phNewRule);

  HRESULT(STDMETHODCALLTYPE *AddProperties)(
      ISpPhraseBuilder *This, const SPPHRASEPROPERTYHANDLE hParent,
      const SPPHRASEPROPERTY *pProperty, SPPHRASEPROPERTYHANDLE *phNewProperty);

  HRESULT(STDMETHODCALLTYPE *AddReplacements)(
      ISpPhraseBuilder *This, ULONG cReplacements,
...
HRESULT STDMETHODCALLTYPE ISpPhraseBuilder_InitFromPhrase_Proxy(
    ISpPhraseBuilder *This, const SPPHRASE *pPhrase);
...
HRESULT STDMETHODCALLTYPE ISpPhraseBuilder_AddRules_Proxy(
    ISpPhraseBuilder *This, const SPPHRASERULEHANDLE hParent,
...
public:
  virtual HRESULT STDMETHODCALLTYPE StartThread(DWORD dwFlags,
                                                HWND * phwnd) = 0;

  virtual HRESULT STDMETHODCALLTYPE WaitForThreadDone(
      BOOL fForceStop, HRESULT * phrThreadResult, ULONG msTimeOut) = 0;
...
typedef struct ISpThreadControlVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *StartThread)(ISpThreadControl *This, DWORD dwFlags,
                                          HWND *phwnd);

  HRESULT(STDMETHODCALLTYPE *WaitForThreadDone)(ISpThreadControl *This,
                                                BOOL fForceStop,
...
HRESULT STDMETHODCALLTYPE ISpThreadControl_StartThread_Proxy(
    ISpThreadControl *This, DWORD dwFlags, HWND *phwnd);
...
HRESULT STDMETHODCALLTYPE ISpThreadControl_WaitForThreadDone_Proxy(
    ISpThreadControl *This, BOOL fForceStop, HRESULT *phrThreadResult,
    ULONG msTimeOut);
...
HRESULT STDMETHODCALLTYPE
ISpThreadControl_TerminateThread_Proxy(ISpThreadControl *This);
...
ISpThreadControl_ThreadHandle_Proxy(ISpThreadControl *This);
...
HANDLE STDMETHODCALLTYPE
ISpThreadControl_NotifyEvent_Proxy(ISpThreadControl *This);

void __RPC_STUB ISpThreadControl_NotifyEvent_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);

HWND STDMETHODCALLTYPE
ISpThreadControl_WindowHandle_Proxy(ISpThreadControl *This);
...
HANDLE STDMETHODCALLTYPE
ISpThreadControl_ThreadCompleteEvent_Proxy(ISpThreadControl *This);
...
HANDLE STDMETHODCALLTYPE
ISpThreadControl_ExitThreadEvent_Proxy(ISpThreadControl *This);
...
HRESULT STDMETHODCALLTYPE
ISpTaskManager_GetThreadPoolInfo_Proxy(ISpTaskManager *This,
                                       /* [out] */ SPTMTHREADINFO *pPoolInfo);
...
HRESULT STDMETHODCALLTYPE
ISpTaskManager_QueueTask_Proxy(ISpTaskManager *This,
                               /* [in] */ ISpTask *pTask,
                               /* [in] */ void *pvTaskData,
                               /* [in] */ HANDLE hCompEvent,
                               /* [out][in] */ DWORD *pdwGroupId,
...
HRESULT STDMETHODCALLTYPE
ISpTaskManager_TerminateTask_Proxy(ISpTaskManager *This,
                                   /* [in] */ DWORD dwTaskId,
                                   /* [in] */ ULONG ulWaitPeriod);
...
HRESULT STDMETHODCALLTYPE
ISpTaskManager_TerminateTaskGroup_Proxy(ISpTaskManager *This,
                                        /* [in] */ DWORD dwGroupId,
                                        /* [in] */ ULONG ulWaitPeriod);
...
ISpTTSEngineSite_GetActions_Proxy(ISpTTSEngineSite *This);
...
HRESULT STDMETHODCALLTYPE
ISpTTSEngineSite_Write_Proxy(ISpTTSEngineSite *This,
                             /* [in] */ const void *pBuff,
                             /* [in] */ ULONG cb,
                             /* [out] */ ULONG *pcbWritten);
...
HRESULT STDMETHODCALLTYPE
ISpTTSEngineSite_GetRate_Proxy(ISpTTSEngineSite *This,
                               /* [out] */ long *pRateAdjust);
...
HRESULT STDMETHODCALLTYPE
ISpTTSEngineSite_GetVolume_Proxy(ISpTTSEngineSite *This,
                                 /* [out] */ USHORT *pusVolume);
...
HRESULT STDMETHODCALLTYPE
ISpTTSEngineSite_GetSkipInfo_Proxy(ISpTTSEngineSite *This,
                                   /* [out] */ SPVSKIPTYPE *peType,
                                   /* [out] */ long *plNumItems);
...
HRESULT STDMETHODCALLTYPE
ISpTTSEngineSite_CompleteSkip_Proxy(ISpTTSEngineSite *This,
                                    /* [in] */ long ulNumSkipped);
...
#define ISpTTSEngine_GetOutputFormat(This, pTargetFmtId, pTargetWaveFormatEx,  \
  ...
  (This)->lpVtbl->GetOutputFormat(This, pTargetFmtId, pTargetWaveFormatEx,     \
                                  pOutputFormatId, ppCoMemOutputWaveFormatEx)
...
HRESULT STDMETHODCALLTYPE
ISpTTSEngine_Speak_Proxy(ISpTTSEngine *This,
                         /* [in] */ DWORD dwSpeakFlags,
                         /* [in] */ REFGUID rguidFormatId,
                         /* [in] */ const WAVEFORMATEX *pWaveFormatEx,
                         /* [in] */ const SPVTEXTFRAG *pTextFragList,
...
void __RPC_STUB ISpTTSEngine_Speak_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE
ISpCFGInterpreter_InitGrammar_Proxy(ISpCFGInterpreter *This,
                                    /* [in] */ const WCHAR *pszGrammarName,
                                    /* [in] */ const void **pvGrammarData);
...
HRESULT STDMETHODCALLTYPE
ISpCFGInterpreter_Interpret_Proxy(ISpCFGInterpreter *This,
                                  /* [in] */ ISpPhraseBuilder *pPhrase,
                                  /* [in] */ const ULONG ulFirstElement,
                                  /* [in] */ const ULONG ulCountOfElements,
                                  /* [in] */ ISpCFGInterpreterSite *pSite);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SetWordClientContext(
      SPWORDHANDLE hWord, void *pvClientContext) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetRuleClientContext(
      SPRULEHANDLE hRule, void *pvClientContext) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetStateInfo(SPSTATEHANDLE hState,
...
typedef struct ISpSREngineSiteVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *SetWordClientContext)(ISpSREngineSite *This,
                                                   SPWORDHANDLE hWord,
                                                   void *pvClientContext);
  ...
  HRESULT(STDMETHODCALLTYPE *SetRuleClientContext)(ISpSREngineSite *This,
                                                   SPRULEHANDLE hRule,
                                                   void *pvClientContext);
...
HRESULT STDMETHODCALLTYPE
ISpSREngineSite_Read_Proxy(ISpSREngineSite *This,
                           /* [in] */ void *pv,
                           /* [in] */ ULONG cb,
                           /* [out] */ ULONG *pcbRead);

void __RPC_STUB ISpSREngineSite_Read_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);

HRESULT STDMETHODCALLTYPE
ISpSREngineSite_DataAvailable_Proxy(ISpSREngineSite *This, ULONG *pcb);
...
HRESULT STDMETHODCALLTYPE
ISpSREngineSite_SetBufferNotifySize_Proxy(ISpSREngineSite *This,
                                          /* [in] */ ULONG cbSize);
...
HRESULT STDMETHODCALLTYPE
ISpSREngineSite_AddEvent_Proxy(ISpSREngineSite *This,
                               /* [in] */ const SPEVENT *pEvent,
                               /* [in] */ SPRECOCONTEXTHANDLE hSAPIRecoContext);
...
HRESULT STDMETHODCALLTYPE
ISpSREngineSite_Synchronize_Proxy(ISpSREngineSite *This,
                                  /* [in] */ ULONGLONG ullProcessedThruPos);
...
HRESULT STDMETHODCALLTYPE
ISpSREngineSite_GetWordInfo_Proxy(ISpSREngineSite *This,
                                  /* [out][in] */ SPWORDENTRY *pWordEntry,
                                  /* [in] */ SPWORDINFOOPT Options);
...
HRESULT STDMETHODCALLTYPE
ISpSREngineSite_GetRuleInfo_Proxy(ISpSREngineSite *This,
                                  /* [out][in] */ SPRULEENTRY *pRuleEntry,
                                  /* [in] */ SPRULEINFOOPT Options);
...
HRESULT STDMETHODCALLTYPE
ISpSREngineSite_GetResource_Proxy(ISpSREngineSite *This,
                                  /* [in] */ SPRULEHANDLE hRule,
                                  /* [in] */ const WCHAR *pszResourceName,
                                  /* [out] */ WCHAR **ppCoMemResource);
...
HRESULT STDMETHODCALLTYPE
ISpSREngineSite_IsAlternate_Proxy(ISpSREngineSite *This,
                                  /* [in] */ SPRULEHANDLE hRule,
                                  /* [in] */ SPRULEHANDLE hAltRule);
...
HRESULT STDMETHODCALLTYPE
ISpSREngineSite_GetMaxAlternates_Proxy(ISpSREngineSite *This,
                                       /* [in] */ SPRULEHANDLE hRule,
                                       /* [out] */ ULONG *pulNumAlts);
...
HRESULT STDMETHODCALLTYPE
ISpSREngineSite_UpdateRecoPos_Proxy(ISpSREngineSite *This,
                                    /* [in] */ ULONGLONG ullCurrentRecoPos);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SetRecoProfile(ISpObjectToken *
                                                   pProfile) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetAdaptationData(
      /* [in] */ void *pvEngineContext, const WCHAR *pAdaptationData,
      const ULONG cch) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE WordNotify(SPCFGNOTIFY Action, ULONG cWords,
                                               const SPWORDENTRY *pWords) = 0;

  virtual HRESULT STDMETHODCALLTYPE RuleNotify(SPCFGNOTIFY Action, ULONG cRules,
...
typedef struct ISpSREngineVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *SetRecoProfile)(ISpSREngine *This,
  ...
  HRESULT(STDMETHODCALLTYPE *WordNotify)(ISpSREngine *This, SPCFGNOTIFY Action,
                                         ULONG cWords,
                                         const SPWORDENTRY *pWords);

  HRESULT(STDMETHODCALLTYPE *RuleNotify)(ISpSREngine *This, SPCFGNOTIFY Action,
                                         ULONG cRules,
...
#define ISpSREngine_SetProprietaryRuleState(                                   \
  ...
  (This)->lpVtbl->SetProprietaryRuleState(This, pvEngineGrammar, pszName,      \
                                          pReserved, NewState, pcRulesChanged)
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_SetSite_Proxy(ISpSREngine *This,
                          /* [in] */ ISpSREngineSite *pSite);

void __RPC_STUB ISpSREngine_SetSite_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_RecognizeStream_Proxy(ISpSREngine *This,
                                  /* [in] */ REFGUID rguidFmtId,
                                  /* [in] */ const WAVEFORMATEX *pWaveFormatEx,
                                  /* [in] */ HANDLE hRequestSync,
                                  /* [in] */ HANDLE hDataAvailable,
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_SetRecoProfile_Proxy(ISpSREngine *This, ISpObjectToken *pProfile);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_OnCreateGrammar_Proxy(ISpSREngine *This,
                                  /* [in] */ void *pvEngineRecoContext,
                                  /* [in] */ SPGRAMMARHANDLE hSAPIGrammar,
                                  /* [out] */ void **ppvEngineGrammarContext);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_OnDeleteGrammar_Proxy(ISpSREngine *This,
                                  /* [in] */ void *pvEngineGrammar);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_UnloadProprietaryGrammar_Proxy(ISpSREngine *This,
                                           /* [in] */ void *pvEngineGrammar);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_SetProprietaryRuleIdState_Proxy(ISpSREngine *This,
                                            /* [in] */ void *pvEngineGrammar,
                                            /* [in] */ DWORD dwRuleId,
                                            /* [in] */ SPRULESTATE NewState);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_LoadSLM_Proxy(ISpSREngine *This,
                          /* [in] */ void *pvEngineGrammar,
                          /* [string][in] */ const WCHAR *pszTopicName);

void __RPC_STUB ISpSREngine_LoadSLM_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);

HRESULT STDMETHODCALLTYPE
ISpSREngine_UnloadSLM_Proxy(ISpSREngine *This,
                            /* [in] */ void *pvEngineGrammar);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_SetSLMState_Proxy(ISpSREngine *This,
                              /* [in] */ void *pvEngineGrammar,
                              /* [in] */ SPRULESTATE NewState);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_SetTextSelection_Proxy(ISpSREngine *This,
                                   /* [in] */ void *pvEngineGrammar,
                                   /* [in] */ const SPTEXTSELECTIONINFO *pInfo);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_OnDeleteRecoContext_Proxy(ISpSREngine *This,
                                      /* [in] */ void *pvEngineContext);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_PrivateCall_Proxy(ISpSREngine *This,
                              /* [in] */ void *pvEngineContext,
                              /* [out][in] */ PVOID pCallFrame,
                              /* [in] */ ULONG ulCallFrameSize);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_SetPropertyNum_Proxy(ISpSREngine *This,
                                 /* [in] */ SPPROPSRC eSrc,
                                 /* [in] */ void *pvSrcObj,
                                 /* [in] */ const WCHAR *pName,
                                 /* [in] */ LONG lValue);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_GetPropertyNum_Proxy(ISpSREngine *This,
                                 /* [in] */ SPPROPSRC eSrc,
                                 /* [in] */ void *pvSrcObj,
                                 /* [in] */ const WCHAR *pName,
                                 /* [out] */ LONG *lValue);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_SetPropertyString_Proxy(ISpSREngine *This,
                                    /* [in] */ SPPROPSRC eSrc,
                                    /* [in] */ void *pvSrcObj,
                                    /* [in] */ const WCHAR *pName,
                                    /* [in] */ const WCHAR *pValue);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_GetPropertyString_Proxy(ISpSREngine *This,
                                    /* [in] */ SPPROPSRC eSrc,
                                    /* [in] */ void *pvSrcObj,
                                    /* [in] */ const WCHAR *pName,
                                    /* [out] */ WCHAR **ppCoMemValue);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_SetGrammarState_Proxy(ISpSREngine *This,
                                  /* [in] */ void *pvEngineGrammar,
                                  /* [in] */ SPGRAMMARSTATE eGrammarState);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_WordNotify_Proxy(ISpSREngine *This, SPCFGNOTIFY Action,
                             ULONG cWords, const SPWORDENTRY *pWords);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_RuleNotify_Proxy(ISpSREngine *This, SPCFGNOTIFY Action,
                             ULONG cRules, const SPRULEENTRY *pRules);
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_PrivateCallEx_Proxy(ISpSREngine *This,
                                /* [in] */ void *pvEngineContext,
                                /* [in] */ const void *pInCallFrame,
                                /* [in] */ ULONG ulInCallFrameSize,
                                /* [out] */ void **ppvCoMemResponse,
...
HRESULT STDMETHODCALLTYPE
ISpSREngine_SetContextState_Proxy(ISpSREngine *This,
                                  /* [in] */ void *pvEngineContext,
                                  /* [in] */ SPCONTEXTSTATE eContextState);
...
HRESULT STDMETHODCALLTYPE
ISpSRAlternates_GetAlternates_Proxy(ISpSRAlternates *This,
                                    /* [in] */ SPPHRASEALTREQUEST *pAltRequest,
                                    /* [out] */ SPPHRASEALT **ppAlts,
                                    /* [out] */ ULONG *pcAlts);
...
HRESULT STDMETHODCALLTYPE
ISpSRAlternates_Commit_Proxy(ISpSRAlternates *This,
                             /* [in] */ SPPHRASEALTREQUEST *pAltRequest,
                             /* [in] */ SPPHRASEALT *pAlt,
                             /* [out] */ void **ppvResultExtra,
                             /* [out] */ ULONG *pcbResultExtra);
...
typedef struct _ISpPrivateEngineCallVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *CallEngine)(_ISpPrivateEngineCall *This,
                                         /* [out][in] */ void *pCallFrame,
                                         /* [in] */ ULONG ulCallFrameSize);

  HRESULT(STDMETHODCALLTYPE *CallEngineEx)(_ISpPrivateEngineCall *This,
                                           /* [in] */ const void *pInFrame,
                                           /* [in] */ ULONG ulInFrameSize,
                                           /* [out] */ void **ppCoMemOutFrame,
...
#define _ISpPrivateEngineCall_CallEngineEx(This, pInFrame, ulInFrameSize,      \
  ...
  (This)->lpVtbl->CallEngineEx(This, pInFrame, ulInFrameSize, ppCoMemOutFrame, \
                               pulOutFrameSize)
...
HRESULT STDMETHODCALLTYPE
_ISpPrivateEngineCall_CallEngine_Proxy(_ISpPrivateEngineCall *This,
                                       /* [out][in] */ void *pCallFrame,
                                       /* [in] */ ULONG ulCallFrameSize);
...
HRESULT STDMETHODCALLTYPE
_ISpPrivateEngineCall_CallEngineEx_Proxy(_ISpPrivateEngineCall *This,
                                         /* [in] */ const void *pInFrame,
                                         /* [in] */ ULONG ulInFrameSize,
                                         /* [out] */ void **ppCoMemOutFrame,
                                         /* [out] */ ULONG *pulOutFrameSize);
