...
// Purpose: Constructor
//-----------------------------------------------------------------------------
SampleListPanelBoth::SampleListPanelBoth(Panel *parent, const char *name)
  ...
  m_pSectionedListPanel->addColumnToSection(0, "items",
                                            SectionedListPanel::COLUMN_TEXT);
  ...
  m_pSectionedListPanel->addColumnToSection(2, "items",
                                            SectionedListPanel::COLUMN_TEXT);
