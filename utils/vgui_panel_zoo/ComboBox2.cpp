...
// Purpose: Constructor
//-----------------------------------------------------------------------------
ComboBox2Demo::ComboBox2Demo(Panel *parent, const char *name)
  ...
  // The fourth arg is if the box is editable or not, this time we set it to
  // true.
  ...
  m_pButton =
      new Button(this, "AButton", "Click to add an item name to the menu");
