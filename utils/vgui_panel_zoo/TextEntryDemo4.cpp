...
// In this demo we create a NON-editable text entry window that holds multiple
// lines of text. We initialize it with some starting text and add a scroll bar
// to the window. Then we use a tick function to add some more text to the
// window every one second. As the window fills with text, the window scrolls
// vertically. The scroll bar will appear after a few lines and the scroll bar
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
TextEntryDemo4::TextEntryDemo4(Panel *parent, const char *name)
  ...
  m_pTextEntry->InsertString(
      "Even more scrumptious, chocolatey delicious text. ");
  m_pTextEntry->InsertString(
      "Enough text to get that scroll bar a-scrolling. ");
