...
// In this demo we create an NON-editable text entry window that holds multiple
// lines of text. We initialize it with some text and add a scroll bar to the
// window.
//-----------------------------------------------------------------------------
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
TextEntryDemo3::TextEntryDemo3(Panel *parent, const char *name)
