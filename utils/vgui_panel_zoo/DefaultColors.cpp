...
Color colors[] = {
    Color(0, 0, 0),       Color(30, 30, 30),    Color(45, 49, 40),
    Color(62, 70, 55),    Color(76, 88, 68),    Color(100, 120, 100),
    Color(136, 145, 128), Color(160, 170, 149), Color(216, 222, 211),
    Color(255, 255, 255), Color(149, 136, 49),  Color(196, 181, 80)};
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
DefaultColors::DefaultColors(Panel *parent, const char *name)
