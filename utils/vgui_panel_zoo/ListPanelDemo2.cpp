...
// Purpose: Constructor
//-----------------------------------------------------------------------------
ListPanelDemo2::ListPanelDemo2(Panel *parent, const char *name)
    : DemoPage(parent, name) {
  // Create a list panel.
  m_pListPanel = new ListPanel(this, "AListPanel");

  // Add a column header
  m_pListPanel->addColumnHeader(0, "Muppet", "Muppet", 150, true, 20, 200,
                                true);

  // Add another column header
  m_pListPanel->addColumnHeader(1, "Description", "Description", 150, true, 20,
                                200, true);
