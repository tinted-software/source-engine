...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CascadingMenuDemo::CascadingMenuDemo(Panel *parent, const char *name)
...
void CascadingMenuDemo::InitMenus() {
  ...
  // Set the number of visible items in the menu to 4, this menu will have a
  // scrollbar.
  m_pDeepestMenu->SetNumberOfVisibleItems(4);

  // Add this menu item to one of the other menus already in the top most menu
  // above
...
void CascadingMenuDemo::OnMaggie() { ivgui()->DPrintf("Maggie selected.\n"); }
