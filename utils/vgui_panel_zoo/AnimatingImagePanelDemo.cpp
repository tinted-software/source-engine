...
//-----------------------------------------------------------------------------
// An AnimatingImagePanel is a panel class that handles drawing of Animated
// Images and gives them all kinds of panel features.
//-----------------------------------------------------------------------------
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
AnimatingImagePanelDemo::AnimatingImagePanelDemo(Panel *parent,
                                                 const char *name)
    : DemoPage(parent, name) {
  // Create an Animating Image Panel
  m_pAnimImagePanel = new AnimatingImagePanel(this, "AnAnimatingImagePanel");

  // Each image file is named c1, c2, c3... c20, one image for each frame of the
  // animation. This loads the 20 images in to the Animation class.
