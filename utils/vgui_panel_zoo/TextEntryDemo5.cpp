...
// In this demo we create an editable text entry window that holds multiple
// lines of text. We initialize it with some starting text. We override the
// enter key to clear the text. To add a newline manually you can type
// ctrl-enter
//-----------------------------------------------------------------------------
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
TextEntryDemo5::TextEntryDemo5(Panel *parent, const char *name)
