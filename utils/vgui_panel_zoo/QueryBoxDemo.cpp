...
// They are useful for asking questions (like... "Are you sure you want to do
// this?"). In this example we will trigger the opening of a query box when a
// button is pressed. Query boxes are Message boxes that have an OK and a Cancel
// button, each button may be linked to an additional command in order to
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
QueryBoxDemo::QueryBoxDemo(Panel *parent, const char *name)
...
void QueryBoxDemo::ShowQueryBox() {
  ...
  QueryBox *pQuery =
      new QueryBox("Message Window", "Will you pick OK or Cancel?");
...
//-----------------------------------------------------------------------------
void QueryBoxDemo::OnCancel() { ivgui()->DPrintf("Query was canceled.\n"); }
