...
// Purpose: Constructor
//-----------------------------------------------------------------------------
SampleMenus::SampleMenus(Panel *parent, const char *name)
  ...
  // A fixed width menu with checkable menu items and items with names longer
  // than the menu width
  ...
  // Cascading menu with checkable menu items and items with names longer than
  // the menu width
  InitMenus();

  // Scrolling menu with checkable menu items and items with names longer than
  // the menu width
  ...
  Label *buttonLabel = new Label(
      this, "buttonLabel",
      "These are the same menus as above with checkable/elipsis menuitems");
  buttonLabel->SetPos(95, 60);
  buttonLabel->SizeToContents();

  // A button to toggle a check setting in a menu
  Button *toggleMenuCheckButton =
      new Button(this, "Toggle Menu Check", "Toggle Simple Menu Check");
...
// We will create a Menu with 2 Menus inside it, and yet another Menu inside one
// of those!
//-----------------------------------------------------------------------------
