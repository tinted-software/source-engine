...
// Purpose: Constructor
//-----------------------------------------------------------------------------
RadioButtonDemo::RadioButtonDemo(Panel *parent, const char *name)
  ...
  // Because all buttons respons when a new one is checked (they uncheck
  // themselves if checked) In this case when a button is selected a
  // RadioButtonChecked message gets sent
}
