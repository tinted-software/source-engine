...
void CFacePoserSound::Init(void) { m_pAudio = CAudioOutput::Create(); }

void CFacePoserSound::Shutdown(void) { delete m_pAudio; }

float CFacePoserSound::GetAmountofTimeAhead(void) { return 0.0f; }

int CFacePoserSound::GetNumberofSamplesAhead(void) { return 0; }
...
bool CFacePoserSound::IsSoundPlaying(CAudioMixer *pMixer) { return false; }

CAudioMixer *CFacePoserSound::FindMixer(CAudioSource *source) { return NULL; }
