...
CToolDemoFile::CToolDemoFile() { m_hDemoFile = FILESYSTEM_INVALID_HANDLE; }
...
servers incompatible #define PROTOCOL_VERSION    7

  if ( m_DemoHeader.networkprotocol != PROTOCOL_VERSION )
  {
          Warning ("ERROR: demo network protocol %i outdated, engine version is
...
int CToolDemoFile::GetSize() { return g_pFileSystem->Size(m_hDemoFile); }
