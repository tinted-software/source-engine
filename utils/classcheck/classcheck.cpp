...
void printusage(void) {
  vprint(
      0,
      "usage:  classcheck -q -h -m -t <root source directory> <game:  hl2 | tf2>\n\
		\t-q = quiet\n\
...
void ProcessDirectory(const char *game, const char *sourcetreebase,
                      const char *subdir, const char *baseentityclass) {
...
//			*baseentityclass -
//-----------------------------------------------------------------------------
void ProcessFile(const char *game, const char *sourcetreebase,
                 const char *subdir, const char *baseentityclass,
...
int main(int argc, char *argv[]) {
  ...
  if (!pSpecificFile) {
    ...
    if (bOutsideGamedir) {
      ...
      ProcessFile(argv[i - 1], sourcetreebase, "server", "CBaseEntity",
                  pSpecificFile);
      ProcessFile(argv[i - 1], sourcetreebase, "client", "C_BaseEntity",
                  pSpecificFile);
    }
  }
