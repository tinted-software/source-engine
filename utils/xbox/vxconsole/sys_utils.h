...
#define MAKEINT64(hiword, loword)                                              \
  ((__int64)((((__int64)(hiword)) << 32) | (__int64)(loword)))
...
extern int Sys_LoadFile(const CHAR *filename, void **bufferptr,
                        bool bText = false);
extern bool Sys_SaveFile(const CHAR *filename, void *buffer, long count,
                         bool bText = false);
...
extern BOOL Sys_GetRegistryString(const CHAR *key, CHAR *value,
...
extern bool Sys_IsWildcardMatch(const CHAR *wildcardString,
                                const CHAR *stringToCheck, bool caseSensitive);
extern char *Sys_NumberToCommaString(__int64 number, char *buffer,
                                     int bufferSize);
