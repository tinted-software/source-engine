...
extern void TL_DefaultExtension(char *path, char *extension,
                                bool bForce = false);
...
extern void TL_ReplaceExtension(const char *inPath, const char *extension,
                                char *outPath);
...
extern bool TL_IsWildcardMatch(const char *wildcardString,
