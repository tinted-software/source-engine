...
template <typename T> class QuickArray : private std::vector<T> {
public:
...
template <typename T> class QuickStack : private std::vector<T> {
public:
...
template <typename K, typename V> class QuickMap : private std::map<K, V> {
public:
...
ComboHandle Combo_GetNext(uint64 &riCommandNumber, ComboHandle &rhCombo,
                          uint64 iCommandEnd) {
