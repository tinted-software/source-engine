...
void Usage(void) {
  ...
  fprintf(stderr, "bspzip -addfile <bspfile> <relativepathname> <fullpathname> "
                  "<newbspfile>\n");
  ...
  fprintf(stderr, "bspzip -addfiles <bspfile> <relativePathPrefix> <listfile> "
                  "<newbspfile>\n");
  fprintf(stderr, "  Adds files to <newbspfile>.\n");
  fprintf(stderr, "bspzip -repack [ -compress ] <bspfile>\n");
  fprintf(stderr, "  Optimally repacks a BSP file, optionally using compressed "
                  "BSP format.\n");
  fprintf(stderr, "  Using on a compressed BSP without -compress will "
                  "effectively decompress\n");
