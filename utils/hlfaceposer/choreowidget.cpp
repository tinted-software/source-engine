...
//-----------------------------------------------------------------------------
int CChoreoWidget::GetItemHeight(void) { return m_pView->GetRowHeight(); }
...
//-----------------------------------------------------------------------------
bool CChoreoWidget::IsSelected(void) { return m_bSelected; }

//-----------------------------------------------------------------------------
// Purpose:
// Input  : selected -
//-----------------------------------------------------------------------------
void CChoreoWidget::SetSelected(bool selected) { m_bSelected = selected; }
...
int CChoreoWidget::x(void) { return m_rcBounds.left; }

int CChoreoWidget::y(void) { return m_rcBounds.top; }

int CChoreoWidget::w(void) { return m_rcBounds.right - m_rcBounds.left; }

int CChoreoWidget::h(void) { return m_rcBounds.bottom - m_rcBounds.top; }

CChoreoWidget *CChoreoWidget::getParent(void) { return m_pParent; }

void CChoreoWidget::setVisible(bool visible) { m_bVisible = visible; }

bool CChoreoWidget::getVisible(void) { return m_bVisible; }

void CChoreoWidget::getBounds(RECT &bounds) { bounds = m_rcBounds; }

RECT &CChoreoWidget::getBounds(void) { return m_rcBounds; }
