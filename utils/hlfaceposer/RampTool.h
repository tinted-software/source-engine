...
public:
  ...
  void DrawSamplesSimple(CChoreoWidgetDrawHelper &drawHelper, CChoreoEvent *e,
                         bool clearbackground, COLORREF sampleColor,
                         RECT &rcSamples);
  ...
  CExpressionSample *
  GetSampleUnderMouse(int mx, int my,
...
private:
  ...
  void DrawRelativeTagsForEvent(CChoreoWidgetDrawHelper &drawHelper, RECT &rc,
                                CChoreoEvent *rampevent, CChoreoEvent *event,
                                float starttime, float endtime);
  void DrawAbsoluteTagsForEvent(CChoreoWidgetDrawHelper &drawHelper, RECT &rc,
                                CChoreoEvent *rampevent, CChoreoEvent *event,
                                float starttime, float endtime);
