...
public:
  ...
  virtual void CreateNewBitmap(int modelindex, char const *pchBitmapFilename,
                               int sequence, int nSnapShotSize,
                               bool bZoomInOnFace,
                               class CExpression *pExpression,
...
private:
  ...
  public:
    ...
    void CreateNewBitmap(char const *pchBitmapFilename, int sequence,
                         int nSnapShotSize, bool bZoomInOnFace,
                         class CExpression *pExpression,
                         mxbitmapdata_t *bitmap);
