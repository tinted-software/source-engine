...
public:
  ...
  bool SetFlexAnimationTrackFromExpression(int mx, int my, CExpClass *cl,
                                           CExpression *exp);
...
private:
  ...
  bool GetTimingTagRect(RECT &rcClient, CChoreoEvent *event,
  ...
  public:
    ...
    public:
      ...
      CTrackData(const CTrackData &other) {
        m_Samples[0].CopyArray(other.m_Samples[0].Base(),
                               other.m_Samples[0].Count());
        m_Samples[1].CopyArray(other.m_Samples[1].Base(),
                               other.m_Samples[1].Count());
      }
