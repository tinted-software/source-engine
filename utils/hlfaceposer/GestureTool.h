...
public:
  ...
  void GetScrubHandleReferenceRect(RECT &rcHandle, float scrub,
                                   bool clipped = false);
  ...
  bool GetAbsTagRect(RECT &rcClient, CChoreoEvent *event, int tagtype,
                     CEventAbsoluteTag *tag, RECT &rcTag);
...
private:
  ...
  void DrawRelativeTagsForEvent(CChoreoWidgetDrawHelper &drawHelper, RECT &rc,
                                CChoreoEvent *gesture, CChoreoEvent *event,
