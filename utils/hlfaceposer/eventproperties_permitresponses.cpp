...
class CEventPropertiesPermitResponsesDialog
...
void CEventPropertiesPermitResponsesDialog::InitControlData(
    CEventParams *params) {
...
static CEventPropertiesPermitResponsesDialog
    g_EventPropertiesPermitResponsesDialog;
...
void CEventPropertiesPermitResponsesDialog::ShowControlsForEventType(
    CEventParams *params) {
...
//-----------------------------------------------------------------------------
static BOOL CALLBACK EventPropertiesPermitResponsesDialogProc(HWND hwndDlg,
                                                              UINT uMsg,
                                                              WPARAM wParam,
                                                              LPARAM lParam) {
  return g_EventPropertiesPermitResponsesDialog.HandleMessage(hwndDlg, uMsg,
                                                              wParam, lParam);
};

BOOL CEventPropertiesPermitResponsesDialog::HandleMessage(HWND hwndDlg,
                                                          UINT uMsg,
                                                          WPARAM wParam,
                                                          LPARAM lParam) {
  m_hDialog = hwndDlg;
  ...
  case WM_COMMAND:
    ...
    case IDOK: {
      ...
      if (!g_Params.m_szName[0]) {
        Q_strncpy(g_Params.m_szName, "Permit Responses",
                  sizeof(g_Params.m_szName));
      }
