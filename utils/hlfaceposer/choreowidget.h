...
//-----------------------------------------------------------------------------
// Purpose: CChoreoWidgets are mxWindows that we show in the Choreography view
// area
//  so that we can manipulate them with the mouse.  The widgets follow the scene
//  hierarchy of actors/channels/events, without having to hang off of the
//  underlying data.  They are just for the UI.
//-----------------------------------------------------------------------------
class CChoreoWidget {
public:
  ...
  // Determine height to reserver for widget ( Actors can be expanded or
  // collapsed, e.g. )
