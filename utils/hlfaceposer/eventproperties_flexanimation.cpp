...
void CEventPropertiesFlexAnimationDialog::InitControlData(
    CEventParams *params) {
...
void CEventPropertiesFlexAnimationDialog::ShowControlsForEventType(
    CEventParams *params) {
...
//-----------------------------------------------------------------------------
static BOOL CALLBACK EventPropertiesFlexAnimationDialogProc(HWND hwndDlg,
                                                            UINT uMsg,
                                                            WPARAM wParam,
                                                            LPARAM lParam) {
  return g_EventPropertiesFlexAnimationDialog.HandleMessage(hwndDlg, uMsg,
                                                            wParam, lParam);
};

BOOL CEventPropertiesFlexAnimationDialog::HandleMessage(HWND hwndDlg, UINT uMsg,
                                                        WPARAM wParam,
                                                        LPARAM lParam) {
  m_hDialog = hwndDlg;
  ...
  case WM_COMMAND:
    ...
    case IDOK: {
      ...
      if (!g_Params.m_szName[0]) {
        Q_strncpy(g_Params.m_szName, "Facial Animation",
                  sizeof(g_Params.m_szName));
      }
