...
void CEventPropertiesSequenceDialog::ShowControlsForEventType(
    CEventParams *params) {
...
//-----------------------------------------------------------------------------
static BOOL CALLBACK EventPropertiesSequenceDialogProc(HWND hwndDlg, UINT uMsg,
                                                       WPARAM wParam,
                                                       LPARAM lParam) {
  return g_EventPropertiesSequenceDialog.HandleMessage(hwndDlg, uMsg, wParam,
                                                       lParam);
};

BOOL CEventPropertiesSequenceDialog::HandleMessage(HWND hwndDlg, UINT uMsg,
                                                   WPARAM wParam,
                                                   LPARAM lParam) {
  m_hDialog = hwndDlg;
  ...
  case WM_COMMAND:
    ...
    case IDC_CHECK_PLAYOVERSCRIPT: {
      g_Params.m_bPlayOverScript =
          SendMessage(GetControl(IDC_CHECK_PLAYOVERSCRIPT), BM_GETCHECK, 0,
                      0) == BST_CHECKED
              ? true
              : false;
    } break;
