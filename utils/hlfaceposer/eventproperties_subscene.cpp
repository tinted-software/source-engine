...
void CEventPropertiesSubSceneDialog::ShowControlsForEventType(
    CEventParams *params) {
...
//-----------------------------------------------------------------------------
static BOOL CALLBACK EventPropertiesSubSceneDialogProc(HWND hwndDlg, UINT uMsg,
                                                       WPARAM wParam,
                                                       LPARAM lParam) {
  return g_EventPropertiesSubSceneDialog.HandleMessage(hwndDlg, uMsg, wParam,
                                                       lParam);
};

BOOL CEventPropertiesSubSceneDialog::HandleMessage(HWND hwndDlg, UINT uMsg,
                                                   WPARAM wParam,
                                                   LPARAM lParam) {
  m_hDialog = hwndDlg;
  ...
  case WM_COMMAND:
    ...
    case IDC_SELECTWAV: {
      char filename[512];
      if (FacePoser_ShowOpenFileNameDialog(filename, sizeof(filename), "scenes",
                                           "*.vcd")) {
