...
void CEventPropertiesFireTriggerDialog::ShowControlsForEventType(
    CEventParams *params) {
...
//-----------------------------------------------------------------------------
static BOOL CALLBACK EventPropertiesFireTriggerDialogProc(HWND hwndDlg,
                                                          UINT uMsg,
                                                          WPARAM wParam,
                                                          LPARAM lParam) {
  return g_EventPropertiesFireTriggerDialog.HandleMessage(hwndDlg, uMsg, wParam,
                                                          lParam);
};

BOOL CEventPropertiesFireTriggerDialog::HandleMessage(HWND hwndDlg, UINT uMsg,
                                                      WPARAM wParam,
                                                      LPARAM lParam) {
  m_hDialog = hwndDlg;
  ...
  case WM_COMMAND:
    ...
    case IDOK: {
      ...
      if (!g_Params.m_szName[0]) {
        Q_snprintf(g_Params.m_szName, sizeof(g_Params.m_szName),
                   "Firetrigger %s", g_Params.m_szParameters);
      }
