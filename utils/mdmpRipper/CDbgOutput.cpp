...
STDMETHODIMP_(ULONG) CDbgOutput::AddRef(THIS) { return (++m_iRefCount); }

STDMETHODIMP_(ULONG) CDbgOutput::Release(THIS) { return (--m_iRefCount); }
...
void CDbgOutput::SetOutputPanel(vgui::VPANEL Target) { m_Target = Target; }
