...
void CreateMessageWindow(void) {
  ...
  staticHwnd = CreateWindowEx(0, "minidumpRipper_Window", "Hidden Window", 0, 0,
                              0, 1, 1, NULL, NULL, GetModuleHandle(NULL), NULL);
}
...
bool CMDRipperApp::PreInit() {
  ...
  g_pFullFileSystem->AddSearchPath(".\\minidumpRipper\\", MDRIPPER_WRITE_PATH,
                                   PATH_ADD_TO_HEAD);
