...
enum moduleType { GOOD, BAD, UNKNOWN };

struct version {
  int v1, v2, v3, v4;
  bool operator==(version version2) {
    return v1 == version2.v1 && v2 == version2.v2 && v3 == version2.v3 &&
           v4 == version2.v4;
  }
};
...
public:
  ...
  CMiniDumpObject(const char *pszFilename,
  ...
  inline const char *GetName() { return m_pszMiniDumpFileName; }

private:
  void Init(HANDLE pFileMap, CUtlVector<module> *pKnownModuleList);
  void InitFromFilename(const char *pszFilename,
                        CUtlVector<module> *pKnownModuleList);
  void InitFromHandle(HANDLE pMiniDumpHandle,
                      CUtlVector<module> *pKnownModuleList);
  int ModuleListToListPanel(vgui::ListPanel *pTokenList,
                            CUtlVector<module> *pModuleList, bool bCumulative,
                            int startingModule);
