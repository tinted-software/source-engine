...
public:
  ...
  void Process(const char *gamespecific, const char *root, const char *dsp,
               const char *config);
...
private:
  void ProcessModule(bool forcequiet, int depth, int &maxdepth, int &numheaders,
                     int &skippedfiles, const char *baseroot, const char *root,
                     const char *module);
  void ProcessModules(const char *root, const char *rootmodule);
  void PrintResults(void);
  void ConstructModuleList_R(int level, const char *gamespecific,
                             const char *root);
  ...
  bool TryBuild(const char *rootdir, const char *filename,
