...
bool UploadBugReport(const netadr_t &cserIP, const CSteamID &userid, int build,
                     char const *title, char const *body, char const *exename,
                     char const *pchGamedir, char const *mapname,
                     char const *reporttype, char const *email,
                     char const *accountname, int ram, int cpu,
                     char const *processor, unsigned int high, unsigned int low,
  ...
  Q_strncpy(params.m_sGameDirectory, pchGamedir,
...
CWin32UploadBugReport::CWin32UploadBugReport(
    ...
    : m_States(), m_uCurrentState(eCreateTCPSocket), m_HarvesterSockAddr(),
      m_SocketTCP(0), m_rBugReportParameters(rBugReportParameters),
...
//
//-----------------------------------------------------------------------------
bool CWin32UploadBugReport::DoBlockingReceive(uint bytesExpected,
                                              CUtlBuffer &buf) {
...
void CWin32UploadBugReport::AddState(uint StateIndex,
...
EBugReportUploadStatus
Win32UploadBugReportBlocking(const TBugReportParameters &rBugReportParameters) {
