...
//-----------------------------------------------------------------------------
static BOOL CALLBACK VSSPropertiesDialogProc(HWND hwndDlg, UINT uMsg,
  ...
  case WM_INITDIALOG:
    ...
    // ...
    {
      ...
      SendMessage(GetDlgItem(hwndDlg, IDC_VSS_USERNAME), EM_SETSEL, 0,
                  MAKELONG(0, 0xffff));
    }
    return FALSE;
  ...
  case WM_COMMAND:
    ...
    case IDOK:
      ...
      GetDlgItemText(hwndDlg, IDC_VSS_USERNAME, g_Params.m_szUserName,
                     sizeof(g_Params.m_szUserName));
      GetDlgItemText(hwndDlg, IDC_VSS_PROJECT, g_Params.m_szProject,
                     sizeof(g_Params.m_szProject));
      EndDialog(hwndDlg, 1);
      break;
    case IDCANCEL:
      EndDialog(hwndDlg, 0);
