...
CProject *CScene::GetOwnerProject() { return m_pOwner; }
...
char const *CScene::GetName() const { return m_szName; }

int CScene::GetVCDCount() const { return m_Files.Count(); }
...
bool CScene::IsCheckedOut() const { return false; }
