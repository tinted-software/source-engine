...
#define MULTIPLY(var, const) ((var) * (const))
  ...
  for (ctr = 0; ctr < DCTSIZE; ctr++) {
    ...
    dataptr[1] =
        (DCTELEM)RIGHT_SHIFT(tmp0 + tmp10 + tmp12, CONST_BITS - PASS1_BITS);
    dataptr[3] =
        (DCTELEM)RIGHT_SHIFT(tmp1 + tmp11 + tmp13, CONST_BITS - PASS1_BITS);
    dataptr[5] =
        (DCTELEM)RIGHT_SHIFT(tmp2 + tmp11 + tmp12, CONST_BITS - PASS1_BITS);
    dataptr[7] =
        (DCTELEM)RIGHT_SHIFT(tmp3 + tmp10 + tmp13, CONST_BITS - PASS1_BITS);
  ...
  for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
    ...
    dataptr[DCTSIZE * 2] = (DCTELEM)RIGHT_SHIFT(
        z1 + MULTIPLY(tmp12, FIX_0_765366865), CONST_BITS + PASS1_BITS);
    dataptr[DCTSIZE * 6] = (DCTELEM)RIGHT_SHIFT(
        z1 - MULTIPLY(tmp13, FIX_1_847759065), CONST_BITS + PASS1_BITS);
...
jpeg_fdct_6x6(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (ctr = 0; ctr < 6; ctr++) {
    ...
    dataptr[DCTSIZE * 0] =
        (DCTELEM)DESCALE(MULTIPLY(tmp10 + tmp11, FIX(1.777777778)), /* 16/9 */
                         CONST_BITS + PASS1_BITS);
    dataptr[DCTSIZE * 2] =
...
jpeg_fdct_5x5(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (ctr = 0; ctr < 5; ctr++) {
    ...
    dataptr[1] =
        (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp0, FIX(0.513743148)), /* c1-c3 */
                         CONST_BITS - PASS1_BITS - 1);
    dataptr[3] =
        (DCTELEM)DESCALE(tmp10 - MULTIPLY(tmp1, FIX(2.176250899)), /* c1+c3 */
                         CONST_BITS - PASS1_BITS - 1);
  ...
  for (ctr = 0; ctr < 5; ctr++) {
    ...
    dataptr[DCTSIZE * 1] =
        (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp0, FIX(0.657591230)), /* c1-c3 */
                         CONST_BITS + PASS1_BITS);
    dataptr[DCTSIZE * 3] =
        (DCTELEM)DESCALE(tmp10 - MULTIPLY(tmp1, FIX(2.785601151)), /* c1+c3 */
                         CONST_BITS + PASS1_BITS);
...
jpeg_fdct_4x4(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (ctr = 0; ctr < 4; ctr++) {
    ...
    /* Add fudge factor here for final descale. */
    tmp0 =
        dataptr[DCTSIZE * 0] + dataptr[DCTSIZE * 3] + (ONE << (PASS1_BITS - 1));
...
jpeg_fdct_10x10(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (;;) {
    ...
    tmp12 += tmp12;
    dataptr[4] =
        (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp12, FIX(1.144122806)) -    /* c4 */
                             MULTIPLY(tmp11 - tmp12, FIX(0.437016024)), /* c8 */
                         CONST_BITS - 1);
    tmp10 = MULTIPLY(tmp13 + tmp14, FIX(0.831253876)); /* c6 */
    dataptr[2] =
        (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp13, FIX(0.513743148)), /* c2-c6 */
                         CONST_BITS - 1);
    dataptr[6] =
        (DCTELEM)DESCALE(tmp10 - MULTIPLY(tmp14, FIX(2.176250899)), /* c2+c6 */
                         CONST_BITS - 1);
    ...
    tmp2 <<= CONST_BITS;
    dataptr[1] =
        (DCTELEM)DESCALE(MULTIPLY(tmp0, FIX(1.396802247)) +            /* c1 */
  ...
  for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
    ...
    dataptr[DCTSIZE * 0] =
        (DCTELEM)DESCALE(MULTIPLY(tmp10 + tmp11 + tmp12, FIX(1.28)), /* 32/25 */
                         CONST_BITS + 2);
    tmp12 += tmp12;
    dataptr[DCTSIZE * 4] =
        (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp12, FIX(1.464477191)) -    /* c4 */
                             MULTIPLY(tmp11 - tmp12, FIX(0.559380511)), /* c8 */
                         CONST_BITS + 2);
    tmp10 = MULTIPLY(tmp13 + tmp14, FIX(1.064004961)); /* c6 */
    dataptr[DCTSIZE * 2] =
        (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp13, FIX(0.657591230)), /* c2-c6 */
                         CONST_BITS + 2);
    dataptr[DCTSIZE * 6] =
        (DCTELEM)DESCALE(tmp10 - MULTIPLY(tmp14, FIX(2.785601151)), /* c2+c6 */
                         CONST_BITS + 2);
    ...
    tmp11 = tmp1 - tmp3;
    dataptr[DCTSIZE * 5] =
        (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp11 - tmp2, FIX(1.28)), /* 32/25 */
                         CONST_BITS + 2);
    tmp2 = MULTIPLY(tmp2, FIX(1.28)); /* 32/25 */
    dataptr[DCTSIZE * 1] =
        (DCTELEM)DESCALE(MULTIPLY(tmp0, FIX(1.787906876)) +            /* c1 */
...
jpeg_fdct_11x11(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (;;) {
    ...
    /* Apply unsigned->signed conversion */
    dataptr[0] =
        (DCTELEM)((tmp0 + tmp1 + tmp2 + tmp3 + tmp4 + tmp5 - 11 * CENTERJSAMPLE)
                  << 1);
    tmp5 += tmp5;
    tmp0 -= tmp5;
    tmp1 -= tmp5;
  ...
  for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
    ...
    dataptr[DCTSIZE * 4] =
        (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp12, FIX(1.088662108)), /* c4 */
                         CONST_BITS + 1);
    dataptr[DCTSIZE * 2] =
        (DCTELEM)DESCALE(MULTIPLY(tmp14 - tmp15, FIX(0.888888889)) + /* 8/9 */
...
jpeg_fdct_14x14(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (;;) {
    ...
    dataptr[2] =
        (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp14, FIX(0.273079590)) /* c2-c6 */
                             + MULTIPLY(tmp16, FIX(0.613604268)),  /* c10 */
                         CONST_BITS);
    dataptr[6] =
        (DCTELEM)DESCALE(tmp10 - MULTIPLY(tmp15, FIX(1.719280954)) /* c6+c10 */
  ...
  for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
    ...
    dataptr[DCTSIZE * 0] = (DCTELEM)DESCALE(
        MULTIPLY(tmp10 + tmp11 + tmp12 + tmp13, FIX(0.653061224)), /* 32/49 */
        CONST_BITS + 1);
    tmp13 += tmp13;
    dataptr[DCTSIZE * 4] = (DCTELEM)DESCALE(
    ...
    dataptr[DCTSIZE * 2] =
        (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp14, FIX(0.178337691)) /* c2-c6 */
                             + MULTIPLY(tmp16, FIX(0.400721155)),  /* c10 */
                         CONST_BITS + 1);
    dataptr[DCTSIZE * 6] =
        (DCTELEM)DESCALE(tmp10 - MULTIPLY(tmp15, FIX(1.122795725)) /* c6+c10 */
    ...
    dataptr[DCTSIZE * 3] = (DCTELEM)DESCALE(
        ...
        CONST_BITS + 1);
    dataptr[DCTSIZE * 1] = (DCTELEM)DESCALE(
        tmp11 + tmp12 + tmp3 - MULTIPLY(tmp0, FIX(0.735987049)) /* c3+c5-c1 */
...
jpeg_fdct_15x15(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
    ...
    z3 = tmp2 + tmp7;
    dataptr[DCTSIZE * 0] =
        (DCTELEM)DESCALE(MULTIPLY(z1 + z2 + z3, FIX(1.137777778)), /* 256/225 */
                         CONST_BITS + 2);
    z3 += z3;
    dataptr[DCTSIZE * 6] =
...
jpeg_fdct_16x16(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (;;) {
    ...
    /* Apply unsigned->signed conversion */
    dataptr[0] = (DCTELEM)((tmp10 + tmp11 + tmp12 + tmp13 - 16 * CENTERJSAMPLE)
                           << PASS1_BITS);
    dataptr[4] = (DCTELEM)DESCALE(
    ...
    dataptr[2] =
        (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp15, FIX(1.451774982)) /* c6+c14 */
                             + MULTIPLY(tmp16, FIX(2.172734804)),  /* c2+c10 */
                         CONST_BITS - PASS1_BITS);
    dataptr[6] =
        (DCTELEM)DESCALE(tmp10 - MULTIPLY(tmp14, FIX(0.211164243)) /* c2-c6 */
...
jpeg_fdct_16x8(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
    ...
    z1 = MULTIPLY(tmp12 + tmp13, FIX_0_541196100);
    dataptr[DCTSIZE * 2] = (DCTELEM)DESCALE(
        z1 + MULTIPLY(tmp12, FIX_0_765366865), CONST_BITS + PASS1_BITS + 1);
    dataptr[DCTSIZE * 6] = (DCTELEM)DESCALE(
        z1 - MULTIPLY(tmp13, FIX_1_847759065), CONST_BITS + PASS1_BITS + 1);
    ...
    dataptr[DCTSIZE * 1] =
        (DCTELEM)DESCALE(tmp0 + tmp10 + tmp12, CONST_BITS + PASS1_BITS + 1);
    dataptr[DCTSIZE * 3] =
        (DCTELEM)DESCALE(tmp1 + tmp11 + tmp13, CONST_BITS + PASS1_BITS + 1);
    dataptr[DCTSIZE * 5] =
        (DCTELEM)DESCALE(tmp2 + tmp11 + tmp12, CONST_BITS + PASS1_BITS + 1);
    dataptr[DCTSIZE * 7] =
        (DCTELEM)DESCALE(tmp3 + tmp10 + tmp13, CONST_BITS + PASS1_BITS + 1);
...
jpeg_fdct_12x6(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (ctr = 0; ctr < 6; ctr++) {
    ...
    /* Apply unsigned->signed conversion */
    dataptr[0] =
        (DCTELEM)((tmp10 + tmp11 + tmp12 - 12 * CENTERJSAMPLE) << PASS1_BITS);
...
jpeg_fdct_10x5(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (ctr = 0; ctr < 5; ctr++) {
    ...
    /* Apply unsigned->signed conversion */
    dataptr[0] =
        (DCTELEM)((tmp10 + tmp11 + tmp12 - 10 * CENTERJSAMPLE) << PASS1_BITS);
    tmp12 += tmp12;
    dataptr[4] =
        (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp12, FIX(1.144122806)) -    /* c4 */
                             MULTIPLY(tmp11 - tmp12, FIX(0.437016024)), /* c8 */
...
jpeg_fdct_8x4(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (ctr = 0; ctr < 4; ctr++) {
    ...
    dataptr[1] =
        (DCTELEM)RIGHT_SHIFT(tmp0 + tmp10 + tmp12, CONST_BITS - PASS1_BITS - 1);
    dataptr[3] =
        (DCTELEM)RIGHT_SHIFT(tmp1 + tmp11 + tmp13, CONST_BITS - PASS1_BITS - 1);
    dataptr[5] =
        (DCTELEM)RIGHT_SHIFT(tmp2 + tmp11 + tmp12, CONST_BITS - PASS1_BITS - 1);
    dataptr[7] =
        (DCTELEM)RIGHT_SHIFT(tmp3 + tmp10 + tmp13, CONST_BITS - PASS1_BITS - 1);
...
jpeg_fdct_8x16(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (;;) {
    ...
    dataptr[1] =
        (DCTELEM)DESCALE(tmp0 + tmp10 + tmp12, CONST_BITS - PASS1_BITS);
    dataptr[3] =
        (DCTELEM)DESCALE(tmp1 + tmp11 + tmp13, CONST_BITS - PASS1_BITS);
    dataptr[5] =
        (DCTELEM)DESCALE(tmp2 + tmp11 + tmp12, CONST_BITS - PASS1_BITS);
    dataptr[7] =
        (DCTELEM)DESCALE(tmp3 + tmp10 + tmp13, CONST_BITS - PASS1_BITS);
