...
//-----------------------------------------------------------------------------
static bool LoadFile(const char *pFileName, CUtlBuffer &buf,
                     bool bFailOnError) {
...
static bool PFMRead(CUtlBuffer &fileBuffer, int &nWidth, int &nHeight,
                    float **ppImage) {
...
void WriteSubRect(int nSrcWidth, int nSrcHeight, const float *pSrcImage,
                  int nSrcOffsetX, int nSrcOffsetY, int nDstWidth,
                  int nDstHeight, const char *pSrcFileName,
                  const char *pDstFileNameExtension) {
  ...
  for (y = 0; y < nDstHeight; y++) {
    for (x = 0; x < nDstWidth; x++) {
      pDstImage[(x + (nDstWidth * y)) * 3 + 0] =
          pSrcImage[((nSrcOffsetX + x) + (nSrcOffsetY + y) * nSrcWidth) * 3 +
                    0];
...
int main(int argc, char **argv) {
  ...
  WriteSubRect(nSrcWidth, nSrcHeight, pSrcImage, nDstWidth * 0, nDstHeight * 1,
               nDstWidth, nDstHeight, argv[1], "ft");
  WriteSubRect(nSrcWidth, nSrcHeight, pSrcImage, nDstWidth * 1, nDstHeight * 1,
               nDstWidth, nDstHeight, argv[1], "lf");
  WriteSubRect(nSrcWidth, nSrcHeight, pSrcImage, nDstWidth * 2, nDstHeight * 1,
               nDstWidth, nDstHeight, argv[1], "bk");
  WriteSubRect(nSrcWidth, nSrcHeight, pSrcImage, nDstWidth * 3, nDstHeight * 1,
               nDstWidth, nDstHeight, argv[1], "rt");
  WriteSubRect(nSrcWidth, nSrcHeight, pSrcImage, nDstWidth * 3, nDstHeight * 0,
               nDstWidth, nDstHeight, argv[1], "up");
  WriteSubRect(nSrcWidth, nSrcHeight, pSrcImage, nDstWidth * 3, nDstHeight * 2,
               nDstWidth, nDstHeight, argv[1], "dn");
