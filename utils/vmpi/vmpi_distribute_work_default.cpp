...
public:
  ...
  void AssignWUsToWorker(int iWorker) {
    ...
    if (CommandLine()->FindParm("-mpi_NoScheduler")) {
      Warning("\n\n-mpi_NoScheduler found: Warning - this should only be used "
              "for testing and with 1 worker!\n\n");
    ...
    // Any absolutely untouched partitions yet?
      ...
      size_t numPartitions =
          min((size_t)(iEnd - iBegin), (size_t)g_nMaxWorkerCount);
