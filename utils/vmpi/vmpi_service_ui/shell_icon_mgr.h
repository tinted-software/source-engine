...
public:
  ...
  bool
  Init(IShellIconMgrHelper *pHelper,
       const char *pToolTip, // This must be allocated by the caller and must be
                             // valid as long as the CShellIconMgr exists.
...
private:
  ...
  UINT m_uTaskbarRestart; // This message is sent to us when the taskbar is
                          // created.
