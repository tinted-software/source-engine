...
char *CTFStatsReport::javaScriptSource =
    ...
    "{\n" LBR "	if (!this.isIE5)\n" LBR
    "		document.write(\"<table width= \"+tableWid.toString() + \" "
    "bordercolor=#999999 border=1 cellspacing=0 cellpadding=5 rows=\"+ "
    "numrows.toString() + \" cols=\"+ numcols.toString() + \">\\n\");\n" LBR
    "	else \n" LBR
    "		document.write(\"<table width= \"+tableWid.toString() + \" "
    "bordercolor=#999999 border=0 cellspacing=0 cellpadding=5 rows=\"+ "
    "numrows.toString() + \" cols=\"+ numcols.toString() + \">\\n\");\n" LBR
    "}\n" LBR "BrowserType.prototype.writeDetailTableTag=BrowserType_"
              "writeDetailTableTag;\n" LBR "\n" LBR "\n" LBR "\n" LBR "\n" LBR
