...
class JM_IX_DECL file_iterator
    : public JM_INPUT_ITERATOR(const char *, __JM_STDC::ptrdiff_t) {
  char *_root;
  char *_path;
  char *ptr;
...
class JM_IX_DECL directory_iterator
    : public JM_INPUT_ITERATOR(const char *, __JM_STDC::ptrdiff_t) {
  char *_root;
  char *_path;
  char *ptr;
...
inline bool operator<(const directory_iterator &f1,
                      const directory_iterator &f2) {
  return false;
}
