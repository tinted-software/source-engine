...
JM_IX_DECL bool RE_CALL re_lookup_def_collate_name(re_str<char> &buf,
                                                   const char *name);
...
inline bool RE_CALL re_lookup_collate(re_str<char> &buf, const char *first,
                                      const char *last) {
...
JM_IX_DECL bool RE_CALL re_lookup_collate(re_str<wchar_t> &out,
                                          const wchar_t *first,
                                          const wchar_t *last);
#endif
