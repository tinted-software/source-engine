...
//------------------------------------------------------------------------------------------------------
// Purpose:  CHTMLFile represents an HTML text file that is being created. It
// has some misc helper stuff, like writing the body tag for you, and linking to
// the style sheet.  Also some little helper functions to do <br>s and <p>s
//------------------------------------------------------------------------------------------------------
class CHTMLFile {
public:
...
public:
  ...
  CHTMLFile(const char *filenm, const char *title, bool fPrintBody = true,
            const char *bgimage = NULL, int leftmarg = 0, int topmarg = 20);
