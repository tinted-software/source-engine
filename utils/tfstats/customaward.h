...
protected:
  ...
  map<PID, int> plrscores; // this is wrt to the current award.  score in this
                           // sense is not related to game score
                           //  but simply a score that is relative to other
                           //  contenders for the award.
  map<PID, int>
      plrnums; // this is the number of times any of the triggers was activated

  map<string, int> stringscores; // this is wrt to the current award.  score in
                                 // this sense is not related to game score
                                 //  but simply a score that is relative to
                                 //  other contenders for the award.
  map<string, int> stringnums; // this is the number of times any of the
                               // triggers was activated
