...
CFolderSelectProps::CFolderSelectProps(CWnd *pParent /*=NULL*/)
    : CPropertyPage(CFolderSelectProps::IDD),
      ...
      m_StrPlayerHTTPPath("PlayerHTTPPath"), m_StrPlayerDir("PlayerDir"),
      m_StrTFStatsDir("TFStatsDir"), m_StrSupportDir("SupportDir"),
      m_StrRuleDir("RuleDir"), m_StrOutDir("OutputDir"),
...
void CFolderSelectProps::OnDefaultCheckBoxClick() { UpdateFolders(); }
...
void CFolderSelectProps::UpdateFolders(bool safe) {
  ...
  this->m_PlayerDir.EnableWindow(theApp.persistPlayerStats &&
                                 !m_DefPlayer.GetCheck());
  this->m_PlayerHTTPPath.EnableWindow(theApp.persistPlayerStats &&
                                      !m_DefPlayer.GetCheck());
  this->m_SupportDir.EnableWindow(theApp.useSupportDir &&
                                  !m_DefSupport.GetCheck());
  this->m_SupportHTTPPath.EnableWindow(theApp.useSupportDir &&
                                       !m_DefSupport.GetCheck());
