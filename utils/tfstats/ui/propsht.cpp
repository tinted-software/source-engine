...
CAllControlsSheet::CAllControlsSheet(UINT nIDCaption, CWnd *pParentWnd,
                                     UINT iSelectPage)
...
CAllControlsSheet::CAllControlsSheet(LPCTSTR pszCaption, CWnd *pParentWnd,
                                     UINT iSelectPage)
...
HCURSOR CAllControlsSheet::OnQueryDragIcon() { return (HCURSOR)m_hIcon; }

BOOL CAllControlsSheet::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName,
