...
//
//-----------------------------------------------------------------------------
CGlobalSubPanel::CGlobalSubPanel(vgui::Panel *pParent, const char *pszName,
  ...
  {
    vgui::Label *pClassLabel =
        new vgui::Label(this, "classLabel", "#classLabel");
    m_pClassComboBox = new vgui::ComboBox(
        this, "classComboBox", CItemUploadTF::GetClassCount(), false);
  ...
  {
    vgui::Label *pAutoSkinLabel =
        new vgui::Label(this, "autoSkinLabel", "#autoSkinLabel");
    m_pAutoSkinCheckButton = new vgui::CheckButton(this, "autoSkinCheckButton",
                                                   "#autoSkinCheckButtonText");
  ...
  {
    vgui::Label *pSteamLabel =
        new vgui::Label(this, "steamLabel", "#steamLabel");
...
void CGlobalSubPanel::UpdateGUI() {
  ...
  m_pAutoSkinCheckButton->SetSelected(
      pItemUploadWizard->Asset().SkinToBipHead());
...
void CGlobalSubPanel::OnCheckButtonChecked(vgui::Panel *pPanel) {
  ...
  pItemUploadWizard->Asset().SetSkinToBipHead(
      m_pAutoSkinCheckButton->IsSelected());
}